...
static inline int list_size(list_entry_t *list) __attribute__((always_inline));
...
#define le2list(le, member)                 \
    to_struct((le), struct list_entry, member)
