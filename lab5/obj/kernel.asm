...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	532060ef          	jal	ra,ffffffffc020657c <memset>
...
ffffffffc0200056:	55658593          	addi	a1,a1,1366 # ffffffffc02065a8 <etext+0x2>
ffffffffc020005a:	00006517          	auipc	a0,0x6
ffffffffc020005e:	56e50513          	addi	a0,a0,1390 # ffffffffc02065c8 <etext+0x22>
...
ffffffffc020007a:	47b050ef          	jal	ra,ffffffffc0205cf4 <proc_init>
...
ffffffffc020008e:	5ff050ef          	jal	ra,ffffffffc0205e8c <cpu_idle>
...
ffffffffc02000ac:	52850513          	addi	a0,a0,1320 # ffffffffc02065d0 <etext+0x2a>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	00a060ef          	jal	ra,ffffffffc020617e <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	7d5050ef          	jal	ra,ffffffffc020617e <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc020020e:	3ce50513          	addi	a0,a0,974 # ffffffffc02065d8 <etext+0x32>
void print_kerninfo(void) {
...
ffffffffc0200224:	3d850513          	addi	a0,a0,984 # ffffffffc02065f8 <etext+0x52>
ffffffffc0200228:	f59ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc020022c:	00006597          	auipc	a1,0x6
ffffffffc0200230:	37a58593          	addi	a1,a1,890 # ffffffffc02065a6 <etext>
ffffffffc0200234:	00006517          	auipc	a0,0x6
ffffffffc0200238:	3e450513          	addi	a0,a0,996 # ffffffffc0206618 <etext+0x72>
...
ffffffffc020024c:	3f050513          	addi	a0,a0,1008 # ffffffffc0206638 <etext+0x92>
...
ffffffffc0200260:	3fc50513          	addi	a0,a0,1020 # ffffffffc0206658 <etext+0xb2>
...
ffffffffc020028e:	3ee50513          	addi	a0,a0,1006 # ffffffffc0206678 <etext+0xd2>
}
...
ffffffffc020029c:	41060613          	addi	a2,a2,1040 # ffffffffc02066a8 <etext+0x102>
ffffffffc02002a0:	04d00593          	li	a1,77
ffffffffc02002a4:	00006517          	auipc	a0,0x6
ffffffffc02002a8:	41c50513          	addi	a0,a0,1052 # ffffffffc02066c0 <etext+0x11a>
void print_stackframe(void) {
...
ffffffffc02002b8:	42460613          	addi	a2,a2,1060 # ffffffffc02066d8 <etext+0x132>
ffffffffc02002bc:	00006597          	auipc	a1,0x6
ffffffffc02002c0:	43c58593          	addi	a1,a1,1084 # ffffffffc02066f8 <etext+0x152>
ffffffffc02002c4:	00006517          	auipc	a0,0x6
ffffffffc02002c8:	43c50513          	addi	a0,a0,1084 # ffffffffc0206700 <etext+0x15a>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002d6:	43e60613          	addi	a2,a2,1086 # ffffffffc0206710 <etext+0x16a>
ffffffffc02002da:	00006597          	auipc	a1,0x6
ffffffffc02002de:	45e58593          	addi	a1,a1,1118 # ffffffffc0206738 <etext+0x192>
ffffffffc02002e2:	00006517          	auipc	a0,0x6
ffffffffc02002e6:	41e50513          	addi	a0,a0,1054 # ffffffffc0206700 <etext+0x15a>
ffffffffc02002ea:	e97ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ee:	00006617          	auipc	a2,0x6
ffffffffc02002f2:	45a60613          	addi	a2,a2,1114 # ffffffffc0206748 <etext+0x1a2>
ffffffffc02002f6:	00006597          	auipc	a1,0x6
ffffffffc02002fa:	47258593          	addi	a1,a1,1138 # ffffffffc0206768 <etext+0x1c2>
ffffffffc02002fe:	00006517          	auipc	a0,0x6
ffffffffc0200302:	40250513          	addi	a0,a0,1026 # ffffffffc0206700 <etext+0x15a>
...
ffffffffc020033c:	44050513          	addi	a0,a0,1088 # ffffffffc0206778 <etext+0x1d2>
kmonitor(struct trapframe *tf) {
...
ffffffffc020035e:	44650513          	addi	a0,a0,1094 # ffffffffc02067a0 <etext+0x1fa>
...
ffffffffc0200374:	4a0c0c13          	addi	s8,s8,1184 # ffffffffc0206810 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200378:	00006917          	auipc	s2,0x6
ffffffffc020037c:	45090913          	addi	s2,s2,1104 # ffffffffc02067c8 <etext+0x222>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200380:	00006497          	auipc	s1,0x6
ffffffffc0200384:	45048493          	addi	s1,s1,1104 # ffffffffc02067d0 <etext+0x22a>
        if (argc == MAXARGS - 1) {
ffffffffc0200388:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020038a:	00006b17          	auipc	s6,0x6
ffffffffc020038e:	44eb0b13          	addi	s6,s6,1102 # ffffffffc02067d8 <etext+0x232>
        argv[argc ++] = buf;
ffffffffc0200392:	00006a17          	auipc	s4,0x6
ffffffffc0200396:	366a0a13          	addi	s4,s4,870 # ffffffffc02066f8 <etext+0x152>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc02003b8:	45cd0d13          	addi	s10,s10,1116 # ffffffffc0206810 <commands>
        argv[argc ++] = buf;
...
ffffffffc02003c0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003c2:	186060ef          	jal	ra,ffffffffc0206548 <strcmp>
...
ffffffffc02003d4:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003d6:	172060ef          	jal	ra,ffffffffc0206548 <strcmp>
...
ffffffffc0200414:	152060ef          	jal	ra,ffffffffc0206566 <strchr>
...
ffffffffc0200452:	114060ef          	jal	ra,ffffffffc0206566 <strchr>
...
ffffffffc0200470:	38c50513          	addi	a0,a0,908 # ffffffffc02067f8 <etext+0x252>
...
ffffffffc02004ac:	3b050513          	addi	a0,a0,944 # ffffffffc0206858 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc02004c2:	35250513          	addi	a0,a0,850 # ffffffffc0207810 <default_pmm_manager+0x518>
...
ffffffffc02004f6:	38650513          	addi	a0,a0,902 # ffffffffc0206878 <commands+0x68>
__warn(const char *file, int line, const char *fmt, ...) {
...
ffffffffc0200516:	2fe50513          	addi	a0,a0,766 # ffffffffc0207810 <default_pmm_manager+0x518>
...
ffffffffc0200550:	34c50513          	addi	a0,a0,844 # ffffffffc0206898 <commands+0x88>
    ticks = 0;
...
ffffffffc020060e:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc0200610:	77f050ef          	jal	ra,ffffffffc020658e <memcpy>
    return 0;
}
...
ffffffffc0200632:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc0200634:	75b050ef          	jal	ra,ffffffffc020658e <memcpy>
    return 0;
}
...
ffffffffc0200674:	24850513          	addi	a0,a0,584 # ffffffffc02068b8 <commands+0xa8>
void print_regs(struct pushregs* gpr) {
...
ffffffffc0200684:	25050513          	addi	a0,a0,592 # ffffffffc02068d0 <commands+0xc0>
...
ffffffffc0200692:	25a50513          	addi	a0,a0,602 # ffffffffc02068e8 <commands+0xd8>
...
ffffffffc02006a0:	26450513          	addi	a0,a0,612 # ffffffffc0206900 <commands+0xf0>
...
ffffffffc02006ae:	26e50513          	addi	a0,a0,622 # ffffffffc0206918 <commands+0x108>
...
ffffffffc02006bc:	27850513          	addi	a0,a0,632 # ffffffffc0206930 <commands+0x120>
...
ffffffffc02006ca:	28250513          	addi	a0,a0,642 # ffffffffc0206948 <commands+0x138>
...
ffffffffc02006d8:	28c50513          	addi	a0,a0,652 # ffffffffc0206960 <commands+0x150>
...
ffffffffc02006e6:	29650513          	addi	a0,a0,662 # ffffffffc0206978 <commands+0x168>
...
ffffffffc02006f4:	2a050513          	addi	a0,a0,672 # ffffffffc0206990 <commands+0x180>
...
ffffffffc0200702:	2aa50513          	addi	a0,a0,682 # ffffffffc02069a8 <commands+0x198>
...
ffffffffc0200710:	2b450513          	addi	a0,a0,692 # ffffffffc02069c0 <commands+0x1b0>
...
ffffffffc020071e:	2be50513          	addi	a0,a0,702 # ffffffffc02069d8 <commands+0x1c8>
...
ffffffffc020072c:	2c850513          	addi	a0,a0,712 # ffffffffc02069f0 <commands+0x1e0>
...
ffffffffc020073a:	2d250513          	addi	a0,a0,722 # ffffffffc0206a08 <commands+0x1f8>
...
ffffffffc0200748:	2dc50513          	addi	a0,a0,732 # ffffffffc0206a20 <commands+0x210>
...
ffffffffc0200756:	2e650513          	addi	a0,a0,742 # ffffffffc0206a38 <commands+0x228>
...
ffffffffc0200764:	2f050513          	addi	a0,a0,752 # ffffffffc0206a50 <commands+0x240>
...
ffffffffc0200772:	2fa50513          	addi	a0,a0,762 # ffffffffc0206a68 <commands+0x258>
...
ffffffffc0200780:	30450513          	addi	a0,a0,772 # ffffffffc0206a80 <commands+0x270>
...
ffffffffc020078e:	30e50513          	addi	a0,a0,782 # ffffffffc0206a98 <commands+0x288>
...
ffffffffc020079c:	31850513          	addi	a0,a0,792 # ffffffffc0206ab0 <commands+0x2a0>
...
ffffffffc02007aa:	32250513          	addi	a0,a0,802 # ffffffffc0206ac8 <commands+0x2b8>
...
ffffffffc02007b8:	32c50513          	addi	a0,a0,812 # ffffffffc0206ae0 <commands+0x2d0>
...
ffffffffc02007c6:	33650513          	addi	a0,a0,822 # ffffffffc0206af8 <commands+0x2e8>
...
ffffffffc02007d4:	34050513          	addi	a0,a0,832 # ffffffffc0206b10 <commands+0x300>
...
ffffffffc02007e2:	34a50513          	addi	a0,a0,842 # ffffffffc0206b28 <commands+0x318>
...
ffffffffc02007f0:	35450513          	addi	a0,a0,852 # ffffffffc0206b40 <commands+0x330>
...
ffffffffc02007fe:	35e50513          	addi	a0,a0,862 # ffffffffc0206b58 <commands+0x348>
...
ffffffffc020080c:	36850513          	addi	a0,a0,872 # ffffffffc0206b70 <commands+0x360>
...
ffffffffc020081a:	37250513          	addi	a0,a0,882 # ffffffffc0206b88 <commands+0x378>
...
ffffffffc020082c:	37850513          	addi	a0,a0,888 # ffffffffc0206ba0 <commands+0x390>
}
...
ffffffffc0200840:	37c50513          	addi	a0,a0,892 # ffffffffc0206bb8 <commands+0x3a8>
print_trapframe(struct trapframe *tf) {
...
ffffffffc0200858:	37c50513          	addi	a0,a0,892 # ffffffffc0206bd0 <commands+0x3c0>
...
ffffffffc0200868:	38450513          	addi	a0,a0,900 # ffffffffc0206be8 <commands+0x3d8>
...
ffffffffc0200878:	38c50513          	addi	a0,a0,908 # ffffffffc0206c00 <commands+0x3f0>
...
ffffffffc020088c:	38850513          	addi	a0,a0,904 # ffffffffc0206c10 <commands+0x400>
}
...
ffffffffc02008d4:	35850513          	addi	a0,a0,856 # ffffffffc0206c28 <commands+0x418>
...
ffffffffc0200940:	30c68693          	addi	a3,a3,780 # ffffffffc0206c48 <commands+0x438>
ffffffffc0200944:	00006617          	auipc	a2,0x6
ffffffffc0200948:	31c60613          	addi	a2,a2,796 # ffffffffc0206c60 <commands+0x450>
ffffffffc020094c:	06b00593          	li	a1,107
ffffffffc0200950:	00006517          	auipc	a0,0x6
ffffffffc0200954:	32850513          	addi	a0,a0,808 # ffffffffc0206c78 <commands+0x468>
...
ffffffffc020098a:	2a250513          	addi	a0,a0,674 # ffffffffc0206c28 <commands+0x418>
ffffffffc020098e:	ff2ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
            panic("unhandled page fault.\n");
ffffffffc0200992:	00006617          	auipc	a2,0x6
ffffffffc0200996:	2fe60613          	addi	a2,a2,766 # ffffffffc0206c90 <commands+0x480>
ffffffffc020099a:	07200593          	li	a1,114
ffffffffc020099e:	00006517          	auipc	a0,0x6
ffffffffc02009a2:	2da50513          	addi	a0,a0,730 # ffffffffc0206c78 <commands+0x468>
...
ffffffffc02009c2:	38a70713          	addi	a4,a4,906 # ffffffffc0206d48 <commands+0x538>
...
ffffffffc02009d4:	33850513          	addi	a0,a0,824 # ffffffffc0206d08 <commands+0x4f8>
ffffffffc02009d8:	fa8ff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02009dc:	00006517          	auipc	a0,0x6
ffffffffc02009e0:	30c50513          	addi	a0,a0,780 # ffffffffc0206ce8 <commands+0x4d8>
ffffffffc02009e4:	f9cff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02009e8:	00006517          	auipc	a0,0x6
ffffffffc02009ec:	2c050513          	addi	a0,a0,704 # ffffffffc0206ca8 <commands+0x498>
ffffffffc02009f0:	f90ff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02009f4:	00006517          	auipc	a0,0x6
ffffffffc02009f8:	2d450513          	addi	a0,a0,724 # ffffffffc0206cc8 <commands+0x4b8>
...
ffffffffc0200a38:	2f450513          	addi	a0,a0,756 # ffffffffc0206d28 <commands+0x518>
...
ffffffffc0200a5a:	4ba70713          	addi	a4,a4,1210 # ffffffffc0206f10 <commands+0x700>
...
ffffffffc0200a6c:	40050513          	addi	a0,a0,1024 # ffffffffc0206e68 <commands+0x658>
...
ffffffffc0200a84:	6105                	addi	sp,sp,32
            syscall();
ffffffffc0200a86:	5f60506f          	j	ffffffffc020607c <syscall>
            cprintf("Environment call from H-mode\n");
ffffffffc0200a8a:	00006517          	auipc	a0,0x6
ffffffffc0200a8e:	3fe50513          	addi	a0,a0,1022 # ffffffffc0206e88 <commands+0x678>
}
...
ffffffffc0200aa2:	40a50513          	addi	a0,a0,1034 # ffffffffc0206ea8 <commands+0x698>
ffffffffc0200aa6:	b7f5                	j	ffffffffc0200a92 <exception_handler+0x50>
            cprintf("Instruction page fault\n");
ffffffffc0200aa8:	00006517          	auipc	a0,0x6
ffffffffc0200aac:	42050513          	addi	a0,a0,1056 # ffffffffc0206ec8 <commands+0x6b8>
ffffffffc0200ab0:	b7cd                	j	ffffffffc0200a92 <exception_handler+0x50>
            cprintf("Load page fault\n");
ffffffffc0200ab2:	00006517          	auipc	a0,0x6
ffffffffc0200ab6:	42e50513          	addi	a0,a0,1070 # ffffffffc0206ee0 <commands+0x6d0>
...
ffffffffc0200ad8:	42450513          	addi	a0,a0,1060 # ffffffffc0206ef8 <commands+0x6e8>
...
ffffffffc0200b42:	10f43423          	sd	a5,264(s0)
                syscall();
ffffffffc0200b46:	536050ef          	jal	ra,ffffffffc020607c <syscall>
...
ffffffffc0200b68:	27c50513          	addi	a0,a0,636 # ffffffffc0206de0 <commands+0x5d0>
ffffffffc0200b6c:	b71d                	j	ffffffffc0200a92 <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc0200b6e:	00006517          	auipc	a0,0x6
ffffffffc0200b72:	29250513          	addi	a0,a0,658 # ffffffffc0206e00 <commands+0x5f0>
...
ffffffffc0200b90:	28c60613          	addi	a2,a2,652 # ffffffffc0206e18 <commands+0x608>
ffffffffc0200b94:	0cd00593          	li	a1,205
ffffffffc0200b98:	00006517          	auipc	a0,0x6
ffffffffc0200b9c:	0e050513          	addi	a0,a0,224 # ffffffffc0206c78 <commands+0x468>
ffffffffc0200ba0:	8dbff0ef          	jal	ra,ffffffffc020047a <__panic>
            cprintf("Store/AMO access fault\n");
ffffffffc0200ba4:	00006517          	auipc	a0,0x6
ffffffffc0200ba8:	2ac50513          	addi	a0,a0,684 # ffffffffc0206e50 <commands+0x640>
...
ffffffffc0200bc8:	25460613          	addi	a2,a2,596 # ffffffffc0206e18 <commands+0x608>
ffffffffc0200bcc:	0d700593          	li	a1,215
ffffffffc0200bd0:	00006517          	auipc	a0,0x6
ffffffffc0200bd4:	0a850513          	addi	a0,a0,168 # ffffffffc0206c78 <commands+0x468>
...
ffffffffc0200bec:	25060613          	addi	a2,a2,592 # ffffffffc0206e38 <commands+0x628>
ffffffffc0200bf0:	0d100593          	li	a1,209
ffffffffc0200bf4:	00006517          	auipc	a0,0x6
ffffffffc0200bf8:	08450513          	addi	a0,a0,132 # ffffffffc0206c78 <commands+0x468>
...
ffffffffc0200c0c:	21060613          	addi	a2,a2,528 # ffffffffc0206e18 <commands+0x608>
ffffffffc0200c10:	0f100593          	li	a1,241
ffffffffc0200c14:	00006517          	auipc	a0,0x6
ffffffffc0200c18:	06450513          	addi	a0,a0,100 # ffffffffc0206c78 <commands+0x468>
...
ffffffffc0200c9a:	6105                	addi	sp,sp,32
                schedule();
ffffffffc0200c9c:	2f40506f          	j	ffffffffc0205f90 <schedule>
                do_exit(-E_KILLED);
ffffffffc0200ca0:	555d                	li	a0,-9
ffffffffc0200ca2:	634040ef          	jal	ra,ffffffffc02052d6 <do_exit>
            if (current->need_resched) {
...
ffffffffc0200ede:	d8663603          	ld	a2,-634(a2) # ffffffffc0208c60 <nbase>
...
ffffffffc0201124:	e3068693          	addi	a3,a3,-464 # ffffffffc0206f50 <commands+0x740>
ffffffffc0201128:	00006617          	auipc	a2,0x6
ffffffffc020112c:	b3860613          	addi	a2,a2,-1224 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201130:	0f000593          	li	a1,240
ffffffffc0201134:	00006517          	auipc	a0,0x6
ffffffffc0201138:	e2c50513          	addi	a0,a0,-468 # ffffffffc0206f60 <commands+0x750>
ffffffffc020113c:	b3eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0201140:	00006697          	auipc	a3,0x6
ffffffffc0201144:	eb868693          	addi	a3,a3,-328 # ffffffffc0206ff8 <commands+0x7e8>
ffffffffc0201148:	00006617          	auipc	a2,0x6
ffffffffc020114c:	b1860613          	addi	a2,a2,-1256 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201150:	0bd00593          	li	a1,189
ffffffffc0201154:	00006517          	auipc	a0,0x6
ffffffffc0201158:	e0c50513          	addi	a0,a0,-500 # ffffffffc0206f60 <commands+0x750>
ffffffffc020115c:	b1eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0201160:	00006697          	auipc	a3,0x6
ffffffffc0201164:	ec068693          	addi	a3,a3,-320 # ffffffffc0207020 <commands+0x810>
ffffffffc0201168:	00006617          	auipc	a2,0x6
ffffffffc020116c:	af860613          	addi	a2,a2,-1288 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201170:	0be00593          	li	a1,190
ffffffffc0201174:	00006517          	auipc	a0,0x6
ffffffffc0201178:	dec50513          	addi	a0,a0,-532 # ffffffffc0206f60 <commands+0x750>
ffffffffc020117c:	afeff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0201180:	00006697          	auipc	a3,0x6
ffffffffc0201184:	ee068693          	addi	a3,a3,-288 # ffffffffc0207060 <commands+0x850>
ffffffffc0201188:	00006617          	auipc	a2,0x6
ffffffffc020118c:	ad860613          	addi	a2,a2,-1320 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201190:	0c000593          	li	a1,192
ffffffffc0201194:	00006517          	auipc	a0,0x6
ffffffffc0201198:	dcc50513          	addi	a0,a0,-564 # ffffffffc0206f60 <commands+0x750>
ffffffffc020119c:	adeff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(!list_empty(&free_list));
ffffffffc02011a0:	00006697          	auipc	a3,0x6
ffffffffc02011a4:	f4868693          	addi	a3,a3,-184 # ffffffffc02070e8 <commands+0x8d8>
ffffffffc02011a8:	00006617          	auipc	a2,0x6
ffffffffc02011ac:	ab860613          	addi	a2,a2,-1352 # ffffffffc0206c60 <commands+0x450>
ffffffffc02011b0:	0d900593          	li	a1,217
ffffffffc02011b4:	00006517          	auipc	a0,0x6
ffffffffc02011b8:	dac50513          	addi	a0,a0,-596 # ffffffffc0206f60 <commands+0x750>
ffffffffc02011bc:	abeff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc02011c0:	00006697          	auipc	a3,0x6
ffffffffc02011c4:	dd868693          	addi	a3,a3,-552 # ffffffffc0206f98 <commands+0x788>
ffffffffc02011c8:	00006617          	auipc	a2,0x6
ffffffffc02011cc:	a9860613          	addi	a2,a2,-1384 # ffffffffc0206c60 <commands+0x450>
ffffffffc02011d0:	0d200593          	li	a1,210
ffffffffc02011d4:	00006517          	auipc	a0,0x6
ffffffffc02011d8:	d8c50513          	addi	a0,a0,-628 # ffffffffc0206f60 <commands+0x750>
ffffffffc02011dc:	a9eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free == 3);
ffffffffc02011e0:	00006697          	auipc	a3,0x6
ffffffffc02011e4:	ef868693          	addi	a3,a3,-264 # ffffffffc02070d8 <commands+0x8c8>
ffffffffc02011e8:	00006617          	auipc	a2,0x6
ffffffffc02011ec:	a7860613          	addi	a2,a2,-1416 # ffffffffc0206c60 <commands+0x450>
ffffffffc02011f0:	0d000593          	li	a1,208
ffffffffc02011f4:	00006517          	auipc	a0,0x6
ffffffffc02011f8:	d6c50513          	addi	a0,a0,-660 # ffffffffc0206f60 <commands+0x750>
ffffffffc02011fc:	a7eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201200:	00006697          	auipc	a3,0x6
ffffffffc0201204:	ec068693          	addi	a3,a3,-320 # ffffffffc02070c0 <commands+0x8b0>
ffffffffc0201208:	00006617          	auipc	a2,0x6
ffffffffc020120c:	a5860613          	addi	a2,a2,-1448 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201210:	0cb00593          	li	a1,203
ffffffffc0201214:	00006517          	auipc	a0,0x6
ffffffffc0201218:	d4c50513          	addi	a0,a0,-692 # ffffffffc0206f60 <commands+0x750>
ffffffffc020121c:	a5eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0201220:	00006697          	auipc	a3,0x6
ffffffffc0201224:	e8068693          	addi	a3,a3,-384 # ffffffffc02070a0 <commands+0x890>
ffffffffc0201228:	00006617          	auipc	a2,0x6
ffffffffc020122c:	a3860613          	addi	a2,a2,-1480 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201230:	0c200593          	li	a1,194
ffffffffc0201234:	00006517          	auipc	a0,0x6
ffffffffc0201238:	d2c50513          	addi	a0,a0,-724 # ffffffffc0206f60 <commands+0x750>
ffffffffc020123c:	a3eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(p0 != NULL);
ffffffffc0201240:	00006697          	auipc	a3,0x6
ffffffffc0201244:	ef068693          	addi	a3,a3,-272 # ffffffffc0207130 <commands+0x920>
ffffffffc0201248:	00006617          	auipc	a2,0x6
ffffffffc020124c:	a1860613          	addi	a2,a2,-1512 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201250:	0f800593          	li	a1,248
ffffffffc0201254:	00006517          	auipc	a0,0x6
ffffffffc0201258:	d0c50513          	addi	a0,a0,-756 # ffffffffc0206f60 <commands+0x750>
ffffffffc020125c:	a1eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free == 0);
ffffffffc0201260:	00006697          	auipc	a3,0x6
ffffffffc0201264:	ec068693          	addi	a3,a3,-320 # ffffffffc0207120 <commands+0x910>
ffffffffc0201268:	00006617          	auipc	a2,0x6
ffffffffc020126c:	9f860613          	addi	a2,a2,-1544 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201270:	0df00593          	li	a1,223
ffffffffc0201274:	00006517          	auipc	a0,0x6
ffffffffc0201278:	cec50513          	addi	a0,a0,-788 # ffffffffc0206f60 <commands+0x750>
ffffffffc020127c:	9feff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201280:	00006697          	auipc	a3,0x6
ffffffffc0201284:	e4068693          	addi	a3,a3,-448 # ffffffffc02070c0 <commands+0x8b0>
ffffffffc0201288:	00006617          	auipc	a2,0x6
ffffffffc020128c:	9d860613          	addi	a2,a2,-1576 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201290:	0dd00593          	li	a1,221
ffffffffc0201294:	00006517          	auipc	a0,0x6
ffffffffc0201298:	ccc50513          	addi	a0,a0,-820 # ffffffffc0206f60 <commands+0x750>
ffffffffc020129c:	9deff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc02012a0:	00006697          	auipc	a3,0x6
ffffffffc02012a4:	e6068693          	addi	a3,a3,-416 # ffffffffc0207100 <commands+0x8f0>
ffffffffc02012a8:	00006617          	auipc	a2,0x6
ffffffffc02012ac:	9b860613          	addi	a2,a2,-1608 # ffffffffc0206c60 <commands+0x450>
ffffffffc02012b0:	0dc00593          	li	a1,220
ffffffffc02012b4:	00006517          	auipc	a0,0x6
ffffffffc02012b8:	cac50513          	addi	a0,a0,-852 # ffffffffc0206f60 <commands+0x750>
ffffffffc02012bc:	9beff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc02012c0:	00006697          	auipc	a3,0x6
ffffffffc02012c4:	cd868693          	addi	a3,a3,-808 # ffffffffc0206f98 <commands+0x788>
ffffffffc02012c8:	00006617          	auipc	a2,0x6
ffffffffc02012cc:	99860613          	addi	a2,a2,-1640 # ffffffffc0206c60 <commands+0x450>
ffffffffc02012d0:	0b900593          	li	a1,185
ffffffffc02012d4:	00006517          	auipc	a0,0x6
ffffffffc02012d8:	c8c50513          	addi	a0,a0,-884 # ffffffffc0206f60 <commands+0x750>
ffffffffc02012dc:	99eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02012e0:	00006697          	auipc	a3,0x6
ffffffffc02012e4:	de068693          	addi	a3,a3,-544 # ffffffffc02070c0 <commands+0x8b0>
ffffffffc02012e8:	00006617          	auipc	a2,0x6
ffffffffc02012ec:	97860613          	addi	a2,a2,-1672 # ffffffffc0206c60 <commands+0x450>
ffffffffc02012f0:	0d600593          	li	a1,214
ffffffffc02012f4:	00006517          	auipc	a0,0x6
ffffffffc02012f8:	c6c50513          	addi	a0,a0,-916 # ffffffffc0206f60 <commands+0x750>
ffffffffc02012fc:	97eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201300:	00006697          	auipc	a3,0x6
ffffffffc0201304:	cd868693          	addi	a3,a3,-808 # ffffffffc0206fd8 <commands+0x7c8>
ffffffffc0201308:	00006617          	auipc	a2,0x6
ffffffffc020130c:	95860613          	addi	a2,a2,-1704 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201310:	0d400593          	li	a1,212
ffffffffc0201314:	00006517          	auipc	a0,0x6
ffffffffc0201318:	c4c50513          	addi	a0,a0,-948 # ffffffffc0206f60 <commands+0x750>
ffffffffc020131c:	95eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201320:	00006697          	auipc	a3,0x6
ffffffffc0201324:	c9868693          	addi	a3,a3,-872 # ffffffffc0206fb8 <commands+0x7a8>
ffffffffc0201328:	00006617          	auipc	a2,0x6
ffffffffc020132c:	93860613          	addi	a2,a2,-1736 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201330:	0d300593          	li	a1,211
ffffffffc0201334:	00006517          	auipc	a0,0x6
ffffffffc0201338:	c2c50513          	addi	a0,a0,-980 # ffffffffc0206f60 <commands+0x750>
ffffffffc020133c:	93eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201340:	00006697          	auipc	a3,0x6
ffffffffc0201344:	c9868693          	addi	a3,a3,-872 # ffffffffc0206fd8 <commands+0x7c8>
ffffffffc0201348:	00006617          	auipc	a2,0x6
ffffffffc020134c:	91860613          	addi	a2,a2,-1768 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201350:	0bb00593          	li	a1,187
ffffffffc0201354:	00006517          	auipc	a0,0x6
ffffffffc0201358:	c0c50513          	addi	a0,a0,-1012 # ffffffffc0206f60 <commands+0x750>
ffffffffc020135c:	91eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(count == 0);
ffffffffc0201360:	00006697          	auipc	a3,0x6
ffffffffc0201364:	f2068693          	addi	a3,a3,-224 # ffffffffc0207280 <commands+0xa70>
ffffffffc0201368:	00006617          	auipc	a2,0x6
ffffffffc020136c:	8f860613          	addi	a2,a2,-1800 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201370:	12500593          	li	a1,293
ffffffffc0201374:	00006517          	auipc	a0,0x6
ffffffffc0201378:	bec50513          	addi	a0,a0,-1044 # ffffffffc0206f60 <commands+0x750>
ffffffffc020137c:	8feff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free == 0);
ffffffffc0201380:	00006697          	auipc	a3,0x6
ffffffffc0201384:	da068693          	addi	a3,a3,-608 # ffffffffc0207120 <commands+0x910>
ffffffffc0201388:	00006617          	auipc	a2,0x6
ffffffffc020138c:	8d860613          	addi	a2,a2,-1832 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201390:	11a00593          	li	a1,282
ffffffffc0201394:	00006517          	auipc	a0,0x6
ffffffffc0201398:	bcc50513          	addi	a0,a0,-1076 # ffffffffc0206f60 <commands+0x750>
ffffffffc020139c:	8deff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02013a0:	00006697          	auipc	a3,0x6
ffffffffc02013a4:	d2068693          	addi	a3,a3,-736 # ffffffffc02070c0 <commands+0x8b0>
ffffffffc02013a8:	00006617          	auipc	a2,0x6
ffffffffc02013ac:	8b860613          	addi	a2,a2,-1864 # ffffffffc0206c60 <commands+0x450>
ffffffffc02013b0:	11800593          	li	a1,280
ffffffffc02013b4:	00006517          	auipc	a0,0x6
ffffffffc02013b8:	bac50513          	addi	a0,a0,-1108 # ffffffffc0206f60 <commands+0x750>
ffffffffc02013bc:	8beff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc02013c0:	00006697          	auipc	a3,0x6
ffffffffc02013c4:	cc068693          	addi	a3,a3,-832 # ffffffffc0207080 <commands+0x870>
ffffffffc02013c8:	00006617          	auipc	a2,0x6
ffffffffc02013cc:	89860613          	addi	a2,a2,-1896 # ffffffffc0206c60 <commands+0x450>
ffffffffc02013d0:	0c100593          	li	a1,193
ffffffffc02013d4:	00006517          	auipc	a0,0x6
ffffffffc02013d8:	b8c50513          	addi	a0,a0,-1140 # ffffffffc0206f60 <commands+0x750>
ffffffffc02013dc:	89eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc02013e0:	00006697          	auipc	a3,0x6
ffffffffc02013e4:	e6068693          	addi	a3,a3,-416 # ffffffffc0207240 <commands+0xa30>
ffffffffc02013e8:	00006617          	auipc	a2,0x6
ffffffffc02013ec:	87860613          	addi	a2,a2,-1928 # ffffffffc0206c60 <commands+0x450>
ffffffffc02013f0:	11200593          	li	a1,274
ffffffffc02013f4:	00006517          	auipc	a0,0x6
ffffffffc02013f8:	b6c50513          	addi	a0,a0,-1172 # ffffffffc0206f60 <commands+0x750>
ffffffffc02013fc:	87eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc0201400:	00006697          	auipc	a3,0x6
ffffffffc0201404:	e2068693          	addi	a3,a3,-480 # ffffffffc0207220 <commands+0xa10>
ffffffffc0201408:	00006617          	auipc	a2,0x6
ffffffffc020140c:	85860613          	addi	a2,a2,-1960 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201410:	11000593          	li	a1,272
ffffffffc0201414:	00006517          	auipc	a0,0x6
ffffffffc0201418:	b4c50513          	addi	a0,a0,-1204 # ffffffffc0206f60 <commands+0x750>
ffffffffc020141c:	85eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc0201420:	00006697          	auipc	a3,0x6
ffffffffc0201424:	dd868693          	addi	a3,a3,-552 # ffffffffc02071f8 <commands+0x9e8>
ffffffffc0201428:	00006617          	auipc	a2,0x6
ffffffffc020142c:	83860613          	addi	a2,a2,-1992 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201430:	10e00593          	li	a1,270
ffffffffc0201434:	00006517          	auipc	a0,0x6
ffffffffc0201438:	b2c50513          	addi	a0,a0,-1236 # ffffffffc0206f60 <commands+0x750>
ffffffffc020143c:	83eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc0201440:	00006697          	auipc	a3,0x6
ffffffffc0201444:	d9068693          	addi	a3,a3,-624 # ffffffffc02071d0 <commands+0x9c0>
ffffffffc0201448:	00006617          	auipc	a2,0x6
ffffffffc020144c:	81860613          	addi	a2,a2,-2024 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201450:	10d00593          	li	a1,269
ffffffffc0201454:	00006517          	auipc	a0,0x6
ffffffffc0201458:	b0c50513          	addi	a0,a0,-1268 # ffffffffc0206f60 <commands+0x750>
ffffffffc020145c:	81eff0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201460:	00006697          	auipc	a3,0x6
ffffffffc0201464:	d6068693          	addi	a3,a3,-672 # ffffffffc02071c0 <commands+0x9b0>
ffffffffc0201468:	00005617          	auipc	a2,0x5
ffffffffc020146c:	7f860613          	addi	a2,a2,2040 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201470:	10800593          	li	a1,264
ffffffffc0201474:	00006517          	auipc	a0,0x6
ffffffffc0201478:	aec50513          	addi	a0,a0,-1300 # ffffffffc0206f60 <commands+0x750>
ffffffffc020147c:	ffffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201480:	00006697          	auipc	a3,0x6
ffffffffc0201484:	c4068693          	addi	a3,a3,-960 # ffffffffc02070c0 <commands+0x8b0>
ffffffffc0201488:	00005617          	auipc	a2,0x5
ffffffffc020148c:	7d860613          	addi	a2,a2,2008 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201490:	10700593          	li	a1,263
ffffffffc0201494:	00006517          	auipc	a0,0x6
ffffffffc0201498:	acc50513          	addi	a0,a0,-1332 # ffffffffc0206f60 <commands+0x750>
ffffffffc020149c:	fdffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc02014a0:	00006697          	auipc	a3,0x6
ffffffffc02014a4:	d0068693          	addi	a3,a3,-768 # ffffffffc02071a0 <commands+0x990>
ffffffffc02014a8:	00005617          	auipc	a2,0x5
ffffffffc02014ac:	7b860613          	addi	a2,a2,1976 # ffffffffc0206c60 <commands+0x450>
ffffffffc02014b0:	10600593          	li	a1,262
ffffffffc02014b4:	00006517          	auipc	a0,0x6
ffffffffc02014b8:	aac50513          	addi	a0,a0,-1364 # ffffffffc0206f60 <commands+0x750>
ffffffffc02014bc:	fbffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc02014c0:	00006697          	auipc	a3,0x6
ffffffffc02014c4:	cb068693          	addi	a3,a3,-848 # ffffffffc0207170 <commands+0x960>
ffffffffc02014c8:	00005617          	auipc	a2,0x5
ffffffffc02014cc:	79860613          	addi	a2,a2,1944 # ffffffffc0206c60 <commands+0x450>
ffffffffc02014d0:	10500593          	li	a1,261
ffffffffc02014d4:	00006517          	auipc	a0,0x6
ffffffffc02014d8:	a8c50513          	addi	a0,a0,-1396 # ffffffffc0206f60 <commands+0x750>
ffffffffc02014dc:	f9ffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc02014e0:	00006697          	auipc	a3,0x6
ffffffffc02014e4:	c7868693          	addi	a3,a3,-904 # ffffffffc0207158 <commands+0x948>
ffffffffc02014e8:	00005617          	auipc	a2,0x5
ffffffffc02014ec:	77860613          	addi	a2,a2,1912 # ffffffffc0206c60 <commands+0x450>
ffffffffc02014f0:	10400593          	li	a1,260
ffffffffc02014f4:	00006517          	auipc	a0,0x6
ffffffffc02014f8:	a6c50513          	addi	a0,a0,-1428 # ffffffffc0206f60 <commands+0x750>
ffffffffc02014fc:	f7ffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201500:	00006697          	auipc	a3,0x6
ffffffffc0201504:	bc068693          	addi	a3,a3,-1088 # ffffffffc02070c0 <commands+0x8b0>
ffffffffc0201508:	00005617          	auipc	a2,0x5
ffffffffc020150c:	75860613          	addi	a2,a2,1880 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201510:	0fe00593          	li	a1,254
ffffffffc0201514:	00006517          	auipc	a0,0x6
ffffffffc0201518:	a4c50513          	addi	a0,a0,-1460 # ffffffffc0206f60 <commands+0x750>
ffffffffc020151c:	f5ffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(!PageProperty(p0));
ffffffffc0201520:	00006697          	auipc	a3,0x6
ffffffffc0201524:	c2068693          	addi	a3,a3,-992 # ffffffffc0207140 <commands+0x930>
ffffffffc0201528:	00005617          	auipc	a2,0x5
ffffffffc020152c:	73860613          	addi	a2,a2,1848 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201530:	0f900593          	li	a1,249
ffffffffc0201534:	00006517          	auipc	a0,0x6
ffffffffc0201538:	a2c50513          	addi	a0,a0,-1492 # ffffffffc0206f60 <commands+0x750>
ffffffffc020153c:	f3ffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0201540:	00006697          	auipc	a3,0x6
ffffffffc0201544:	d2068693          	addi	a3,a3,-736 # ffffffffc0207260 <commands+0xa50>
ffffffffc0201548:	00005617          	auipc	a2,0x5
ffffffffc020154c:	71860613          	addi	a2,a2,1816 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201550:	11700593          	li	a1,279
ffffffffc0201554:	00006517          	auipc	a0,0x6
ffffffffc0201558:	a0c50513          	addi	a0,a0,-1524 # ffffffffc0206f60 <commands+0x750>
ffffffffc020155c:	f1ffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(total == 0);
ffffffffc0201560:	00006697          	auipc	a3,0x6
ffffffffc0201564:	d3068693          	addi	a3,a3,-720 # ffffffffc0207290 <commands+0xa80>
ffffffffc0201568:	00005617          	auipc	a2,0x5
ffffffffc020156c:	6f860613          	addi	a2,a2,1784 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201570:	12600593          	li	a1,294
ffffffffc0201574:	00006517          	auipc	a0,0x6
ffffffffc0201578:	9ec50513          	addi	a0,a0,-1556 # ffffffffc0206f60 <commands+0x750>
ffffffffc020157c:	efffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(total == nr_free_pages());
ffffffffc0201580:	00006697          	auipc	a3,0x6
ffffffffc0201584:	9f868693          	addi	a3,a3,-1544 # ffffffffc0206f78 <commands+0x768>
ffffffffc0201588:	00005617          	auipc	a2,0x5
ffffffffc020158c:	6d860613          	addi	a2,a2,1752 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201590:	0f300593          	li	a1,243
ffffffffc0201594:	00006517          	auipc	a0,0x6
ffffffffc0201598:	9cc50513          	addi	a0,a0,-1588 # ffffffffc0206f60 <commands+0x750>
ffffffffc020159c:	edffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02015a0:	00006697          	auipc	a3,0x6
ffffffffc02015a4:	a1868693          	addi	a3,a3,-1512 # ffffffffc0206fb8 <commands+0x7a8>
ffffffffc02015a8:	00005617          	auipc	a2,0x5
ffffffffc02015ac:	6b860613          	addi	a2,a2,1720 # ffffffffc0206c60 <commands+0x450>
ffffffffc02015b0:	0ba00593          	li	a1,186
ffffffffc02015b4:	00006517          	auipc	a0,0x6
ffffffffc02015b8:	9ac50513          	addi	a0,a0,-1620 # ffffffffc0206f60 <commands+0x750>
...
ffffffffc02016f0:	bbc68693          	addi	a3,a3,-1092 # ffffffffc02072a8 <commands+0xa98>
ffffffffc02016f4:	00005617          	auipc	a2,0x5
ffffffffc02016f8:	56c60613          	addi	a2,a2,1388 # ffffffffc0206c60 <commands+0x450>
ffffffffc02016fc:	08300593          	li	a1,131
ffffffffc0201700:	00006517          	auipc	a0,0x6
ffffffffc0201704:	86050513          	addi	a0,a0,-1952 # ffffffffc0206f60 <commands+0x750>
ffffffffc0201708:	d73fe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(n > 0);
ffffffffc020170c:	00006697          	auipc	a3,0x6
ffffffffc0201710:	b9468693          	addi	a3,a3,-1132 # ffffffffc02072a0 <commands+0xa90>
ffffffffc0201714:	00005617          	auipc	a2,0x5
ffffffffc0201718:	54c60613          	addi	a2,a2,1356 # ffffffffc0206c60 <commands+0x450>
ffffffffc020171c:	08000593          	li	a1,128
ffffffffc0201720:	00006517          	auipc	a0,0x6
ffffffffc0201724:	84050513          	addi	a0,a0,-1984 # ffffffffc0206f60 <commands+0x750>
...
ffffffffc02017c2:	ae268693          	addi	a3,a3,-1310 # ffffffffc02072a0 <commands+0xa90>
ffffffffc02017c6:	00005617          	auipc	a2,0x5
ffffffffc02017ca:	49a60613          	addi	a2,a2,1178 # ffffffffc0206c60 <commands+0x450>
ffffffffc02017ce:	06200593          	li	a1,98
ffffffffc02017d2:	00005517          	auipc	a0,0x5
ffffffffc02017d6:	78e50513          	addi	a0,a0,1934 # ffffffffc0206f60 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc0201894:	a4068693          	addi	a3,a3,-1472 # ffffffffc02072d0 <commands+0xac0>
ffffffffc0201898:	00005617          	auipc	a2,0x5
ffffffffc020189c:	3c860613          	addi	a2,a2,968 # ffffffffc0206c60 <commands+0x450>
ffffffffc02018a0:	04900593          	li	a1,73
ffffffffc02018a4:	00005517          	auipc	a0,0x5
ffffffffc02018a8:	6bc50513          	addi	a0,a0,1724 # ffffffffc0206f60 <commands+0x750>
ffffffffc02018ac:	bcffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(n > 0);
ffffffffc02018b0:	00006697          	auipc	a3,0x6
ffffffffc02018b4:	9f068693          	addi	a3,a3,-1552 # ffffffffc02072a0 <commands+0xa90>
ffffffffc02018b8:	00005617          	auipc	a2,0x5
ffffffffc02018bc:	3a860613          	addi	a2,a2,936 # ffffffffc0206c60 <commands+0x450>
ffffffffc02018c0:	04600593          	li	a1,70
ffffffffc02018c4:	00005517          	auipc	a0,0x5
ffffffffc02018c8:	69c50513          	addi	a0,a0,1692 # ffffffffc0206f60 <commands+0x750>
...
ffffffffc02019a4:	2c06b683          	ld	a3,704(a3) # ffffffffc0208c60 <nbase>
...
ffffffffc02019d4:	96060613          	addi	a2,a2,-1696 # ffffffffc0207330 <default_pmm_manager+0x38>
ffffffffc02019d8:	06900593          	li	a1,105
ffffffffc02019dc:	00006517          	auipc	a0,0x6
ffffffffc02019e0:	97c50513          	addi	a0,a0,-1668 # ffffffffc0207358 <default_pmm_manager+0x60>
...
ffffffffc0201ac2:	8aa68693          	addi	a3,a3,-1878 # ffffffffc0207368 <default_pmm_manager+0x70>
ffffffffc0201ac6:	00005617          	auipc	a2,0x5
ffffffffc0201aca:	19a60613          	addi	a2,a2,410 # ffffffffc0206c60 <commands+0x450>
ffffffffc0201ace:	06400593          	li	a1,100
ffffffffc0201ad2:	00006517          	auipc	a0,0x6
ffffffffc0201ad6:	8b650513          	addi	a0,a0,-1866 # ffffffffc0207388 <default_pmm_manager+0x90>
...
ffffffffc0201ae4:	8c050513          	addi	a0,a0,-1856 # ffffffffc02073a0 <default_pmm_manager+0xa8>
kmalloc_init(void) {
...
ffffffffc0201af4:	8c850513          	addi	a0,a0,-1848 # ffffffffc02073b8 <default_pmm_manager+0xc0>
}
...
ffffffffc0201c1c:	04853503          	ld	a0,72(a0) # ffffffffc0208c60 <nbase>
...
ffffffffc0201c7a:	78a60613          	addi	a2,a2,1930 # ffffffffc0207400 <default_pmm_manager+0x108>
ffffffffc0201c7e:	06200593          	li	a1,98
ffffffffc0201c82:	00005517          	auipc	a0,0x5
ffffffffc0201c86:	6d650513          	addi	a0,a0,1750 # ffffffffc0207358 <default_pmm_manager+0x60>
...
ffffffffc0201c94:	74860613          	addi	a2,a2,1864 # ffffffffc02073d8 <default_pmm_manager+0xe0>
ffffffffc0201c98:	06e00593          	li	a1,110
ffffffffc0201c9c:	00005517          	auipc	a0,0x5
ffffffffc0201ca0:	6bc50513          	addi	a0,a0,1724 # ffffffffc0207358 <default_pmm_manager+0x60>
...
ffffffffc0201cae:	75660613          	addi	a2,a2,1878 # ffffffffc0207400 <default_pmm_manager+0x108>
ffffffffc0201cb2:	06200593          	li	a1,98
ffffffffc0201cb6:	00005517          	auipc	a0,0x5
ffffffffc0201cba:	6a250513          	addi	a0,a0,1698 # ffffffffc0207358 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0201cca:	75a60613          	addi	a2,a2,1882 # ffffffffc0207420 <default_pmm_manager+0x128>
ffffffffc0201cce:	07400593          	li	a1,116
ffffffffc0201cd2:	00005517          	auipc	a0,0x5
ffffffffc0201cd6:	68650513          	addi	a0,a0,1670 # ffffffffc0207358 <default_pmm_manager+0x60>
pte2page(pte_t pte) {
...
ffffffffc0201e72:	70a040ef          	jal	ra,ffffffffc020657c <memset>
    return page - pages + nbase;
...
ffffffffc0201f04:	678040ef          	jal	ra,ffffffffc020657c <memset>
    return page - pages + nbase;
...
ffffffffc0201f5e:	3d660613          	addi	a2,a2,982 # ffffffffc0207330 <default_pmm_manager+0x38>
ffffffffc0201f62:	0e300593          	li	a1,227
ffffffffc0201f66:	00005517          	auipc	a0,0x5
ffffffffc0201f6a:	4e250513          	addi	a0,a0,1250 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0201f6e:	d0cfe0ef          	jal	ra,ffffffffc020047a <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201f72:	00005617          	auipc	a2,0x5
ffffffffc0201f76:	3be60613          	addi	a2,a2,958 # ffffffffc0207330 <default_pmm_manager+0x38>
ffffffffc0201f7a:	0ee00593          	li	a1,238
ffffffffc0201f7e:	00005517          	auipc	a0,0x5
ffffffffc0201f82:	4ca50513          	addi	a0,a0,1226 # ffffffffc0207448 <default_pmm_manager+0x150>
...
ffffffffc0201f90:	3a460613          	addi	a2,a2,932 # ffffffffc0207330 <default_pmm_manager+0x38>
ffffffffc0201f94:	0eb00593          	li	a1,235
ffffffffc0201f98:	00005517          	auipc	a0,0x5
ffffffffc0201f9c:	4b050513          	addi	a0,a0,1200 # ffffffffc0207448 <default_pmm_manager+0x150>
...
ffffffffc0201faa:	38a60613          	addi	a2,a2,906 # ffffffffc0207330 <default_pmm_manager+0x38>
ffffffffc0201fae:	0df00593          	li	a1,223
ffffffffc0201fb2:	00005517          	auipc	a0,0x5
ffffffffc0201fb6:	49650513          	addi	a0,a0,1174 # ffffffffc0207448 <default_pmm_manager+0x150>
...
ffffffffc0202118:	34468693          	addi	a3,a3,836 # ffffffffc0207458 <default_pmm_manager+0x160>
ffffffffc020211c:	00005617          	auipc	a2,0x5
ffffffffc0202120:	b4460613          	addi	a2,a2,-1212 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202124:	10f00593          	li	a1,271
ffffffffc0202128:	00005517          	auipc	a0,0x5
ffffffffc020212c:	32050513          	addi	a0,a0,800 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202130:	b4afe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(USER_ACCESS(start, end));
ffffffffc0202134:	00005697          	auipc	a3,0x5
ffffffffc0202138:	35468693          	addi	a3,a3,852 # ffffffffc0207488 <default_pmm_manager+0x190>
ffffffffc020213c:	00005617          	auipc	a2,0x5
ffffffffc0202140:	b2460613          	addi	a2,a2,-1244 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202144:	11000593          	li	a1,272
ffffffffc0202148:	00005517          	auipc	a0,0x5
ffffffffc020214c:	30050513          	addi	a0,a0,768 # ffffffffc0207448 <default_pmm_manager+0x150>
...
ffffffffc0202392:	0ca68693          	addi	a3,a3,202 # ffffffffc0207458 <default_pmm_manager+0x160>
ffffffffc0202396:	00005617          	auipc	a2,0x5
ffffffffc020239a:	8ca60613          	addi	a2,a2,-1846 # ffffffffc0206c60 <commands+0x450>
ffffffffc020239e:	12000593          	li	a1,288
ffffffffc02023a2:	00005517          	auipc	a0,0x5
ffffffffc02023a6:	0a650513          	addi	a0,a0,166 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc02023aa:	8d0fe0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc02023ae:	00005617          	auipc	a2,0x5
ffffffffc02023b2:	f8260613          	addi	a2,a2,-126 # ffffffffc0207330 <default_pmm_manager+0x38>
ffffffffc02023b6:	06900593          	li	a1,105
ffffffffc02023ba:	00005517          	auipc	a0,0x5
ffffffffc02023be:	f9e50513          	addi	a0,a0,-98 # ffffffffc0207358 <default_pmm_manager+0x60>
...
ffffffffc02023ce:	0be68693          	addi	a3,a3,190 # ffffffffc0207488 <default_pmm_manager+0x190>
ffffffffc02023d2:	00005617          	auipc	a2,0x5
ffffffffc02023d6:	88e60613          	addi	a2,a2,-1906 # ffffffffc0206c60 <commands+0x450>
ffffffffc02023da:	12100593          	li	a1,289
ffffffffc02023de:	00005517          	auipc	a0,0x5
ffffffffc02023e2:	06a50513          	addi	a0,a0,106 # ffffffffc0207448 <default_pmm_manager+0x150>
...
ffffffffc0202580:	d7c78793          	addi	a5,a5,-644 # ffffffffc02072f8 <default_pmm_manager>
...
ffffffffc020258e:	f1650513          	addi	a0,a0,-234 # ffffffffc02074a0 <default_pmm_manager+0x1a8>
    pmm_manager = &default_pmm_manager;
...
ffffffffc02025dc:	ee050513          	addi	a0,a0,-288 # ffffffffc02074b8 <default_pmm_manager+0x1c0>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc02025fc:	ed850513          	addi	a0,a0,-296 # ffffffffc02074d0 <default_pmm_manager+0x1d8>
...
ffffffffc0202664:	e9850513          	addi	a0,a0,-360 # ffffffffc02074f8 <default_pmm_manager+0x200>
...
ffffffffc0202680:	e9450513          	addi	a0,a0,-364 # ffffffffc0207510 <default_pmm_manager+0x218>
...
ffffffffc0202920:	edc50513          	addi	a0,a0,-292 # ffffffffc02077f8 <default_pmm_manager+0x500>
...
ffffffffc02029d6:	f5e58593          	addi	a1,a1,-162 # ffffffffc0207930 <default_pmm_manager+0x638>
ffffffffc02029da:	10000513          	li	a0,256
ffffffffc02029de:	359030ef          	jal	ra,ffffffffc0206536 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02029e2:	10040593          	addi	a1,s0,256
ffffffffc02029e6:	10000513          	li	a0,256
ffffffffc02029ea:	35f030ef          	jal	ra,ffffffffc0206548 <strcmp>
...
ffffffffc0202a1c:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a20:	2e1030ef          	jal	ra,ffffffffc0206500 <strlen>
...
ffffffffc0202ae4:	ec850513          	addi	a0,a0,-312 # ffffffffc02079a8 <default_pmm_manager+0x6b0>
...
ffffffffc0202bfe:	c5e68693          	addi	a3,a3,-930 # ffffffffc0207858 <default_pmm_manager+0x560>
ffffffffc0202c02:	00004617          	auipc	a2,0x4
ffffffffc0202c06:	05e60613          	addi	a2,a2,94 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202c0a:	22900593          	li	a1,553
ffffffffc0202c0e:	00005517          	auipc	a0,0x5
ffffffffc0202c12:	83a50513          	addi	a0,a0,-1990 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202c16:	865fd0ef          	jal	ra,ffffffffc020047a <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc0202c1a:	00005697          	auipc	a3,0x5
ffffffffc0202c1e:	bfe68693          	addi	a3,a3,-1026 # ffffffffc0207818 <default_pmm_manager+0x520>
ffffffffc0202c22:	00004617          	auipc	a2,0x4
ffffffffc0202c26:	03e60613          	addi	a2,a2,62 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202c2a:	22800593          	li	a1,552
ffffffffc0202c2e:	00005517          	auipc	a0,0x5
ffffffffc0202c32:	81a50513          	addi	a0,a0,-2022 # ffffffffc0207448 <default_pmm_manager+0x150>
...
ffffffffc0202c40:	6f460613          	addi	a2,a2,1780 # ffffffffc0207330 <default_pmm_manager+0x38>
ffffffffc0202c44:	22800593          	li	a1,552
ffffffffc0202c48:	00005517          	auipc	a0,0x5
ffffffffc0202c4c:	80050513          	addi	a0,a0,-2048 # ffffffffc0207448 <default_pmm_manager+0x150>
...
ffffffffc0202c5c:	78060613          	addi	a2,a2,1920 # ffffffffc02073d8 <default_pmm_manager+0xe0>
ffffffffc0202c60:	07f00593          	li	a1,127
ffffffffc0202c64:	00004517          	auipc	a0,0x4
ffffffffc0202c68:	7e450513          	addi	a0,a0,2020 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202c6c:	80ffd0ef          	jal	ra,ffffffffc020047a <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202c70:	00004617          	auipc	a2,0x4
ffffffffc0202c74:	76860613          	addi	a2,a2,1896 # ffffffffc02073d8 <default_pmm_manager+0xe0>
ffffffffc0202c78:	0c100593          	li	a1,193
ffffffffc0202c7c:	00004517          	auipc	a0,0x4
ffffffffc0202c80:	7cc50513          	addi	a0,a0,1996 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202c84:	ff6fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc0202c88:	00005697          	auipc	a3,0x5
ffffffffc0202c8c:	8c868693          	addi	a3,a3,-1848 # ffffffffc0207550 <default_pmm_manager+0x258>
ffffffffc0202c90:	00004617          	auipc	a2,0x4
ffffffffc0202c94:	fd060613          	addi	a2,a2,-48 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202c98:	1ec00593          	li	a1,492
ffffffffc0202c9c:	00004517          	auipc	a0,0x4
ffffffffc0202ca0:	7ac50513          	addi	a0,a0,1964 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202ca4:	fd6fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc0202ca8:	00005697          	auipc	a3,0x5
ffffffffc0202cac:	88868693          	addi	a3,a3,-1912 # ffffffffc0207530 <default_pmm_manager+0x238>
ffffffffc0202cb0:	00004617          	auipc	a2,0x4
ffffffffc0202cb4:	fb060613          	addi	a2,a2,-80 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202cb8:	1eb00593          	li	a1,491
ffffffffc0202cbc:	00004517          	auipc	a0,0x4
ffffffffc0202cc0:	78c50513          	addi	a0,a0,1932 # ffffffffc0207448 <default_pmm_manager+0x150>
...
ffffffffc0202cd0:	91468693          	addi	a3,a3,-1772 # ffffffffc02075e0 <default_pmm_manager+0x2e8>
ffffffffc0202cd4:	00004617          	auipc	a2,0x4
ffffffffc0202cd8:	f8c60613          	addi	a2,a2,-116 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202cdc:	1f400593          	li	a1,500
ffffffffc0202ce0:	00004517          	auipc	a0,0x4
ffffffffc0202ce4:	76850513          	addi	a0,a0,1896 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202ce8:	f92fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202cec:	00005697          	auipc	a3,0x5
ffffffffc0202cf0:	8c468693          	addi	a3,a3,-1852 # ffffffffc02075b0 <default_pmm_manager+0x2b8>
ffffffffc0202cf4:	00004617          	auipc	a2,0x4
ffffffffc0202cf8:	f6c60613          	addi	a2,a2,-148 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202cfc:	1f100593          	li	a1,497
ffffffffc0202d00:	00004517          	auipc	a0,0x4
ffffffffc0202d04:	74850513          	addi	a0,a0,1864 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202d08:	f72fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc0202d0c:	00005697          	auipc	a3,0x5
ffffffffc0202d10:	87c68693          	addi	a3,a3,-1924 # ffffffffc0207588 <default_pmm_manager+0x290>
ffffffffc0202d14:	00004617          	auipc	a2,0x4
ffffffffc0202d18:	f4c60613          	addi	a2,a2,-180 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202d1c:	1ed00593          	li	a1,493
ffffffffc0202d20:	00004517          	auipc	a0,0x4
ffffffffc0202d24:	72850513          	addi	a0,a0,1832 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202d28:	f52fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc0202d2c:	00005697          	auipc	a3,0x5
ffffffffc0202d30:	93c68693          	addi	a3,a3,-1732 # ffffffffc0207668 <default_pmm_manager+0x370>
ffffffffc0202d34:	00004617          	auipc	a2,0x4
ffffffffc0202d38:	f2c60613          	addi	a2,a2,-212 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202d3c:	1fd00593          	li	a1,509
ffffffffc0202d40:	00004517          	auipc	a0,0x4
ffffffffc0202d44:	70850513          	addi	a0,a0,1800 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202d48:	f32fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p2) == 1);
ffffffffc0202d4c:	00005697          	auipc	a3,0x5
ffffffffc0202d50:	9bc68693          	addi	a3,a3,-1604 # ffffffffc0207708 <default_pmm_manager+0x410>
ffffffffc0202d54:	00004617          	auipc	a2,0x4
ffffffffc0202d58:	f0c60613          	addi	a2,a2,-244 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202d5c:	20200593          	li	a1,514
ffffffffc0202d60:	00004517          	auipc	a0,0x4
ffffffffc0202d64:	6e850513          	addi	a0,a0,1768 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202d68:	f12fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202d6c:	00005697          	auipc	a3,0x5
ffffffffc0202d70:	8d468693          	addi	a3,a3,-1836 # ffffffffc0207640 <default_pmm_manager+0x348>
ffffffffc0202d74:	00004617          	auipc	a2,0x4
ffffffffc0202d78:	eec60613          	addi	a2,a2,-276 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202d7c:	1fa00593          	li	a1,506
ffffffffc0202d80:	00004517          	auipc	a0,0x4
ffffffffc0202d84:	6c850513          	addi	a0,a0,1736 # ffffffffc0207448 <default_pmm_manager+0x150>
...
ffffffffc0202d92:	5a260613          	addi	a2,a2,1442 # ffffffffc0207330 <default_pmm_manager+0x38>
ffffffffc0202d96:	1f900593          	li	a1,505
ffffffffc0202d9a:	00004517          	auipc	a0,0x4
ffffffffc0202d9e:	6ae50513          	addi	a0,a0,1710 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202da2:	ed8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202da6:	00005697          	auipc	a3,0x5
ffffffffc0202daa:	8fa68693          	addi	a3,a3,-1798 # ffffffffc02076a0 <default_pmm_manager+0x3a8>
ffffffffc0202dae:	00004617          	auipc	a2,0x4
ffffffffc0202db2:	eb260613          	addi	a2,a2,-334 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202db6:	20700593          	li	a1,519
ffffffffc0202dba:	00004517          	auipc	a0,0x4
ffffffffc0202dbe:	68e50513          	addi	a0,a0,1678 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202dc2:	eb8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202dc6:	00005697          	auipc	a3,0x5
ffffffffc0202dca:	9a268693          	addi	a3,a3,-1630 # ffffffffc0207768 <default_pmm_manager+0x470>
ffffffffc0202dce:	00004617          	auipc	a2,0x4
ffffffffc0202dd2:	e9260613          	addi	a2,a2,-366 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202dd6:	20600593          	li	a1,518
ffffffffc0202dda:	00004517          	auipc	a0,0x4
ffffffffc0202dde:	66e50513          	addi	a0,a0,1646 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202de2:	e98fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p1) == 2);
ffffffffc0202de6:	00005697          	auipc	a3,0x5
ffffffffc0202dea:	96a68693          	addi	a3,a3,-1686 # ffffffffc0207750 <default_pmm_manager+0x458>
ffffffffc0202dee:	00004617          	auipc	a2,0x4
ffffffffc0202df2:	e7260613          	addi	a2,a2,-398 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202df6:	20500593          	li	a1,517
ffffffffc0202dfa:	00004517          	auipc	a0,0x4
ffffffffc0202dfe:	64e50513          	addi	a0,a0,1614 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202e02:	e78fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc0202e06:	00005697          	auipc	a3,0x5
ffffffffc0202e0a:	91a68693          	addi	a3,a3,-1766 # ffffffffc0207720 <default_pmm_manager+0x428>
ffffffffc0202e0e:	00004617          	auipc	a2,0x4
ffffffffc0202e12:	e5260613          	addi	a2,a2,-430 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202e16:	20400593          	li	a1,516
ffffffffc0202e1a:	00004517          	auipc	a0,0x4
ffffffffc0202e1e:	62e50513          	addi	a0,a0,1582 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202e22:	e58fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc0202e26:	00005697          	auipc	a3,0x5
ffffffffc0202e2a:	ab268693          	addi	a3,a3,-1358 # ffffffffc02078d8 <default_pmm_manager+0x5e0>
ffffffffc0202e2e:	00004617          	auipc	a2,0x4
ffffffffc0202e32:	e3260613          	addi	a2,a2,-462 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202e36:	23300593          	li	a1,563
ffffffffc0202e3a:	00004517          	auipc	a0,0x4
ffffffffc0202e3e:	60e50513          	addi	a0,a0,1550 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202e42:	e38fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc0202e46:	00005697          	auipc	a3,0x5
ffffffffc0202e4a:	8aa68693          	addi	a3,a3,-1878 # ffffffffc02076f0 <default_pmm_manager+0x3f8>
ffffffffc0202e4e:	00004617          	auipc	a2,0x4
ffffffffc0202e52:	e1260613          	addi	a2,a2,-494 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202e56:	20100593          	li	a1,513
ffffffffc0202e5a:	00004517          	auipc	a0,0x4
ffffffffc0202e5e:	5ee50513          	addi	a0,a0,1518 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202e62:	e18fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(*ptep & PTE_W);
ffffffffc0202e66:	00005697          	auipc	a3,0x5
ffffffffc0202e6a:	87a68693          	addi	a3,a3,-1926 # ffffffffc02076e0 <default_pmm_manager+0x3e8>
ffffffffc0202e6e:	00004617          	auipc	a2,0x4
ffffffffc0202e72:	df260613          	addi	a2,a2,-526 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202e76:	20000593          	li	a1,512
ffffffffc0202e7a:	00004517          	auipc	a0,0x4
ffffffffc0202e7e:	5ce50513          	addi	a0,a0,1486 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202e82:	df8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0202e86:	00005697          	auipc	a3,0x5
ffffffffc0202e8a:	95268693          	addi	a3,a3,-1710 # ffffffffc02077d8 <default_pmm_manager+0x4e0>
ffffffffc0202e8e:	00004617          	auipc	a2,0x4
ffffffffc0202e92:	dd260613          	addi	a2,a2,-558 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202e96:	24400593          	li	a1,580
ffffffffc0202e9a:	00004517          	auipc	a0,0x4
ffffffffc0202e9e:	5ae50513          	addi	a0,a0,1454 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202ea2:	dd8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(*ptep & PTE_U);
ffffffffc0202ea6:	00005697          	auipc	a3,0x5
ffffffffc0202eaa:	82a68693          	addi	a3,a3,-2006 # ffffffffc02076d0 <default_pmm_manager+0x3d8>
ffffffffc0202eae:	00004617          	auipc	a2,0x4
ffffffffc0202eb2:	db260613          	addi	a2,a2,-590 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202eb6:	1ff00593          	li	a1,511
ffffffffc0202eba:	00004517          	auipc	a0,0x4
ffffffffc0202ebe:	58e50513          	addi	a0,a0,1422 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202ec2:	db8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0202ec6:	00004697          	auipc	a3,0x4
ffffffffc0202eca:	76268693          	addi	a3,a3,1890 # ffffffffc0207628 <default_pmm_manager+0x330>
ffffffffc0202ece:	00004617          	auipc	a2,0x4
ffffffffc0202ed2:	d9260613          	addi	a2,a2,-622 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202ed6:	20c00593          	li	a1,524
ffffffffc0202eda:	00004517          	auipc	a0,0x4
ffffffffc0202ede:	56e50513          	addi	a0,a0,1390 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202ee2:	d98fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc0202ee6:	00005697          	auipc	a3,0x5
ffffffffc0202eea:	89a68693          	addi	a3,a3,-1894 # ffffffffc0207780 <default_pmm_manager+0x488>
ffffffffc0202eee:	00004617          	auipc	a2,0x4
ffffffffc0202ef2:	d7260613          	addi	a2,a2,-654 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202ef6:	20900593          	li	a1,521
ffffffffc0202efa:	00004517          	auipc	a0,0x4
ffffffffc0202efe:	54e50513          	addi	a0,a0,1358 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202f02:	d78fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc0202f06:	00004697          	auipc	a3,0x4
ffffffffc0202f0a:	70a68693          	addi	a3,a3,1802 # ffffffffc0207610 <default_pmm_manager+0x318>
ffffffffc0202f0e:	00004617          	auipc	a2,0x4
ffffffffc0202f12:	d5260613          	addi	a2,a2,-686 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202f16:	20800593          	li	a1,520
ffffffffc0202f1a:	00004517          	auipc	a0,0x4
ffffffffc0202f1e:	52e50513          	addi	a0,a0,1326 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202f22:	d58fd0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc0202f26:	00004617          	auipc	a2,0x4
ffffffffc0202f2a:	40a60613          	addi	a2,a2,1034 # ffffffffc0207330 <default_pmm_manager+0x38>
ffffffffc0202f2e:	06900593          	li	a1,105
ffffffffc0202f32:	00004517          	auipc	a0,0x4
ffffffffc0202f36:	42650513          	addi	a0,a0,1062 # ffffffffc0207358 <default_pmm_manager+0x60>
ffffffffc0202f3a:	d40fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc0202f3e:	00005697          	auipc	a3,0x5
ffffffffc0202f42:	87268693          	addi	a3,a3,-1934 # ffffffffc02077b0 <default_pmm_manager+0x4b8>
ffffffffc0202f46:	00004617          	auipc	a2,0x4
ffffffffc0202f4a:	d1a60613          	addi	a2,a2,-742 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202f4e:	21300593          	li	a1,531
ffffffffc0202f52:	00004517          	auipc	a0,0x4
ffffffffc0202f56:	4f650513          	addi	a0,a0,1270 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202f5a:	d20fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202f5e:	00005697          	auipc	a3,0x5
ffffffffc0202f62:	80a68693          	addi	a3,a3,-2038 # ffffffffc0207768 <default_pmm_manager+0x470>
ffffffffc0202f66:	00004617          	auipc	a2,0x4
ffffffffc0202f6a:	cfa60613          	addi	a2,a2,-774 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202f6e:	21100593          	li	a1,529
ffffffffc0202f72:	00004517          	auipc	a0,0x4
ffffffffc0202f76:	4d650513          	addi	a0,a0,1238 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202f7a:	d00fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202f7e:	00005697          	auipc	a3,0x5
ffffffffc0202f82:	81a68693          	addi	a3,a3,-2022 # ffffffffc0207798 <default_pmm_manager+0x4a0>
ffffffffc0202f86:	00004617          	auipc	a2,0x4
ffffffffc0202f8a:	cda60613          	addi	a2,a2,-806 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202f8e:	21000593          	li	a1,528
ffffffffc0202f92:	00004517          	auipc	a0,0x4
ffffffffc0202f96:	4b650513          	addi	a0,a0,1206 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202f9a:	ce0fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202f9e:	00004697          	auipc	a3,0x4
ffffffffc0202fa2:	7ca68693          	addi	a3,a3,1994 # ffffffffc0207768 <default_pmm_manager+0x470>
ffffffffc0202fa6:	00004617          	auipc	a2,0x4
ffffffffc0202faa:	cba60613          	addi	a2,a2,-838 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202fae:	20d00593          	li	a1,525
ffffffffc0202fb2:	00004517          	auipc	a0,0x4
ffffffffc0202fb6:	49650513          	addi	a0,a0,1174 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202fba:	cc0fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202fbe:	00005697          	auipc	a3,0x5
ffffffffc0202fc2:	90268693          	addi	a3,a3,-1790 # ffffffffc02078c0 <default_pmm_manager+0x5c8>
ffffffffc0202fc6:	00004617          	auipc	a2,0x4
ffffffffc0202fca:	c9a60613          	addi	a2,a2,-870 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202fce:	23200593          	li	a1,562
ffffffffc0202fd2:	00004517          	auipc	a0,0x4
ffffffffc0202fd6:	47650513          	addi	a0,a0,1142 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202fda:	ca0fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202fde:	00005697          	auipc	a3,0x5
ffffffffc0202fe2:	8aa68693          	addi	a3,a3,-1878 # ffffffffc0207888 <default_pmm_manager+0x590>
ffffffffc0202fe6:	00004617          	auipc	a2,0x4
ffffffffc0202fea:	c7a60613          	addi	a2,a2,-902 # ffffffffc0206c60 <commands+0x450>
ffffffffc0202fee:	23100593          	li	a1,561
ffffffffc0202ff2:	00004517          	auipc	a0,0x4
ffffffffc0202ff6:	45650513          	addi	a0,a0,1110 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0202ffa:	c80fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc0202ffe:	00005697          	auipc	a3,0x5
ffffffffc0203002:	87268693          	addi	a3,a3,-1934 # ffffffffc0207870 <default_pmm_manager+0x578>
ffffffffc0203006:	00004617          	auipc	a2,0x4
ffffffffc020300a:	c5a60613          	addi	a2,a2,-934 # ffffffffc0206c60 <commands+0x450>
ffffffffc020300e:	22d00593          	li	a1,557
ffffffffc0203012:	00004517          	auipc	a0,0x4
ffffffffc0203016:	43650513          	addi	a0,a0,1078 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc020301a:	c60fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc020301e:	00004697          	auipc	a3,0x4
ffffffffc0203022:	7ba68693          	addi	a3,a3,1978 # ffffffffc02077d8 <default_pmm_manager+0x4e0>
ffffffffc0203026:	00004617          	auipc	a2,0x4
ffffffffc020302a:	c3a60613          	addi	a2,a2,-966 # ffffffffc0206c60 <commands+0x450>
ffffffffc020302e:	21b00593          	li	a1,539
ffffffffc0203032:	00004517          	auipc	a0,0x4
ffffffffc0203036:	41650513          	addi	a0,a0,1046 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc020303a:	c40fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020303e:	00004697          	auipc	a3,0x4
ffffffffc0203042:	5d268693          	addi	a3,a3,1490 # ffffffffc0207610 <default_pmm_manager+0x318>
ffffffffc0203046:	00004617          	auipc	a2,0x4
ffffffffc020304a:	c1a60613          	addi	a2,a2,-998 # ffffffffc0206c60 <commands+0x450>
ffffffffc020304e:	1f500593          	li	a1,501
ffffffffc0203052:	00004517          	auipc	a0,0x4
ffffffffc0203056:	3f650513          	addi	a0,a0,1014 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc020305a:	c20fd0ef          	jal	ra,ffffffffc020047a <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc020305e:	00004617          	auipc	a2,0x4
ffffffffc0203062:	2d260613          	addi	a2,a2,722 # ffffffffc0207330 <default_pmm_manager+0x38>
ffffffffc0203066:	1f800593          	li	a1,504
ffffffffc020306a:	00004517          	auipc	a0,0x4
ffffffffc020306e:	3de50513          	addi	a0,a0,990 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0203072:	c08fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0203076:	00004697          	auipc	a3,0x4
ffffffffc020307a:	5b268693          	addi	a3,a3,1458 # ffffffffc0207628 <default_pmm_manager+0x330>
ffffffffc020307e:	00004617          	auipc	a2,0x4
ffffffffc0203082:	be260613          	addi	a2,a2,-1054 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203086:	1f600593          	li	a1,502
ffffffffc020308a:	00004517          	auipc	a0,0x4
ffffffffc020308e:	3be50513          	addi	a0,a0,958 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc0203092:	be8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0203096:	00004697          	auipc	a3,0x4
ffffffffc020309a:	60a68693          	addi	a3,a3,1546 # ffffffffc02076a0 <default_pmm_manager+0x3a8>
ffffffffc020309e:	00004617          	auipc	a2,0x4
ffffffffc02030a2:	bc260613          	addi	a2,a2,-1086 # ffffffffc0206c60 <commands+0x450>
ffffffffc02030a6:	1fe00593          	li	a1,510
ffffffffc02030aa:	00004517          	auipc	a0,0x4
ffffffffc02030ae:	39e50513          	addi	a0,a0,926 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc02030b2:	bc8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc02030b6:	00005697          	auipc	a3,0x5
ffffffffc02030ba:	8ca68693          	addi	a3,a3,-1846 # ffffffffc0207980 <default_pmm_manager+0x688>
ffffffffc02030be:	00004617          	auipc	a2,0x4
ffffffffc02030c2:	ba260613          	addi	a2,a2,-1118 # ffffffffc0206c60 <commands+0x450>
ffffffffc02030c6:	23b00593          	li	a1,571
ffffffffc02030ca:	00004517          	auipc	a0,0x4
ffffffffc02030ce:	37e50513          	addi	a0,a0,894 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc02030d2:	ba8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02030d6:	00005697          	auipc	a3,0x5
ffffffffc02030da:	87268693          	addi	a3,a3,-1934 # ffffffffc0207948 <default_pmm_manager+0x650>
ffffffffc02030de:	00004617          	auipc	a2,0x4
ffffffffc02030e2:	b8260613          	addi	a2,a2,-1150 # ffffffffc0206c60 <commands+0x450>
ffffffffc02030e6:	23800593          	li	a1,568
ffffffffc02030ea:	00004517          	auipc	a0,0x4
ffffffffc02030ee:	35e50513          	addi	a0,a0,862 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc02030f2:	b88fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p) == 2);
ffffffffc02030f6:	00005697          	auipc	a3,0x5
ffffffffc02030fa:	82268693          	addi	a3,a3,-2014 # ffffffffc0207918 <default_pmm_manager+0x620>
ffffffffc02030fe:	00004617          	auipc	a2,0x4
ffffffffc0203102:	b6260613          	addi	a2,a2,-1182 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203106:	23400593          	li	a1,564
ffffffffc020310a:	00004517          	auipc	a0,0x4
ffffffffc020310e:	33e50513          	addi	a0,a0,830 # ffffffffc0207448 <default_pmm_manager+0x150>
...
ffffffffc0203232:	35c030ef          	jal	ra,ffffffffc020658e <memcpy>
...
ffffffffc0203248:	7a468693          	addi	a3,a3,1956 # ffffffffc02079e8 <default_pmm_manager+0x6f0>
ffffffffc020324c:	00004617          	auipc	a2,0x4
ffffffffc0203250:	a1460613          	addi	a2,a2,-1516 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203254:	18d00593          	li	a1,397
ffffffffc0203258:	00004517          	auipc	a0,0x4
ffffffffc020325c:	1f050513          	addi	a0,a0,496 # ffffffffc0207448 <default_pmm_manager+0x150>
...
ffffffffc0203282:	0b260613          	addi	a2,a2,178 # ffffffffc0207330 <default_pmm_manager+0x38>
ffffffffc0203286:	06900593          	li	a1,105
ffffffffc020328a:	00004517          	auipc	a0,0x4
ffffffffc020328e:	0ce50513          	addi	a0,a0,206 # ffffffffc0207358 <default_pmm_manager+0x60>
ffffffffc0203292:	9e8fd0ef          	jal	ra,ffffffffc020047a <__panic>
            assert(page != NULL);
ffffffffc0203296:	00004697          	auipc	a3,0x4
ffffffffc020329a:	73268693          	addi	a3,a3,1842 # ffffffffc02079c8 <default_pmm_manager+0x6d0>
ffffffffc020329e:	00004617          	auipc	a2,0x4
ffffffffc02032a2:	9c260613          	addi	a2,a2,-1598 # ffffffffc0206c60 <commands+0x450>
ffffffffc02032a6:	17200593          	li	a1,370
ffffffffc02032aa:	00004517          	auipc	a0,0x4
ffffffffc02032ae:	19e50513          	addi	a0,a0,414 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc02032b2:	9c8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(USER_ACCESS(start, end));
ffffffffc02032b6:	00004697          	auipc	a3,0x4
ffffffffc02032ba:	1d268693          	addi	a3,a3,466 # ffffffffc0207488 <default_pmm_manager+0x190>
ffffffffc02032be:	00004617          	auipc	a2,0x4
ffffffffc02032c2:	9a260613          	addi	a2,a2,-1630 # ffffffffc0206c60 <commands+0x450>
ffffffffc02032c6:	15e00593          	li	a1,350
ffffffffc02032ca:	00004517          	auipc	a0,0x4
ffffffffc02032ce:	17e50513          	addi	a0,a0,382 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc02032d2:	9a8fd0ef          	jal	ra,ffffffffc020047a <__panic>
            assert(npage != NULL);
ffffffffc02032d6:	00004697          	auipc	a3,0x4
ffffffffc02032da:	70268693          	addi	a3,a3,1794 # ffffffffc02079d8 <default_pmm_manager+0x6e0>
ffffffffc02032de:	00004617          	auipc	a2,0x4
ffffffffc02032e2:	98260613          	addi	a2,a2,-1662 # ffffffffc0206c60 <commands+0x450>
ffffffffc02032e6:	17300593          	li	a1,371
ffffffffc02032ea:	00004517          	auipc	a0,0x4
ffffffffc02032ee:	15e50513          	addi	a0,a0,350 # ffffffffc0207448 <default_pmm_manager+0x150>
ffffffffc02032f2:	988fd0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02032f6:	00004617          	auipc	a2,0x4
ffffffffc02032fa:	10a60613          	addi	a2,a2,266 # ffffffffc0207400 <default_pmm_manager+0x108>
ffffffffc02032fe:	06200593          	li	a1,98
ffffffffc0203302:	00004517          	auipc	a0,0x4
ffffffffc0203306:	05650513          	addi	a0,a0,86 # ffffffffc0207358 <default_pmm_manager+0x60>
ffffffffc020330a:	970fd0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pte2page called with invalid pte");
ffffffffc020330e:	00004617          	auipc	a2,0x4
ffffffffc0203312:	11260613          	addi	a2,a2,274 # ffffffffc0207420 <default_pmm_manager+0x128>
ffffffffc0203316:	07400593          	li	a1,116
ffffffffc020331a:	00004517          	auipc	a0,0x4
ffffffffc020331e:	03e50513          	addi	a0,a0,62 # ffffffffc0207358 <default_pmm_manager+0x60>
ffffffffc0203322:	958fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(start % PGSIZE == 0 && end % PGSIZE == 0);
ffffffffc0203326:	00004697          	auipc	a3,0x4
ffffffffc020332a:	13268693          	addi	a3,a3,306 # ffffffffc0207458 <default_pmm_manager+0x160>
ffffffffc020332e:	00004617          	auipc	a2,0x4
ffffffffc0203332:	93260613          	addi	a2,a2,-1742 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203336:	15d00593          	li	a1,349
ffffffffc020333a:	00004517          	auipc	a0,0x4
ffffffffc020333e:	10e50513          	addi	a0,a0,270 # ffffffffc0207448 <default_pmm_manager+0x150>
...
ffffffffc02033ea:	61268693          	addi	a3,a3,1554 # ffffffffc02079f8 <default_pmm_manager+0x700>
ffffffffc02033ee:	00004617          	auipc	a2,0x4
ffffffffc02033f2:	87260613          	addi	a2,a2,-1934 # ffffffffc0206c60 <commands+0x450>
ffffffffc02033f6:	1cc00593          	li	a1,460
ffffffffc02033fa:	00004517          	auipc	a0,0x4
ffffffffc02033fe:	04e50513          	addi	a0,a0,78 # ffffffffc0207448 <default_pmm_manager+0x150>
...
ffffffffc020340c:	ff860613          	addi	a2,a2,-8 # ffffffffc0207400 <default_pmm_manager+0x108>
ffffffffc0203410:	06200593          	li	a1,98
ffffffffc0203414:	00004517          	auipc	a0,0x4
ffffffffc0203418:	f4450513          	addi	a0,a0,-188 # ffffffffc0207358 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc020349c:	5a850513          	addi	a0,a0,1448 # ffffffffc0207a40 <default_pmm_manager+0x748>
    return listelm->next;
...
ffffffffc02034ee:	56e50513          	addi	a0,a0,1390 # ffffffffc0207a58 <default_pmm_manager+0x760>
...
ffffffffc0203542:	58a50513          	addi	a0,a0,1418 # ffffffffc0207ac8 <default_pmm_manager+0x7d0>
...
ffffffffc020355e:	5be50513          	addi	a0,a0,1470 # ffffffffc0207b18 <default_pmm_manager+0x820>
...
ffffffffc02035d2:	5d250513          	addi	a0,a0,1490 # ffffffffc0207ba0 <default_pmm_manager+0x8a8>
...
ffffffffc02036ea:	57a60613          	addi	a2,a2,1402 # ffffffffc0208c60 <nbase>
...
ffffffffc0203716:	53650513          	addi	a0,a0,1334 # ffffffffc0207c48 <default_pmm_manager+0x950>
...
ffffffffc02037f6:	4a650513          	addi	a0,a0,1190 # ffffffffc0207c98 <default_pmm_manager+0x9a0>
...
ffffffffc0203808:	74c68693          	addi	a3,a3,1868 # ffffffffc0206f50 <commands+0x740>
ffffffffc020380c:	00003617          	auipc	a2,0x3
ffffffffc0203810:	45460613          	addi	a2,a2,1108 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203814:	0bc00593          	li	a1,188
ffffffffc0203818:	00004517          	auipc	a0,0x4
ffffffffc020381c:	21850513          	addi	a0,a0,536 # ffffffffc0207a30 <default_pmm_manager+0x738>
...
ffffffffc020382c:	bd860613          	addi	a2,a2,-1064 # ffffffffc0207400 <default_pmm_manager+0x108>
ffffffffc0203830:	06200593          	li	a1,98
ffffffffc0203834:	00004517          	auipc	a0,0x4
ffffffffc0203838:	b2450513          	addi	a0,a0,-1244 # ffffffffc0207358 <default_pmm_manager+0x60>
ffffffffc020383c:	c3ffc0ef          	jal	ra,ffffffffc020047a <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0203840:	00004697          	auipc	a3,0x4
ffffffffc0203844:	3e068693          	addi	a3,a3,992 # ffffffffc0207c20 <default_pmm_manager+0x928>
ffffffffc0203848:	00003617          	auipc	a2,0x3
ffffffffc020384c:	41860613          	addi	a2,a2,1048 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203850:	0fc00593          	li	a1,252
ffffffffc0203854:	00004517          	auipc	a0,0x4
ffffffffc0203858:	1dc50513          	addi	a0,a0,476 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc020385c:	c1ffc0ef          	jal	ra,ffffffffc020047a <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0203860:	00004697          	auipc	a3,0x4
ffffffffc0203864:	2e068693          	addi	a3,a3,736 # ffffffffc0207b40 <default_pmm_manager+0x848>
ffffffffc0203868:	00003617          	auipc	a2,0x3
ffffffffc020386c:	3f860613          	addi	a2,a2,1016 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203870:	0dc00593          	li	a1,220
ffffffffc0203874:	00004517          	auipc	a0,0x4
ffffffffc0203878:	1bc50513          	addi	a0,a0,444 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc020387c:	bfffc0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0203880:	00004617          	auipc	a2,0x4
ffffffffc0203884:	19060613          	addi	a2,a2,400 # ffffffffc0207a10 <default_pmm_manager+0x718>
ffffffffc0203888:	02800593          	li	a1,40
ffffffffc020388c:	00004517          	auipc	a0,0x4
ffffffffc0203890:	1a450513          	addi	a0,a0,420 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc0203894:	be7fc0ef          	jal	ra,ffffffffc020047a <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0203898:	00004697          	auipc	a3,0x4
ffffffffc020389c:	37068693          	addi	a3,a3,880 # ffffffffc0207c08 <default_pmm_manager+0x910>
ffffffffc02038a0:	00003617          	auipc	a2,0x3
ffffffffc02038a4:	3c060613          	addi	a2,a2,960 # ffffffffc0206c60 <commands+0x450>
ffffffffc02038a8:	0fb00593          	li	a1,251
ffffffffc02038ac:	00004517          	auipc	a0,0x4
ffffffffc02038b0:	18450513          	addi	a0,a0,388 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc02038b4:	bc7fc0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pte2page called with invalid pte");
ffffffffc02038b8:	00004617          	auipc	a2,0x4
ffffffffc02038bc:	b6860613          	addi	a2,a2,-1176 # ffffffffc0207420 <default_pmm_manager+0x128>
ffffffffc02038c0:	07400593          	li	a1,116
ffffffffc02038c4:	00004517          	auipc	a0,0x4
ffffffffc02038c8:	a9450513          	addi	a0,a0,-1388 # ffffffffc0207358 <default_pmm_manager+0x60>
ffffffffc02038cc:	baffc0ef          	jal	ra,ffffffffc020047a <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc02038d0:	00004697          	auipc	a3,0x4
ffffffffc02038d4:	28868693          	addi	a3,a3,648 # ffffffffc0207b58 <default_pmm_manager+0x860>
ffffffffc02038d8:	00003617          	auipc	a2,0x3
ffffffffc02038dc:	38860613          	addi	a2,a2,904 # ffffffffc0206c60 <commands+0x450>
ffffffffc02038e0:	0dd00593          	li	a1,221
ffffffffc02038e4:	00004517          	auipc	a0,0x4
ffffffffc02038e8:	14c50513          	addi	a0,a0,332 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc02038ec:	b8ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(check_mm_struct == NULL);
ffffffffc02038f0:	00004697          	auipc	a3,0x4
ffffffffc02038f4:	1a068693          	addi	a3,a3,416 # ffffffffc0207a90 <default_pmm_manager+0x798>
ffffffffc02038f8:	00003617          	auipc	a2,0x3
ffffffffc02038fc:	36860613          	addi	a2,a2,872 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203900:	0c700593          	li	a1,199
ffffffffc0203904:	00004517          	auipc	a0,0x4
ffffffffc0203908:	12c50513          	addi	a0,a0,300 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc020390c:	b6ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(total == nr_free_pages());
ffffffffc0203910:	00003697          	auipc	a3,0x3
ffffffffc0203914:	66868693          	addi	a3,a3,1640 # ffffffffc0206f78 <commands+0x768>
ffffffffc0203918:	00003617          	auipc	a2,0x3
ffffffffc020391c:	34860613          	addi	a2,a2,840 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203920:	0bf00593          	li	a1,191
ffffffffc0203924:	00004517          	auipc	a0,0x4
ffffffffc0203928:	10c50513          	addi	a0,a0,268 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc020392c:	b4ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert( nr_free == 0);         
ffffffffc0203930:	00003697          	auipc	a3,0x3
ffffffffc0203934:	7f068693          	addi	a3,a3,2032 # ffffffffc0207120 <commands+0x910>
ffffffffc0203938:	00003617          	auipc	a2,0x3
ffffffffc020393c:	32860613          	addi	a2,a2,808 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203940:	0f300593          	li	a1,243
ffffffffc0203944:	00004517          	auipc	a0,0x4
ffffffffc0203948:	0ec50513          	addi	a0,a0,236 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc020394c:	b2ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203950:	00004697          	auipc	a3,0x4
ffffffffc0203954:	15868693          	addi	a3,a3,344 # ffffffffc0207aa8 <default_pmm_manager+0x7b0>
ffffffffc0203958:	00003617          	auipc	a2,0x3
ffffffffc020395c:	30860613          	addi	a2,a2,776 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203960:	0cc00593          	li	a1,204
ffffffffc0203964:	00004517          	auipc	a0,0x4
ffffffffc0203968:	0cc50513          	addi	a0,a0,204 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc020396c:	b0ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(mm != NULL);
ffffffffc0203970:	00004697          	auipc	a3,0x4
ffffffffc0203974:	11068693          	addi	a3,a3,272 # ffffffffc0207a80 <default_pmm_manager+0x788>
ffffffffc0203978:	00003617          	auipc	a2,0x3
ffffffffc020397c:	2e860613          	addi	a2,a2,744 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203980:	0c400593          	li	a1,196
ffffffffc0203984:	00004517          	auipc	a0,0x4
ffffffffc0203988:	0ac50513          	addi	a0,a0,172 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc020398c:	aeffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(total==0);
ffffffffc0203990:	00004697          	auipc	a3,0x4
ffffffffc0203994:	2f868693          	addi	a3,a3,760 # ffffffffc0207c88 <default_pmm_manager+0x990>
ffffffffc0203998:	00003617          	auipc	a2,0x3
ffffffffc020399c:	2c860613          	addi	a2,a2,712 # ffffffffc0206c60 <commands+0x450>
ffffffffc02039a0:	11e00593          	li	a1,286
ffffffffc02039a4:	00004517          	auipc	a0,0x4
ffffffffc02039a8:	08c50513          	addi	a0,a0,140 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc02039ac:	acffc0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc02039b0:	00004617          	auipc	a2,0x4
ffffffffc02039b4:	98060613          	addi	a2,a2,-1664 # ffffffffc0207330 <default_pmm_manager+0x38>
ffffffffc02039b8:	06900593          	li	a1,105
ffffffffc02039bc:	00004517          	auipc	a0,0x4
ffffffffc02039c0:	99c50513          	addi	a0,a0,-1636 # ffffffffc0207358 <default_pmm_manager+0x60>
ffffffffc02039c4:	ab7fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(count==0);
ffffffffc02039c8:	00004697          	auipc	a3,0x4
ffffffffc02039cc:	2b068693          	addi	a3,a3,688 # ffffffffc0207c78 <default_pmm_manager+0x980>
ffffffffc02039d0:	00003617          	auipc	a2,0x3
ffffffffc02039d4:	29060613          	addi	a2,a2,656 # ffffffffc0206c60 <commands+0x450>
ffffffffc02039d8:	11d00593          	li	a1,285
ffffffffc02039dc:	00004517          	auipc	a0,0x4
ffffffffc02039e0:	05450513          	addi	a0,a0,84 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc02039e4:	a97fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==1);
ffffffffc02039e8:	00004697          	auipc	a3,0x4
ffffffffc02039ec:	1e068693          	addi	a3,a3,480 # ffffffffc0207bc8 <default_pmm_manager+0x8d0>
ffffffffc02039f0:	00003617          	auipc	a2,0x3
ffffffffc02039f4:	27060613          	addi	a2,a2,624 # ffffffffc0206c60 <commands+0x450>
ffffffffc02039f8:	09500593          	li	a1,149
ffffffffc02039fc:	00004517          	auipc	a0,0x4
ffffffffc0203a00:	03450513          	addi	a0,a0,52 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc0203a04:	a77fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0203a08:	00004697          	auipc	a3,0x4
ffffffffc0203a0c:	17068693          	addi	a3,a3,368 # ffffffffc0207b78 <default_pmm_manager+0x880>
ffffffffc0203a10:	00003617          	auipc	a2,0x3
ffffffffc0203a14:	25060613          	addi	a2,a2,592 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203a18:	0ea00593          	li	a1,234
ffffffffc0203a1c:	00004517          	auipc	a0,0x4
ffffffffc0203a20:	01450513          	addi	a0,a0,20 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc0203a24:	a57fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0203a28:	00004697          	auipc	a3,0x4
ffffffffc0203a2c:	0d868693          	addi	a3,a3,216 # ffffffffc0207b00 <default_pmm_manager+0x808>
ffffffffc0203a30:	00003617          	auipc	a2,0x3
ffffffffc0203a34:	23060613          	addi	a2,a2,560 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203a38:	0d700593          	li	a1,215
ffffffffc0203a3c:	00004517          	auipc	a0,0x4
ffffffffc0203a40:	ff450513          	addi	a0,a0,-12 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc0203a44:	a37fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(ret==0);
ffffffffc0203a48:	00004697          	auipc	a3,0x4
ffffffffc0203a4c:	22868693          	addi	a3,a3,552 # ffffffffc0207c70 <default_pmm_manager+0x978>
ffffffffc0203a50:	00003617          	auipc	a2,0x3
ffffffffc0203a54:	21060613          	addi	a2,a2,528 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203a58:	10200593          	li	a1,258
ffffffffc0203a5c:	00004517          	auipc	a0,0x4
ffffffffc0203a60:	fd450513          	addi	a0,a0,-44 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc0203a64:	a17fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(vma != NULL);
ffffffffc0203a68:	00004697          	auipc	a3,0x4
ffffffffc0203a6c:	05068693          	addi	a3,a3,80 # ffffffffc0207ab8 <default_pmm_manager+0x7c0>
ffffffffc0203a70:	00003617          	auipc	a2,0x3
ffffffffc0203a74:	1f060613          	addi	a2,a2,496 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203a78:	0cf00593          	li	a1,207
ffffffffc0203a7c:	00004517          	auipc	a0,0x4
ffffffffc0203a80:	fb450513          	addi	a0,a0,-76 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc0203a84:	9f7fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==4);
ffffffffc0203a88:	00004697          	auipc	a3,0x4
ffffffffc0203a8c:	17068693          	addi	a3,a3,368 # ffffffffc0207bf8 <default_pmm_manager+0x900>
ffffffffc0203a90:	00003617          	auipc	a2,0x3
ffffffffc0203a94:	1d060613          	addi	a2,a2,464 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203a98:	09f00593          	li	a1,159
ffffffffc0203a9c:	00004517          	auipc	a0,0x4
ffffffffc0203aa0:	f9450513          	addi	a0,a0,-108 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc0203aa4:	9d7fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==4);
ffffffffc0203aa8:	00004697          	auipc	a3,0x4
ffffffffc0203aac:	15068693          	addi	a3,a3,336 # ffffffffc0207bf8 <default_pmm_manager+0x900>
ffffffffc0203ab0:	00003617          	auipc	a2,0x3
ffffffffc0203ab4:	1b060613          	addi	a2,a2,432 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203ab8:	0a100593          	li	a1,161
ffffffffc0203abc:	00004517          	auipc	a0,0x4
ffffffffc0203ac0:	f7450513          	addi	a0,a0,-140 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc0203ac4:	9b7fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==2);
ffffffffc0203ac8:	00004697          	auipc	a3,0x4
ffffffffc0203acc:	11068693          	addi	a3,a3,272 # ffffffffc0207bd8 <default_pmm_manager+0x8e0>
ffffffffc0203ad0:	00003617          	auipc	a2,0x3
ffffffffc0203ad4:	19060613          	addi	a2,a2,400 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203ad8:	09700593          	li	a1,151
ffffffffc0203adc:	00004517          	auipc	a0,0x4
ffffffffc0203ae0:	f5450513          	addi	a0,a0,-172 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc0203ae4:	997fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==2);
ffffffffc0203ae8:	00004697          	auipc	a3,0x4
ffffffffc0203aec:	0f068693          	addi	a3,a3,240 # ffffffffc0207bd8 <default_pmm_manager+0x8e0>
ffffffffc0203af0:	00003617          	auipc	a2,0x3
ffffffffc0203af4:	17060613          	addi	a2,a2,368 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203af8:	09900593          	li	a1,153
ffffffffc0203afc:	00004517          	auipc	a0,0x4
ffffffffc0203b00:	f3450513          	addi	a0,a0,-204 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc0203b04:	977fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==3);
ffffffffc0203b08:	00004697          	auipc	a3,0x4
ffffffffc0203b0c:	0e068693          	addi	a3,a3,224 # ffffffffc0207be8 <default_pmm_manager+0x8f0>
ffffffffc0203b10:	00003617          	auipc	a2,0x3
ffffffffc0203b14:	15060613          	addi	a2,a2,336 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203b18:	09b00593          	li	a1,155
ffffffffc0203b1c:	00004517          	auipc	a0,0x4
ffffffffc0203b20:	f1450513          	addi	a0,a0,-236 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc0203b24:	957fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==3);
ffffffffc0203b28:	00004697          	auipc	a3,0x4
ffffffffc0203b2c:	0c068693          	addi	a3,a3,192 # ffffffffc0207be8 <default_pmm_manager+0x8f0>
ffffffffc0203b30:	00003617          	auipc	a2,0x3
ffffffffc0203b34:	13060613          	addi	a2,a2,304 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203b38:	09d00593          	li	a1,157
ffffffffc0203b3c:	00004517          	auipc	a0,0x4
ffffffffc0203b40:	ef450513          	addi	a0,a0,-268 # ffffffffc0207a30 <default_pmm_manager+0x738>
ffffffffc0203b44:	937fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==1);
ffffffffc0203b48:	00004697          	auipc	a3,0x4
ffffffffc0203b4c:	08068693          	addi	a3,a3,128 # ffffffffc0207bc8 <default_pmm_manager+0x8d0>
ffffffffc0203b50:	00003617          	auipc	a2,0x3
ffffffffc0203b54:	11060613          	addi	a2,a2,272 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203b58:	09300593          	li	a1,147
ffffffffc0203b5c:	00004517          	auipc	a0,0x4
ffffffffc0203b60:	ed450513          	addi	a0,a0,-300 # ffffffffc0207a30 <default_pmm_manager+0x738>
...
ffffffffc0203bac:	170b0b13          	addi	s6,s6,368 # ffffffffc0207d18 <default_pmm_manager+0xa20>
                    cprintf("SWAP: failed to save\n");
ffffffffc0203bb0:	00004b97          	auipc	s7,0x4
ffffffffc0203bb4:	150b8b93          	addi	s7,s7,336 # ffffffffc0207d00 <default_pmm_manager+0xa08>
...
ffffffffc0203c66:	05650513          	addi	a0,a0,86 # ffffffffc0207cb8 <default_pmm_manager+0x9c0>
...
ffffffffc0203c78:	07468693          	addi	a3,a3,116 # ffffffffc0207ce8 <default_pmm_manager+0x9f0>
ffffffffc0203c7c:	00003617          	auipc	a2,0x3
ffffffffc0203c80:	fe460613          	addi	a2,a2,-28 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203c84:	06800593          	li	a1,104
ffffffffc0203c88:	00004517          	auipc	a0,0x4
ffffffffc0203c8c:	da850513          	addi	a0,a0,-600 # ffffffffc0207a30 <default_pmm_manager+0x738>
...
ffffffffc0203cd0:	09c50513          	addi	a0,a0,156 # ffffffffc0207d68 <default_pmm_manager+0xa70>
...
ffffffffc0203cf2:	06a68693          	addi	a3,a3,106 # ffffffffc0207d58 <default_pmm_manager+0xa60>
ffffffffc0203cf6:	00003617          	auipc	a2,0x3
ffffffffc0203cfa:	f6a60613          	addi	a2,a2,-150 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203cfe:	07e00593          	li	a1,126
ffffffffc0203d02:	00004517          	auipc	a0,0x4
ffffffffc0203d06:	d2e50513          	addi	a0,a0,-722 # ffffffffc0207a30 <default_pmm_manager+0x738>
...
ffffffffc0203d36:	07650513          	addi	a0,a0,118 # ffffffffc0207da8 <default_pmm_manager+0xab0>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc0203d6c:	08050513          	addi	a0,a0,128 # ffffffffc0207de8 <default_pmm_manager+0xaf0>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc0203d90:	08450513          	addi	a0,a0,132 # ffffffffc0207e10 <default_pmm_manager+0xb18>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc0203dae:	08e50513          	addi	a0,a0,142 # ffffffffc0207e38 <default_pmm_manager+0xb40>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203dca:	09a50513          	addi	a0,a0,154 # ffffffffc0207e60 <default_pmm_manager+0xb68>
...
ffffffffc0203de8:	05450513          	addi	a0,a0,84 # ffffffffc0207e38 <default_pmm_manager+0xb40>
...
ffffffffc0203e00:	fec50513          	addi	a0,a0,-20 # ffffffffc0207de8 <default_pmm_manager+0xaf0>
...
ffffffffc0203e1a:	02250513          	addi	a0,a0,34 # ffffffffc0207e38 <default_pmm_manager+0xb40>
...
ffffffffc0203e34:	f7850513          	addi	a0,a0,-136 # ffffffffc0207da8 <default_pmm_manager+0xab0>
...
ffffffffc0203e4e:	fc650513          	addi	a0,a0,-58 # ffffffffc0207e10 <default_pmm_manager+0xb18>
...
ffffffffc0203e68:	ffc50513          	addi	a0,a0,-4 # ffffffffc0207e60 <default_pmm_manager+0xb68>
...
ffffffffc0203e86:	f6650513          	addi	a0,a0,-154 # ffffffffc0207de8 <default_pmm_manager+0xaf0>
...
ffffffffc0203ec4:	d3868693          	addi	a3,a3,-712 # ffffffffc0207bf8 <default_pmm_manager+0x900>
ffffffffc0203ec8:	00003617          	auipc	a2,0x3
ffffffffc0203ecc:	d9860613          	addi	a2,a2,-616 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203ed0:	05100593          	li	a1,81
ffffffffc0203ed4:	00004517          	auipc	a0,0x4
ffffffffc0203ed8:	efc50513          	addi	a0,a0,-260 # ffffffffc0207dd0 <default_pmm_manager+0xad8>
ffffffffc0203edc:	d9efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==11);
ffffffffc0203ee0:	00004697          	auipc	a3,0x4
ffffffffc0203ee4:	03068693          	addi	a3,a3,48 # ffffffffc0207f10 <default_pmm_manager+0xc18>
ffffffffc0203ee8:	00003617          	auipc	a2,0x3
ffffffffc0203eec:	d7860613          	addi	a2,a2,-648 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203ef0:	07300593          	li	a1,115
ffffffffc0203ef4:	00004517          	auipc	a0,0x4
ffffffffc0203ef8:	edc50513          	addi	a0,a0,-292 # ffffffffc0207dd0 <default_pmm_manager+0xad8>
ffffffffc0203efc:	d7efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203f00:	00004697          	auipc	a3,0x4
ffffffffc0203f04:	fe868693          	addi	a3,a3,-24 # ffffffffc0207ee8 <default_pmm_manager+0xbf0>
ffffffffc0203f08:	00003617          	auipc	a2,0x3
ffffffffc0203f0c:	d5860613          	addi	a2,a2,-680 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203f10:	07100593          	li	a1,113
ffffffffc0203f14:	00004517          	auipc	a0,0x4
ffffffffc0203f18:	ebc50513          	addi	a0,a0,-324 # ffffffffc0207dd0 <default_pmm_manager+0xad8>
ffffffffc0203f1c:	d5efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==10);
ffffffffc0203f20:	00004697          	auipc	a3,0x4
ffffffffc0203f24:	fb868693          	addi	a3,a3,-72 # ffffffffc0207ed8 <default_pmm_manager+0xbe0>
ffffffffc0203f28:	00003617          	auipc	a2,0x3
ffffffffc0203f2c:	d3860613          	addi	a2,a2,-712 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203f30:	06f00593          	li	a1,111
ffffffffc0203f34:	00004517          	auipc	a0,0x4
ffffffffc0203f38:	e9c50513          	addi	a0,a0,-356 # ffffffffc0207dd0 <default_pmm_manager+0xad8>
ffffffffc0203f3c:	d3efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==9);
ffffffffc0203f40:	00004697          	auipc	a3,0x4
ffffffffc0203f44:	f8868693          	addi	a3,a3,-120 # ffffffffc0207ec8 <default_pmm_manager+0xbd0>
ffffffffc0203f48:	00003617          	auipc	a2,0x3
ffffffffc0203f4c:	d1860613          	addi	a2,a2,-744 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203f50:	06c00593          	li	a1,108
ffffffffc0203f54:	00004517          	auipc	a0,0x4
ffffffffc0203f58:	e7c50513          	addi	a0,a0,-388 # ffffffffc0207dd0 <default_pmm_manager+0xad8>
ffffffffc0203f5c:	d1efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==8);
ffffffffc0203f60:	00004697          	auipc	a3,0x4
ffffffffc0203f64:	f5868693          	addi	a3,a3,-168 # ffffffffc0207eb8 <default_pmm_manager+0xbc0>
ffffffffc0203f68:	00003617          	auipc	a2,0x3
ffffffffc0203f6c:	cf860613          	addi	a2,a2,-776 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203f70:	06900593          	li	a1,105
ffffffffc0203f74:	00004517          	auipc	a0,0x4
ffffffffc0203f78:	e5c50513          	addi	a0,a0,-420 # ffffffffc0207dd0 <default_pmm_manager+0xad8>
ffffffffc0203f7c:	cfefc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==7);
ffffffffc0203f80:	00004697          	auipc	a3,0x4
ffffffffc0203f84:	f2868693          	addi	a3,a3,-216 # ffffffffc0207ea8 <default_pmm_manager+0xbb0>
ffffffffc0203f88:	00003617          	auipc	a2,0x3
ffffffffc0203f8c:	cd860613          	addi	a2,a2,-808 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203f90:	06600593          	li	a1,102
ffffffffc0203f94:	00004517          	auipc	a0,0x4
ffffffffc0203f98:	e3c50513          	addi	a0,a0,-452 # ffffffffc0207dd0 <default_pmm_manager+0xad8>
ffffffffc0203f9c:	cdefc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==6);
ffffffffc0203fa0:	00004697          	auipc	a3,0x4
ffffffffc0203fa4:	ef868693          	addi	a3,a3,-264 # ffffffffc0207e98 <default_pmm_manager+0xba0>
ffffffffc0203fa8:	00003617          	auipc	a2,0x3
ffffffffc0203fac:	cb860613          	addi	a2,a2,-840 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203fb0:	06300593          	li	a1,99
ffffffffc0203fb4:	00004517          	auipc	a0,0x4
ffffffffc0203fb8:	e1c50513          	addi	a0,a0,-484 # ffffffffc0207dd0 <default_pmm_manager+0xad8>
ffffffffc0203fbc:	cbefc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==5);
ffffffffc0203fc0:	00004697          	auipc	a3,0x4
ffffffffc0203fc4:	ec868693          	addi	a3,a3,-312 # ffffffffc0207e88 <default_pmm_manager+0xb90>
ffffffffc0203fc8:	00003617          	auipc	a2,0x3
ffffffffc0203fcc:	c9860613          	addi	a2,a2,-872 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203fd0:	06000593          	li	a1,96
ffffffffc0203fd4:	00004517          	auipc	a0,0x4
ffffffffc0203fd8:	dfc50513          	addi	a0,a0,-516 # ffffffffc0207dd0 <default_pmm_manager+0xad8>
ffffffffc0203fdc:	c9efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==5);
ffffffffc0203fe0:	00004697          	auipc	a3,0x4
ffffffffc0203fe4:	ea868693          	addi	a3,a3,-344 # ffffffffc0207e88 <default_pmm_manager+0xb90>
ffffffffc0203fe8:	00003617          	auipc	a2,0x3
ffffffffc0203fec:	c7860613          	addi	a2,a2,-904 # ffffffffc0206c60 <commands+0x450>
ffffffffc0203ff0:	05d00593          	li	a1,93
ffffffffc0203ff4:	00004517          	auipc	a0,0x4
ffffffffc0203ff8:	ddc50513          	addi	a0,a0,-548 # ffffffffc0207dd0 <default_pmm_manager+0xad8>
ffffffffc0203ffc:	c7efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==4);
ffffffffc0204000:	00004697          	auipc	a3,0x4
ffffffffc0204004:	bf868693          	addi	a3,a3,-1032 # ffffffffc0207bf8 <default_pmm_manager+0x900>
ffffffffc0204008:	00003617          	auipc	a2,0x3
ffffffffc020400c:	c5860613          	addi	a2,a2,-936 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204010:	05a00593          	li	a1,90
ffffffffc0204014:	00004517          	auipc	a0,0x4
ffffffffc0204018:	dbc50513          	addi	a0,a0,-580 # ffffffffc0207dd0 <default_pmm_manager+0xad8>
ffffffffc020401c:	c5efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==4);
ffffffffc0204020:	00004697          	auipc	a3,0x4
ffffffffc0204024:	bd868693          	addi	a3,a3,-1064 # ffffffffc0207bf8 <default_pmm_manager+0x900>
ffffffffc0204028:	00003617          	auipc	a2,0x3
ffffffffc020402c:	c3860613          	addi	a2,a2,-968 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204030:	05700593          	li	a1,87
ffffffffc0204034:	00004517          	auipc	a0,0x4
ffffffffc0204038:	d9c50513          	addi	a0,a0,-612 # ffffffffc0207dd0 <default_pmm_manager+0xad8>
ffffffffc020403c:	c3efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==4);
ffffffffc0204040:	00004697          	auipc	a3,0x4
ffffffffc0204044:	bb868693          	addi	a3,a3,-1096 # ffffffffc0207bf8 <default_pmm_manager+0x900>
ffffffffc0204048:	00003617          	auipc	a2,0x3
ffffffffc020404c:	c1860613          	addi	a2,a2,-1000 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204050:	05400593          	li	a1,84
ffffffffc0204054:	00004517          	auipc	a0,0x4
ffffffffc0204058:	d7c50513          	addi	a0,a0,-644 # ffffffffc0207dd0 <default_pmm_manager+0xad8>
...
ffffffffc0204086:	e9e68693          	addi	a3,a3,-354 # ffffffffc0207f20 <default_pmm_manager+0xc28>
ffffffffc020408a:	00003617          	auipc	a2,0x3
ffffffffc020408e:	bd660613          	addi	a2,a2,-1066 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204092:	04100593          	li	a1,65
ffffffffc0204096:	00004517          	auipc	a0,0x4
ffffffffc020409a:	d3a50513          	addi	a0,a0,-710 # ffffffffc0207dd0 <default_pmm_manager+0xad8>
ffffffffc020409e:	bdcfc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(in_tick==0);
ffffffffc02040a2:	00004697          	auipc	a3,0x4
ffffffffc02040a6:	e8e68693          	addi	a3,a3,-370 # ffffffffc0207f30 <default_pmm_manager+0xc38>
ffffffffc02040aa:	00003617          	auipc	a2,0x3
ffffffffc02040ae:	bb660613          	addi	a2,a2,-1098 # ffffffffc0206c60 <commands+0x450>
ffffffffc02040b2:	04200593          	li	a1,66
ffffffffc02040b6:	00004517          	auipc	a0,0x4
ffffffffc02040ba:	d1a50513          	addi	a0,a0,-742 # ffffffffc0207dd0 <default_pmm_manager+0xad8>
...
ffffffffc02040de:	e6668693          	addi	a3,a3,-410 # ffffffffc0207f40 <default_pmm_manager+0xc48>
ffffffffc02040e2:	00003617          	auipc	a2,0x3
ffffffffc02040e6:	b7e60613          	addi	a2,a2,-1154 # ffffffffc0206c60 <commands+0x450>
ffffffffc02040ea:	03200593          	li	a1,50
ffffffffc02040ee:	00004517          	auipc	a0,0x4
ffffffffc02040f2:	ce250513          	addi	a0,a0,-798 # ffffffffc0207dd0 <default_pmm_manager+0xad8>
{
...
ffffffffc0204102:	e7a68693          	addi	a3,a3,-390 # ffffffffc0207f78 <default_pmm_manager+0xc80>
ffffffffc0204106:	00003617          	auipc	a2,0x3
ffffffffc020410a:	b5a60613          	addi	a2,a2,-1190 # ffffffffc0206c60 <commands+0x450>
ffffffffc020410e:	06d00593          	li	a1,109
ffffffffc0204112:	00004517          	auipc	a0,0x4
ffffffffc0204116:	e8650513          	addi	a0,a0,-378 # ffffffffc0207f98 <default_pmm_manager+0xca0>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc020424a:	d6268693          	addi	a3,a3,-670 # ffffffffc0207fa8 <default_pmm_manager+0xcb0>
ffffffffc020424e:	00003617          	auipc	a2,0x3
ffffffffc0204252:	a1260613          	addi	a2,a2,-1518 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204256:	07400593          	li	a1,116
ffffffffc020425a:	00004517          	auipc	a0,0x4
ffffffffc020425e:	d3e50513          	addi	a0,a0,-706 # ffffffffc0207f98 <default_pmm_manager+0xca0>
ffffffffc0204262:	a18fc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0204266:	00004697          	auipc	a3,0x4
ffffffffc020426a:	d8268693          	addi	a3,a3,-638 # ffffffffc0207fe8 <default_pmm_manager+0xcf0>
ffffffffc020426e:	00003617          	auipc	a2,0x3
ffffffffc0204272:	9f260613          	addi	a2,a2,-1550 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204276:	06c00593          	li	a1,108
ffffffffc020427a:	00004517          	auipc	a0,0x4
ffffffffc020427e:	d1e50513          	addi	a0,a0,-738 # ffffffffc0207f98 <default_pmm_manager+0xca0>
ffffffffc0204282:	9f8fc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0204286:	00004697          	auipc	a3,0x4
ffffffffc020428a:	d4268693          	addi	a3,a3,-702 # ffffffffc0207fc8 <default_pmm_manager+0xcd0>
ffffffffc020428e:	00003617          	auipc	a2,0x3
ffffffffc0204292:	9d260613          	addi	a2,a2,-1582 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204296:	06b00593          	li	a1,107
ffffffffc020429a:	00004517          	auipc	a0,0x4
ffffffffc020429e:	cfe50513          	addi	a0,a0,-770 # ffffffffc0207f98 <default_pmm_manager+0xca0>
...
ffffffffc02042dc:	d3068693          	addi	a3,a3,-720 # ffffffffc0208008 <default_pmm_manager+0xd10>
ffffffffc02042e0:	00003617          	auipc	a2,0x3
ffffffffc02042e4:	98060613          	addi	a2,a2,-1664 # ffffffffc0206c60 <commands+0x450>
ffffffffc02042e8:	09400593          	li	a1,148
ffffffffc02042ec:	00004517          	auipc	a0,0x4
ffffffffc02042f0:	cac50513          	addi	a0,a0,-852 # ffffffffc0207f98 <default_pmm_manager+0xca0>
...
ffffffffc020438c:	6f868693          	addi	a3,a3,1784 # ffffffffc0207a80 <default_pmm_manager+0x788>
ffffffffc0204390:	00003617          	auipc	a2,0x3
ffffffffc0204394:	8d060613          	addi	a2,a2,-1840 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204398:	0a700593          	li	a1,167
ffffffffc020439c:	00004517          	auipc	a0,0x4
ffffffffc02043a0:	bfc50513          	addi	a0,a0,-1028 # ffffffffc0207f98 <default_pmm_manager+0xca0>
...
ffffffffc0204426:	bfe68693          	addi	a3,a3,-1026 # ffffffffc0208020 <default_pmm_manager+0xd28>
ffffffffc020442a:	00003617          	auipc	a2,0x3
ffffffffc020442e:	83660613          	addi	a2,a2,-1994 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204432:	0c000593          	li	a1,192
ffffffffc0204436:	00004517          	auipc	a0,0x4
ffffffffc020443a:	b6250513          	addi	a0,a0,-1182 # ffffffffc0207f98 <default_pmm_manager+0xca0>
...
ffffffffc020449c:	ba868693          	addi	a3,a3,-1112 # ffffffffc0208040 <default_pmm_manager+0xd48>
ffffffffc02044a0:	00002617          	auipc	a2,0x2
ffffffffc02044a4:	7c060613          	addi	a2,a2,1984 # ffffffffc0206c60 <commands+0x450>
ffffffffc02044a8:	0d600593          	li	a1,214
ffffffffc02044ac:	00004517          	auipc	a0,0x4
ffffffffc02044b0:	aec50513          	addi	a0,a0,-1300 # ffffffffc0207f98 <default_pmm_manager+0xca0>
...
ffffffffc02044fc:	5c068693          	addi	a3,a3,1472 # ffffffffc0207ab8 <default_pmm_manager+0x7c0>
ffffffffc0204500:	00002617          	auipc	a2,0x2
ffffffffc0204504:	76060613          	addi	a2,a2,1888 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204508:	11300593          	li	a1,275
ffffffffc020450c:	00004517          	auipc	a0,0x4
ffffffffc0204510:	a8c50513          	addi	a0,a0,-1396 # ffffffffc0207f98 <default_pmm_manager+0xca0>
...
ffffffffc020454a:	57268693          	addi	a3,a3,1394 # ffffffffc0207ab8 <default_pmm_manager+0x7c0>
ffffffffc020454e:	00002617          	auipc	a2,0x2
ffffffffc0204552:	71260613          	addi	a2,a2,1810 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204556:	11900593          	li	a1,281
ffffffffc020455a:	00004517          	auipc	a0,0x4
ffffffffc020455e:	a3e50513          	addi	a0,a0,-1474 # ffffffffc0207f98 <default_pmm_manager+0xca0>
...
ffffffffc020461e:	b4650513          	addi	a0,a0,-1210 # ffffffffc0208160 <default_pmm_manager+0xe68>
ffffffffc0204622:	b5ffb0ef          	jal	ra,ffffffffc0200180 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0204626:	00004697          	auipc	a3,0x4
ffffffffc020462a:	b6268693          	addi	a3,a3,-1182 # ffffffffc0208188 <default_pmm_manager+0xe90>
ffffffffc020462e:	00002617          	auipc	a2,0x2
ffffffffc0204632:	63260613          	addi	a2,a2,1586 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204636:	13b00593          	li	a1,315
ffffffffc020463a:	00004517          	auipc	a0,0x4
ffffffffc020463e:	95e50513          	addi	a0,a0,-1698 # ffffffffc0207f98 <default_pmm_manager+0xca0>
...
ffffffffc0204656:	b4e50513          	addi	a0,a0,-1202 # ffffffffc02081a0 <default_pmm_manager+0xea8>
...
ffffffffc0204706:	55ea3a03          	ld	s4,1374(s4) # ffffffffc0208c60 <nbase>
...
ffffffffc02047a4:	a9050513          	addi	a0,a0,-1392 # ffffffffc0208230 <default_pmm_manager+0xf38>
...
ffffffffc02047be:	a9650513          	addi	a0,a0,-1386 # ffffffffc0208250 <default_pmm_manager+0xf58>
}
...
ffffffffc02047cc:	8b068693          	addi	a3,a3,-1872 # ffffffffc0208078 <default_pmm_manager+0xd80>
ffffffffc02047d0:	00002617          	auipc	a2,0x2
ffffffffc02047d4:	49060613          	addi	a2,a2,1168 # ffffffffc0206c60 <commands+0x450>
ffffffffc02047d8:	12200593          	li	a1,290
ffffffffc02047dc:	00003517          	auipc	a0,0x3
ffffffffc02047e0:	7bc50513          	addi	a0,a0,1980 # ffffffffc0207f98 <default_pmm_manager+0xca0>
ffffffffc02047e4:	c97fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02047e8:	00004697          	auipc	a3,0x4
ffffffffc02047ec:	91868693          	addi	a3,a3,-1768 # ffffffffc0208100 <default_pmm_manager+0xe08>
ffffffffc02047f0:	00002617          	auipc	a2,0x2
ffffffffc02047f4:	47060613          	addi	a2,a2,1136 # ffffffffc0206c60 <commands+0x450>
ffffffffc02047f8:	13200593          	li	a1,306
ffffffffc02047fc:	00003517          	auipc	a0,0x3
ffffffffc0204800:	79c50513          	addi	a0,a0,1948 # ffffffffc0207f98 <default_pmm_manager+0xca0>
ffffffffc0204804:	c77fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0204808:	00004697          	auipc	a3,0x4
ffffffffc020480c:	92868693          	addi	a3,a3,-1752 # ffffffffc0208130 <default_pmm_manager+0xe38>
ffffffffc0204810:	00002617          	auipc	a2,0x2
ffffffffc0204814:	45060613          	addi	a2,a2,1104 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204818:	13300593          	li	a1,307
ffffffffc020481c:	00003517          	auipc	a0,0x3
ffffffffc0204820:	77c50513          	addi	a0,a0,1916 # ffffffffc0207f98 <default_pmm_manager+0xca0>
ffffffffc0204824:	c57fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(vma != NULL);
ffffffffc0204828:	00003697          	auipc	a3,0x3
ffffffffc020482c:	29068693          	addi	a3,a3,656 # ffffffffc0207ab8 <default_pmm_manager+0x7c0>
ffffffffc0204830:	00002617          	auipc	a2,0x2
ffffffffc0204834:	43060613          	addi	a2,a2,1072 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204838:	15200593          	li	a1,338
ffffffffc020483c:	00003517          	auipc	a0,0x3
ffffffffc0204840:	75c50513          	addi	a0,a0,1884 # ffffffffc0207f98 <default_pmm_manager+0xca0>
ffffffffc0204844:	c37fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0204848:	00004697          	auipc	a3,0x4
ffffffffc020484c:	81868693          	addi	a3,a3,-2024 # ffffffffc0208060 <default_pmm_manager+0xd68>
ffffffffc0204850:	00002617          	auipc	a2,0x2
ffffffffc0204854:	41060613          	addi	a2,a2,1040 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204858:	12000593          	li	a1,288
ffffffffc020485c:	00003517          	auipc	a0,0x3
ffffffffc0204860:	73c50513          	addi	a0,a0,1852 # ffffffffc0207f98 <default_pmm_manager+0xca0>
ffffffffc0204864:	c17fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma3 == NULL);
ffffffffc0204868:	00004697          	auipc	a3,0x4
ffffffffc020486c:	86868693          	addi	a3,a3,-1944 # ffffffffc02080d0 <default_pmm_manager+0xdd8>
ffffffffc0204870:	00002617          	auipc	a2,0x2
ffffffffc0204874:	3f060613          	addi	a2,a2,1008 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204878:	12c00593          	li	a1,300
ffffffffc020487c:	00003517          	auipc	a0,0x3
ffffffffc0204880:	71c50513          	addi	a0,a0,1820 # ffffffffc0207f98 <default_pmm_manager+0xca0>
ffffffffc0204884:	bf7fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma2 != NULL);
ffffffffc0204888:	00004697          	auipc	a3,0x4
ffffffffc020488c:	83868693          	addi	a3,a3,-1992 # ffffffffc02080c0 <default_pmm_manager+0xdc8>
ffffffffc0204890:	00002617          	auipc	a2,0x2
ffffffffc0204894:	3d060613          	addi	a2,a2,976 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204898:	12a00593          	li	a1,298
ffffffffc020489c:	00003517          	auipc	a0,0x3
ffffffffc02048a0:	6fc50513          	addi	a0,a0,1788 # ffffffffc0207f98 <default_pmm_manager+0xca0>
ffffffffc02048a4:	bd7fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma1 != NULL);
ffffffffc02048a8:	00004697          	auipc	a3,0x4
ffffffffc02048ac:	80868693          	addi	a3,a3,-2040 # ffffffffc02080b0 <default_pmm_manager+0xdb8>
ffffffffc02048b0:	00002617          	auipc	a2,0x2
ffffffffc02048b4:	3b060613          	addi	a2,a2,944 # ffffffffc0206c60 <commands+0x450>
ffffffffc02048b8:	12800593          	li	a1,296
ffffffffc02048bc:	00003517          	auipc	a0,0x3
ffffffffc02048c0:	6dc50513          	addi	a0,a0,1756 # ffffffffc0207f98 <default_pmm_manager+0xca0>
ffffffffc02048c4:	bb7fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma5 == NULL);
ffffffffc02048c8:	00004697          	auipc	a3,0x4
ffffffffc02048cc:	82868693          	addi	a3,a3,-2008 # ffffffffc02080f0 <default_pmm_manager+0xdf8>
ffffffffc02048d0:	00002617          	auipc	a2,0x2
ffffffffc02048d4:	39060613          	addi	a2,a2,912 # ffffffffc0206c60 <commands+0x450>
ffffffffc02048d8:	13000593          	li	a1,304
ffffffffc02048dc:	00003517          	auipc	a0,0x3
ffffffffc02048e0:	6bc50513          	addi	a0,a0,1724 # ffffffffc0207f98 <default_pmm_manager+0xca0>
ffffffffc02048e4:	b97fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma4 == NULL);
ffffffffc02048e8:	00003697          	auipc	a3,0x3
ffffffffc02048ec:	7f868693          	addi	a3,a3,2040 # ffffffffc02080e0 <default_pmm_manager+0xde8>
ffffffffc02048f0:	00002617          	auipc	a2,0x2
ffffffffc02048f4:	37060613          	addi	a2,a2,880 # ffffffffc0206c60 <commands+0x450>
ffffffffc02048f8:	12e00593          	li	a1,302
ffffffffc02048fc:	00003517          	auipc	a0,0x3
ffffffffc0204900:	69c50513          	addi	a0,a0,1692 # ffffffffc0207f98 <default_pmm_manager+0xca0>
ffffffffc0204904:	b77fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0204908:	00004697          	auipc	a3,0x4
ffffffffc020490c:	8b868693          	addi	a3,a3,-1864 # ffffffffc02081c0 <default_pmm_manager+0xec8>
ffffffffc0204910:	00002617          	auipc	a2,0x2
ffffffffc0204914:	35060613          	addi	a2,a2,848 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204918:	14b00593          	li	a1,331
ffffffffc020491c:	00003517          	auipc	a0,0x3
ffffffffc0204920:	67c50513          	addi	a0,a0,1660 # ffffffffc0207f98 <default_pmm_manager+0xca0>
ffffffffc0204924:	b57fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(mm != NULL);
ffffffffc0204928:	00003697          	auipc	a3,0x3
ffffffffc020492c:	15868693          	addi	a3,a3,344 # ffffffffc0207a80 <default_pmm_manager+0x788>
ffffffffc0204930:	00002617          	auipc	a2,0x2
ffffffffc0204934:	33060613          	addi	a2,a2,816 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204938:	10c00593          	li	a1,268
ffffffffc020493c:	00003517          	auipc	a0,0x3
ffffffffc0204940:	65c50513          	addi	a0,a0,1628 # ffffffffc0207f98 <default_pmm_manager+0xca0>
ffffffffc0204944:	b37fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0204948:	00004697          	auipc	a3,0x4
ffffffffc020494c:	8c068693          	addi	a3,a3,-1856 # ffffffffc0208208 <default_pmm_manager+0xf10>
ffffffffc0204950:	00002617          	auipc	a2,0x2
ffffffffc0204954:	31060613          	addi	a2,a2,784 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204958:	17000593          	li	a1,368
ffffffffc020495c:	00003517          	auipc	a0,0x3
ffffffffc0204960:	63c50513          	addi	a0,a0,1596 # ffffffffc0207f98 <default_pmm_manager+0xca0>
ffffffffc0204964:	b17fb0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc0204968:	00003617          	auipc	a2,0x3
ffffffffc020496c:	9c860613          	addi	a2,a2,-1592 # ffffffffc0207330 <default_pmm_manager+0x38>
ffffffffc0204970:	06900593          	li	a1,105
ffffffffc0204974:	00003517          	auipc	a0,0x3
ffffffffc0204978:	9e450513          	addi	a0,a0,-1564 # ffffffffc0207358 <default_pmm_manager+0x60>
ffffffffc020497c:	afffb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir[0] == 0);
ffffffffc0204980:	00003697          	auipc	a3,0x3
ffffffffc0204984:	12868693          	addi	a3,a3,296 # ffffffffc0207aa8 <default_pmm_manager+0x7b0>
ffffffffc0204988:	00002617          	auipc	a2,0x2
ffffffffc020498c:	2d860613          	addi	a2,a2,728 # ffffffffc0206c60 <commands+0x450>
ffffffffc0204990:	14f00593          	li	a1,335
ffffffffc0204994:	00003517          	auipc	a0,0x3
ffffffffc0204998:	60450513          	addi	a0,a0,1540 # ffffffffc0207f98 <default_pmm_manager+0xca0>
ffffffffc020499c:	adffb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc02049a0:	00004697          	auipc	a3,0x4
ffffffffc02049a4:	83868693          	addi	a3,a3,-1992 # ffffffffc02081d8 <default_pmm_manager+0xee0>
ffffffffc02049a8:	00002617          	auipc	a2,0x2
ffffffffc02049ac:	2b860613          	addi	a2,a2,696 # ffffffffc0206c60 <commands+0x450>
ffffffffc02049b0:	15700593          	li	a1,343
ffffffffc02049b4:	00003517          	auipc	a0,0x3
ffffffffc02049b8:	5e450513          	addi	a0,a0,1508 # ffffffffc0207f98 <default_pmm_manager+0xca0>
ffffffffc02049bc:	abffb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02049c0:	00003617          	auipc	a2,0x3
ffffffffc02049c4:	a4060613          	addi	a2,a2,-1472 # ffffffffc0207400 <default_pmm_manager+0x108>
ffffffffc02049c8:	06200593          	li	a1,98
ffffffffc02049cc:	00003517          	auipc	a0,0x3
ffffffffc02049d0:	98c50513          	addi	a0,a0,-1652 # ffffffffc0207358 <default_pmm_manager+0x60>
ffffffffc02049d4:	aa7fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(sum == 0);
ffffffffc02049d8:	00004697          	auipc	a3,0x4
ffffffffc02049dc:	82068693          	addi	a3,a3,-2016 # ffffffffc02081f8 <default_pmm_manager+0xf00>
ffffffffc02049e0:	00002617          	auipc	a2,0x2
ffffffffc02049e4:	28060613          	addi	a2,a2,640 # ffffffffc0206c60 <commands+0x450>
ffffffffc02049e8:	16300593          	li	a1,355
ffffffffc02049ec:	00003517          	auipc	a0,0x3
ffffffffc02049f0:	5ac50513          	addi	a0,a0,1452 # ffffffffc0207f98 <default_pmm_manager+0xca0>
...
ffffffffc0204a9a:	82250513          	addi	a0,a0,-2014 # ffffffffc02082b8 <default_pmm_manager+0xfc0>
...
ffffffffc0204aac:	7c050513          	addi	a0,a0,1984 # ffffffffc0208268 <default_pmm_manager+0xf70>
...
ffffffffc0204abc:	82850513          	addi	a0,a0,-2008 # ffffffffc02082e0 <default_pmm_manager+0xfe8>
...
ffffffffc0204acc:	7d050513          	addi	a0,a0,2000 # ffffffffc0208298 <default_pmm_manager+0xfa0>
...
ffffffffc0204b86:	d6a7b723          	sd	a0,-658(a5) # ffffffffc02b28f0 <max_swap_offset>
}
ffffffffc0204b8a:	0141                	addi	sp,sp,16
ffffffffc0204b8c:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0204b8e:	00003617          	auipc	a2,0x3
ffffffffc0204b92:	77a60613          	addi	a2,a2,1914 # ffffffffc0208308 <default_pmm_manager+0x1010>
ffffffffc0204b96:	45b5                	li	a1,13
ffffffffc0204b98:	00003517          	auipc	a0,0x3
ffffffffc0204b9c:	79050513          	addi	a0,a0,1936 # ffffffffc0208328 <default_pmm_manager+0x1030>
...
ffffffffc0204bdc:	cf86b683          	ld	a3,-776(a3) # ffffffffc02b28d0 <npage>
...
ffffffffc0204bf0:	cfc7b783          	ld	a5,-772(a5) # ffffffffc02b28e8 <va_pa_offset>
...
ffffffffc0204c06:	73e60613          	addi	a2,a2,1854 # ffffffffc0208340 <default_pmm_manager+0x1048>
ffffffffc0204c0a:	45d1                	li	a1,20
ffffffffc0204c0c:	00003517          	auipc	a0,0x3
ffffffffc0204c10:	71c50513          	addi	a0,a0,1820 # ffffffffc0208328 <default_pmm_manager+0x1030>
...
ffffffffc0204c22:	71260613          	addi	a2,a2,1810 # ffffffffc0207330 <default_pmm_manager+0x38>
ffffffffc0204c26:	00002517          	auipc	a0,0x2
ffffffffc0204c2a:	73250513          	addi	a0,a0,1842 # ffffffffc0207358 <default_pmm_manager+0x60>
...
ffffffffc0204c6a:	c6a6b683          	ld	a3,-918(a3) # ffffffffc02b28d0 <npage>
...
ffffffffc0204c7e:	c6e7b783          	ld	a5,-914(a5) # ffffffffc02b28e8 <va_pa_offset>
...
ffffffffc0204c94:	6b060613          	addi	a2,a2,1712 # ffffffffc0208340 <default_pmm_manager+0x1048>
ffffffffc0204c98:	45e5                	li	a1,25
ffffffffc0204c9a:	00003517          	auipc	a0,0x3
ffffffffc0204c9e:	68e50513          	addi	a0,a0,1678 # ffffffffc0208328 <default_pmm_manager+0x1030>
...
ffffffffc0204cb0:	68460613          	addi	a2,a2,1668 # ffffffffc0207330 <default_pmm_manager+0x38>
ffffffffc0204cb4:	00002517          	auipc	a0,0x2
ffffffffc0204cb8:	6a450513          	addi	a0,a0,1700 # ffffffffc0207358 <default_pmm_manager+0x60>
...
ffffffffc0204cc2:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204cc4:	612000ef          	jal	ra,ffffffffc02052d6 <do_exit>
...
ffffffffc0204cfe:	07f010ef          	jal	ra,ffffffffc020657c <memset>
         proc->tf = NULL;
         proc->cr3 = boot_cr3;
ffffffffc0204d02:	000ae797          	auipc	a5,0xae
ffffffffc0204d06:	bbe7b783          	ld	a5,-1090(a5) # ffffffffc02b28c0 <boot_cr3>
         proc->tf = NULL;
...
ffffffffc0204d1c:	061010ef          	jal	ra,ffffffffc020657c <memset>
         
         proc->state = 0;
ffffffffc0204d20:	00042023          	sw	zero,0(s0)
         proc->cptr = NULL;
...
ffffffffc0204d3e:	bde7b783          	ld	a5,-1058(a5) # ffffffffc02b2918 <current>
...
ffffffffc0204d4c:	bd07b783          	ld	a5,-1072(a5) # ffffffffc02b2918 <current>
ffffffffc0204d50:	43cc                	lw	a1,4(a5)
user_main(void *arg) {
ffffffffc0204d52:	7139                	addi	sp,sp,-64
    KERNEL_EXECVE2(TEST, TESTSTART, TESTSIZE);
ffffffffc0204d54:	00003617          	auipc	a2,0x3
ffffffffc0204d58:	60c60613          	addi	a2,a2,1548 # ffffffffc0208360 <default_pmm_manager+0x1068>
ffffffffc0204d5c:	00003517          	auipc	a0,0x3
ffffffffc0204d60:	61450513          	addi	a0,a0,1556 # ffffffffc0208370 <default_pmm_manager+0x1078>
user_main(void *arg) {
...
ffffffffc0204d6e:	c0e78793          	addi	a5,a5,-1010 # a978 <_binary_obj___user_forktest_out_size>
ffffffffc0204d72:	e43e                	sd	a5,8(sp)
ffffffffc0204d74:	00003517          	auipc	a0,0x3
ffffffffc0204d78:	5ec50513          	addi	a0,a0,1516 # ffffffffc0208360 <default_pmm_manager+0x1068>
ffffffffc0204d7c:	00046797          	auipc	a5,0x46
ffffffffc0204d80:	9d478793          	addi	a5,a5,-1580 # ffffffffc024a750 <_binary_obj___user_forktest_out_start>
ffffffffc0204d84:	f03e                	sd	a5,32(sp)
ffffffffc0204d86:	f42a                	sd	a0,40(sp)
    int64_t ret=0, len = strlen(name);
ffffffffc0204d88:	e802                	sd	zero,16(sp)
ffffffffc0204d8a:	776010ef          	jal	ra,ffffffffc0206500 <strlen>
...
ffffffffc0204da6:	5f650513          	addi	a0,a0,1526 # ffffffffc0208398 <default_pmm_manager+0x10a0>
...
ffffffffc0204db2:	5fa60613          	addi	a2,a2,1530 # ffffffffc02083a8 <default_pmm_manager+0x10b0>
ffffffffc0204db6:	34f00593          	li	a1,847
ffffffffc0204dba:	00003517          	auipc	a0,0x3
ffffffffc0204dbe:	60e50513          	addi	a0,a0,1550 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
...
ffffffffc0204dfe:	ade53503          	ld	a0,-1314(a0) # ffffffffc02b28d8 <pages>
...
ffffffffc0204e10:	5cc60613          	addi	a2,a2,1484 # ffffffffc02073d8 <default_pmm_manager+0xe0>
ffffffffc0204e14:	06e00593          	li	a1,110
ffffffffc0204e18:	00002517          	auipc	a0,0x2
ffffffffc0204e1c:	54050513          	addi	a0,a0,1344 # ffffffffc0207358 <default_pmm_manager+0x60>
ffffffffc0204e20:	e5afb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204e24:	00002617          	auipc	a2,0x2
ffffffffc0204e28:	5dc60613          	addi	a2,a2,1500 # ffffffffc0207400 <default_pmm_manager+0x108>
ffffffffc0204e2c:	06200593          	li	a1,98
ffffffffc0204e30:	00002517          	auipc	a0,0x2
ffffffffc0204e34:	52850513          	addi	a0,a0,1320 # ffffffffc0207358 <default_pmm_manager+0x60>
...
ffffffffc0204e44:	ad890913          	addi	s2,s2,-1320 # ffffffffc02b2918 <current>
proc_run(struct proc_struct *proc) {
...
ffffffffc0204e7a:	02c010ef          	jal	ra,ffffffffc0205ea6 <switch_to>
    if (flag) {
...
ffffffffc0204eb0:	a8490913          	addi	s2,s2,-1404 # ffffffffc02b2930 <nr_process>
...
ffffffffc0204ed2:	32f75863          	bge	a4,a5,ffffffffc0205202 <do_fork+0x35a>
...
ffffffffc0204ee2:	30050163          	beqz	a0,ffffffffc02051e4 <do_fork+0x33c>
    current->wait_state = 0;
ffffffffc0204ee6:	000aec17          	auipc	s8,0xae
ffffffffc0204eea:	a32c0c13          	addi	s8,s8,-1486 # ffffffffc02b2918 <current>
ffffffffc0204eee:	000c3783          	ld	a5,0(s8)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0204ef2:	4509                	li	a0,2
    current->wait_state = 0;
ffffffffc0204ef4:	0e07a623          	sw	zero,236(a5) # 10ec <_binary_obj___user_faultread_out_size-0x8acc>
    proc->parent = current;
ffffffffc0204ef8:	f09c                	sd	a5,32(s1)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0204efa:	de7fc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
    if (page != NULL) {
ffffffffc0204efe:	2e050063          	beqz	a0,ffffffffc02051de <do_fork+0x336>
    return page - pages + nbase;
ffffffffc0204f02:	000aea97          	auipc	s5,0xae
ffffffffc0204f06:	9d6a8a93          	addi	s5,s5,-1578 # ffffffffc02b28d8 <pages>
ffffffffc0204f0a:	000ab683          	ld	a3,0(s5)
ffffffffc0204f0e:	00004b17          	auipc	s6,0x4
ffffffffc0204f12:	d52b0b13          	addi	s6,s6,-686 # ffffffffc0208c60 <nbase>
ffffffffc0204f16:	000b3783          	ld	a5,0(s6)
ffffffffc0204f1a:	40d506b3          	sub	a3,a0,a3
    return KADDR(page2pa(page));
ffffffffc0204f1e:	000aeb97          	auipc	s7,0xae
ffffffffc0204f22:	9b2b8b93          	addi	s7,s7,-1614 # ffffffffc02b28d0 <npage>
    return page - pages + nbase;
ffffffffc0204f26:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0204f28:	5dfd                	li	s11,-1
ffffffffc0204f2a:	000bb703          	ld	a4,0(s7)
    return page - pages + nbase;
ffffffffc0204f2e:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0204f30:	00cddd93          	srli	s11,s11,0xc
ffffffffc0204f34:	01b6f633          	and	a2,a3,s11
    return page2ppn(page) << PGSHIFT;
ffffffffc0204f38:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204f3a:	32e67a63          	bgeu	a2,a4,ffffffffc020526e <do_fork+0x3c6>
    struct mm_struct *mm, *oldmm = current->mm;
ffffffffc0204f3e:	000c3603          	ld	a2,0(s8)
ffffffffc0204f42:	000aec17          	auipc	s8,0xae
ffffffffc0204f46:	9a6c0c13          	addi	s8,s8,-1626 # ffffffffc02b28e8 <va_pa_offset>
ffffffffc0204f4a:	000c3703          	ld	a4,0(s8)
ffffffffc0204f4e:	02863d03          	ld	s10,40(a2)
ffffffffc0204f52:	e43e                	sd	a5,8(sp)
ffffffffc0204f54:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc0204f56:	e894                	sd	a3,16(s1)
    if (oldmm == NULL) {
ffffffffc0204f58:	020d0863          	beqz	s10,ffffffffc0204f88 <do_fork+0xe0>
    if (clone_flags & CLONE_VM) {
ffffffffc0204f5c:	100a7a13          	andi	s4,s4,256
ffffffffc0204f60:	1c0a0163          	beqz	s4,ffffffffc0205122 <do_fork+0x27a>
}

static inline int
mm_count_inc(struct mm_struct *mm) {
    mm->mm_count += 1;
ffffffffc0204f64:	030d2703          	lw	a4,48(s10)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204f68:	018d3783          	ld	a5,24(s10)
ffffffffc0204f6c:	c02006b7          	lui	a3,0xc0200
ffffffffc0204f70:	2705                	addiw	a4,a4,1
ffffffffc0204f72:	02ed2823          	sw	a4,48(s10)
    proc->mm = mm;
ffffffffc0204f76:	03a4b423          	sd	s10,40(s1)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204f7a:	2cd7e163          	bltu	a5,a3,ffffffffc020523c <do_fork+0x394>
...
ffffffffc0204f8a:	ee078793          	addi	a5,a5,-288 # 1ee0 <_binary_obj___user_faultread_out_size-0x7cd8>
...
ffffffffc0204fb6:	ff1612e3          	bne	a2,a7,ffffffffc0204f9a <do_fork+0xf2>
    proc->tf->gpr.a0 = 0;
ffffffffc0204fba:	0406b823          	sd	zero,80(a3) # ffffffffc0200050 <kern_init+0x1e>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204fbe:	12098f63          	beqz	s3,ffffffffc02050fc <do_fork+0x254>
ffffffffc0204fc2:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204fc6:	00000797          	auipc	a5,0x0
ffffffffc0204fca:	d7478793          	addi	a5,a5,-652 # ffffffffc0204d3a <forkret>
...
ffffffffc0204fd8:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204fda:	14079063          	bnez	a5,ffffffffc020511a <do_fork+0x272>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204fde:	000a2817          	auipc	a6,0xa2
ffffffffc0204fe2:	3f280813          	addi	a6,a6,1010 # ffffffffc02a73d0 <last_pid.1>
...
ffffffffc0204ff4:	08e55d63          	bge	a0,a4,ffffffffc020508e <do_fork+0x1e6>
    if (last_pid >= next_safe) {
ffffffffc0204ff8:	000a2317          	auipc	t1,0xa2
ffffffffc0204ffc:	3dc30313          	addi	t1,t1,988 # ffffffffc02a73d4 <next_safe.0>
ffffffffc0205000:	00032783          	lw	a5,0(t1)
ffffffffc0205004:	000ae417          	auipc	s0,0xae
ffffffffc0205008:	88c40413          	addi	s0,s0,-1908 # ffffffffc02b2890 <proc_list>
ffffffffc020500c:	08f55963          	bge	a0,a5,ffffffffc020509e <do_fork+0x1f6>
        proc->pid = get_pid();
ffffffffc0205010:	c0c8                	sw	a0,4(s1)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0205012:	45a9                	li	a1,10
ffffffffc0205014:	2501                	sext.w	a0,a0
ffffffffc0205016:	0e6010ef          	jal	ra,ffffffffc02060fc <hash32>
...
ffffffffc0205026:	86e78793          	addi	a5,a5,-1938 # ffffffffc02ae890 <hash_list>
...
ffffffffc0205054:	c311                	beqz	a4,ffffffffc0205058 <do_fork+0x1b0>
        proc->optr->yptr = proc;
...
ffffffffc0205060:	00f92023          	sw	a5,0(s2)
    if (flag) {
ffffffffc0205064:	18099263          	bnez	s3,ffffffffc02051e8 <do_fork+0x340>
    wakeup_proc(proc);
ffffffffc0205068:	8526                	mv	a0,s1
ffffffffc020506a:	6a7000ef          	jal	ra,ffffffffc0205f10 <wakeup_proc>
    ret = proc->pid;
ffffffffc020506e:	40c8                	lw	a0,4(s1)
}
ffffffffc0205070:	70e6                	ld	ra,120(sp)
ffffffffc0205072:	7446                	ld	s0,112(sp)
ffffffffc0205074:	74a6                	ld	s1,104(sp)
ffffffffc0205076:	7906                	ld	s2,96(sp)
ffffffffc0205078:	69e6                	ld	s3,88(sp)
ffffffffc020507a:	6a46                	ld	s4,80(sp)
ffffffffc020507c:	6aa6                	ld	s5,72(sp)
ffffffffc020507e:	6b06                	ld	s6,64(sp)
ffffffffc0205080:	7be2                	ld	s7,56(sp)
ffffffffc0205082:	7c42                	ld	s8,48(sp)
ffffffffc0205084:	7ca2                	ld	s9,40(sp)
ffffffffc0205086:	7d02                	ld	s10,32(sp)
ffffffffc0205088:	6de2                	ld	s11,24(sp)
ffffffffc020508a:	6109                	addi	sp,sp,128
...
ffffffffc020509a:	33e30313          	addi	t1,t1,830 # ffffffffc02a73d4 <next_safe.0>
    return listelm->next;
ffffffffc020509e:	000ad417          	auipc	s0,0xad
ffffffffc02050a2:	7f240413          	addi	s0,s0,2034 # ffffffffc02b2890 <proc_list>
...
ffffffffc02050b6:	148e0163          	beq	t3,s0,ffffffffc02051f8 <do_fork+0x350>
ffffffffc02050ba:	88ae                	mv	a7,a1
ffffffffc02050bc:	87f2                	mv	a5,t3
ffffffffc02050be:	6609                	lui	a2,0x2
ffffffffc02050c0:	a811                	j	ffffffffc02050d4 <do_fork+0x22c>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc02050c2:	00e6d663          	bge	a3,a4,ffffffffc02050ce <do_fork+0x226>
ffffffffc02050c6:	00c75463          	bge	a4,a2,ffffffffc02050ce <do_fork+0x226>
ffffffffc02050ca:	863a                	mv	a2,a4
ffffffffc02050cc:	4885                	li	a7,1
ffffffffc02050ce:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02050d0:	00878d63          	beq	a5,s0,ffffffffc02050ea <do_fork+0x242>
            if (proc->pid == last_pid) {
ffffffffc02050d4:	f3c7a703          	lw	a4,-196(a5) # 1f3c <_binary_obj___user_faultread_out_size-0x7c7c>
ffffffffc02050d8:	fed715e3          	bne	a4,a3,ffffffffc02050c2 <do_fork+0x21a>
                if (++ last_pid >= next_safe) {
ffffffffc02050dc:	2685                	addiw	a3,a3,1
ffffffffc02050de:	10c6d863          	bge	a3,a2,ffffffffc02051ee <do_fork+0x346>
ffffffffc02050e2:	679c                	ld	a5,8(a5)
ffffffffc02050e4:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc02050e6:	fe8797e3          	bne	a5,s0,ffffffffc02050d4 <do_fork+0x22c>
ffffffffc02050ea:	c581                	beqz	a1,ffffffffc02050f2 <do_fork+0x24a>
ffffffffc02050ec:	00d82023          	sw	a3,0(a6)
ffffffffc02050f0:	8536                	mv	a0,a3
ffffffffc02050f2:	f0088fe3          	beqz	a7,ffffffffc0205010 <do_fork+0x168>
ffffffffc02050f6:	00c32023          	sw	a2,0(t1)
ffffffffc02050fa:	bf19                	j	ffffffffc0205010 <do_fork+0x168>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc02050fc:	89b6                	mv	s3,a3
ffffffffc02050fe:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0205102:	00000797          	auipc	a5,0x0
ffffffffc0205106:	c3878793          	addi	a5,a5,-968 # ffffffffc0204d3a <forkret>
...
ffffffffc0205114:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205116:	ec0784e3          	beqz	a5,ffffffffc0204fde <do_fork+0x136>
        intr_disable();
ffffffffc020511a:	d2cfb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc020511e:	4985                	li	s3,1
ffffffffc0205120:	bd7d                	j	ffffffffc0204fde <do_fork+0x136>
    if ((mm = mm_create()) == NULL) {
ffffffffc0205122:	ffffe0ef          	jal	ra,ffffffffc0204120 <mm_create>
ffffffffc0205126:	8caa                	mv	s9,a0
ffffffffc0205128:	c159                	beqz	a0,ffffffffc02051ae <do_fork+0x306>
    if ((page = alloc_page()) == NULL) {
ffffffffc020512a:	4505                	li	a0,1
ffffffffc020512c:	bb5fc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
ffffffffc0205130:	cd25                	beqz	a0,ffffffffc02051a8 <do_fork+0x300>
    return page - pages + nbase;
ffffffffc0205132:	000ab683          	ld	a3,0(s5)
ffffffffc0205136:	67a2                	ld	a5,8(sp)
    return KADDR(page2pa(page));
ffffffffc0205138:	000bb703          	ld	a4,0(s7)
    return page - pages + nbase;
ffffffffc020513c:	40d506b3          	sub	a3,a0,a3
ffffffffc0205140:	8699                	srai	a3,a3,0x6
ffffffffc0205142:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205144:	01b6fdb3          	and	s11,a3,s11
    return page2ppn(page) << PGSHIFT;
ffffffffc0205148:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc020514a:	12edf263          	bgeu	s11,a4,ffffffffc020526e <do_fork+0x3c6>
ffffffffc020514e:	000c3a03          	ld	s4,0(s8)
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc0205152:	6605                	lui	a2,0x1
ffffffffc0205154:	000ad597          	auipc	a1,0xad
ffffffffc0205158:	7745b583          	ld	a1,1908(a1) # ffffffffc02b28c8 <boot_pgdir>
ffffffffc020515c:	9a36                	add	s4,s4,a3
ffffffffc020515e:	8552                	mv	a0,s4
ffffffffc0205160:	42e010ef          	jal	ra,ffffffffc020658e <memcpy>
}
...
lock_mm(struct mm_struct *mm) {
    if (mm != NULL) {
        lock(&(mm->mm_lock));
ffffffffc0205164:	038d0d93          	addi	s11,s10,56
    mm->pgdir = pgdir;
ffffffffc0205168:	014cbc23          	sd	s4,24(s9)
...
ffffffffc020516e:	40fdb7af          	amoor.d	a5,a5,(s11)
...
ffffffffc0205176:	c799                	beqz	a5,ffffffffc0205184 <do_fork+0x2dc>
        schedule();
ffffffffc0205178:	619000ef          	jal	ra,ffffffffc0205f90 <schedule>
ffffffffc020517c:	414db7af          	amoor.d	a5,s4,(s11)
    while (!try_lock(lock)) {
ffffffffc0205180:	8b85                	andi	a5,a5,1
ffffffffc0205182:	fbfd                	bnez	a5,ffffffffc0205178 <do_fork+0x2d0>
        ret = dup_mmap(mm, oldmm);
ffffffffc0205184:	85ea                	mv	a1,s10
ffffffffc0205186:	8566                	mv	a0,s9
ffffffffc0205188:	a20ff0ef          	jal	ra,ffffffffc02043a8 <dup_mmap>
...
ffffffffc020518e:	60fdb7af          	amoand.d	a5,a5,(s11)
...
ffffffffc0205194:	cfa5                	beqz	a5,ffffffffc020520c <do_fork+0x364>
good_mm:
ffffffffc0205196:	8d66                	mv	s10,s9
    if (ret != 0) {
ffffffffc0205198:	dc0506e3          	beqz	a0,ffffffffc0204f64 <do_fork+0xbc>
    exit_mmap(mm);
ffffffffc020519c:	8566                	mv	a0,s9
ffffffffc020519e:	aa4ff0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
    put_pgdir(mm);
ffffffffc02051a2:	8566                	mv	a0,s9
ffffffffc02051a4:	c23ff0ef          	jal	ra,ffffffffc0204dc6 <put_pgdir>
    mm_destroy(mm);
ffffffffc02051a8:	8566                	mv	a0,s9
ffffffffc02051aa:	8fcff0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc02051ae:	6894                	ld	a3,16(s1)
    return pa2page(PADDR(kva));
ffffffffc02051b0:	c02007b7          	lui	a5,0xc0200
ffffffffc02051b4:	0af6e163          	bltu	a3,a5,ffffffffc0205256 <do_fork+0x3ae>
ffffffffc02051b8:	000c3783          	ld	a5,0(s8)
    if (PPN(pa) >= npage) {
ffffffffc02051bc:	000bb703          	ld	a4,0(s7)
    return pa2page(PADDR(kva));
ffffffffc02051c0:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc02051c4:	83b1                	srli	a5,a5,0xc
ffffffffc02051c6:	04e7ff63          	bgeu	a5,a4,ffffffffc0205224 <do_fork+0x37c>
    return &pages[PPN(pa) - nbase];
ffffffffc02051ca:	000b3703          	ld	a4,0(s6)
ffffffffc02051ce:	000ab503          	ld	a0,0(s5)
ffffffffc02051d2:	4589                	li	a1,2
ffffffffc02051d4:	8f99                	sub	a5,a5,a4
ffffffffc02051d6:	079a                	slli	a5,a5,0x6
ffffffffc02051d8:	953e                	add	a0,a0,a5
ffffffffc02051da:	b99fc0ef          	jal	ra,ffffffffc0201d72 <free_pages>
    kfree(proc);
ffffffffc02051de:	8526                	mv	a0,s1
ffffffffc02051e0:	9d3fc0ef          	jal	ra,ffffffffc0201bb2 <kfree>
    ret = -E_NO_MEM;
ffffffffc02051e4:	5571                	li	a0,-4
    return ret;
ffffffffc02051e6:	b569                	j	ffffffffc0205070 <do_fork+0x1c8>
        intr_enable();
ffffffffc02051e8:	c58fb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc02051ec:	bdb5                	j	ffffffffc0205068 <do_fork+0x1c0>
                    if (last_pid >= MAX_PID) {
ffffffffc02051ee:	01d6c363          	blt	a3,t4,ffffffffc02051f4 <do_fork+0x34c>
                        last_pid = 1;
ffffffffc02051f2:	4685                	li	a3,1
                    goto repeat;
ffffffffc02051f4:	4585                	li	a1,1
ffffffffc02051f6:	b5c1                	j	ffffffffc02050b6 <do_fork+0x20e>
ffffffffc02051f8:	c599                	beqz	a1,ffffffffc0205206 <do_fork+0x35e>
ffffffffc02051fa:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc02051fe:	8536                	mv	a0,a3
ffffffffc0205200:	bd01                	j	ffffffffc0205010 <do_fork+0x168>
    int ret = -E_NO_FREE_PROC;
ffffffffc0205202:	556d                	li	a0,-5
ffffffffc0205204:	b5b5                	j	ffffffffc0205070 <do_fork+0x1c8>
    return last_pid;
ffffffffc0205206:	00082503          	lw	a0,0(a6)
ffffffffc020520a:	b519                	j	ffffffffc0205010 <do_fork+0x168>
        panic("Unlock failed.\n");
ffffffffc020520c:	00003617          	auipc	a2,0x3
ffffffffc0205210:	1d460613          	addi	a2,a2,468 # ffffffffc02083e0 <default_pmm_manager+0x10e8>
ffffffffc0205214:	03100593          	li	a1,49
ffffffffc0205218:	00003517          	auipc	a0,0x3
ffffffffc020521c:	1d850513          	addi	a0,a0,472 # ffffffffc02083f0 <default_pmm_manager+0x10f8>
ffffffffc0205220:	a5afb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0205224:	00002617          	auipc	a2,0x2
ffffffffc0205228:	1dc60613          	addi	a2,a2,476 # ffffffffc0207400 <default_pmm_manager+0x108>
ffffffffc020522c:	06200593          	li	a1,98
ffffffffc0205230:	00002517          	auipc	a0,0x2
ffffffffc0205234:	12850513          	addi	a0,a0,296 # ffffffffc0207358 <default_pmm_manager+0x60>
ffffffffc0205238:	a42fb0ef          	jal	ra,ffffffffc020047a <__panic>
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc020523c:	86be                	mv	a3,a5
ffffffffc020523e:	00002617          	auipc	a2,0x2
ffffffffc0205242:	19a60613          	addi	a2,a2,410 # ffffffffc02073d8 <default_pmm_manager+0xe0>
ffffffffc0205246:	16400593          	li	a1,356
ffffffffc020524a:	00003517          	auipc	a0,0x3
ffffffffc020524e:	17e50513          	addi	a0,a0,382 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc0205252:	a28fb0ef          	jal	ra,ffffffffc020047a <__panic>
    return pa2page(PADDR(kva));
ffffffffc0205256:	00002617          	auipc	a2,0x2
ffffffffc020525a:	18260613          	addi	a2,a2,386 # ffffffffc02073d8 <default_pmm_manager+0xe0>
ffffffffc020525e:	06e00593          	li	a1,110
ffffffffc0205262:	00002517          	auipc	a0,0x2
ffffffffc0205266:	0f650513          	addi	a0,a0,246 # ffffffffc0207358 <default_pmm_manager+0x60>
ffffffffc020526a:	a10fb0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc020526e:	00002617          	auipc	a2,0x2
ffffffffc0205272:	0c260613          	addi	a2,a2,194 # ffffffffc0207330 <default_pmm_manager+0x38>
ffffffffc0205276:	06900593          	li	a1,105
ffffffffc020527a:	00002517          	auipc	a0,0x2
ffffffffc020527e:	0de50513          	addi	a0,a0,222 # ffffffffc0207358 <default_pmm_manager+0x60>
ffffffffc0205282:	9f8fb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205286 <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc0205286:	7129                	addi	sp,sp,-320
ffffffffc0205288:	fa22                	sd	s0,304(sp)
ffffffffc020528a:	f626                	sd	s1,296(sp)
ffffffffc020528c:	f24a                	sd	s2,288(sp)
ffffffffc020528e:	84ae                	mv	s1,a1
ffffffffc0205290:	892a                	mv	s2,a0
ffffffffc0205292:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0205294:	4581                	li	a1,0
ffffffffc0205296:	12000613          	li	a2,288
ffffffffc020529a:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc020529c:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc020529e:	2de010ef          	jal	ra,ffffffffc020657c <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc02052a2:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc02052a4:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc02052a6:	100027f3          	csrr	a5,sstatus
ffffffffc02052aa:	edd7f793          	andi	a5,a5,-291
ffffffffc02052ae:	1207e793          	ori	a5,a5,288
ffffffffc02052b2:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02052b4:	860a                	mv	a2,sp
ffffffffc02052b6:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02052ba:	00000797          	auipc	a5,0x0
ffffffffc02052be:	a0678793          	addi	a5,a5,-1530 # ffffffffc0204cc0 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02052c2:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02052c4:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02052c6:	be3ff0ef          	jal	ra,ffffffffc0204ea8 <do_fork>
}
ffffffffc02052ca:	70f2                	ld	ra,312(sp)
ffffffffc02052cc:	7452                	ld	s0,304(sp)
ffffffffc02052ce:	74b2                	ld	s1,296(sp)
ffffffffc02052d0:	7912                	ld	s2,288(sp)
ffffffffc02052d2:	6131                	addi	sp,sp,320
ffffffffc02052d4:	8082                	ret

ffffffffc02052d6 <do_exit>:
do_exit(int error_code) {
ffffffffc02052d6:	7179                	addi	sp,sp,-48
ffffffffc02052d8:	f022                	sd	s0,32(sp)
    if (current == idleproc) {
ffffffffc02052da:	000ad417          	auipc	s0,0xad
ffffffffc02052de:	63e40413          	addi	s0,s0,1598 # ffffffffc02b2918 <current>
ffffffffc02052e2:	601c                	ld	a5,0(s0)
do_exit(int error_code) {
ffffffffc02052e4:	f406                	sd	ra,40(sp)
ffffffffc02052e6:	ec26                	sd	s1,24(sp)
ffffffffc02052e8:	e84a                	sd	s2,16(sp)
ffffffffc02052ea:	e44e                	sd	s3,8(sp)
ffffffffc02052ec:	e052                	sd	s4,0(sp)
    if (current == idleproc) {
ffffffffc02052ee:	000ad717          	auipc	a4,0xad
ffffffffc02052f2:	63273703          	ld	a4,1586(a4) # ffffffffc02b2920 <idleproc>
ffffffffc02052f6:	0ce78c63          	beq	a5,a4,ffffffffc02053ce <do_exit+0xf8>
    if (current == initproc) {
ffffffffc02052fa:	000ad497          	auipc	s1,0xad
ffffffffc02052fe:	62e48493          	addi	s1,s1,1582 # ffffffffc02b2928 <initproc>
ffffffffc0205302:	6098                	ld	a4,0(s1)
ffffffffc0205304:	0ee78b63          	beq	a5,a4,ffffffffc02053fa <do_exit+0x124>
    struct mm_struct *mm = current->mm;
ffffffffc0205308:	0287b983          	ld	s3,40(a5)
ffffffffc020530c:	892a                	mv	s2,a0
    if (mm != NULL) {
ffffffffc020530e:	02098663          	beqz	s3,ffffffffc020533a <do_exit+0x64>
ffffffffc0205312:	000ad797          	auipc	a5,0xad
ffffffffc0205316:	5ae7b783          	ld	a5,1454(a5) # ffffffffc02b28c0 <boot_cr3>
ffffffffc020531a:	577d                	li	a4,-1
ffffffffc020531c:	177e                	slli	a4,a4,0x3f
ffffffffc020531e:	83b1                	srli	a5,a5,0xc
ffffffffc0205320:	8fd9                	or	a5,a5,a4
ffffffffc0205322:	18079073          	csrw	satp,a5
    mm->mm_count -= 1;
ffffffffc0205326:	0309a783          	lw	a5,48(s3)
ffffffffc020532a:	fff7871b          	addiw	a4,a5,-1
ffffffffc020532e:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0) {
ffffffffc0205332:	cb55                	beqz	a4,ffffffffc02053e6 <do_exit+0x110>
        current->mm = NULL;
ffffffffc0205334:	601c                	ld	a5,0(s0)
ffffffffc0205336:	0207b423          	sd	zero,40(a5)
    current->state = PROC_ZOMBIE;
ffffffffc020533a:	601c                	ld	a5,0(s0)
ffffffffc020533c:	470d                	li	a4,3
ffffffffc020533e:	c398                	sw	a4,0(a5)
    current->exit_code = error_code;
ffffffffc0205340:	0f27a423          	sw	s2,232(a5)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205344:	100027f3          	csrr	a5,sstatus
ffffffffc0205348:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020534a:	4a01                	li	s4,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020534c:	e3f9                	bnez	a5,ffffffffc0205412 <do_exit+0x13c>
        proc = current->parent;
ffffffffc020534e:	6018                	ld	a4,0(s0)
        if (proc->wait_state == WT_CHILD) {
ffffffffc0205350:	800007b7          	lui	a5,0x80000
ffffffffc0205354:	0785                	addi	a5,a5,1
        proc = current->parent;
ffffffffc0205356:	7308                	ld	a0,32(a4)
        if (proc->wait_state == WT_CHILD) {
ffffffffc0205358:	0ec52703          	lw	a4,236(a0)
ffffffffc020535c:	0af70f63          	beq	a4,a5,ffffffffc020541a <do_exit+0x144>
        while (current->cptr != NULL) {
ffffffffc0205360:	6018                	ld	a4,0(s0)
ffffffffc0205362:	7b7c                	ld	a5,240(a4)
ffffffffc0205364:	c3a1                	beqz	a5,ffffffffc02053a4 <do_exit+0xce>
                if (initproc->wait_state == WT_CHILD) {
ffffffffc0205366:	800009b7          	lui	s3,0x80000
            if (proc->state == PROC_ZOMBIE) {
ffffffffc020536a:	490d                	li	s2,3
                if (initproc->wait_state == WT_CHILD) {
ffffffffc020536c:	0985                	addi	s3,s3,1
ffffffffc020536e:	a021                	j	ffffffffc0205376 <do_exit+0xa0>
        while (current->cptr != NULL) {
ffffffffc0205370:	6018                	ld	a4,0(s0)
ffffffffc0205372:	7b7c                	ld	a5,240(a4)
ffffffffc0205374:	cb85                	beqz	a5,ffffffffc02053a4 <do_exit+0xce>
            current->cptr = proc->optr;
ffffffffc0205376:	1007b683          	ld	a3,256(a5) # ffffffff80000100 <_binary_obj___user_exit_out_size+0xffffffff7fff4fd0>
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc020537a:	6088                	ld	a0,0(s1)
            current->cptr = proc->optr;
ffffffffc020537c:	fb74                	sd	a3,240(a4)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc020537e:	7978                	ld	a4,240(a0)
            proc->yptr = NULL;
ffffffffc0205380:	0e07bc23          	sd	zero,248(a5)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc0205384:	10e7b023          	sd	a4,256(a5)
ffffffffc0205388:	c311                	beqz	a4,ffffffffc020538c <do_exit+0xb6>
                initproc->cptr->yptr = proc;
ffffffffc020538a:	ff7c                	sd	a5,248(a4)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc020538c:	4398                	lw	a4,0(a5)
            proc->parent = initproc;
ffffffffc020538e:	f388                	sd	a0,32(a5)
            initproc->cptr = proc;
ffffffffc0205390:	f97c                	sd	a5,240(a0)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205392:	fd271fe3          	bne	a4,s2,ffffffffc0205370 <do_exit+0x9a>
                if (initproc->wait_state == WT_CHILD) {
ffffffffc0205396:	0ec52783          	lw	a5,236(a0)
ffffffffc020539a:	fd379be3          	bne	a5,s3,ffffffffc0205370 <do_exit+0x9a>
                    wakeup_proc(initproc);
ffffffffc020539e:	373000ef          	jal	ra,ffffffffc0205f10 <wakeup_proc>
ffffffffc02053a2:	b7f9                	j	ffffffffc0205370 <do_exit+0x9a>
    if (flag) {
ffffffffc02053a4:	020a1263          	bnez	s4,ffffffffc02053c8 <do_exit+0xf2>
    schedule();
ffffffffc02053a8:	3e9000ef          	jal	ra,ffffffffc0205f90 <schedule>
    panic("do_exit will not return!! %d.\n", current->pid);
ffffffffc02053ac:	601c                	ld	a5,0(s0)
ffffffffc02053ae:	00003617          	auipc	a2,0x3
ffffffffc02053b2:	07a60613          	addi	a2,a2,122 # ffffffffc0208428 <default_pmm_manager+0x1130>
ffffffffc02053b6:	20300593          	li	a1,515
ffffffffc02053ba:	43d4                	lw	a3,4(a5)
ffffffffc02053bc:	00003517          	auipc	a0,0x3
ffffffffc02053c0:	00c50513          	addi	a0,a0,12 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc02053c4:	8b6fb0ef          	jal	ra,ffffffffc020047a <__panic>
        intr_enable();
ffffffffc02053c8:	a78fb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc02053cc:	bff1                	j	ffffffffc02053a8 <do_exit+0xd2>
        panic("idleproc exit.\n");
ffffffffc02053ce:	00003617          	auipc	a2,0x3
ffffffffc02053d2:	03a60613          	addi	a2,a2,58 # ffffffffc0208408 <default_pmm_manager+0x1110>
ffffffffc02053d6:	1d700593          	li	a1,471
ffffffffc02053da:	00003517          	auipc	a0,0x3
ffffffffc02053de:	fee50513          	addi	a0,a0,-18 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc02053e2:	898fb0ef          	jal	ra,ffffffffc020047a <__panic>
            exit_mmap(mm);
ffffffffc02053e6:	854e                	mv	a0,s3
ffffffffc02053e8:	85aff0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
            put_pgdir(mm);
ffffffffc02053ec:	854e                	mv	a0,s3
ffffffffc02053ee:	9d9ff0ef          	jal	ra,ffffffffc0204dc6 <put_pgdir>
            mm_destroy(mm);
ffffffffc02053f2:	854e                	mv	a0,s3
ffffffffc02053f4:	eb3fe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
ffffffffc02053f8:	bf35                	j	ffffffffc0205334 <do_exit+0x5e>
        panic("initproc exit.\n");
ffffffffc02053fa:	00003617          	auipc	a2,0x3
ffffffffc02053fe:	01e60613          	addi	a2,a2,30 # ffffffffc0208418 <default_pmm_manager+0x1120>
ffffffffc0205402:	1da00593          	li	a1,474
ffffffffc0205406:	00003517          	auipc	a0,0x3
ffffffffc020540a:	fc250513          	addi	a0,a0,-62 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc020540e:	86cfb0ef          	jal	ra,ffffffffc020047a <__panic>
        intr_disable();
ffffffffc0205412:	a34fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0205416:	4a05                	li	s4,1
ffffffffc0205418:	bf1d                	j	ffffffffc020534e <do_exit+0x78>
            wakeup_proc(proc);
ffffffffc020541a:	2f7000ef          	jal	ra,ffffffffc0205f10 <wakeup_proc>
ffffffffc020541e:	b789                	j	ffffffffc0205360 <do_exit+0x8a>

ffffffffc0205420 <do_wait.part.0>:
do_wait(int pid, int *code_store) {
ffffffffc0205420:	715d                	addi	sp,sp,-80
ffffffffc0205422:	f84a                	sd	s2,48(sp)
ffffffffc0205424:	f44e                	sd	s3,40(sp)
        current->wait_state = WT_CHILD;
ffffffffc0205426:	80000937          	lui	s2,0x80000
    if (0 < pid && pid < MAX_PID) {
ffffffffc020542a:	6989                	lui	s3,0x2
do_wait(int pid, int *code_store) {
ffffffffc020542c:	fc26                	sd	s1,56(sp)
ffffffffc020542e:	f052                	sd	s4,32(sp)
ffffffffc0205430:	ec56                	sd	s5,24(sp)
ffffffffc0205432:	e85a                	sd	s6,16(sp)
ffffffffc0205434:	e45e                	sd	s7,8(sp)
ffffffffc0205436:	e486                	sd	ra,72(sp)
ffffffffc0205438:	e0a2                	sd	s0,64(sp)
ffffffffc020543a:	84aa                	mv	s1,a0
ffffffffc020543c:	8a2e                	mv	s4,a1
        proc = current->cptr;
ffffffffc020543e:	000adb97          	auipc	s7,0xad
ffffffffc0205442:	4dab8b93          	addi	s7,s7,1242 # ffffffffc02b2918 <current>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205446:	00050b1b          	sext.w	s6,a0
ffffffffc020544a:	fff50a9b          	addiw	s5,a0,-1
ffffffffc020544e:	19f9                	addi	s3,s3,-2
        current->wait_state = WT_CHILD;
ffffffffc0205450:	0905                	addi	s2,s2,1
    if (pid != 0) {
ffffffffc0205452:	ccbd                	beqz	s1,ffffffffc02054d0 <do_wait.part.0+0xb0>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205454:	0359e863          	bltu	s3,s5,ffffffffc0205484 <do_wait.part.0+0x64>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205458:	45a9                	li	a1,10
ffffffffc020545a:	855a                	mv	a0,s6
ffffffffc020545c:	4a1000ef          	jal	ra,ffffffffc02060fc <hash32>
ffffffffc0205460:	02051793          	slli	a5,a0,0x20
ffffffffc0205464:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0205468:	000a9797          	auipc	a5,0xa9
ffffffffc020546c:	42878793          	addi	a5,a5,1064 # ffffffffc02ae890 <hash_list>
ffffffffc0205470:	953e                	add	a0,a0,a5
ffffffffc0205472:	842a                	mv	s0,a0
        while ((le = list_next(le)) != list) {
ffffffffc0205474:	a029                	j	ffffffffc020547e <do_wait.part.0+0x5e>
            if (proc->pid == pid) {
ffffffffc0205476:	f2c42783          	lw	a5,-212(s0)
ffffffffc020547a:	02978163          	beq	a5,s1,ffffffffc020549c <do_wait.part.0+0x7c>
ffffffffc020547e:	6400                	ld	s0,8(s0)
        while ((le = list_next(le)) != list) {
ffffffffc0205480:	fe851be3          	bne	a0,s0,ffffffffc0205476 <do_wait.part.0+0x56>
    return -E_BAD_PROC;
ffffffffc0205484:	5579                	li	a0,-2
}
ffffffffc0205486:	60a6                	ld	ra,72(sp)
ffffffffc0205488:	6406                	ld	s0,64(sp)
ffffffffc020548a:	74e2                	ld	s1,56(sp)
ffffffffc020548c:	7942                	ld	s2,48(sp)
ffffffffc020548e:	79a2                	ld	s3,40(sp)
ffffffffc0205490:	7a02                	ld	s4,32(sp)
ffffffffc0205492:	6ae2                	ld	s5,24(sp)
ffffffffc0205494:	6b42                	ld	s6,16(sp)
ffffffffc0205496:	6ba2                	ld	s7,8(sp)
ffffffffc0205498:	6161                	addi	sp,sp,80
ffffffffc020549a:	8082                	ret
        if (proc != NULL && proc->parent == current) {
ffffffffc020549c:	000bb683          	ld	a3,0(s7)
ffffffffc02054a0:	f4843783          	ld	a5,-184(s0)
ffffffffc02054a4:	fed790e3          	bne	a5,a3,ffffffffc0205484 <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02054a8:	f2842703          	lw	a4,-216(s0)
ffffffffc02054ac:	478d                	li	a5,3
ffffffffc02054ae:	0ef70b63          	beq	a4,a5,ffffffffc02055a4 <do_wait.part.0+0x184>
        current->state = PROC_SLEEPING;
ffffffffc02054b2:	4785                	li	a5,1
ffffffffc02054b4:	c29c                	sw	a5,0(a3)
        current->wait_state = WT_CHILD;
ffffffffc02054b6:	0f26a623          	sw	s2,236(a3)
        schedule();
ffffffffc02054ba:	2d7000ef          	jal	ra,ffffffffc0205f90 <schedule>
        if (current->flags & PF_EXITING) {
ffffffffc02054be:	000bb783          	ld	a5,0(s7)
ffffffffc02054c2:	0b07a783          	lw	a5,176(a5)
ffffffffc02054c6:	8b85                	andi	a5,a5,1
ffffffffc02054c8:	d7c9                	beqz	a5,ffffffffc0205452 <do_wait.part.0+0x32>
            do_exit(-E_KILLED);
ffffffffc02054ca:	555d                	li	a0,-9
ffffffffc02054cc:	e0bff0ef          	jal	ra,ffffffffc02052d6 <do_exit>
        proc = current->cptr;
ffffffffc02054d0:	000bb683          	ld	a3,0(s7)
ffffffffc02054d4:	7ae0                	ld	s0,240(a3)
        for (; proc != NULL; proc = proc->optr) {
ffffffffc02054d6:	d45d                	beqz	s0,ffffffffc0205484 <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02054d8:	470d                	li	a4,3
ffffffffc02054da:	a021                	j	ffffffffc02054e2 <do_wait.part.0+0xc2>
        for (; proc != NULL; proc = proc->optr) {
ffffffffc02054dc:	10043403          	ld	s0,256(s0)
ffffffffc02054e0:	d869                	beqz	s0,ffffffffc02054b2 <do_wait.part.0+0x92>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02054e2:	401c                	lw	a5,0(s0)
ffffffffc02054e4:	fee79ce3          	bne	a5,a4,ffffffffc02054dc <do_wait.part.0+0xbc>
    if (proc == idleproc || proc == initproc) {
ffffffffc02054e8:	000ad797          	auipc	a5,0xad
ffffffffc02054ec:	4387b783          	ld	a5,1080(a5) # ffffffffc02b2920 <idleproc>
ffffffffc02054f0:	0c878963          	beq	a5,s0,ffffffffc02055c2 <do_wait.part.0+0x1a2>
ffffffffc02054f4:	000ad797          	auipc	a5,0xad
ffffffffc02054f8:	4347b783          	ld	a5,1076(a5) # ffffffffc02b2928 <initproc>
ffffffffc02054fc:	0cf40363          	beq	s0,a5,ffffffffc02055c2 <do_wait.part.0+0x1a2>
    if (code_store != NULL) {
ffffffffc0205500:	000a0663          	beqz	s4,ffffffffc020550c <do_wait.part.0+0xec>
        *code_store = proc->exit_code;
ffffffffc0205504:	0e842783          	lw	a5,232(s0)
ffffffffc0205508:	00fa2023          	sw	a5,0(s4) # 1000 <_binary_obj___user_faultread_out_size-0x8bb8>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020550c:	100027f3          	csrr	a5,sstatus
ffffffffc0205510:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205512:	4581                	li	a1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205514:	e7c1                	bnez	a5,ffffffffc020559c <do_wait.part.0+0x17c>
    __list_del(listelm->prev, listelm->next);
ffffffffc0205516:	6c70                	ld	a2,216(s0)
ffffffffc0205518:	7074                	ld	a3,224(s0)
    if (proc->optr != NULL) {
ffffffffc020551a:	10043703          	ld	a4,256(s0)
        proc->optr->yptr = proc->yptr;
ffffffffc020551e:	7c7c                	ld	a5,248(s0)
    prev->next = next;
ffffffffc0205520:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc0205522:	e290                	sd	a2,0(a3)
    __list_del(listelm->prev, listelm->next);
ffffffffc0205524:	6470                	ld	a2,200(s0)
ffffffffc0205526:	6874                	ld	a3,208(s0)
    prev->next = next;
ffffffffc0205528:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc020552a:	e290                	sd	a2,0(a3)
    if (proc->optr != NULL) {
ffffffffc020552c:	c319                	beqz	a4,ffffffffc0205532 <do_wait.part.0+0x112>
        proc->optr->yptr = proc->yptr;
ffffffffc020552e:	ff7c                	sd	a5,248(a4)
    if (proc->yptr != NULL) {
ffffffffc0205530:	7c7c                	ld	a5,248(s0)
ffffffffc0205532:	c3b5                	beqz	a5,ffffffffc0205596 <do_wait.part.0+0x176>
        proc->yptr->optr = proc->optr;
ffffffffc0205534:	10e7b023          	sd	a4,256(a5)
    nr_process --;
ffffffffc0205538:	000ad717          	auipc	a4,0xad
ffffffffc020553c:	3f870713          	addi	a4,a4,1016 # ffffffffc02b2930 <nr_process>
ffffffffc0205540:	431c                	lw	a5,0(a4)
ffffffffc0205542:	37fd                	addiw	a5,a5,-1
ffffffffc0205544:	c31c                	sw	a5,0(a4)
    if (flag) {
ffffffffc0205546:	e5a9                	bnez	a1,ffffffffc0205590 <do_wait.part.0+0x170>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc0205548:	6814                	ld	a3,16(s0)
    return pa2page(PADDR(kva));
ffffffffc020554a:	c02007b7          	lui	a5,0xc0200
ffffffffc020554e:	04f6ee63          	bltu	a3,a5,ffffffffc02055aa <do_wait.part.0+0x18a>
ffffffffc0205552:	000ad797          	auipc	a5,0xad
ffffffffc0205556:	3967b783          	ld	a5,918(a5) # ffffffffc02b28e8 <va_pa_offset>
ffffffffc020555a:	8e9d                	sub	a3,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc020555c:	82b1                	srli	a3,a3,0xc
ffffffffc020555e:	000ad797          	auipc	a5,0xad
ffffffffc0205562:	3727b783          	ld	a5,882(a5) # ffffffffc02b28d0 <npage>
ffffffffc0205566:	06f6fa63          	bgeu	a3,a5,ffffffffc02055da <do_wait.part.0+0x1ba>
    return &pages[PPN(pa) - nbase];
ffffffffc020556a:	00003517          	auipc	a0,0x3
ffffffffc020556e:	6f653503          	ld	a0,1782(a0) # ffffffffc0208c60 <nbase>
ffffffffc0205572:	8e89                	sub	a3,a3,a0
ffffffffc0205574:	069a                	slli	a3,a3,0x6
ffffffffc0205576:	000ad517          	auipc	a0,0xad
ffffffffc020557a:	36253503          	ld	a0,866(a0) # ffffffffc02b28d8 <pages>
ffffffffc020557e:	9536                	add	a0,a0,a3
ffffffffc0205580:	4589                	li	a1,2
ffffffffc0205582:	ff0fc0ef          	jal	ra,ffffffffc0201d72 <free_pages>
    kfree(proc);
ffffffffc0205586:	8522                	mv	a0,s0
ffffffffc0205588:	e2afc0ef          	jal	ra,ffffffffc0201bb2 <kfree>
    return 0;
ffffffffc020558c:	4501                	li	a0,0
ffffffffc020558e:	bde5                	j	ffffffffc0205486 <do_wait.part.0+0x66>
        intr_enable();
ffffffffc0205590:	8b0fb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc0205594:	bf55                	j	ffffffffc0205548 <do_wait.part.0+0x128>
       proc->parent->cptr = proc->optr;
ffffffffc0205596:	701c                	ld	a5,32(s0)
ffffffffc0205598:	fbf8                	sd	a4,240(a5)
ffffffffc020559a:	bf79                	j	ffffffffc0205538 <do_wait.part.0+0x118>
        intr_disable();
ffffffffc020559c:	8aafb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc02055a0:	4585                	li	a1,1
ffffffffc02055a2:	bf95                	j	ffffffffc0205516 <do_wait.part.0+0xf6>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02055a4:	f2840413          	addi	s0,s0,-216
ffffffffc02055a8:	b781                	j	ffffffffc02054e8 <do_wait.part.0+0xc8>
    return pa2page(PADDR(kva));
ffffffffc02055aa:	00002617          	auipc	a2,0x2
ffffffffc02055ae:	e2e60613          	addi	a2,a2,-466 # ffffffffc02073d8 <default_pmm_manager+0xe0>
ffffffffc02055b2:	06e00593          	li	a1,110
ffffffffc02055b6:	00002517          	auipc	a0,0x2
ffffffffc02055ba:	da250513          	addi	a0,a0,-606 # ffffffffc0207358 <default_pmm_manager+0x60>
ffffffffc02055be:	ebdfa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("wait idleproc or initproc.\n");
ffffffffc02055c2:	00003617          	auipc	a2,0x3
ffffffffc02055c6:	e8660613          	addi	a2,a2,-378 # ffffffffc0208448 <default_pmm_manager+0x1150>
ffffffffc02055ca:	2fd00593          	li	a1,765
ffffffffc02055ce:	00003517          	auipc	a0,0x3
ffffffffc02055d2:	dfa50513          	addi	a0,a0,-518 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc02055d6:	ea5fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02055da:	00002617          	auipc	a2,0x2
ffffffffc02055de:	e2660613          	addi	a2,a2,-474 # ffffffffc0207400 <default_pmm_manager+0x108>
ffffffffc02055e2:	06200593          	li	a1,98
ffffffffc02055e6:	00002517          	auipc	a0,0x2
ffffffffc02055ea:	d7250513          	addi	a0,a0,-654 # ffffffffc0207358 <default_pmm_manager+0x60>
ffffffffc02055ee:	e8dfa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc02055f2 <init_main>:
}

// init_main - the second kernel thread used to create user_main kernel threads
static int
init_main(void *arg) {
ffffffffc02055f2:	1141                	addi	sp,sp,-16
ffffffffc02055f4:	e406                	sd	ra,8(sp)
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc02055f6:	fbcfc0ef          	jal	ra,ffffffffc0201db2 <nr_free_pages>
    size_t kernel_allocated_store = kallocated();
ffffffffc02055fa:	d04fc0ef          	jal	ra,ffffffffc0201afe <kallocated>

    int pid = kernel_thread(user_main, NULL, 0);
ffffffffc02055fe:	4601                	li	a2,0
ffffffffc0205600:	4581                	li	a1,0
ffffffffc0205602:	fffff517          	auipc	a0,0xfffff
ffffffffc0205606:	74650513          	addi	a0,a0,1862 # ffffffffc0204d48 <user_main>
ffffffffc020560a:	c7dff0ef          	jal	ra,ffffffffc0205286 <kernel_thread>
    if (pid <= 0) {
ffffffffc020560e:	00a04563          	bgtz	a0,ffffffffc0205618 <init_main+0x26>
ffffffffc0205612:	a071                	j	ffffffffc020569e <init_main+0xac>
        panic("create user_main failed.\n");
    }

    while (do_wait(0, NULL) == 0) {
        schedule();
ffffffffc0205614:	17d000ef          	jal	ra,ffffffffc0205f90 <schedule>
    if (code_store != NULL) {
ffffffffc0205618:	4581                	li	a1,0
ffffffffc020561a:	4501                	li	a0,0
ffffffffc020561c:	e05ff0ef          	jal	ra,ffffffffc0205420 <do_wait.part.0>
    while (do_wait(0, NULL) == 0) {
ffffffffc0205620:	d975                	beqz	a0,ffffffffc0205614 <init_main+0x22>
    }

    cprintf("all user-mode processes have quit.\n");
ffffffffc0205622:	00003517          	auipc	a0,0x3
ffffffffc0205626:	e6650513          	addi	a0,a0,-410 # ffffffffc0208488 <default_pmm_manager+0x1190>
ffffffffc020562a:	b57fa0ef          	jal	ra,ffffffffc0200180 <cprintf>
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc020562e:	000ad797          	auipc	a5,0xad
ffffffffc0205632:	2fa7b783          	ld	a5,762(a5) # ffffffffc02b2928 <initproc>
ffffffffc0205636:	7bf8                	ld	a4,240(a5)
ffffffffc0205638:	e339                	bnez	a4,ffffffffc020567e <init_main+0x8c>
ffffffffc020563a:	7ff8                	ld	a4,248(a5)
ffffffffc020563c:	e329                	bnez	a4,ffffffffc020567e <init_main+0x8c>
ffffffffc020563e:	1007b703          	ld	a4,256(a5)
ffffffffc0205642:	ef15                	bnez	a4,ffffffffc020567e <init_main+0x8c>
    assert(nr_process == 2);
ffffffffc0205644:	000ad697          	auipc	a3,0xad
ffffffffc0205648:	2ec6a683          	lw	a3,748(a3) # ffffffffc02b2930 <nr_process>
ffffffffc020564c:	4709                	li	a4,2
ffffffffc020564e:	0ae69463          	bne	a3,a4,ffffffffc02056f6 <init_main+0x104>
    return listelm->next;
ffffffffc0205652:	000ad697          	auipc	a3,0xad
ffffffffc0205656:	23e68693          	addi	a3,a3,574 # ffffffffc02b2890 <proc_list>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc020565a:	6698                	ld	a4,8(a3)
ffffffffc020565c:	0c878793          	addi	a5,a5,200
ffffffffc0205660:	06f71b63          	bne	a4,a5,ffffffffc02056d6 <init_main+0xe4>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc0205664:	629c                	ld	a5,0(a3)
ffffffffc0205666:	04f71863          	bne	a4,a5,ffffffffc02056b6 <init_main+0xc4>

    cprintf("init check memory pass.\n");
ffffffffc020566a:	00003517          	auipc	a0,0x3
ffffffffc020566e:	f0650513          	addi	a0,a0,-250 # ffffffffc0208570 <default_pmm_manager+0x1278>
ffffffffc0205672:	b0ffa0ef          	jal	ra,ffffffffc0200180 <cprintf>
    return 0;
}
ffffffffc0205676:	60a2                	ld	ra,8(sp)
ffffffffc0205678:	4501                	li	a0,0
ffffffffc020567a:	0141                	addi	sp,sp,16
ffffffffc020567c:	8082                	ret
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc020567e:	00003697          	auipc	a3,0x3
ffffffffc0205682:	e3268693          	addi	a3,a3,-462 # ffffffffc02084b0 <default_pmm_manager+0x11b8>
ffffffffc0205686:	00001617          	auipc	a2,0x1
ffffffffc020568a:	5da60613          	addi	a2,a2,1498 # ffffffffc0206c60 <commands+0x450>
ffffffffc020568e:	36200593          	li	a1,866
ffffffffc0205692:	00003517          	auipc	a0,0x3
ffffffffc0205696:	d3650513          	addi	a0,a0,-714 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc020569a:	de1fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("create user_main failed.\n");
ffffffffc020569e:	00003617          	auipc	a2,0x3
ffffffffc02056a2:	dca60613          	addi	a2,a2,-566 # ffffffffc0208468 <default_pmm_manager+0x1170>
ffffffffc02056a6:	35a00593          	li	a1,858
ffffffffc02056aa:	00003517          	auipc	a0,0x3
ffffffffc02056ae:	d1e50513          	addi	a0,a0,-738 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc02056b2:	dc9fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc02056b6:	00003697          	auipc	a3,0x3
ffffffffc02056ba:	e8a68693          	addi	a3,a3,-374 # ffffffffc0208540 <default_pmm_manager+0x1248>
ffffffffc02056be:	00001617          	auipc	a2,0x1
ffffffffc02056c2:	5a260613          	addi	a2,a2,1442 # ffffffffc0206c60 <commands+0x450>
ffffffffc02056c6:	36500593          	li	a1,869
ffffffffc02056ca:	00003517          	auipc	a0,0x3
ffffffffc02056ce:	cfe50513          	addi	a0,a0,-770 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc02056d2:	da9fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc02056d6:	00003697          	auipc	a3,0x3
ffffffffc02056da:	e3a68693          	addi	a3,a3,-454 # ffffffffc0208510 <default_pmm_manager+0x1218>
ffffffffc02056de:	00001617          	auipc	a2,0x1
ffffffffc02056e2:	58260613          	addi	a2,a2,1410 # ffffffffc0206c60 <commands+0x450>
ffffffffc02056e6:	36400593          	li	a1,868
ffffffffc02056ea:	00003517          	auipc	a0,0x3
ffffffffc02056ee:	cde50513          	addi	a0,a0,-802 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc02056f2:	d89fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_process == 2);
ffffffffc02056f6:	00003697          	auipc	a3,0x3
ffffffffc02056fa:	e0a68693          	addi	a3,a3,-502 # ffffffffc0208500 <default_pmm_manager+0x1208>
ffffffffc02056fe:	00001617          	auipc	a2,0x1
ffffffffc0205702:	56260613          	addi	a2,a2,1378 # ffffffffc0206c60 <commands+0x450>
ffffffffc0205706:	36300593          	li	a1,867
ffffffffc020570a:	00003517          	auipc	a0,0x3
ffffffffc020570e:	cbe50513          	addi	a0,a0,-834 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc0205712:	d69fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205716 <do_execve>:
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc0205716:	7171                	addi	sp,sp,-176
ffffffffc0205718:	e4ee                	sd	s11,72(sp)
    struct mm_struct *mm = current->mm;
ffffffffc020571a:	000add97          	auipc	s11,0xad
ffffffffc020571e:	1fed8d93          	addi	s11,s11,510 # ffffffffc02b2918 <current>
ffffffffc0205722:	000db783          	ld	a5,0(s11)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc0205726:	e54e                	sd	s3,136(sp)
ffffffffc0205728:	ed26                	sd	s1,152(sp)
    struct mm_struct *mm = current->mm;
ffffffffc020572a:	0287b983          	ld	s3,40(a5)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc020572e:	e94a                	sd	s2,144(sp)
ffffffffc0205730:	f4de                	sd	s7,104(sp)
ffffffffc0205732:	892a                	mv	s2,a0
ffffffffc0205734:	8bb2                	mv	s7,a2
ffffffffc0205736:	84ae                	mv	s1,a1
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) {
ffffffffc0205738:	862e                	mv	a2,a1
ffffffffc020573a:	4681                	li	a3,0
ffffffffc020573c:	85aa                	mv	a1,a0
ffffffffc020573e:	854e                	mv	a0,s3
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc0205740:	f506                	sd	ra,168(sp)
ffffffffc0205742:	f122                	sd	s0,160(sp)
ffffffffc0205744:	e152                	sd	s4,128(sp)
ffffffffc0205746:	fcd6                	sd	s5,120(sp)
ffffffffc0205748:	f8da                	sd	s6,112(sp)
ffffffffc020574a:	f0e2                	sd	s8,96(sp)
ffffffffc020574c:	ece6                	sd	s9,88(sp)
ffffffffc020574e:	e8ea                	sd	s10,80(sp)
ffffffffc0205750:	f05e                	sd	s7,32(sp)
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) {
ffffffffc0205752:	b86ff0ef          	jal	ra,ffffffffc0204ad8 <user_mem_check>
ffffffffc0205756:	40050a63          	beqz	a0,ffffffffc0205b6a <do_execve+0x454>
    memset(local_name, 0, sizeof(local_name));
ffffffffc020575a:	4641                	li	a2,16
ffffffffc020575c:	4581                	li	a1,0
ffffffffc020575e:	1808                	addi	a0,sp,48
ffffffffc0205760:	61d000ef          	jal	ra,ffffffffc020657c <memset>
    memcpy(local_name, name, len);
ffffffffc0205764:	47bd                	li	a5,15
ffffffffc0205766:	8626                	mv	a2,s1
ffffffffc0205768:	1e97e263          	bltu	a5,s1,ffffffffc020594c <do_execve+0x236>
ffffffffc020576c:	85ca                	mv	a1,s2
ffffffffc020576e:	1808                	addi	a0,sp,48
ffffffffc0205770:	61f000ef          	jal	ra,ffffffffc020658e <memcpy>
    if (mm != NULL) {
ffffffffc0205774:	1e098363          	beqz	s3,ffffffffc020595a <do_execve+0x244>
        cputs("mm != NULL");
ffffffffc0205778:	00002517          	auipc	a0,0x2
ffffffffc020577c:	30850513          	addi	a0,a0,776 # ffffffffc0207a80 <default_pmm_manager+0x788>
ffffffffc0205780:	a39fa0ef          	jal	ra,ffffffffc02001b8 <cputs>
ffffffffc0205784:	000ad797          	auipc	a5,0xad
ffffffffc0205788:	13c7b783          	ld	a5,316(a5) # ffffffffc02b28c0 <boot_cr3>
ffffffffc020578c:	577d                	li	a4,-1
ffffffffc020578e:	177e                	slli	a4,a4,0x3f
ffffffffc0205790:	83b1                	srli	a5,a5,0xc
ffffffffc0205792:	8fd9                	or	a5,a5,a4
ffffffffc0205794:	18079073          	csrw	satp,a5
ffffffffc0205798:	0309a783          	lw	a5,48(s3) # 2030 <_binary_obj___user_faultread_out_size-0x7b88>
ffffffffc020579c:	fff7871b          	addiw	a4,a5,-1
ffffffffc02057a0:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0) {
ffffffffc02057a4:	2c070463          	beqz	a4,ffffffffc0205a6c <do_execve+0x356>
        current->mm = NULL;
ffffffffc02057a8:	000db783          	ld	a5,0(s11)
ffffffffc02057ac:	0207b423          	sd	zero,40(a5)
    if ((mm = mm_create()) == NULL) {
ffffffffc02057b0:	971fe0ef          	jal	ra,ffffffffc0204120 <mm_create>
ffffffffc02057b4:	84aa                	mv	s1,a0
ffffffffc02057b6:	1c050d63          	beqz	a0,ffffffffc0205990 <do_execve+0x27a>
    if ((page = alloc_page()) == NULL) {
ffffffffc02057ba:	4505                	li	a0,1
ffffffffc02057bc:	d24fc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
ffffffffc02057c0:	3a050963          	beqz	a0,ffffffffc0205b72 <do_execve+0x45c>
    return page - pages + nbase;
ffffffffc02057c4:	000adc97          	auipc	s9,0xad
ffffffffc02057c8:	114c8c93          	addi	s9,s9,276 # ffffffffc02b28d8 <pages>
ffffffffc02057cc:	000cb683          	ld	a3,0(s9)
    return KADDR(page2pa(page));
ffffffffc02057d0:	000adc17          	auipc	s8,0xad
ffffffffc02057d4:	100c0c13          	addi	s8,s8,256 # ffffffffc02b28d0 <npage>
    return page - pages + nbase;
ffffffffc02057d8:	00003717          	auipc	a4,0x3
ffffffffc02057dc:	48873703          	ld	a4,1160(a4) # ffffffffc0208c60 <nbase>
ffffffffc02057e0:	40d506b3          	sub	a3,a0,a3
ffffffffc02057e4:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc02057e6:	5afd                	li	s5,-1
ffffffffc02057e8:	000c3783          	ld	a5,0(s8)
    return page - pages + nbase;
ffffffffc02057ec:	96ba                	add	a3,a3,a4
ffffffffc02057ee:	e83a                	sd	a4,16(sp)
    return KADDR(page2pa(page));
ffffffffc02057f0:	00cad713          	srli	a4,s5,0xc
ffffffffc02057f4:	ec3a                	sd	a4,24(sp)
ffffffffc02057f6:	8f75                	and	a4,a4,a3
    return page2ppn(page) << PGSHIFT;
ffffffffc02057f8:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02057fa:	38f77063          	bgeu	a4,a5,ffffffffc0205b7a <do_execve+0x464>
ffffffffc02057fe:	000adb17          	auipc	s6,0xad
ffffffffc0205802:	0eab0b13          	addi	s6,s6,234 # ffffffffc02b28e8 <va_pa_offset>
ffffffffc0205806:	000b3903          	ld	s2,0(s6)
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc020580a:	6605                	lui	a2,0x1
ffffffffc020580c:	000ad597          	auipc	a1,0xad
ffffffffc0205810:	0bc5b583          	ld	a1,188(a1) # ffffffffc02b28c8 <boot_pgdir>
ffffffffc0205814:	9936                	add	s2,s2,a3
ffffffffc0205816:	854a                	mv	a0,s2
ffffffffc0205818:	577000ef          	jal	ra,ffffffffc020658e <memcpy>
    if (elf->e_magic != ELF_MAGIC) {
ffffffffc020581c:	7782                	ld	a5,32(sp)
ffffffffc020581e:	4398                	lw	a4,0(a5)
ffffffffc0205820:	464c47b7          	lui	a5,0x464c4
    mm->pgdir = pgdir;
ffffffffc0205824:	0124bc23          	sd	s2,24(s1)
    if (elf->e_magic != ELF_MAGIC) {
ffffffffc0205828:	57f78793          	addi	a5,a5,1407 # 464c457f <_binary_obj___user_exit_out_size+0x464b944f>
ffffffffc020582c:	14f71863          	bne	a4,a5,ffffffffc020597c <do_execve+0x266>
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0205830:	7682                	ld	a3,32(sp)
ffffffffc0205832:	0386d703          	lhu	a4,56(a3)
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc0205836:	0206b983          	ld	s3,32(a3)
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc020583a:	00371793          	slli	a5,a4,0x3
ffffffffc020583e:	8f99                	sub	a5,a5,a4
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc0205840:	99b6                	add	s3,s3,a3
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0205842:	078e                	slli	a5,a5,0x3
ffffffffc0205844:	97ce                	add	a5,a5,s3
ffffffffc0205846:	f43e                	sd	a5,40(sp)
    for (; ph < ph_end; ph ++) {
ffffffffc0205848:	00f9fc63          	bgeu	s3,a5,ffffffffc0205860 <do_execve+0x14a>
        if (ph->p_type != ELF_PT_LOAD) {
ffffffffc020584c:	0009a783          	lw	a5,0(s3)
ffffffffc0205850:	4705                	li	a4,1
ffffffffc0205852:	14e78163          	beq	a5,a4,ffffffffc0205994 <do_execve+0x27e>
    for (; ph < ph_end; ph ++) {
ffffffffc0205856:	77a2                	ld	a5,40(sp)
ffffffffc0205858:	03898993          	addi	s3,s3,56
ffffffffc020585c:	fef9e8e3          	bltu	s3,a5,ffffffffc020584c <do_execve+0x136>
    if ((ret = mm_map(mm, USTACKTOP - USTACKSIZE, USTACKSIZE, vm_flags, NULL)) != 0) {
ffffffffc0205860:	4701                	li	a4,0
ffffffffc0205862:	46ad                	li	a3,11
ffffffffc0205864:	00100637          	lui	a2,0x100
ffffffffc0205868:	7ff005b7          	lui	a1,0x7ff00
ffffffffc020586c:	8526                	mv	a0,s1
ffffffffc020586e:	a8bfe0ef          	jal	ra,ffffffffc02042f8 <mm_map>
ffffffffc0205872:	8a2a                	mv	s4,a0
ffffffffc0205874:	1e051263          	bnez	a0,ffffffffc0205a58 <do_execve+0x342>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc0205878:	6c88                	ld	a0,24(s1)
ffffffffc020587a:	467d                	li	a2,31
ffffffffc020587c:	7ffff5b7          	lui	a1,0x7ffff
ffffffffc0205880:	acdfd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205884:	38050363          	beqz	a0,ffffffffc0205c0a <do_execve+0x4f4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc0205888:	6c88                	ld	a0,24(s1)
ffffffffc020588a:	467d                	li	a2,31
ffffffffc020588c:	7fffe5b7          	lui	a1,0x7fffe
ffffffffc0205890:	abdfd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205894:	34050b63          	beqz	a0,ffffffffc0205bea <do_execve+0x4d4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc0205898:	6c88                	ld	a0,24(s1)
ffffffffc020589a:	467d                	li	a2,31
ffffffffc020589c:	7fffd5b7          	lui	a1,0x7fffd
ffffffffc02058a0:	aadfd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc02058a4:	32050363          	beqz	a0,ffffffffc0205bca <do_execve+0x4b4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc02058a8:	6c88                	ld	a0,24(s1)
ffffffffc02058aa:	467d                	li	a2,31
ffffffffc02058ac:	7fffc5b7          	lui	a1,0x7fffc
ffffffffc02058b0:	a9dfd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc02058b4:	2e050b63          	beqz	a0,ffffffffc0205baa <do_execve+0x494>
    mm->mm_count += 1;
ffffffffc02058b8:	589c                	lw	a5,48(s1)
    current->mm = mm;
ffffffffc02058ba:	000db603          	ld	a2,0(s11)
    current->cr3 = PADDR(mm->pgdir);
ffffffffc02058be:	6c94                	ld	a3,24(s1)
ffffffffc02058c0:	2785                	addiw	a5,a5,1
ffffffffc02058c2:	d89c                	sw	a5,48(s1)
    current->mm = mm;
ffffffffc02058c4:	f604                	sd	s1,40(a2)
    current->cr3 = PADDR(mm->pgdir);
ffffffffc02058c6:	c02007b7          	lui	a5,0xc0200
ffffffffc02058ca:	2cf6e463          	bltu	a3,a5,ffffffffc0205b92 <do_execve+0x47c>
ffffffffc02058ce:	000b3783          	ld	a5,0(s6)
ffffffffc02058d2:	577d                	li	a4,-1
ffffffffc02058d4:	177e                	slli	a4,a4,0x3f
ffffffffc02058d6:	8e9d                	sub	a3,a3,a5
ffffffffc02058d8:	00c6d793          	srli	a5,a3,0xc
ffffffffc02058dc:	f654                	sd	a3,168(a2)
ffffffffc02058de:	8fd9                	or	a5,a5,a4
ffffffffc02058e0:	18079073          	csrw	satp,a5
    struct trapframe *tf = current->tf;
ffffffffc02058e4:	7240                	ld	s0,160(a2)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc02058e6:	4581                	li	a1,0
ffffffffc02058e8:	12000613          	li	a2,288
ffffffffc02058ec:	8522                	mv	a0,s0
    uintptr_t sstatus = tf->status;
ffffffffc02058ee:	10043483          	ld	s1,256(s0)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc02058f2:	48b000ef          	jal	ra,ffffffffc020657c <memset>
    tf->epc = elf->e_entry;
ffffffffc02058f6:	7782                	ld	a5,32(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02058f8:	000db903          	ld	s2,0(s11)
    tf->status = (sstatus & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc02058fc:	edf4f493          	andi	s1,s1,-289
    tf->epc = elf->e_entry;
ffffffffc0205900:	6f98                	ld	a4,24(a5)
    tf->gpr.sp = USTACKTOP;
ffffffffc0205902:	4785                	li	a5,1
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205904:	0b490913          	addi	s2,s2,180 # ffffffff800000b4 <_binary_obj___user_exit_out_size+0xffffffff7fff4f84>
    tf->gpr.sp = USTACKTOP;
ffffffffc0205908:	07fe                	slli	a5,a5,0x1f
    tf->status = (sstatus & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc020590a:	0204e493          	ori	s1,s1,32
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020590e:	4641                	li	a2,16
ffffffffc0205910:	4581                	li	a1,0
    tf->gpr.sp = USTACKTOP;
ffffffffc0205912:	e81c                	sd	a5,16(s0)
    tf->epc = elf->e_entry;
ffffffffc0205914:	10e43423          	sd	a4,264(s0)
    tf->status = (sstatus & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc0205918:	10943023          	sd	s1,256(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020591c:	854a                	mv	a0,s2
ffffffffc020591e:	45f000ef          	jal	ra,ffffffffc020657c <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205922:	463d                	li	a2,15
ffffffffc0205924:	180c                	addi	a1,sp,48
ffffffffc0205926:	854a                	mv	a0,s2
ffffffffc0205928:	467000ef          	jal	ra,ffffffffc020658e <memcpy>
}
ffffffffc020592c:	70aa                	ld	ra,168(sp)
ffffffffc020592e:	740a                	ld	s0,160(sp)
ffffffffc0205930:	64ea                	ld	s1,152(sp)
ffffffffc0205932:	694a                	ld	s2,144(sp)
ffffffffc0205934:	69aa                	ld	s3,136(sp)
ffffffffc0205936:	7ae6                	ld	s5,120(sp)
ffffffffc0205938:	7b46                	ld	s6,112(sp)
ffffffffc020593a:	7ba6                	ld	s7,104(sp)
ffffffffc020593c:	7c06                	ld	s8,96(sp)
ffffffffc020593e:	6ce6                	ld	s9,88(sp)
ffffffffc0205940:	6d46                	ld	s10,80(sp)
ffffffffc0205942:	6da6                	ld	s11,72(sp)
ffffffffc0205944:	8552                	mv	a0,s4
ffffffffc0205946:	6a0a                	ld	s4,128(sp)
ffffffffc0205948:	614d                	addi	sp,sp,176
ffffffffc020594a:	8082                	ret
    memcpy(local_name, name, len);
ffffffffc020594c:	463d                	li	a2,15
ffffffffc020594e:	85ca                	mv	a1,s2
ffffffffc0205950:	1808                	addi	a0,sp,48
ffffffffc0205952:	43d000ef          	jal	ra,ffffffffc020658e <memcpy>
    if (mm != NULL) {
ffffffffc0205956:	e20991e3          	bnez	s3,ffffffffc0205778 <do_execve+0x62>
    if (current->mm != NULL) {
ffffffffc020595a:	000db783          	ld	a5,0(s11)
ffffffffc020595e:	779c                	ld	a5,40(a5)
ffffffffc0205960:	e40788e3          	beqz	a5,ffffffffc02057b0 <do_execve+0x9a>
        panic("load_icode: current->mm must be empty.\n");
ffffffffc0205964:	00003617          	auipc	a2,0x3
ffffffffc0205968:	c2c60613          	addi	a2,a2,-980 # ffffffffc0208590 <default_pmm_manager+0x1298>
ffffffffc020596c:	20d00593          	li	a1,525
ffffffffc0205970:	00003517          	auipc	a0,0x3
ffffffffc0205974:	a5850513          	addi	a0,a0,-1448 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc0205978:	b03fa0ef          	jal	ra,ffffffffc020047a <__panic>
    put_pgdir(mm);
ffffffffc020597c:	8526                	mv	a0,s1
ffffffffc020597e:	c48ff0ef          	jal	ra,ffffffffc0204dc6 <put_pgdir>
    mm_destroy(mm);
ffffffffc0205982:	8526                	mv	a0,s1
ffffffffc0205984:	923fe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
        ret = -E_INVAL_ELF;
ffffffffc0205988:	5a61                	li	s4,-8
    do_exit(ret);
ffffffffc020598a:	8552                	mv	a0,s4
ffffffffc020598c:	94bff0ef          	jal	ra,ffffffffc02052d6 <do_exit>
    int ret = -E_NO_MEM;
ffffffffc0205990:	5a71                	li	s4,-4
ffffffffc0205992:	bfe5                	j	ffffffffc020598a <do_execve+0x274>
        if (ph->p_filesz > ph->p_memsz) {
ffffffffc0205994:	0289b603          	ld	a2,40(s3)
ffffffffc0205998:	0209b783          	ld	a5,32(s3)
ffffffffc020599c:	1cf66d63          	bltu	a2,a5,ffffffffc0205b76 <do_execve+0x460>
        if (ph->p_flags & ELF_PF_X) vm_flags |= VM_EXEC;
ffffffffc02059a0:	0049a783          	lw	a5,4(s3)
ffffffffc02059a4:	0017f693          	andi	a3,a5,1
ffffffffc02059a8:	c291                	beqz	a3,ffffffffc02059ac <do_execve+0x296>
ffffffffc02059aa:	4691                	li	a3,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc02059ac:	0027f713          	andi	a4,a5,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc02059b0:	8b91                	andi	a5,a5,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc02059b2:	e779                	bnez	a4,ffffffffc0205a80 <do_execve+0x36a>
        vm_flags = 0, perm = PTE_U | PTE_V;
ffffffffc02059b4:	4d45                	li	s10,17
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc02059b6:	c781                	beqz	a5,ffffffffc02059be <do_execve+0x2a8>
ffffffffc02059b8:	0016e693          	ori	a3,a3,1
        if (vm_flags & VM_READ) perm |= PTE_R;
ffffffffc02059bc:	4d4d                	li	s10,19
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc02059be:	0026f793          	andi	a5,a3,2
ffffffffc02059c2:	e3f1                	bnez	a5,ffffffffc0205a86 <do_execve+0x370>
        if (vm_flags & VM_EXEC) perm |= PTE_X;
ffffffffc02059c4:	0046f793          	andi	a5,a3,4
ffffffffc02059c8:	c399                	beqz	a5,ffffffffc02059ce <do_execve+0x2b8>
ffffffffc02059ca:	008d6d13          	ori	s10,s10,8
        if ((ret = mm_map(mm, ph->p_va, ph->p_memsz, vm_flags, NULL)) != 0) {
ffffffffc02059ce:	0109b583          	ld	a1,16(s3)
ffffffffc02059d2:	4701                	li	a4,0
ffffffffc02059d4:	8526                	mv	a0,s1
ffffffffc02059d6:	923fe0ef          	jal	ra,ffffffffc02042f8 <mm_map>
ffffffffc02059da:	8a2a                	mv	s4,a0
ffffffffc02059dc:	ed35                	bnez	a0,ffffffffc0205a58 <do_execve+0x342>
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc02059de:	0109bb83          	ld	s7,16(s3)
ffffffffc02059e2:	77fd                	lui	a5,0xfffff
        end = ph->p_va + ph->p_filesz;
ffffffffc02059e4:	0209ba03          	ld	s4,32(s3)
        unsigned char *from = binary + ph->p_offset;
ffffffffc02059e8:	0089b903          	ld	s2,8(s3)
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc02059ec:	00fbfab3          	and	s5,s7,a5
        unsigned char *from = binary + ph->p_offset;
ffffffffc02059f0:	7782                	ld	a5,32(sp)
        end = ph->p_va + ph->p_filesz;
ffffffffc02059f2:	9a5e                	add	s4,s4,s7
        unsigned char *from = binary + ph->p_offset;
ffffffffc02059f4:	993e                	add	s2,s2,a5
        while (start < end) {
ffffffffc02059f6:	054be963          	bltu	s7,s4,ffffffffc0205a48 <do_execve+0x332>
ffffffffc02059fa:	aa95                	j	ffffffffc0205b6e <do_execve+0x458>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc02059fc:	6785                	lui	a5,0x1
ffffffffc02059fe:	415b8533          	sub	a0,s7,s5
ffffffffc0205a02:	9abe                	add	s5,s5,a5
ffffffffc0205a04:	417a8633          	sub	a2,s5,s7
            if (end < la) {
ffffffffc0205a08:	015a7463          	bgeu	s4,s5,ffffffffc0205a10 <do_execve+0x2fa>
                size -= la - end;
ffffffffc0205a0c:	417a0633          	sub	a2,s4,s7
    return page - pages + nbase;
ffffffffc0205a10:	000cb683          	ld	a3,0(s9)
ffffffffc0205a14:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205a16:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
ffffffffc0205a1a:	40d406b3          	sub	a3,s0,a3
ffffffffc0205a1e:	8699                	srai	a3,a3,0x6
ffffffffc0205a20:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205a22:	67e2                	ld	a5,24(sp)
ffffffffc0205a24:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205a28:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205a2a:	14b87863          	bgeu	a6,a1,ffffffffc0205b7a <do_execve+0x464>
ffffffffc0205a2e:	000b3803          	ld	a6,0(s6)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a32:	85ca                	mv	a1,s2
            start += size, from += size;
ffffffffc0205a34:	9bb2                	add	s7,s7,a2
ffffffffc0205a36:	96c2                	add	a3,a3,a6
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a38:	9536                	add	a0,a0,a3
            start += size, from += size;
ffffffffc0205a3a:	e432                	sd	a2,8(sp)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a3c:	353000ef          	jal	ra,ffffffffc020658e <memcpy>
            start += size, from += size;
ffffffffc0205a40:	6622                	ld	a2,8(sp)
ffffffffc0205a42:	9932                	add	s2,s2,a2
        while (start < end) {
ffffffffc0205a44:	054bf363          	bgeu	s7,s4,ffffffffc0205a8a <do_execve+0x374>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205a48:	6c88                	ld	a0,24(s1)
ffffffffc0205a4a:	866a                	mv	a2,s10
ffffffffc0205a4c:	85d6                	mv	a1,s5
ffffffffc0205a4e:	8fffd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205a52:	842a                	mv	s0,a0
ffffffffc0205a54:	f545                	bnez	a0,ffffffffc02059fc <do_execve+0x2e6>
        ret = -E_NO_MEM;
ffffffffc0205a56:	5a71                	li	s4,-4
    exit_mmap(mm);
ffffffffc0205a58:	8526                	mv	a0,s1
ffffffffc0205a5a:	9e9fe0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
    put_pgdir(mm);
ffffffffc0205a5e:	8526                	mv	a0,s1
ffffffffc0205a60:	b66ff0ef          	jal	ra,ffffffffc0204dc6 <put_pgdir>
    mm_destroy(mm);
ffffffffc0205a64:	8526                	mv	a0,s1
ffffffffc0205a66:	841fe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
    return ret;
ffffffffc0205a6a:	b705                	j	ffffffffc020598a <do_execve+0x274>
            exit_mmap(mm);
ffffffffc0205a6c:	854e                	mv	a0,s3
ffffffffc0205a6e:	9d5fe0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
            put_pgdir(mm);
ffffffffc0205a72:	854e                	mv	a0,s3
ffffffffc0205a74:	b52ff0ef          	jal	ra,ffffffffc0204dc6 <put_pgdir>
            mm_destroy(mm);
ffffffffc0205a78:	854e                	mv	a0,s3
ffffffffc0205a7a:	82dfe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
ffffffffc0205a7e:	b32d                	j	ffffffffc02057a8 <do_execve+0x92>
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205a80:	0026e693          	ori	a3,a3,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205a84:	fb95                	bnez	a5,ffffffffc02059b8 <do_execve+0x2a2>
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc0205a86:	4d5d                	li	s10,23
ffffffffc0205a88:	bf35                	j	ffffffffc02059c4 <do_execve+0x2ae>
        end = ph->p_va + ph->p_memsz;
ffffffffc0205a8a:	0109b683          	ld	a3,16(s3)
ffffffffc0205a8e:	0289b903          	ld	s2,40(s3)
ffffffffc0205a92:	9936                	add	s2,s2,a3
        if (start < la) {
ffffffffc0205a94:	075bfd63          	bgeu	s7,s5,ffffffffc0205b0e <do_execve+0x3f8>
            if (start == end) {
ffffffffc0205a98:	db790fe3          	beq	s2,s7,ffffffffc0205856 <do_execve+0x140>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205a9c:	6785                	lui	a5,0x1
ffffffffc0205a9e:	00fb8533          	add	a0,s7,a5
ffffffffc0205aa2:	41550533          	sub	a0,a0,s5
                size -= la - end;
ffffffffc0205aa6:	41790a33          	sub	s4,s2,s7
            if (end < la) {
ffffffffc0205aaa:	0b597d63          	bgeu	s2,s5,ffffffffc0205b64 <do_execve+0x44e>
    return page - pages + nbase;
ffffffffc0205aae:	000cb683          	ld	a3,0(s9)
ffffffffc0205ab2:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205ab4:	000c3603          	ld	a2,0(s8)
    return page - pages + nbase;
ffffffffc0205ab8:	40d406b3          	sub	a3,s0,a3
ffffffffc0205abc:	8699                	srai	a3,a3,0x6
ffffffffc0205abe:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205ac0:	67e2                	ld	a5,24(sp)
ffffffffc0205ac2:	00f6f5b3          	and	a1,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205ac6:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205ac8:	0ac5f963          	bgeu	a1,a2,ffffffffc0205b7a <do_execve+0x464>
ffffffffc0205acc:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205ad0:	8652                	mv	a2,s4
ffffffffc0205ad2:	4581                	li	a1,0
ffffffffc0205ad4:	96c2                	add	a3,a3,a6
ffffffffc0205ad6:	9536                	add	a0,a0,a3
ffffffffc0205ad8:	2a5000ef          	jal	ra,ffffffffc020657c <memset>
            start += size;
ffffffffc0205adc:	017a0733          	add	a4,s4,s7
            assert((end < la && start == end) || (end >= la && start == la));
ffffffffc0205ae0:	03597463          	bgeu	s2,s5,ffffffffc0205b08 <do_execve+0x3f2>
ffffffffc0205ae4:	d6e909e3          	beq	s2,a4,ffffffffc0205856 <do_execve+0x140>
ffffffffc0205ae8:	00003697          	auipc	a3,0x3
ffffffffc0205aec:	ad068693          	addi	a3,a3,-1328 # ffffffffc02085b8 <default_pmm_manager+0x12c0>
ffffffffc0205af0:	00001617          	auipc	a2,0x1
ffffffffc0205af4:	17060613          	addi	a2,a2,368 # ffffffffc0206c60 <commands+0x450>
ffffffffc0205af8:	26200593          	li	a1,610
ffffffffc0205afc:	00003517          	auipc	a0,0x3
ffffffffc0205b00:	8cc50513          	addi	a0,a0,-1844 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc0205b04:	977fa0ef          	jal	ra,ffffffffc020047a <__panic>
ffffffffc0205b08:	ff5710e3          	bne	a4,s5,ffffffffc0205ae8 <do_execve+0x3d2>
ffffffffc0205b0c:	8bd6                	mv	s7,s5
        while (start < end) {
ffffffffc0205b0e:	d52bf4e3          	bgeu	s7,s2,ffffffffc0205856 <do_execve+0x140>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205b12:	6c88                	ld	a0,24(s1)
ffffffffc0205b14:	866a                	mv	a2,s10
ffffffffc0205b16:	85d6                	mv	a1,s5
ffffffffc0205b18:	835fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205b1c:	842a                	mv	s0,a0
ffffffffc0205b1e:	dd05                	beqz	a0,ffffffffc0205a56 <do_execve+0x340>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205b20:	6785                	lui	a5,0x1
ffffffffc0205b22:	415b8533          	sub	a0,s7,s5
ffffffffc0205b26:	9abe                	add	s5,s5,a5
ffffffffc0205b28:	417a8633          	sub	a2,s5,s7
            if (end < la) {
ffffffffc0205b2c:	01597463          	bgeu	s2,s5,ffffffffc0205b34 <do_execve+0x41e>
                size -= la - end;
ffffffffc0205b30:	41790633          	sub	a2,s2,s7
    return page - pages + nbase;
ffffffffc0205b34:	000cb683          	ld	a3,0(s9)
ffffffffc0205b38:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205b3a:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
ffffffffc0205b3e:	40d406b3          	sub	a3,s0,a3
ffffffffc0205b42:	8699                	srai	a3,a3,0x6
ffffffffc0205b44:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205b46:	67e2                	ld	a5,24(sp)
ffffffffc0205b48:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205b4c:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205b4e:	02b87663          	bgeu	a6,a1,ffffffffc0205b7a <do_execve+0x464>
ffffffffc0205b52:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205b56:	4581                	li	a1,0
            start += size;
ffffffffc0205b58:	9bb2                	add	s7,s7,a2
ffffffffc0205b5a:	96c2                	add	a3,a3,a6
            memset(page2kva(page) + off, 0, size);
ffffffffc0205b5c:	9536                	add	a0,a0,a3
ffffffffc0205b5e:	21f000ef          	jal	ra,ffffffffc020657c <memset>
ffffffffc0205b62:	b775                	j	ffffffffc0205b0e <do_execve+0x3f8>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205b64:	417a8a33          	sub	s4,s5,s7
ffffffffc0205b68:	b799                	j	ffffffffc0205aae <do_execve+0x398>
        return -E_INVAL;
ffffffffc0205b6a:	5a75                	li	s4,-3
ffffffffc0205b6c:	b3c1                	j	ffffffffc020592c <do_execve+0x216>
        while (start < end) {
ffffffffc0205b6e:	86de                	mv	a3,s7
ffffffffc0205b70:	bf39                	j	ffffffffc0205a8e <do_execve+0x378>
    int ret = -E_NO_MEM;
ffffffffc0205b72:	5a71                	li	s4,-4
ffffffffc0205b74:	bdc5                	j	ffffffffc0205a64 <do_execve+0x34e>
            ret = -E_INVAL_ELF;
ffffffffc0205b76:	5a61                	li	s4,-8
ffffffffc0205b78:	b5c5                	j	ffffffffc0205a58 <do_execve+0x342>
ffffffffc0205b7a:	00001617          	auipc	a2,0x1
ffffffffc0205b7e:	7b660613          	addi	a2,a2,1974 # ffffffffc0207330 <default_pmm_manager+0x38>
ffffffffc0205b82:	06900593          	li	a1,105
ffffffffc0205b86:	00001517          	auipc	a0,0x1
ffffffffc0205b8a:	7d250513          	addi	a0,a0,2002 # ffffffffc0207358 <default_pmm_manager+0x60>
ffffffffc0205b8e:	8edfa0ef          	jal	ra,ffffffffc020047a <__panic>
    current->cr3 = PADDR(mm->pgdir);
ffffffffc0205b92:	00002617          	auipc	a2,0x2
ffffffffc0205b96:	84660613          	addi	a2,a2,-1978 # ffffffffc02073d8 <default_pmm_manager+0xe0>
ffffffffc0205b9a:	27d00593          	li	a1,637
ffffffffc0205b9e:	00003517          	auipc	a0,0x3
ffffffffc0205ba2:	82a50513          	addi	a0,a0,-2006 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc0205ba6:	8d5fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc0205baa:	00003697          	auipc	a3,0x3
ffffffffc0205bae:	b2668693          	addi	a3,a3,-1242 # ffffffffc02086d0 <default_pmm_manager+0x13d8>
ffffffffc0205bb2:	00001617          	auipc	a2,0x1
ffffffffc0205bb6:	0ae60613          	addi	a2,a2,174 # ffffffffc0206c60 <commands+0x450>
ffffffffc0205bba:	27800593          	li	a1,632
ffffffffc0205bbe:	00003517          	auipc	a0,0x3
ffffffffc0205bc2:	80a50513          	addi	a0,a0,-2038 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc0205bc6:	8b5fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc0205bca:	00003697          	auipc	a3,0x3
ffffffffc0205bce:	abe68693          	addi	a3,a3,-1346 # ffffffffc0208688 <default_pmm_manager+0x1390>
ffffffffc0205bd2:	00001617          	auipc	a2,0x1
ffffffffc0205bd6:	08e60613          	addi	a2,a2,142 # ffffffffc0206c60 <commands+0x450>
ffffffffc0205bda:	27700593          	li	a1,631
ffffffffc0205bde:	00002517          	auipc	a0,0x2
ffffffffc0205be2:	7ea50513          	addi	a0,a0,2026 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc0205be6:	895fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc0205bea:	00003697          	auipc	a3,0x3
ffffffffc0205bee:	a5668693          	addi	a3,a3,-1450 # ffffffffc0208640 <default_pmm_manager+0x1348>
ffffffffc0205bf2:	00001617          	auipc	a2,0x1
ffffffffc0205bf6:	06e60613          	addi	a2,a2,110 # ffffffffc0206c60 <commands+0x450>
ffffffffc0205bfa:	27600593          	li	a1,630
ffffffffc0205bfe:	00002517          	auipc	a0,0x2
ffffffffc0205c02:	7ca50513          	addi	a0,a0,1994 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc0205c06:	875fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc0205c0a:	00003697          	auipc	a3,0x3
ffffffffc0205c0e:	9ee68693          	addi	a3,a3,-1554 # ffffffffc02085f8 <default_pmm_manager+0x1300>
ffffffffc0205c12:	00001617          	auipc	a2,0x1
ffffffffc0205c16:	04e60613          	addi	a2,a2,78 # ffffffffc0206c60 <commands+0x450>
ffffffffc0205c1a:	27500593          	li	a1,629
ffffffffc0205c1e:	00002517          	auipc	a0,0x2
ffffffffc0205c22:	7aa50513          	addi	a0,a0,1962 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc0205c26:	855fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205c2a <do_yield>:
    current->need_resched = 1;
ffffffffc0205c2a:	000ad797          	auipc	a5,0xad
ffffffffc0205c2e:	cee7b783          	ld	a5,-786(a5) # ffffffffc02b2918 <current>
ffffffffc0205c32:	4705                	li	a4,1
ffffffffc0205c34:	ef98                	sd	a4,24(a5)
}
ffffffffc0205c36:	4501                	li	a0,0
ffffffffc0205c38:	8082                	ret

ffffffffc0205c3a <do_wait>:
do_wait(int pid, int *code_store) {
ffffffffc0205c3a:	1101                	addi	sp,sp,-32
ffffffffc0205c3c:	e822                	sd	s0,16(sp)
ffffffffc0205c3e:	e426                	sd	s1,8(sp)
ffffffffc0205c40:	ec06                	sd	ra,24(sp)
ffffffffc0205c42:	842e                	mv	s0,a1
ffffffffc0205c44:	84aa                	mv	s1,a0
    if (code_store != NULL) {
ffffffffc0205c46:	c999                	beqz	a1,ffffffffc0205c5c <do_wait+0x22>
    struct mm_struct *mm = current->mm;
ffffffffc0205c48:	000ad797          	auipc	a5,0xad
ffffffffc0205c4c:	cd07b783          	ld	a5,-816(a5) # ffffffffc02b2918 <current>
        if (!user_mem_check(mm, (uintptr_t)code_store, sizeof(int), 1)) {
ffffffffc0205c50:	7788                	ld	a0,40(a5)
ffffffffc0205c52:	4685                	li	a3,1
ffffffffc0205c54:	4611                	li	a2,4
ffffffffc0205c56:	e83fe0ef          	jal	ra,ffffffffc0204ad8 <user_mem_check>
ffffffffc0205c5a:	c909                	beqz	a0,ffffffffc0205c6c <do_wait+0x32>
ffffffffc0205c5c:	85a2                	mv	a1,s0
}
ffffffffc0205c5e:	6442                	ld	s0,16(sp)
ffffffffc0205c60:	60e2                	ld	ra,24(sp)
ffffffffc0205c62:	8526                	mv	a0,s1
ffffffffc0205c64:	64a2                	ld	s1,8(sp)
ffffffffc0205c66:	6105                	addi	sp,sp,32
ffffffffc0205c68:	fb8ff06f          	j	ffffffffc0205420 <do_wait.part.0>
ffffffffc0205c6c:	60e2                	ld	ra,24(sp)
ffffffffc0205c6e:	6442                	ld	s0,16(sp)
ffffffffc0205c70:	64a2                	ld	s1,8(sp)
ffffffffc0205c72:	5575                	li	a0,-3
ffffffffc0205c74:	6105                	addi	sp,sp,32
ffffffffc0205c76:	8082                	ret

ffffffffc0205c78 <do_kill>:
do_kill(int pid) {
ffffffffc0205c78:	1141                	addi	sp,sp,-16
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205c7a:	6789                	lui	a5,0x2
do_kill(int pid) {
ffffffffc0205c7c:	e406                	sd	ra,8(sp)
ffffffffc0205c7e:	e022                	sd	s0,0(sp)
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205c80:	fff5071b          	addiw	a4,a0,-1
ffffffffc0205c84:	17f9                	addi	a5,a5,-2
ffffffffc0205c86:	02e7e963          	bltu	a5,a4,ffffffffc0205cb8 <do_kill+0x40>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205c8a:	842a                	mv	s0,a0
ffffffffc0205c8c:	45a9                	li	a1,10
ffffffffc0205c8e:	2501                	sext.w	a0,a0
ffffffffc0205c90:	46c000ef          	jal	ra,ffffffffc02060fc <hash32>
ffffffffc0205c94:	02051793          	slli	a5,a0,0x20
ffffffffc0205c98:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0205c9c:	000a9797          	auipc	a5,0xa9
ffffffffc0205ca0:	bf478793          	addi	a5,a5,-1036 # ffffffffc02ae890 <hash_list>
ffffffffc0205ca4:	953e                	add	a0,a0,a5
ffffffffc0205ca6:	87aa                	mv	a5,a0
        while ((le = list_next(le)) != list) {
ffffffffc0205ca8:	a029                	j	ffffffffc0205cb2 <do_kill+0x3a>
            if (proc->pid == pid) {
ffffffffc0205caa:	f2c7a703          	lw	a4,-212(a5)
ffffffffc0205cae:	00870b63          	beq	a4,s0,ffffffffc0205cc4 <do_kill+0x4c>
ffffffffc0205cb2:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0205cb4:	fef51be3          	bne	a0,a5,ffffffffc0205caa <do_kill+0x32>
    return -E_INVAL;
ffffffffc0205cb8:	5475                	li	s0,-3
}
ffffffffc0205cba:	60a2                	ld	ra,8(sp)
ffffffffc0205cbc:	8522                	mv	a0,s0
ffffffffc0205cbe:	6402                	ld	s0,0(sp)
ffffffffc0205cc0:	0141                	addi	sp,sp,16
ffffffffc0205cc2:	8082                	ret
        if (!(proc->flags & PF_EXITING)) {
ffffffffc0205cc4:	fd87a703          	lw	a4,-40(a5)
ffffffffc0205cc8:	00177693          	andi	a3,a4,1
ffffffffc0205ccc:	e295                	bnez	a3,ffffffffc0205cf0 <do_kill+0x78>
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205cce:	4bd4                	lw	a3,20(a5)
            proc->flags |= PF_EXITING;
ffffffffc0205cd0:	00176713          	ori	a4,a4,1
ffffffffc0205cd4:	fce7ac23          	sw	a4,-40(a5)
            return 0;
ffffffffc0205cd8:	4401                	li	s0,0
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205cda:	fe06d0e3          	bgez	a3,ffffffffc0205cba <do_kill+0x42>
                wakeup_proc(proc);
ffffffffc0205cde:	f2878513          	addi	a0,a5,-216
ffffffffc0205ce2:	22e000ef          	jal	ra,ffffffffc0205f10 <wakeup_proc>
}
ffffffffc0205ce6:	60a2                	ld	ra,8(sp)
ffffffffc0205ce8:	8522                	mv	a0,s0
...
ffffffffc0205cf2:	b7e1                	j	ffffffffc0205cba <do_kill+0x42>

ffffffffc0205cf4 <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc0205cf4:	1101                	addi	sp,sp,-32
ffffffffc0205cf6:	e426                	sd	s1,8(sp)
    elm->prev = elm->next = elm;
ffffffffc0205cf8:	000ad797          	auipc	a5,0xad
ffffffffc0205cfc:	b9878793          	addi	a5,a5,-1128 # ffffffffc02b2890 <proc_list>
ffffffffc0205d00:	ec06                	sd	ra,24(sp)
ffffffffc0205d02:	e822                	sd	s0,16(sp)
ffffffffc0205d04:	e04a                	sd	s2,0(sp)
ffffffffc0205d06:	000a9497          	auipc	s1,0xa9
ffffffffc0205d0a:	b8a48493          	addi	s1,s1,-1142 # ffffffffc02ae890 <hash_list>
ffffffffc0205d0e:	e79c                	sd	a5,8(a5)
ffffffffc0205d10:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc0205d12:	000ad717          	auipc	a4,0xad
ffffffffc0205d16:	b7e70713          	addi	a4,a4,-1154 # ffffffffc02b2890 <proc_list>
ffffffffc0205d1a:	87a6                	mv	a5,s1
ffffffffc0205d1c:	e79c                	sd	a5,8(a5)
ffffffffc0205d1e:	e39c                	sd	a5,0(a5)
ffffffffc0205d20:	07c1                	addi	a5,a5,16
ffffffffc0205d22:	fef71de3          	bne	a4,a5,ffffffffc0205d1c <proc_init+0x28>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0205d26:	fa3fe0ef          	jal	ra,ffffffffc0204cc8 <alloc_proc>
ffffffffc0205d2a:	000ad917          	auipc	s2,0xad
ffffffffc0205d2e:	bf690913          	addi	s2,s2,-1034 # ffffffffc02b2920 <idleproc>
ffffffffc0205d32:	00a93023          	sd	a0,0(s2)
ffffffffc0205d36:	0e050f63          	beqz	a0,ffffffffc0205e34 <proc_init+0x140>
        panic("cannot alloc idleproc.\n");
    }

    idleproc->pid = 0;
    idleproc->state = PROC_RUNNABLE;
ffffffffc0205d3a:	4789                	li	a5,2
ffffffffc0205d3c:	e11c                	sd	a5,0(a0)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205d3e:	00003797          	auipc	a5,0x3
ffffffffc0205d42:	2c278793          	addi	a5,a5,706 # ffffffffc0209000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205d46:	0b450413          	addi	s0,a0,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205d4a:	e91c                	sd	a5,16(a0)
    idleproc->need_resched = 1;
ffffffffc0205d4c:	4785                	li	a5,1
ffffffffc0205d4e:	ed1c                	sd	a5,24(a0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205d50:	4641                	li	a2,16
ffffffffc0205d52:	4581                	li	a1,0
ffffffffc0205d54:	8522                	mv	a0,s0
ffffffffc0205d56:	027000ef          	jal	ra,ffffffffc020657c <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205d5a:	463d                	li	a2,15
ffffffffc0205d5c:	00003597          	auipc	a1,0x3
ffffffffc0205d60:	9d458593          	addi	a1,a1,-1580 # ffffffffc0208730 <default_pmm_manager+0x1438>
ffffffffc0205d64:	8522                	mv	a0,s0
ffffffffc0205d66:	029000ef          	jal	ra,ffffffffc020658e <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc0205d6a:	000ad717          	auipc	a4,0xad
ffffffffc0205d6e:	bc670713          	addi	a4,a4,-1082 # ffffffffc02b2930 <nr_process>
ffffffffc0205d72:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc0205d74:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205d78:	4601                	li	a2,0
    nr_process ++;
ffffffffc0205d7a:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205d7c:	4581                	li	a1,0
ffffffffc0205d7e:	00000517          	auipc	a0,0x0
ffffffffc0205d82:	87450513          	addi	a0,a0,-1932 # ffffffffc02055f2 <init_main>
    nr_process ++;
ffffffffc0205d86:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0205d88:	000ad797          	auipc	a5,0xad
ffffffffc0205d8c:	b8d7b823          	sd	a3,-1136(a5) # ffffffffc02b2918 <current>
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205d90:	cf6ff0ef          	jal	ra,ffffffffc0205286 <kernel_thread>
ffffffffc0205d94:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc0205d96:	08a05363          	blez	a0,ffffffffc0205e1c <proc_init+0x128>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205d9a:	6789                	lui	a5,0x2
ffffffffc0205d9c:	fff5071b          	addiw	a4,a0,-1
ffffffffc0205da0:	17f9                	addi	a5,a5,-2
ffffffffc0205da2:	2501                	sext.w	a0,a0
ffffffffc0205da4:	02e7e363          	bltu	a5,a4,ffffffffc0205dca <proc_init+0xd6>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205da8:	45a9                	li	a1,10
ffffffffc0205daa:	352000ef          	jal	ra,ffffffffc02060fc <hash32>
ffffffffc0205dae:	02051793          	slli	a5,a0,0x20
ffffffffc0205db2:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0205db6:	96a6                	add	a3,a3,s1
ffffffffc0205db8:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc0205dba:	a029                	j	ffffffffc0205dc4 <proc_init+0xd0>
            if (proc->pid == pid) {
ffffffffc0205dbc:	f2c7a703          	lw	a4,-212(a5) # 1f2c <_binary_obj___user_faultread_out_size-0x7c8c>
ffffffffc0205dc0:	04870b63          	beq	a4,s0,ffffffffc0205e16 <proc_init+0x122>
    return listelm->next;
ffffffffc0205dc4:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0205dc6:	fef69be3          	bne	a3,a5,ffffffffc0205dbc <proc_init+0xc8>
    return NULL;
ffffffffc0205dca:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205dcc:	0b478493          	addi	s1,a5,180
ffffffffc0205dd0:	4641                	li	a2,16
ffffffffc0205dd2:	4581                	li	a1,0
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc0205dd4:	000ad417          	auipc	s0,0xad
ffffffffc0205dd8:	b5440413          	addi	s0,s0,-1196 # ffffffffc02b2928 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205ddc:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0205dde:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205de0:	79c000ef          	jal	ra,ffffffffc020657c <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205de4:	463d                	li	a2,15
ffffffffc0205de6:	00003597          	auipc	a1,0x3
ffffffffc0205dea:	97258593          	addi	a1,a1,-1678 # ffffffffc0208758 <default_pmm_manager+0x1460>
ffffffffc0205dee:	8526                	mv	a0,s1
ffffffffc0205df0:	79e000ef          	jal	ra,ffffffffc020658e <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205df4:	00093783          	ld	a5,0(s2)
ffffffffc0205df8:	cbb5                	beqz	a5,ffffffffc0205e6c <proc_init+0x178>
ffffffffc0205dfa:	43dc                	lw	a5,4(a5)
ffffffffc0205dfc:	eba5                	bnez	a5,ffffffffc0205e6c <proc_init+0x178>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205dfe:	601c                	ld	a5,0(s0)
ffffffffc0205e00:	c7b1                	beqz	a5,ffffffffc0205e4c <proc_init+0x158>
ffffffffc0205e02:	43d8                	lw	a4,4(a5)
ffffffffc0205e04:	4785                	li	a5,1
ffffffffc0205e06:	04f71363          	bne	a4,a5,ffffffffc0205e4c <proc_init+0x158>
}
ffffffffc0205e0a:	60e2                	ld	ra,24(sp)
ffffffffc0205e0c:	6442                	ld	s0,16(sp)
ffffffffc0205e0e:	64a2                	ld	s1,8(sp)
ffffffffc0205e10:	6902                	ld	s2,0(sp)
ffffffffc0205e12:	6105                	addi	sp,sp,32
ffffffffc0205e14:	8082                	ret
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0205e16:	f2878793          	addi	a5,a5,-216
ffffffffc0205e1a:	bf4d                	j	ffffffffc0205dcc <proc_init+0xd8>
        panic("create init_main failed.\n");
ffffffffc0205e1c:	00003617          	auipc	a2,0x3
ffffffffc0205e20:	91c60613          	addi	a2,a2,-1764 # ffffffffc0208738 <default_pmm_manager+0x1440>
ffffffffc0205e24:	38500593          	li	a1,901
ffffffffc0205e28:	00002517          	auipc	a0,0x2
ffffffffc0205e2c:	5a050513          	addi	a0,a0,1440 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc0205e30:	e4afa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("cannot alloc idleproc.\n");
ffffffffc0205e34:	00003617          	auipc	a2,0x3
ffffffffc0205e38:	8e460613          	addi	a2,a2,-1820 # ffffffffc0208718 <default_pmm_manager+0x1420>
ffffffffc0205e3c:	37700593          	li	a1,887
ffffffffc0205e40:	00002517          	auipc	a0,0x2
ffffffffc0205e44:	58850513          	addi	a0,a0,1416 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc0205e48:	e32fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205e4c:	00003697          	auipc	a3,0x3
ffffffffc0205e50:	93c68693          	addi	a3,a3,-1732 # ffffffffc0208788 <default_pmm_manager+0x1490>
ffffffffc0205e54:	00001617          	auipc	a2,0x1
ffffffffc0205e58:	e0c60613          	addi	a2,a2,-500 # ffffffffc0206c60 <commands+0x450>
ffffffffc0205e5c:	38c00593          	li	a1,908
ffffffffc0205e60:	00002517          	auipc	a0,0x2
ffffffffc0205e64:	56850513          	addi	a0,a0,1384 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc0205e68:	e12fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205e6c:	00003697          	auipc	a3,0x3
ffffffffc0205e70:	8f468693          	addi	a3,a3,-1804 # ffffffffc0208760 <default_pmm_manager+0x1468>
ffffffffc0205e74:	00001617          	auipc	a2,0x1
ffffffffc0205e78:	dec60613          	addi	a2,a2,-532 # ffffffffc0206c60 <commands+0x450>
ffffffffc0205e7c:	38b00593          	li	a1,907
ffffffffc0205e80:	00002517          	auipc	a0,0x2
ffffffffc0205e84:	54850513          	addi	a0,a0,1352 # ffffffffc02083c8 <default_pmm_manager+0x10d0>
ffffffffc0205e88:	df2fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205e8c <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc0205e8c:	1141                	addi	sp,sp,-16
ffffffffc0205e8e:	e022                	sd	s0,0(sp)
ffffffffc0205e90:	e406                	sd	ra,8(sp)
ffffffffc0205e92:	000ad417          	auipc	s0,0xad
ffffffffc0205e96:	a8640413          	addi	s0,s0,-1402 # ffffffffc02b2918 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc0205e9a:	6018                	ld	a4,0(s0)
ffffffffc0205e9c:	6f1c                	ld	a5,24(a4)
ffffffffc0205e9e:	dffd                	beqz	a5,ffffffffc0205e9c <cpu_idle+0x10>
            schedule();
ffffffffc0205ea0:	0f0000ef          	jal	ra,ffffffffc0205f90 <schedule>
ffffffffc0205ea4:	bfdd                	j	ffffffffc0205e9a <cpu_idle+0xe>

ffffffffc0205ea6 <switch_to>:
.text
...
ffffffffc0205ea6:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0205eaa:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0205eae:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0205eb0:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0205eb2:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0205eb6:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0205eba:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0205ebe:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc0205ec2:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0205ec6:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0205eca:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0205ece:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc0205ed2:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0205ed6:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0205eda:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0205ede:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0205ee2:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0205ee4:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0205ee6:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0205eea:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0205eee:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0205ef2:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0205ef6:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0205efa:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0205efe:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0205f02:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0205f06:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc0205f0a:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc0205f0e:	8082                	ret

ffffffffc0205f10 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc0205f10:	4118                	lw	a4,0(a0)
wakeup_proc(struct proc_struct *proc) {
ffffffffc0205f12:	1101                	addi	sp,sp,-32
ffffffffc0205f14:	ec06                	sd	ra,24(sp)
ffffffffc0205f16:	e822                	sd	s0,16(sp)
ffffffffc0205f18:	e426                	sd	s1,8(sp)
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205f1a:	478d                	li	a5,3
ffffffffc0205f1c:	04f70b63          	beq	a4,a5,ffffffffc0205f72 <wakeup_proc+0x62>
ffffffffc0205f20:	842a                	mv	s0,a0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205f22:	100027f3          	csrr	a5,sstatus
ffffffffc0205f26:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205f28:	4481                	li	s1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205f2a:	ef9d                	bnez	a5,ffffffffc0205f68 <wakeup_proc+0x58>
    bool intr_flag;
    local_intr_save(intr_flag);
    {
        if (proc->state != PROC_RUNNABLE) {
ffffffffc0205f2c:	4789                	li	a5,2
ffffffffc0205f2e:	02f70163          	beq	a4,a5,ffffffffc0205f50 <wakeup_proc+0x40>
            proc->state = PROC_RUNNABLE;
ffffffffc0205f32:	c01c                	sw	a5,0(s0)
            proc->wait_state = 0;
ffffffffc0205f34:	0e042623          	sw	zero,236(s0)
    if (flag) {
ffffffffc0205f38:	e491                	bnez	s1,ffffffffc0205f44 <wakeup_proc+0x34>
        else {
...
ffffffffc0205f46:	60e2                	ld	ra,24(sp)
ffffffffc0205f48:	64a2                	ld	s1,8(sp)
ffffffffc0205f4a:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc0205f4c:	ef4fa06f          	j	ffffffffc0200640 <intr_enable>
            warn("wakeup runnable process.\n");
ffffffffc0205f50:	00003617          	auipc	a2,0x3
ffffffffc0205f54:	89860613          	addi	a2,a2,-1896 # ffffffffc02087e8 <default_pmm_manager+0x14f0>
ffffffffc0205f58:	45c9                	li	a1,18
ffffffffc0205f5a:	00003517          	auipc	a0,0x3
ffffffffc0205f5e:	87650513          	addi	a0,a0,-1930 # ffffffffc02087d0 <default_pmm_manager+0x14d8>
ffffffffc0205f62:	d80fa0ef          	jal	ra,ffffffffc02004e2 <__warn>
ffffffffc0205f66:	bfc9                	j	ffffffffc0205f38 <wakeup_proc+0x28>
        intr_disable();
ffffffffc0205f68:	edefa0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        if (proc->state != PROC_RUNNABLE) {
ffffffffc0205f6c:	4018                	lw	a4,0(s0)
        return 1;
ffffffffc0205f6e:	4485                	li	s1,1
ffffffffc0205f70:	bf75                	j	ffffffffc0205f2c <wakeup_proc+0x1c>
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205f72:	00003697          	auipc	a3,0x3
ffffffffc0205f76:	83e68693          	addi	a3,a3,-1986 # ffffffffc02087b0 <default_pmm_manager+0x14b8>
ffffffffc0205f7a:	00001617          	auipc	a2,0x1
ffffffffc0205f7e:	ce660613          	addi	a2,a2,-794 # ffffffffc0206c60 <commands+0x450>
ffffffffc0205f82:	45a5                	li	a1,9
ffffffffc0205f84:	00003517          	auipc	a0,0x3
ffffffffc0205f88:	84c50513          	addi	a0,a0,-1972 # ffffffffc02087d0 <default_pmm_manager+0x14d8>
ffffffffc0205f8c:	ceefa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205f90 <schedule>:

void
schedule(void) {
ffffffffc0205f90:	1141                	addi	sp,sp,-16
ffffffffc0205f92:	e406                	sd	ra,8(sp)
ffffffffc0205f94:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205f96:	100027f3          	csrr	a5,sstatus
ffffffffc0205f9a:	8b89                	andi	a5,a5,2
ffffffffc0205f9c:	4401                	li	s0,0
ffffffffc0205f9e:	efbd                	bnez	a5,ffffffffc020601c <schedule+0x8c>
    bool intr_flag;
...
ffffffffc0205fa0:	000ad897          	auipc	a7,0xad
ffffffffc0205fa4:	9788b883          	ld	a7,-1672(a7) # ffffffffc02b2918 <current>
ffffffffc0205fa8:	0008bc23          	sd	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0205fac:	000ad517          	auipc	a0,0xad
ffffffffc0205fb0:	97453503          	ld	a0,-1676(a0) # ffffffffc02b2920 <idleproc>
ffffffffc0205fb4:	04a88e63          	beq	a7,a0,ffffffffc0206010 <schedule+0x80>
ffffffffc0205fb8:	0c888693          	addi	a3,a7,200
ffffffffc0205fbc:	000ad617          	auipc	a2,0xad
ffffffffc0205fc0:	8d460613          	addi	a2,a2,-1836 # ffffffffc02b2890 <proc_list>
        le = last;
ffffffffc0205fc4:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc0205fc8:	4809                	li	a6,2
ffffffffc0205fca:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0205fcc:	00c78863          	beq	a5,a2,ffffffffc0205fdc <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0205fd0:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0205fd4:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0205fd8:	03070163          	beq	a4,a6,ffffffffc0205ffa <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc0205fdc:	fef697e3          	bne	a3,a5,ffffffffc0205fca <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0205fe0:	ed89                	bnez	a1,ffffffffc0205ffa <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc0205fe2:	451c                	lw	a5,8(a0)
ffffffffc0205fe4:	2785                	addiw	a5,a5,1
ffffffffc0205fe6:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0205fe8:	00a88463          	beq	a7,a0,ffffffffc0205ff0 <schedule+0x60>
            proc_run(next);
ffffffffc0205fec:	e51fe0ef          	jal	ra,ffffffffc0204e3c <proc_run>
    if (flag) {
ffffffffc0205ff0:	e819                	bnez	s0,ffffffffc0206006 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc0205ff2:	60a2                	ld	ra,8(sp)
ffffffffc0205ff4:	6402                	ld	s0,0(sp)
ffffffffc0205ff6:	0141                	addi	sp,sp,16
ffffffffc0205ff8:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0205ffa:	4198                	lw	a4,0(a1)
ffffffffc0205ffc:	4789                	li	a5,2
ffffffffc0205ffe:	fef712e3          	bne	a4,a5,ffffffffc0205fe2 <schedule+0x52>
ffffffffc0206002:	852e                	mv	a0,a1
ffffffffc0206004:	bff9                	j	ffffffffc0205fe2 <schedule+0x52>
}
ffffffffc0206006:	6402                	ld	s0,0(sp)
ffffffffc0206008:	60a2                	ld	ra,8(sp)
ffffffffc020600a:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc020600c:	e34fa06f          	j	ffffffffc0200640 <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0206010:	000ad617          	auipc	a2,0xad
ffffffffc0206014:	88060613          	addi	a2,a2,-1920 # ffffffffc02b2890 <proc_list>
ffffffffc0206018:	86b2                	mv	a3,a2
ffffffffc020601a:	b76d                	j	ffffffffc0205fc4 <schedule+0x34>
        intr_disable();
ffffffffc020601c:	e2afa0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0206020:	4405                	li	s0,1
ffffffffc0206022:	bfbd                	j	ffffffffc0205fa0 <schedule+0x10>

ffffffffc0206024 <sys_getpid>:
    return do_kill(pid);
}
...
sys_getpid(uint64_t arg[]) {
    return current->pid;
ffffffffc0206024:	000ad797          	auipc	a5,0xad
ffffffffc0206028:	8f47b783          	ld	a5,-1804(a5) # ffffffffc02b2918 <current>
}
ffffffffc020602c:	43c8                	lw	a0,4(a5)
ffffffffc020602e:	8082                	ret

ffffffffc0206030 <sys_pgdir>:
...
ffffffffc0206030:	4501                	li	a0,0
ffffffffc0206032:	8082                	ret

ffffffffc0206034 <sys_putc>:
    cputchar(c);
...
ffffffffc0206038:	e406                	sd	ra,8(sp)
    cputchar(c);
ffffffffc020603a:	97cfa0ef          	jal	ra,ffffffffc02001b6 <cputchar>
}
...
ffffffffc0206046 <sys_kill>:
    return do_kill(pid);
ffffffffc0206046:	4108                	lw	a0,0(a0)
ffffffffc0206048:	c31ff06f          	j	ffffffffc0205c78 <do_kill>

ffffffffc020604c <sys_yield>:
    return do_yield();
ffffffffc020604c:	bdfff06f          	j	ffffffffc0205c2a <do_yield>

ffffffffc0206050 <sys_exec>:
    return do_execve(name, len, binary, size);
ffffffffc0206050:	6d14                	ld	a3,24(a0)
ffffffffc0206052:	6910                	ld	a2,16(a0)
ffffffffc0206054:	650c                	ld	a1,8(a0)
ffffffffc0206056:	6108                	ld	a0,0(a0)
ffffffffc0206058:	ebeff06f          	j	ffffffffc0205716 <do_execve>

ffffffffc020605c <sys_wait>:
    return do_wait(pid, store);
ffffffffc020605c:	650c                	ld	a1,8(a0)
ffffffffc020605e:	4108                	lw	a0,0(a0)
ffffffffc0206060:	bdbff06f          	j	ffffffffc0205c3a <do_wait>

ffffffffc0206064 <sys_fork>:
    struct trapframe *tf = current->tf;
ffffffffc0206064:	000ad797          	auipc	a5,0xad
ffffffffc0206068:	8b47b783          	ld	a5,-1868(a5) # ffffffffc02b2918 <current>
ffffffffc020606c:	73d0                	ld	a2,160(a5)
    return do_fork(0, stack, tf);
ffffffffc020606e:	4501                	li	a0,0
ffffffffc0206070:	6a0c                	ld	a1,16(a2)
ffffffffc0206072:	e37fe06f          	j	ffffffffc0204ea8 <do_fork>

ffffffffc0206076 <sys_exit>:
    return do_exit(error_code);
ffffffffc0206076:	4108                	lw	a0,0(a0)
ffffffffc0206078:	a5eff06f          	j	ffffffffc02052d6 <do_exit>
...
ffffffffc020607e:	fc26                	sd	s1,56(sp)
    struct trapframe *tf = current->tf;
ffffffffc0206080:	000ad497          	auipc	s1,0xad
ffffffffc0206084:	89848493          	addi	s1,s1,-1896 # ffffffffc02b2918 <current>
...
ffffffffc02060a4:	7b078793          	addi	a5,a5,1968 # ffffffffc0208850 <syscalls>
...
ffffffffc02060c6:	60a6                	ld	ra,72(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc02060c8:	e828                	sd	a0,80(s0)
}
...
ffffffffc02060d6:	f5efa0ef          	jal	ra,ffffffffc0200834 <print_trapframe>
    panic("undefined syscall %d, pid = %d, name = %s.\n",
ffffffffc02060da:	609c                	ld	a5,0(s1)
ffffffffc02060dc:	86ca                	mv	a3,s2
ffffffffc02060de:	00002617          	auipc	a2,0x2
ffffffffc02060e2:	72a60613          	addi	a2,a2,1834 # ffffffffc0208808 <default_pmm_manager+0x1510>
ffffffffc02060e6:	43d8                	lw	a4,4(a5)
ffffffffc02060e8:	06200593          	li	a1,98
ffffffffc02060ec:	0b478793          	addi	a5,a5,180
ffffffffc02060f0:	00002517          	auipc	a0,0x2
ffffffffc02060f4:	74850513          	addi	a0,a0,1864 # ffffffffc0208838 <default_pmm_manager+0x1540>
ffffffffc02060f8:	b82fa0ef          	jal	ra,ffffffffc020047a <__panic>
...
ffffffffc0206102:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0206106:	02000793          	li	a5,32
ffffffffc020610a:	9f8d                	subw	a5,a5,a1
}
ffffffffc020610c:	00f5553b          	srlw	a0,a0,a5
ffffffffc0206110:	8082                	ret

ffffffffc0206112 <printnum>:
 * */
static void
...
ffffffffc0206112:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0206116:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0206118:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc020611c:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc020611e:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0206122:	f022                	sd	s0,32(sp)
ffffffffc0206124:	ec26                	sd	s1,24(sp)
ffffffffc0206126:	e84a                	sd	s2,16(sp)
ffffffffc0206128:	f406                	sd	ra,40(sp)
ffffffffc020612a:	e44e                	sd	s3,8(sp)
ffffffffc020612c:	84aa                	mv	s1,a0
ffffffffc020612e:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0206130:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0206134:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0206136:	03067e63          	bgeu	a2,a6,ffffffffc0206172 <printnum+0x60>
ffffffffc020613a:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc020613c:	00805763          	blez	s0,ffffffffc020614a <printnum+0x38>
ffffffffc0206140:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0206142:	85ca                	mv	a1,s2
ffffffffc0206144:	854e                	mv	a0,s3
ffffffffc0206146:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0206148:	fc65                	bnez	s0,ffffffffc0206140 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020614a:	1a02                	slli	s4,s4,0x20
ffffffffc020614c:	00003797          	auipc	a5,0x3
ffffffffc0206150:	80478793          	addi	a5,a5,-2044 # ffffffffc0208950 <syscalls+0x100>
ffffffffc0206154:	020a5a13          	srli	s4,s4,0x20
ffffffffc0206158:	9a3e                	add	s4,s4,a5
...
ffffffffc020615a:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020615c:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0206160:	70a2                	ld	ra,40(sp)
ffffffffc0206162:	69a2                	ld	s3,8(sp)
ffffffffc0206164:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0206166:	85ca                	mv	a1,s2
ffffffffc0206168:	87a6                	mv	a5,s1
}
ffffffffc020616a:	6942                	ld	s2,16(sp)
ffffffffc020616c:	64e2                	ld	s1,24(sp)
ffffffffc020616e:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0206170:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0206172:	03065633          	divu	a2,a2,a6
ffffffffc0206176:	8722                	mv	a4,s0
ffffffffc0206178:	f9bff0ef          	jal	ra,ffffffffc0206112 <printnum>
ffffffffc020617c:	b7f9                	j	ffffffffc020614a <printnum+0x38>

ffffffffc020617e <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc020617e:	7119                	addi	sp,sp,-128
ffffffffc0206180:	f4a6                	sd	s1,104(sp)
ffffffffc0206182:	f0ca                	sd	s2,96(sp)
ffffffffc0206184:	ecce                	sd	s3,88(sp)
...
ffffffffc0206190:	fc86                	sd	ra,120(sp)
ffffffffc0206192:	f8a2                	sd	s0,112(sp)
ffffffffc0206194:	f862                	sd	s8,48(sp)
ffffffffc0206196:	f466                	sd	s9,40(sp)
ffffffffc0206198:	ec6e                	sd	s11,24(sp)
ffffffffc020619a:	892a                	mv	s2,a0
ffffffffc020619c:	84ae                	mv	s1,a1
ffffffffc020619e:	8d32                	mv	s10,a2
ffffffffc02061a0:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc02061a2:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc02061a6:	5b7d                	li	s6,-1
ffffffffc02061a8:	00002a97          	auipc	s5,0x2
ffffffffc02061ac:	7d4a8a93          	addi	s5,s5,2004 # ffffffffc020897c <syscalls+0x12c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc02061b0:	00003b97          	auipc	s7,0x3
ffffffffc02061b4:	9e8b8b93          	addi	s7,s7,-1560 # ffffffffc0208b98 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02061b8:	000d4503          	lbu	a0,0(s10)
ffffffffc02061bc:	001d0413          	addi	s0,s10,1
ffffffffc02061c0:	01350a63          	beq	a0,s3,ffffffffc02061d4 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc02061c4:	c121                	beqz	a0,ffffffffc0206204 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc02061c6:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02061c8:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc02061ca:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02061cc:	fff44503          	lbu	a0,-1(s0)
ffffffffc02061d0:	ff351ae3          	bne	a0,s3,ffffffffc02061c4 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02061d4:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc02061d8:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc02061dc:	4c81                	li	s9,0
ffffffffc02061de:	4881                	li	a7,0
        width = precision = -1;
ffffffffc02061e0:	5c7d                	li	s8,-1
ffffffffc02061e2:	5dfd                	li	s11,-1
ffffffffc02061e4:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc02061e8:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02061ea:	fdd6059b          	addiw	a1,a2,-35
ffffffffc02061ee:	0ff5f593          	zext.b	a1,a1
ffffffffc02061f2:	00140d13          	addi	s10,s0,1
ffffffffc02061f6:	04b56263          	bltu	a0,a1,ffffffffc020623a <vprintfmt+0xbc>
ffffffffc02061fa:	058a                	slli	a1,a1,0x2
ffffffffc02061fc:	95d6                	add	a1,a1,s5
ffffffffc02061fe:	4194                	lw	a3,0(a1)
ffffffffc0206200:	96d6                	add	a3,a3,s5
ffffffffc0206202:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0206204:	70e6                	ld	ra,120(sp)
ffffffffc0206206:	7446                	ld	s0,112(sp)
ffffffffc0206208:	74a6                	ld	s1,104(sp)
ffffffffc020620a:	7906                	ld	s2,96(sp)
ffffffffc020620c:	69e6                	ld	s3,88(sp)
ffffffffc020620e:	6a46                	ld	s4,80(sp)
ffffffffc0206210:	6aa6                	ld	s5,72(sp)
ffffffffc0206212:	6b06                	ld	s6,64(sp)
ffffffffc0206214:	7be2                	ld	s7,56(sp)
ffffffffc0206216:	7c42                	ld	s8,48(sp)
ffffffffc0206218:	7ca2                	ld	s9,40(sp)
ffffffffc020621a:	7d02                	ld	s10,32(sp)
ffffffffc020621c:	6de2                	ld	s11,24(sp)
ffffffffc020621e:	6109                	addi	sp,sp,128
ffffffffc0206220:	8082                	ret
            padc = '0';
ffffffffc0206222:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0206224:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206228:	846a                	mv	s0,s10
ffffffffc020622a:	00140d13          	addi	s10,s0,1
ffffffffc020622e:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0206232:	0ff5f593          	zext.b	a1,a1
ffffffffc0206236:	fcb572e3          	bgeu	a0,a1,ffffffffc02061fa <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc020623a:	85a6                	mv	a1,s1
ffffffffc020623c:	02500513          	li	a0,37
ffffffffc0206240:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0206242:	fff44783          	lbu	a5,-1(s0)
ffffffffc0206246:	8d22                	mv	s10,s0
ffffffffc0206248:	f73788e3          	beq	a5,s3,ffffffffc02061b8 <vprintfmt+0x3a>
ffffffffc020624c:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0206250:	1d7d                	addi	s10,s10,-1
ffffffffc0206252:	ff379de3          	bne	a5,s3,ffffffffc020624c <vprintfmt+0xce>
ffffffffc0206256:	b78d                	j	ffffffffc02061b8 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0206258:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc020625c:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206260:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0206262:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0206266:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc020626a:	02d86463          	bltu	a6,a3,ffffffffc0206292 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc020626e:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0206272:	002c169b          	slliw	a3,s8,0x2
ffffffffc0206276:	0186873b          	addw	a4,a3,s8
ffffffffc020627a:	0017171b          	slliw	a4,a4,0x1
ffffffffc020627e:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0206280:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0206284:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0206286:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc020628a:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc020628e:	fed870e3          	bgeu	a6,a3,ffffffffc020626e <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0206292:	f40ddce3          	bgez	s11,ffffffffc02061ea <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0206296:	8de2                	mv	s11,s8
ffffffffc0206298:	5c7d                	li	s8,-1
ffffffffc020629a:	bf81                	j	ffffffffc02061ea <vprintfmt+0x6c>
            if (width < 0)
ffffffffc020629c:	fffdc693          	not	a3,s11
ffffffffc02062a0:	96fd                	srai	a3,a3,0x3f
ffffffffc02062a2:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062a6:	00144603          	lbu	a2,1(s0)
ffffffffc02062aa:	2d81                	sext.w	s11,s11
ffffffffc02062ac:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02062ae:	bf35                	j	ffffffffc02061ea <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc02062b0:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062b4:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc02062b8:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062ba:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc02062bc:	bfd9                	j	ffffffffc0206292 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc02062be:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02062c0:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02062c4:	01174463          	blt	a4,a7,ffffffffc02062cc <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc02062c8:	1a088e63          	beqz	a7,ffffffffc0206484 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc02062cc:	000a3603          	ld	a2,0(s4)
ffffffffc02062d0:	46c1                	li	a3,16
ffffffffc02062d2:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc02062d4:	2781                	sext.w	a5,a5
ffffffffc02062d6:	876e                	mv	a4,s11
ffffffffc02062d8:	85a6                	mv	a1,s1
ffffffffc02062da:	854a                	mv	a0,s2
ffffffffc02062dc:	e37ff0ef          	jal	ra,ffffffffc0206112 <printnum>
            break;
ffffffffc02062e0:	bde1                	j	ffffffffc02061b8 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc02062e2:	000a2503          	lw	a0,0(s4)
ffffffffc02062e6:	85a6                	mv	a1,s1
ffffffffc02062e8:	0a21                	addi	s4,s4,8
ffffffffc02062ea:	9902                	jalr	s2
            break;
ffffffffc02062ec:	b5f1                	j	ffffffffc02061b8 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02062ee:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02062f0:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02062f4:	01174463          	blt	a4,a7,ffffffffc02062fc <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc02062f8:	18088163          	beqz	a7,ffffffffc020647a <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc02062fc:	000a3603          	ld	a2,0(s4)
ffffffffc0206300:	46a9                	li	a3,10
ffffffffc0206302:	8a2e                	mv	s4,a1
ffffffffc0206304:	bfc1                	j	ffffffffc02062d4 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206306:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc020630a:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020630c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020630e:	bdf1                	j	ffffffffc02061ea <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0206310:	85a6                	mv	a1,s1
ffffffffc0206312:	02500513          	li	a0,37
ffffffffc0206316:	9902                	jalr	s2
            break;
ffffffffc0206318:	b545                	j	ffffffffc02061b8 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020631a:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc020631e:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206320:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0206322:	b5e1                	j	ffffffffc02061ea <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0206324:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0206326:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020632a:	01174463          	blt	a4,a7,ffffffffc0206332 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc020632e:	14088163          	beqz	a7,ffffffffc0206470 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0206332:	000a3603          	ld	a2,0(s4)
ffffffffc0206336:	46a1                	li	a3,8
ffffffffc0206338:	8a2e                	mv	s4,a1
ffffffffc020633a:	bf69                	j	ffffffffc02062d4 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc020633c:	03000513          	li	a0,48
ffffffffc0206340:	85a6                	mv	a1,s1
ffffffffc0206342:	e03e                	sd	a5,0(sp)
ffffffffc0206344:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0206346:	85a6                	mv	a1,s1
ffffffffc0206348:	07800513          	li	a0,120
ffffffffc020634c:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc020634e:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0206350:	6782                	ld	a5,0(sp)
ffffffffc0206352:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0206354:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0206358:	bfb5                	j	ffffffffc02062d4 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc020635a:	000a3403          	ld	s0,0(s4)
ffffffffc020635e:	008a0713          	addi	a4,s4,8
ffffffffc0206362:	e03a                	sd	a4,0(sp)
ffffffffc0206364:	14040263          	beqz	s0,ffffffffc02064a8 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0206368:	0fb05763          	blez	s11,ffffffffc0206456 <vprintfmt+0x2d8>
ffffffffc020636c:	02d00693          	li	a3,45
ffffffffc0206370:	0cd79163          	bne	a5,a3,ffffffffc0206432 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0206374:	00044783          	lbu	a5,0(s0)
ffffffffc0206378:	0007851b          	sext.w	a0,a5
ffffffffc020637c:	cf85                	beqz	a5,ffffffffc02063b4 <vprintfmt+0x236>
ffffffffc020637e:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0206382:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0206386:	000c4563          	bltz	s8,ffffffffc0206390 <vprintfmt+0x212>
ffffffffc020638a:	3c7d                	addiw	s8,s8,-1
ffffffffc020638c:	036c0263          	beq	s8,s6,ffffffffc02063b0 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0206390:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0206392:	0e0c8e63          	beqz	s9,ffffffffc020648e <vprintfmt+0x310>
ffffffffc0206396:	3781                	addiw	a5,a5,-32
ffffffffc0206398:	0ef47b63          	bgeu	s0,a5,ffffffffc020648e <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc020639c:	03f00513          	li	a0,63
ffffffffc02063a0:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02063a2:	000a4783          	lbu	a5,0(s4)
ffffffffc02063a6:	3dfd                	addiw	s11,s11,-1
ffffffffc02063a8:	0a05                	addi	s4,s4,1
ffffffffc02063aa:	0007851b          	sext.w	a0,a5
ffffffffc02063ae:	ffe1                	bnez	a5,ffffffffc0206386 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc02063b0:	01b05963          	blez	s11,ffffffffc02063c2 <vprintfmt+0x244>
ffffffffc02063b4:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc02063b6:	85a6                	mv	a1,s1
ffffffffc02063b8:	02000513          	li	a0,32
ffffffffc02063bc:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02063be:	fe0d9be3          	bnez	s11,ffffffffc02063b4 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02063c2:	6a02                	ld	s4,0(sp)
ffffffffc02063c4:	bbd5                	j	ffffffffc02061b8 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02063c6:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02063c8:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc02063cc:	01174463          	blt	a4,a7,ffffffffc02063d4 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc02063d0:	08088d63          	beqz	a7,ffffffffc020646a <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc02063d4:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc02063d8:	0a044d63          	bltz	s0,ffffffffc0206492 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc02063dc:	8622                	mv	a2,s0
ffffffffc02063de:	8a66                	mv	s4,s9
ffffffffc02063e0:	46a9                	li	a3,10
ffffffffc02063e2:	bdcd                	j	ffffffffc02062d4 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc02063e4:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02063e8:	4761                	li	a4,24
            err = va_arg(ap, int);
ffffffffc02063ea:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc02063ec:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc02063f0:	8fb5                	xor	a5,a5,a3
ffffffffc02063f2:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02063f6:	02d74163          	blt	a4,a3,ffffffffc0206418 <vprintfmt+0x29a>
ffffffffc02063fa:	00369793          	slli	a5,a3,0x3
ffffffffc02063fe:	97de                	add	a5,a5,s7
ffffffffc0206400:	639c                	ld	a5,0(a5)
ffffffffc0206402:	cb99                	beqz	a5,ffffffffc0206418 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0206404:	86be                	mv	a3,a5
ffffffffc0206406:	00000617          	auipc	a2,0x0
ffffffffc020640a:	1ca60613          	addi	a2,a2,458 # ffffffffc02065d0 <etext+0x2a>
ffffffffc020640e:	85a6                	mv	a1,s1
ffffffffc0206410:	854a                	mv	a0,s2
ffffffffc0206412:	0ce000ef          	jal	ra,ffffffffc02064e0 <printfmt>
ffffffffc0206416:	b34d                	j	ffffffffc02061b8 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0206418:	00002617          	auipc	a2,0x2
ffffffffc020641c:	55860613          	addi	a2,a2,1368 # ffffffffc0208970 <syscalls+0x120>
ffffffffc0206420:	85a6                	mv	a1,s1
ffffffffc0206422:	854a                	mv	a0,s2
ffffffffc0206424:	0bc000ef          	jal	ra,ffffffffc02064e0 <printfmt>
ffffffffc0206428:	bb41                	j	ffffffffc02061b8 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc020642a:	00002417          	auipc	s0,0x2
ffffffffc020642e:	53e40413          	addi	s0,s0,1342 # ffffffffc0208968 <syscalls+0x118>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0206432:	85e2                	mv	a1,s8
ffffffffc0206434:	8522                	mv	a0,s0
ffffffffc0206436:	e43e                	sd	a5,8(sp)
ffffffffc0206438:	0e2000ef          	jal	ra,ffffffffc020651a <strnlen>
ffffffffc020643c:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0206440:	01b05b63          	blez	s11,ffffffffc0206456 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0206444:	67a2                	ld	a5,8(sp)
ffffffffc0206446:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020644a:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc020644c:	85a6                	mv	a1,s1
ffffffffc020644e:	8552                	mv	a0,s4
ffffffffc0206450:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0206452:	fe0d9ce3          	bnez	s11,ffffffffc020644a <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0206456:	00044783          	lbu	a5,0(s0)
ffffffffc020645a:	00140a13          	addi	s4,s0,1
ffffffffc020645e:	0007851b          	sext.w	a0,a5
ffffffffc0206462:	d3a5                	beqz	a5,ffffffffc02063c2 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0206464:	05e00413          	li	s0,94
ffffffffc0206468:	bf39                	j	ffffffffc0206386 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc020646a:	000a2403          	lw	s0,0(s4)
ffffffffc020646e:	b7ad                	j	ffffffffc02063d8 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0206470:	000a6603          	lwu	a2,0(s4)
ffffffffc0206474:	46a1                	li	a3,8
ffffffffc0206476:	8a2e                	mv	s4,a1
ffffffffc0206478:	bdb1                	j	ffffffffc02062d4 <vprintfmt+0x156>
ffffffffc020647a:	000a6603          	lwu	a2,0(s4)
ffffffffc020647e:	46a9                	li	a3,10
ffffffffc0206480:	8a2e                	mv	s4,a1
ffffffffc0206482:	bd89                	j	ffffffffc02062d4 <vprintfmt+0x156>
ffffffffc0206484:	000a6603          	lwu	a2,0(s4)
ffffffffc0206488:	46c1                	li	a3,16
ffffffffc020648a:	8a2e                	mv	s4,a1
ffffffffc020648c:	b5a1                	j	ffffffffc02062d4 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc020648e:	9902                	jalr	s2
ffffffffc0206490:	bf09                	j	ffffffffc02063a2 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0206492:	85a6                	mv	a1,s1
ffffffffc0206494:	02d00513          	li	a0,45
ffffffffc0206498:	e03e                	sd	a5,0(sp)
ffffffffc020649a:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc020649c:	6782                	ld	a5,0(sp)
ffffffffc020649e:	8a66                	mv	s4,s9
ffffffffc02064a0:	40800633          	neg	a2,s0
ffffffffc02064a4:	46a9                	li	a3,10
ffffffffc02064a6:	b53d                	j	ffffffffc02062d4 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc02064a8:	03b05163          	blez	s11,ffffffffc02064ca <vprintfmt+0x34c>
ffffffffc02064ac:	02d00693          	li	a3,45
ffffffffc02064b0:	f6d79de3          	bne	a5,a3,ffffffffc020642a <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc02064b4:	00002417          	auipc	s0,0x2
ffffffffc02064b8:	4b440413          	addi	s0,s0,1204 # ffffffffc0208968 <syscalls+0x118>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02064bc:	02800793          	li	a5,40
ffffffffc02064c0:	02800513          	li	a0,40
ffffffffc02064c4:	00140a13          	addi	s4,s0,1
ffffffffc02064c8:	bd6d                	j	ffffffffc0206382 <vprintfmt+0x204>
ffffffffc02064ca:	00002a17          	auipc	s4,0x2
ffffffffc02064ce:	49fa0a13          	addi	s4,s4,1183 # ffffffffc0208969 <syscalls+0x119>
ffffffffc02064d2:	02800513          	li	a0,40
ffffffffc02064d6:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02064da:	05e00413          	li	s0,94
ffffffffc02064de:	b565                	j	ffffffffc0206386 <vprintfmt+0x208>

ffffffffc02064e0 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02064e0:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc02064e2:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02064e6:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02064e8:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02064ea:	ec06                	sd	ra,24(sp)
ffffffffc02064ec:	f83a                	sd	a4,48(sp)
ffffffffc02064ee:	fc3e                	sd	a5,56(sp)
ffffffffc02064f0:	e0c2                	sd	a6,64(sp)
ffffffffc02064f2:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc02064f4:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02064f6:	c89ff0ef          	jal	ra,ffffffffc020617e <vprintfmt>
}
ffffffffc02064fa:	60e2                	ld	ra,24(sp)
ffffffffc02064fc:	6161                	addi	sp,sp,80
ffffffffc02064fe:	8082                	ret

ffffffffc0206500 <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0206500:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc0206504:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0206506:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0206508:	cb81                	beqz	a5,ffffffffc0206518 <strlen+0x18>
        cnt ++;
ffffffffc020650a:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc020650c:	00a707b3          	add	a5,a4,a0
ffffffffc0206510:	0007c783          	lbu	a5,0(a5)
ffffffffc0206514:	fbfd                	bnez	a5,ffffffffc020650a <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc020651a:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc020651c:	e589                	bnez	a1,ffffffffc0206526 <strnlen+0xc>
ffffffffc020651e:	a811                	j	ffffffffc0206532 <strnlen+0x18>
        cnt ++;
ffffffffc0206520:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0206522:	00f58863          	beq	a1,a5,ffffffffc0206532 <strnlen+0x18>
ffffffffc0206526:	00f50733          	add	a4,a0,a5
ffffffffc020652a:	00074703          	lbu	a4,0(a4)
ffffffffc020652e:	fb6d                	bnez	a4,ffffffffc0206520 <strnlen+0x6>
ffffffffc0206530:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0206532:	852e                	mv	a0,a1
ffffffffc0206534:	8082                	ret

ffffffffc0206536 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0206536:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0206538:	0005c703          	lbu	a4,0(a1)
ffffffffc020653c:	0785                	addi	a5,a5,1
ffffffffc020653e:	0585                	addi	a1,a1,1
ffffffffc0206540:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0206544:	fb75                	bnez	a4,ffffffffc0206538 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc020654c:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0206550:	cb89                	beqz	a5,ffffffffc0206562 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0206552:	0505                	addi	a0,a0,1
ffffffffc0206554:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0206556:	fee789e3          	beq	a5,a4,ffffffffc0206548 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc020655a:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc020655e:	9d19                	subw	a0,a0,a4
ffffffffc0206560:	8082                	ret
ffffffffc0206562:	4501                	li	a0,0
ffffffffc0206564:	bfed                	j	ffffffffc020655e <strcmp+0x16>

ffffffffc0206566 <strchr>:
...
ffffffffc020656a:	c799                	beqz	a5,ffffffffc0206578 <strchr+0x12>
        if (*s == c) {
ffffffffc020656c:	00f58763          	beq	a1,a5,ffffffffc020657a <strchr+0x14>
    while (*s != '\0') {
ffffffffc0206570:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0206574:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0206576:	fbfd                	bnez	a5,ffffffffc020656c <strchr+0x6>
    }
    return NULL;
ffffffffc0206578:	4501                	li	a0,0
}
ffffffffc020657a:	8082                	ret

ffffffffc020657c <memset>:
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc020657c:	ca01                	beqz	a2,ffffffffc020658c <memset+0x10>
ffffffffc020657e:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0206580:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0206582:	0785                	addi	a5,a5,1
ffffffffc0206584:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0206588:	fec79de3          	bne	a5,a2,ffffffffc0206582 <memset+0x6>
    }
    return s;
...
ffffffffc020658e <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc020658e:	ca19                	beqz	a2,ffffffffc02065a4 <memcpy+0x16>
ffffffffc0206590:	962e                	add	a2,a2,a1
    char *d = dst;
...
ffffffffc020659c:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02065a0:	fec59ae3          	bne	a1,a2,ffffffffc0206594 <memcpy+0x6>
    }
    return dst;
