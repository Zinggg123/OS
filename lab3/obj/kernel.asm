...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	338040ef          	jal	ra,ffffffffc0204382 <memset>

    const char *message = "(THU.CST) os is loading ...";
    cprintf("%s\n\n", message);
ffffffffc020004e:	00004597          	auipc	a1,0x4
ffffffffc0200052:	36258593          	addi	a1,a1,866 # ffffffffc02043b0 <etext+0x4>
ffffffffc0200056:	00004517          	auipc	a0,0x4
ffffffffc020005a:	37a50513          	addi	a0,a0,890 # ffffffffc02043d0 <etext+0x24>
...
ffffffffc020006e:	5e4030ef          	jal	ra,ffffffffc0203652 <vmm_init>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	623030ef          	jal	ra,ffffffffc0203ed0 <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	5ed030ef          	jal	ra,ffffffffc0203ed0 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	2d450513          	addi	a0,a0,724 # ffffffffc02043d8 <etext+0x2c>
void print_kerninfo(void) {
...
ffffffffc020011e:	2de50513          	addi	a0,a0,734 # ffffffffc02043f8 <etext+0x4c>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	28658593          	addi	a1,a1,646 # ffffffffc02043ac <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	2ea50513          	addi	a0,a0,746 # ffffffffc0204418 <etext+0x6c>
...
ffffffffc0200146:	2f650513          	addi	a0,a0,758 # ffffffffc0204438 <etext+0x8c>
...
ffffffffc020015a:	30250513          	addi	a0,a0,770 # ffffffffc0204458 <etext+0xac>
...
ffffffffc0200188:	2f450513          	addi	a0,a0,756 # ffffffffc0204478 <etext+0xcc>
}
...
ffffffffc0200196:	31660613          	addi	a2,a2,790 # ffffffffc02044a8 <etext+0xfc>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	32250513          	addi	a0,a0,802 # ffffffffc02044c0 <etext+0x114>
void print_stackframe(void) {
...
ffffffffc02001b2:	32a60613          	addi	a2,a2,810 # ffffffffc02044d8 <etext+0x12c>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	34258593          	addi	a1,a1,834 # ffffffffc02044f8 <etext+0x14c>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	34250513          	addi	a0,a0,834 # ffffffffc0204500 <etext+0x154>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	34460613          	addi	a2,a2,836 # ffffffffc0204510 <etext+0x164>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	36458593          	addi	a1,a1,868 # ffffffffc0204538 <etext+0x18c>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	32450513          	addi	a0,a0,804 # ffffffffc0204500 <etext+0x154>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	36060613          	addi	a2,a2,864 # ffffffffc0204548 <etext+0x19c>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	37858593          	addi	a1,a1,888 # ffffffffc0204568 <etext+0x1bc>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	30850513          	addi	a0,a0,776 # ffffffffc0204500 <etext+0x154>
...
ffffffffc0200236:	34650513          	addi	a0,a0,838 # ffffffffc0204578 <etext+0x1cc>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	34c50513          	addi	a0,a0,844 # ffffffffc02045a0 <etext+0x1f4>
...
ffffffffc020026e:	39ec0c13          	addi	s8,s8,926 # ffffffffc0204608 <commands>
        if ((buf = readline("")) != NULL) {
ffffffffc0200272:	00005917          	auipc	s2,0x5
ffffffffc0200276:	7a690913          	addi	s2,s2,1958 # ffffffffc0205a18 <default_pmm_manager+0x928>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020027a:	00004497          	auipc	s1,0x4
ffffffffc020027e:	34e48493          	addi	s1,s1,846 # ffffffffc02045c8 <etext+0x21c>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	34cb0b13          	addi	s6,s6,844 # ffffffffc02045d0 <etext+0x224>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	26ca0a13          	addi	s4,s4,620 # ffffffffc02044f8 <etext+0x14c>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	7bb030ef          	jal	ra,ffffffffc0204252 <readline>
...
ffffffffc02002b2:	35ad0d13          	addi	s10,s10,858 # ffffffffc0204608 <commands>
        argv[argc ++] = buf;
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	092040ef          	jal	ra,ffffffffc020434e <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	07e040ef          	jal	ra,ffffffffc020434e <strcmp>
...
ffffffffc020030e:	05e040ef          	jal	ra,ffffffffc020436c <strchr>
...
ffffffffc020034c:	020040ef          	jal	ra,ffffffffc020436c <strchr>
...
ffffffffc020036a:	28a50513          	addi	a0,a0,650 # ffffffffc02045f0 <etext+0x244>
...
ffffffffc02003a6:	2ae50513          	addi	a0,a0,686 # ffffffffc0204650 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc02003bc:	1b050513          	addi	a0,a0,432 # ffffffffc0205568 <default_pmm_manager+0x478>
...
ffffffffc02003fa:	27a50513          	addi	a0,a0,634 # ffffffffc0204670 <commands+0x68>
    ticks = 0;
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	6dd030ef          	jal	ra,ffffffffc0204394 <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	6b9030ef          	jal	ra,ffffffffc0204394 <memcpy>
    return 0;
}
...
ffffffffc0200528:	16c50513          	addi	a0,a0,364 # ffffffffc0204690 <commands+0x88>
...
ffffffffc0200546:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200548:	6e20306f          	j	ffffffffc0203c2a <do_pgfault>
    panic("unhandled page fault.\n");
ffffffffc020054c:	00004617          	auipc	a2,0x4
ffffffffc0200550:	16460613          	addi	a2,a2,356 # ffffffffc02046b0 <commands+0xa8>
ffffffffc0200554:	07800593          	li	a1,120
ffffffffc0200558:	00004517          	auipc	a0,0x4
ffffffffc020055c:	17050513          	addi	a0,a0,368 # ffffffffc02046c8 <commands+0xc0>
...
ffffffffc020058e:	15650513          	addi	a0,a0,342 # ffffffffc02046e0 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200746:	28650513          	addi	a0,a0,646 # ffffffffc02049c8 <commands+0x3c0>
}
...
ffffffffc020075a:	28a50513          	addi	a0,a0,650 # ffffffffc02049e0 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200772:	28a50513          	addi	a0,a0,650 # ffffffffc02049f8 <commands+0x3f0>
ffffffffc0200776:	945ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  epc      0x%08x\n", tf->epc);
ffffffffc020077a:	10843583          	ld	a1,264(s0)
ffffffffc020077e:	00004517          	auipc	a0,0x4
ffffffffc0200782:	29250513          	addi	a0,a0,658 # ffffffffc0204a10 <commands+0x408>
ffffffffc0200786:	935ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  badvaddr 0x%08x\n", tf->badvaddr);
ffffffffc020078a:	11043583          	ld	a1,272(s0)
ffffffffc020078e:	00004517          	auipc	a0,0x4
ffffffffc0200792:	29a50513          	addi	a0,a0,666 # ffffffffc0204a28 <commands+0x420>
...
ffffffffc02007a6:	29e50513          	addi	a0,a0,670 # ffffffffc0204a40 <commands+0x438>
}
...
ffffffffc02007c2:	34a70713          	addi	a4,a4,842 # ffffffffc0204b08 <commands+0x500>
...
ffffffffc02007d4:	2e850513          	addi	a0,a0,744 # ffffffffc0204ab8 <commands+0x4b0>
ffffffffc02007d8:	8e3ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02007dc:	00004517          	auipc	a0,0x4
ffffffffc02007e0:	2bc50513          	addi	a0,a0,700 # ffffffffc0204a98 <commands+0x490>
ffffffffc02007e4:	8d7ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02007e8:	00004517          	auipc	a0,0x4
ffffffffc02007ec:	27050513          	addi	a0,a0,624 # ffffffffc0204a58 <commands+0x450>
ffffffffc02007f0:	8cbff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02007f4:	00004517          	auipc	a0,0x4
ffffffffc02007f8:	28450513          	addi	a0,a0,644 # ffffffffc0204a78 <commands+0x470>
...
ffffffffc020082a:	2c250513          	addi	a0,a0,706 # ffffffffc0204ae8 <commands+0x4e0>
...
ffffffffc020083e:	29e50513          	addi	a0,a0,670 # ffffffffc0204ad8 <commands+0x4d0>
}
...
ffffffffc0200860:	49470713          	addi	a4,a4,1172 # ffffffffc0204cf0 <commands+0x6e8>
...
ffffffffc0200872:	46a50513          	addi	a0,a0,1130 # ffffffffc0204cd8 <commands+0x6d0>
...
ffffffffc0200894:	2a850513          	addi	a0,a0,680 # ffffffffc0204b38 <commands+0x530>
}
...
ffffffffc02008a8:	2b450513          	addi	a0,a0,692 # ffffffffc0204b58 <commands+0x550>
ffffffffc02008ac:	b7f5                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Illegal instruction\n");
ffffffffc02008ae:	00004517          	auipc	a0,0x4
ffffffffc02008b2:	2ca50513          	addi	a0,a0,714 # ffffffffc0204b78 <commands+0x570>
ffffffffc02008b6:	b7cd                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Breakpoint\n");
ffffffffc02008b8:	00004517          	auipc	a0,0x4
ffffffffc02008bc:	2d850513          	addi	a0,a0,728 # ffffffffc0204b90 <commands+0x588>
ffffffffc02008c0:	bfe1                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load address misaligned\n");
ffffffffc02008c2:	00004517          	auipc	a0,0x4
ffffffffc02008c6:	2de50513          	addi	a0,a0,734 # ffffffffc0204ba0 <commands+0x598>
ffffffffc02008ca:	b7f9                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc02008cc:	00004517          	auipc	a0,0x4
ffffffffc02008d0:	2f450513          	addi	a0,a0,756 # ffffffffc0204bc0 <commands+0x5b8>
...
ffffffffc02008ee:	2ee60613          	addi	a2,a2,750 # ffffffffc0204bd8 <commands+0x5d0>
ffffffffc02008f2:	0ca00593          	li	a1,202
ffffffffc02008f6:	00004517          	auipc	a0,0x4
ffffffffc02008fa:	dd250513          	addi	a0,a0,-558 # ffffffffc02046c8 <commands+0xc0>
ffffffffc02008fe:	a77ff0ef          	jal	ra,ffffffffc0200374 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc0200902:	00004517          	auipc	a0,0x4
ffffffffc0200906:	2f650513          	addi	a0,a0,758 # ffffffffc0204bf8 <commands+0x5f0>
ffffffffc020090a:	b779                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc020090c:	00004517          	auipc	a0,0x4
ffffffffc0200910:	30450513          	addi	a0,a0,772 # ffffffffc0204c10 <commands+0x608>
...
ffffffffc0200998:	24460613          	addi	a2,a2,580 # ffffffffc0204bd8 <commands+0x5d0>
ffffffffc020099c:	0ea00593          	li	a1,234
ffffffffc02009a0:	00004517          	auipc	a0,0x4
ffffffffc02009a4:	d2850513          	addi	a0,a0,-728 # ffffffffc02046c8 <commands+0xc0>
...
ffffffffc02009c4:	21860613          	addi	a2,a2,536 # ffffffffc0204bd8 <commands+0x5d0>
ffffffffc02009c8:	0f100593          	li	a1,241
ffffffffc02009cc:	00004517          	auipc	a0,0x4
ffffffffc02009d0:	cfc50513          	addi	a0,a0,-772 # ffffffffc02046c8 <commands+0xc0>
...
ffffffffc0200dc6:	f6e68693          	addi	a3,a3,-146 # ffffffffc0204d30 <commands+0x728>
ffffffffc0200dca:	00004617          	auipc	a2,0x4
ffffffffc0200dce:	f7660613          	addi	a2,a2,-138 # ffffffffc0204d40 <commands+0x738>
ffffffffc0200dd2:	0f000593          	li	a1,240
ffffffffc0200dd6:	00004517          	auipc	a0,0x4
ffffffffc0200dda:	f8250513          	addi	a0,a0,-126 # ffffffffc0204d58 <commands+0x750>
ffffffffc0200dde:	d96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200de2:	00004697          	auipc	a3,0x4
ffffffffc0200de6:	00e68693          	addi	a3,a3,14 # ffffffffc0204df0 <commands+0x7e8>
ffffffffc0200dea:	00004617          	auipc	a2,0x4
ffffffffc0200dee:	f5660613          	addi	a2,a2,-170 # ffffffffc0204d40 <commands+0x738>
ffffffffc0200df2:	0bd00593          	li	a1,189
ffffffffc0200df6:	00004517          	auipc	a0,0x4
ffffffffc0200dfa:	f6250513          	addi	a0,a0,-158 # ffffffffc0204d58 <commands+0x750>
ffffffffc0200dfe:	d76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200e02:	00004697          	auipc	a3,0x4
ffffffffc0200e06:	01668693          	addi	a3,a3,22 # ffffffffc0204e18 <commands+0x810>
ffffffffc0200e0a:	00004617          	auipc	a2,0x4
ffffffffc0200e0e:	f3660613          	addi	a2,a2,-202 # ffffffffc0204d40 <commands+0x738>
ffffffffc0200e12:	0be00593          	li	a1,190
ffffffffc0200e16:	00004517          	auipc	a0,0x4
ffffffffc0200e1a:	f4250513          	addi	a0,a0,-190 # ffffffffc0204d58 <commands+0x750>
ffffffffc0200e1e:	d56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200e22:	00004697          	auipc	a3,0x4
ffffffffc0200e26:	03668693          	addi	a3,a3,54 # ffffffffc0204e58 <commands+0x850>
ffffffffc0200e2a:	00004617          	auipc	a2,0x4
ffffffffc0200e2e:	f1660613          	addi	a2,a2,-234 # ffffffffc0204d40 <commands+0x738>
ffffffffc0200e32:	0c000593          	li	a1,192
ffffffffc0200e36:	00004517          	auipc	a0,0x4
ffffffffc0200e3a:	f2250513          	addi	a0,a0,-222 # ffffffffc0204d58 <commands+0x750>
ffffffffc0200e3e:	d36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200e42:	00004697          	auipc	a3,0x4
ffffffffc0200e46:	09e68693          	addi	a3,a3,158 # ffffffffc0204ee0 <commands+0x8d8>
ffffffffc0200e4a:	00004617          	auipc	a2,0x4
ffffffffc0200e4e:	ef660613          	addi	a2,a2,-266 # ffffffffc0204d40 <commands+0x738>
ffffffffc0200e52:	0d900593          	li	a1,217
ffffffffc0200e56:	00004517          	auipc	a0,0x4
ffffffffc0200e5a:	f0250513          	addi	a0,a0,-254 # ffffffffc0204d58 <commands+0x750>
ffffffffc0200e5e:	d16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200e62:	00004697          	auipc	a3,0x4
ffffffffc0200e66:	f2e68693          	addi	a3,a3,-210 # ffffffffc0204d90 <commands+0x788>
ffffffffc0200e6a:	00004617          	auipc	a2,0x4
ffffffffc0200e6e:	ed660613          	addi	a2,a2,-298 # ffffffffc0204d40 <commands+0x738>
ffffffffc0200e72:	0d200593          	li	a1,210
ffffffffc0200e76:	00004517          	auipc	a0,0x4
ffffffffc0200e7a:	ee250513          	addi	a0,a0,-286 # ffffffffc0204d58 <commands+0x750>
ffffffffc0200e7e:	cf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 3);
ffffffffc0200e82:	00004697          	auipc	a3,0x4
ffffffffc0200e86:	04e68693          	addi	a3,a3,78 # ffffffffc0204ed0 <commands+0x8c8>
ffffffffc0200e8a:	00004617          	auipc	a2,0x4
ffffffffc0200e8e:	eb660613          	addi	a2,a2,-330 # ffffffffc0204d40 <commands+0x738>
ffffffffc0200e92:	0d000593          	li	a1,208
ffffffffc0200e96:	00004517          	auipc	a0,0x4
ffffffffc0200e9a:	ec250513          	addi	a0,a0,-318 # ffffffffc0204d58 <commands+0x750>
ffffffffc0200e9e:	cd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200ea2:	00004697          	auipc	a3,0x4
ffffffffc0200ea6:	01668693          	addi	a3,a3,22 # ffffffffc0204eb8 <commands+0x8b0>
ffffffffc0200eaa:	00004617          	auipc	a2,0x4
ffffffffc0200eae:	e9660613          	addi	a2,a2,-362 # ffffffffc0204d40 <commands+0x738>
ffffffffc0200eb2:	0cb00593          	li	a1,203
ffffffffc0200eb6:	00004517          	auipc	a0,0x4
ffffffffc0200eba:	ea250513          	addi	a0,a0,-350 # ffffffffc0204d58 <commands+0x750>
ffffffffc0200ebe:	cb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200ec2:	00004697          	auipc	a3,0x4
ffffffffc0200ec6:	fd668693          	addi	a3,a3,-42 # ffffffffc0204e98 <commands+0x890>
ffffffffc0200eca:	00004617          	auipc	a2,0x4
ffffffffc0200ece:	e7660613          	addi	a2,a2,-394 # ffffffffc0204d40 <commands+0x738>
ffffffffc0200ed2:	0c200593          	li	a1,194
ffffffffc0200ed6:	00004517          	auipc	a0,0x4
ffffffffc0200eda:	e8250513          	addi	a0,a0,-382 # ffffffffc0204d58 <commands+0x750>
ffffffffc0200ede:	c96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != NULL);
ffffffffc0200ee2:	00004697          	auipc	a3,0x4
ffffffffc0200ee6:	04668693          	addi	a3,a3,70 # ffffffffc0204f28 <commands+0x920>
ffffffffc0200eea:	00004617          	auipc	a2,0x4
ffffffffc0200eee:	e5660613          	addi	a2,a2,-426 # ffffffffc0204d40 <commands+0x738>
ffffffffc0200ef2:	0f800593          	li	a1,248
ffffffffc0200ef6:	00004517          	auipc	a0,0x4
ffffffffc0200efa:	e6250513          	addi	a0,a0,-414 # ffffffffc0204d58 <commands+0x750>
ffffffffc0200efe:	c76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0200f02:	00004697          	auipc	a3,0x4
ffffffffc0200f06:	01668693          	addi	a3,a3,22 # ffffffffc0204f18 <commands+0x910>
ffffffffc0200f0a:	00004617          	auipc	a2,0x4
ffffffffc0200f0e:	e3660613          	addi	a2,a2,-458 # ffffffffc0204d40 <commands+0x738>
ffffffffc0200f12:	0df00593          	li	a1,223
ffffffffc0200f16:	00004517          	auipc	a0,0x4
ffffffffc0200f1a:	e4250513          	addi	a0,a0,-446 # ffffffffc0204d58 <commands+0x750>
ffffffffc0200f1e:	c56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f22:	00004697          	auipc	a3,0x4
ffffffffc0200f26:	f9668693          	addi	a3,a3,-106 # ffffffffc0204eb8 <commands+0x8b0>
ffffffffc0200f2a:	00004617          	auipc	a2,0x4
ffffffffc0200f2e:	e1660613          	addi	a2,a2,-490 # ffffffffc0204d40 <commands+0x738>
ffffffffc0200f32:	0dd00593          	li	a1,221
ffffffffc0200f36:	00004517          	auipc	a0,0x4
ffffffffc0200f3a:	e2250513          	addi	a0,a0,-478 # ffffffffc0204d58 <commands+0x750>
ffffffffc0200f3e:	c36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200f42:	00004697          	auipc	a3,0x4
ffffffffc0200f46:	fb668693          	addi	a3,a3,-74 # ffffffffc0204ef8 <commands+0x8f0>
ffffffffc0200f4a:	00004617          	auipc	a2,0x4
ffffffffc0200f4e:	df660613          	addi	a2,a2,-522 # ffffffffc0204d40 <commands+0x738>
ffffffffc0200f52:	0dc00593          	li	a1,220
ffffffffc0200f56:	00004517          	auipc	a0,0x4
ffffffffc0200f5a:	e0250513          	addi	a0,a0,-510 # ffffffffc0204d58 <commands+0x750>
ffffffffc0200f5e:	c16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f62:	00004697          	auipc	a3,0x4
ffffffffc0200f66:	e2e68693          	addi	a3,a3,-466 # ffffffffc0204d90 <commands+0x788>
ffffffffc0200f6a:	00004617          	auipc	a2,0x4
ffffffffc0200f6e:	dd660613          	addi	a2,a2,-554 # ffffffffc0204d40 <commands+0x738>
ffffffffc0200f72:	0b900593          	li	a1,185
ffffffffc0200f76:	00004517          	auipc	a0,0x4
ffffffffc0200f7a:	de250513          	addi	a0,a0,-542 # ffffffffc0204d58 <commands+0x750>
ffffffffc0200f7e:	bf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f82:	00004697          	auipc	a3,0x4
ffffffffc0200f86:	f3668693          	addi	a3,a3,-202 # ffffffffc0204eb8 <commands+0x8b0>
ffffffffc0200f8a:	00004617          	auipc	a2,0x4
ffffffffc0200f8e:	db660613          	addi	a2,a2,-586 # ffffffffc0204d40 <commands+0x738>
ffffffffc0200f92:	0d600593          	li	a1,214
ffffffffc0200f96:	00004517          	auipc	a0,0x4
ffffffffc0200f9a:	dc250513          	addi	a0,a0,-574 # ffffffffc0204d58 <commands+0x750>
ffffffffc0200f9e:	bd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fa2:	00004697          	auipc	a3,0x4
ffffffffc0200fa6:	e2e68693          	addi	a3,a3,-466 # ffffffffc0204dd0 <commands+0x7c8>
ffffffffc0200faa:	00004617          	auipc	a2,0x4
ffffffffc0200fae:	d9660613          	addi	a2,a2,-618 # ffffffffc0204d40 <commands+0x738>
ffffffffc0200fb2:	0d400593          	li	a1,212
ffffffffc0200fb6:	00004517          	auipc	a0,0x4
ffffffffc0200fba:	da250513          	addi	a0,a0,-606 # ffffffffc0204d58 <commands+0x750>
ffffffffc0200fbe:	bb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0200fc2:	00004697          	auipc	a3,0x4
ffffffffc0200fc6:	dee68693          	addi	a3,a3,-530 # ffffffffc0204db0 <commands+0x7a8>
ffffffffc0200fca:	00004617          	auipc	a2,0x4
ffffffffc0200fce:	d7660613          	addi	a2,a2,-650 # ffffffffc0204d40 <commands+0x738>
ffffffffc0200fd2:	0d300593          	li	a1,211
ffffffffc0200fd6:	00004517          	auipc	a0,0x4
ffffffffc0200fda:	d8250513          	addi	a0,a0,-638 # ffffffffc0204d58 <commands+0x750>
ffffffffc0200fde:	b96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fe2:	00004697          	auipc	a3,0x4
ffffffffc0200fe6:	dee68693          	addi	a3,a3,-530 # ffffffffc0204dd0 <commands+0x7c8>
ffffffffc0200fea:	00004617          	auipc	a2,0x4
ffffffffc0200fee:	d5660613          	addi	a2,a2,-682 # ffffffffc0204d40 <commands+0x738>
ffffffffc0200ff2:	0bb00593          	li	a1,187
ffffffffc0200ff6:	00004517          	auipc	a0,0x4
ffffffffc0200ffa:	d6250513          	addi	a0,a0,-670 # ffffffffc0204d58 <commands+0x750>
ffffffffc0200ffe:	b76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(count == 0);
ffffffffc0201002:	00004697          	auipc	a3,0x4
ffffffffc0201006:	07668693          	addi	a3,a3,118 # ffffffffc0205078 <commands+0xa70>
ffffffffc020100a:	00004617          	auipc	a2,0x4
ffffffffc020100e:	d3660613          	addi	a2,a2,-714 # ffffffffc0204d40 <commands+0x738>
ffffffffc0201012:	12500593          	li	a1,293
ffffffffc0201016:	00004517          	auipc	a0,0x4
ffffffffc020101a:	d4250513          	addi	a0,a0,-702 # ffffffffc0204d58 <commands+0x750>
ffffffffc020101e:	b56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0201022:	00004697          	auipc	a3,0x4
ffffffffc0201026:	ef668693          	addi	a3,a3,-266 # ffffffffc0204f18 <commands+0x910>
ffffffffc020102a:	00004617          	auipc	a2,0x4
ffffffffc020102e:	d1660613          	addi	a2,a2,-746 # ffffffffc0204d40 <commands+0x738>
ffffffffc0201032:	11a00593          	li	a1,282
ffffffffc0201036:	00004517          	auipc	a0,0x4
ffffffffc020103a:	d2250513          	addi	a0,a0,-734 # ffffffffc0204d58 <commands+0x750>
ffffffffc020103e:	b36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201042:	00004697          	auipc	a3,0x4
ffffffffc0201046:	e7668693          	addi	a3,a3,-394 # ffffffffc0204eb8 <commands+0x8b0>
ffffffffc020104a:	00004617          	auipc	a2,0x4
ffffffffc020104e:	cf660613          	addi	a2,a2,-778 # ffffffffc0204d40 <commands+0x738>
ffffffffc0201052:	11800593          	li	a1,280
ffffffffc0201056:	00004517          	auipc	a0,0x4
ffffffffc020105a:	d0250513          	addi	a0,a0,-766 # ffffffffc0204d58 <commands+0x750>
ffffffffc020105e:	b16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201062:	00004697          	auipc	a3,0x4
ffffffffc0201066:	e1668693          	addi	a3,a3,-490 # ffffffffc0204e78 <commands+0x870>
ffffffffc020106a:	00004617          	auipc	a2,0x4
ffffffffc020106e:	cd660613          	addi	a2,a2,-810 # ffffffffc0204d40 <commands+0x738>
ffffffffc0201072:	0c100593          	li	a1,193
ffffffffc0201076:	00004517          	auipc	a0,0x4
ffffffffc020107a:	ce250513          	addi	a0,a0,-798 # ffffffffc0204d58 <commands+0x750>
ffffffffc020107e:	af6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201082:	00004697          	auipc	a3,0x4
ffffffffc0201086:	fb668693          	addi	a3,a3,-74 # ffffffffc0205038 <commands+0xa30>
ffffffffc020108a:	00004617          	auipc	a2,0x4
ffffffffc020108e:	cb660613          	addi	a2,a2,-842 # ffffffffc0204d40 <commands+0x738>
ffffffffc0201092:	11200593          	li	a1,274
ffffffffc0201096:	00004517          	auipc	a0,0x4
ffffffffc020109a:	cc250513          	addi	a0,a0,-830 # ffffffffc0204d58 <commands+0x750>
ffffffffc020109e:	ad6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02010a2:	00004697          	auipc	a3,0x4
ffffffffc02010a6:	f7668693          	addi	a3,a3,-138 # ffffffffc0205018 <commands+0xa10>
ffffffffc02010aa:	00004617          	auipc	a2,0x4
ffffffffc02010ae:	c9660613          	addi	a2,a2,-874 # ffffffffc0204d40 <commands+0x738>
ffffffffc02010b2:	11000593          	li	a1,272
ffffffffc02010b6:	00004517          	auipc	a0,0x4
ffffffffc02010ba:	ca250513          	addi	a0,a0,-862 # ffffffffc0204d58 <commands+0x750>
ffffffffc02010be:	ab6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02010c2:	00004697          	auipc	a3,0x4
ffffffffc02010c6:	f2e68693          	addi	a3,a3,-210 # ffffffffc0204ff0 <commands+0x9e8>
ffffffffc02010ca:	00004617          	auipc	a2,0x4
ffffffffc02010ce:	c7660613          	addi	a2,a2,-906 # ffffffffc0204d40 <commands+0x738>
ffffffffc02010d2:	10e00593          	li	a1,270
ffffffffc02010d6:	00004517          	auipc	a0,0x4
ffffffffc02010da:	c8250513          	addi	a0,a0,-894 # ffffffffc0204d58 <commands+0x750>
ffffffffc02010de:	a96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02010e2:	00004697          	auipc	a3,0x4
ffffffffc02010e6:	ee668693          	addi	a3,a3,-282 # ffffffffc0204fc8 <commands+0x9c0>
ffffffffc02010ea:	00004617          	auipc	a2,0x4
ffffffffc02010ee:	c5660613          	addi	a2,a2,-938 # ffffffffc0204d40 <commands+0x738>
ffffffffc02010f2:	10d00593          	li	a1,269
ffffffffc02010f6:	00004517          	auipc	a0,0x4
ffffffffc02010fa:	c6250513          	addi	a0,a0,-926 # ffffffffc0204d58 <commands+0x750>
ffffffffc02010fe:	a76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201102:	00004697          	auipc	a3,0x4
ffffffffc0201106:	eb668693          	addi	a3,a3,-330 # ffffffffc0204fb8 <commands+0x9b0>
ffffffffc020110a:	00004617          	auipc	a2,0x4
ffffffffc020110e:	c3660613          	addi	a2,a2,-970 # ffffffffc0204d40 <commands+0x738>
ffffffffc0201112:	10800593          	li	a1,264
ffffffffc0201116:	00004517          	auipc	a0,0x4
ffffffffc020111a:	c4250513          	addi	a0,a0,-958 # ffffffffc0204d58 <commands+0x750>
ffffffffc020111e:	a56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201122:	00004697          	auipc	a3,0x4
ffffffffc0201126:	d9668693          	addi	a3,a3,-618 # ffffffffc0204eb8 <commands+0x8b0>
ffffffffc020112a:	00004617          	auipc	a2,0x4
ffffffffc020112e:	c1660613          	addi	a2,a2,-1002 # ffffffffc0204d40 <commands+0x738>
ffffffffc0201132:	10700593          	li	a1,263
ffffffffc0201136:	00004517          	auipc	a0,0x4
ffffffffc020113a:	c2250513          	addi	a0,a0,-990 # ffffffffc0204d58 <commands+0x750>
ffffffffc020113e:	a36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201142:	00004697          	auipc	a3,0x4
ffffffffc0201146:	e5668693          	addi	a3,a3,-426 # ffffffffc0204f98 <commands+0x990>
ffffffffc020114a:	00004617          	auipc	a2,0x4
ffffffffc020114e:	bf660613          	addi	a2,a2,-1034 # ffffffffc0204d40 <commands+0x738>
ffffffffc0201152:	10600593          	li	a1,262
ffffffffc0201156:	00004517          	auipc	a0,0x4
ffffffffc020115a:	c0250513          	addi	a0,a0,-1022 # ffffffffc0204d58 <commands+0x750>
ffffffffc020115e:	a16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201162:	00004697          	auipc	a3,0x4
ffffffffc0201166:	e0668693          	addi	a3,a3,-506 # ffffffffc0204f68 <commands+0x960>
ffffffffc020116a:	00004617          	auipc	a2,0x4
ffffffffc020116e:	bd660613          	addi	a2,a2,-1066 # ffffffffc0204d40 <commands+0x738>
ffffffffc0201172:	10500593          	li	a1,261
ffffffffc0201176:	00004517          	auipc	a0,0x4
ffffffffc020117a:	be250513          	addi	a0,a0,-1054 # ffffffffc0204d58 <commands+0x750>
ffffffffc020117e:	9f6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201182:	00004697          	auipc	a3,0x4
ffffffffc0201186:	dce68693          	addi	a3,a3,-562 # ffffffffc0204f50 <commands+0x948>
ffffffffc020118a:	00004617          	auipc	a2,0x4
ffffffffc020118e:	bb660613          	addi	a2,a2,-1098 # ffffffffc0204d40 <commands+0x738>
ffffffffc0201192:	10400593          	li	a1,260
ffffffffc0201196:	00004517          	auipc	a0,0x4
ffffffffc020119a:	bc250513          	addi	a0,a0,-1086 # ffffffffc0204d58 <commands+0x750>
ffffffffc020119e:	9d6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011a2:	00004697          	auipc	a3,0x4
ffffffffc02011a6:	d1668693          	addi	a3,a3,-746 # ffffffffc0204eb8 <commands+0x8b0>
ffffffffc02011aa:	00004617          	auipc	a2,0x4
ffffffffc02011ae:	b9660613          	addi	a2,a2,-1130 # ffffffffc0204d40 <commands+0x738>
ffffffffc02011b2:	0fe00593          	li	a1,254
ffffffffc02011b6:	00004517          	auipc	a0,0x4
ffffffffc02011ba:	ba250513          	addi	a0,a0,-1118 # ffffffffc0204d58 <commands+0x750>
ffffffffc02011be:	9b6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!PageProperty(p0));
ffffffffc02011c2:	00004697          	auipc	a3,0x4
ffffffffc02011c6:	d7668693          	addi	a3,a3,-650 # ffffffffc0204f38 <commands+0x930>
ffffffffc02011ca:	00004617          	auipc	a2,0x4
ffffffffc02011ce:	b7660613          	addi	a2,a2,-1162 # ffffffffc0204d40 <commands+0x738>
ffffffffc02011d2:	0f900593          	li	a1,249
ffffffffc02011d6:	00004517          	auipc	a0,0x4
ffffffffc02011da:	b8250513          	addi	a0,a0,-1150 # ffffffffc0204d58 <commands+0x750>
ffffffffc02011de:	996ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02011e2:	00004697          	auipc	a3,0x4
ffffffffc02011e6:	e7668693          	addi	a3,a3,-394 # ffffffffc0205058 <commands+0xa50>
ffffffffc02011ea:	00004617          	auipc	a2,0x4
ffffffffc02011ee:	b5660613          	addi	a2,a2,-1194 # ffffffffc0204d40 <commands+0x738>
ffffffffc02011f2:	11700593          	li	a1,279
ffffffffc02011f6:	00004517          	auipc	a0,0x4
ffffffffc02011fa:	b6250513          	addi	a0,a0,-1182 # ffffffffc0204d58 <commands+0x750>
ffffffffc02011fe:	976ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == 0);
ffffffffc0201202:	00004697          	auipc	a3,0x4
ffffffffc0201206:	e8668693          	addi	a3,a3,-378 # ffffffffc0205088 <commands+0xa80>
ffffffffc020120a:	00004617          	auipc	a2,0x4
ffffffffc020120e:	b3660613          	addi	a2,a2,-1226 # ffffffffc0204d40 <commands+0x738>
ffffffffc0201212:	12600593          	li	a1,294
ffffffffc0201216:	00004517          	auipc	a0,0x4
ffffffffc020121a:	b4250513          	addi	a0,a0,-1214 # ffffffffc0204d58 <commands+0x750>
ffffffffc020121e:	956ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == nr_free_pages());
ffffffffc0201222:	00004697          	auipc	a3,0x4
ffffffffc0201226:	b4e68693          	addi	a3,a3,-1202 # ffffffffc0204d70 <commands+0x768>
ffffffffc020122a:	00004617          	auipc	a2,0x4
ffffffffc020122e:	b1660613          	addi	a2,a2,-1258 # ffffffffc0204d40 <commands+0x738>
ffffffffc0201232:	0f300593          	li	a1,243
ffffffffc0201236:	00004517          	auipc	a0,0x4
ffffffffc020123a:	b2250513          	addi	a0,a0,-1246 # ffffffffc0204d58 <commands+0x750>
ffffffffc020123e:	936ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201242:	00004697          	auipc	a3,0x4
ffffffffc0201246:	b6e68693          	addi	a3,a3,-1170 # ffffffffc0204db0 <commands+0x7a8>
ffffffffc020124a:	00004617          	auipc	a2,0x4
ffffffffc020124e:	af660613          	addi	a2,a2,-1290 # ffffffffc0204d40 <commands+0x738>
ffffffffc0201252:	0ba00593          	li	a1,186
ffffffffc0201256:	00004517          	auipc	a0,0x4
ffffffffc020125a:	b0250513          	addi	a0,a0,-1278 # ffffffffc0204d58 <commands+0x750>
...
ffffffffc020139e:	d0668693          	addi	a3,a3,-762 # ffffffffc02050a0 <commands+0xa98>
ffffffffc02013a2:	00004617          	auipc	a2,0x4
ffffffffc02013a6:	99e60613          	addi	a2,a2,-1634 # ffffffffc0204d40 <commands+0x738>
ffffffffc02013aa:	08300593          	li	a1,131
ffffffffc02013ae:	00004517          	auipc	a0,0x4
ffffffffc02013b2:	9aa50513          	addi	a0,a0,-1622 # ffffffffc0204d58 <commands+0x750>
ffffffffc02013b6:	fbffe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc02013ba:	00004697          	auipc	a3,0x4
ffffffffc02013be:	cde68693          	addi	a3,a3,-802 # ffffffffc0205098 <commands+0xa90>
ffffffffc02013c2:	00004617          	auipc	a2,0x4
ffffffffc02013c6:	97e60613          	addi	a2,a2,-1666 # ffffffffc0204d40 <commands+0x738>
ffffffffc02013ca:	08000593          	li	a1,128
ffffffffc02013ce:	00004517          	auipc	a0,0x4
ffffffffc02013d2:	98a50513          	addi	a0,a0,-1654 # ffffffffc0204d58 <commands+0x750>
...
ffffffffc0201476:	c2668693          	addi	a3,a3,-986 # ffffffffc0205098 <commands+0xa90>
ffffffffc020147a:	00004617          	auipc	a2,0x4
ffffffffc020147e:	8c660613          	addi	a2,a2,-1850 # ffffffffc0204d40 <commands+0x738>
ffffffffc0201482:	06200593          	li	a1,98
ffffffffc0201486:	00004517          	auipc	a0,0x4
ffffffffc020148a:	8d250513          	addi	a0,a0,-1838 # ffffffffc0204d58 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc020154c:	b8068693          	addi	a3,a3,-1152 # ffffffffc02050c8 <commands+0xac0>
ffffffffc0201550:	00003617          	auipc	a2,0x3
ffffffffc0201554:	7f060613          	addi	a2,a2,2032 # ffffffffc0204d40 <commands+0x738>
ffffffffc0201558:	04900593          	li	a1,73
ffffffffc020155c:	00003517          	auipc	a0,0x3
ffffffffc0201560:	7fc50513          	addi	a0,a0,2044 # ffffffffc0204d58 <commands+0x750>
ffffffffc0201564:	e11fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc0201568:	00004697          	auipc	a3,0x4
ffffffffc020156c:	b3068693          	addi	a3,a3,-1232 # ffffffffc0205098 <commands+0xa90>
ffffffffc0201570:	00003617          	auipc	a2,0x3
ffffffffc0201574:	7d060613          	addi	a2,a2,2000 # ffffffffc0204d40 <commands+0x738>
ffffffffc0201578:	04600593          	li	a1,70
ffffffffc020157c:	00003517          	auipc	a0,0x3
ffffffffc0201580:	7dc50513          	addi	a0,a0,2012 # ffffffffc0204d58 <commands+0x750>
...
ffffffffc020158e:	b9e60613          	addi	a2,a2,-1122 # ffffffffc0205128 <default_pmm_manager+0x38>
ffffffffc0201592:	06500593          	li	a1,101
ffffffffc0201596:	00004517          	auipc	a0,0x4
ffffffffc020159a:	bb250513          	addi	a0,a0,-1102 # ffffffffc0205148 <default_pmm_manager+0x58>
static inline struct Page *pa2page(uintptr_t pa) {
...
ffffffffc02015aa:	bb260613          	addi	a2,a2,-1102 # ffffffffc0205158 <default_pmm_manager+0x68>
ffffffffc02015ae:	07000593          	li	a1,112
ffffffffc02015b2:	00004517          	auipc	a0,0x4
ffffffffc02015b6:	b9650513          	addi	a0,a0,-1130 # ffffffffc0205148 <default_pmm_manager+0x58>
static inline struct Page *pte2page(pte_t pte) {
...
ffffffffc0201760:	423020ef          	jal	ra,ffffffffc0204382 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201802:	381020ef          	jal	ra,ffffffffc0204382 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201862:	92260613          	addi	a2,a2,-1758 # ffffffffc0205180 <default_pmm_manager+0x90>
ffffffffc0201866:	10200593          	li	a1,258
ffffffffc020186a:	00004517          	auipc	a0,0x4
ffffffffc020186e:	93e50513          	addi	a0,a0,-1730 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc0201872:	b03fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201876:	00004617          	auipc	a2,0x4
ffffffffc020187a:	90a60613          	addi	a2,a2,-1782 # ffffffffc0205180 <default_pmm_manager+0x90>
ffffffffc020187e:	10f00593          	li	a1,271
ffffffffc0201882:	00004517          	auipc	a0,0x4
ffffffffc0201886:	92650513          	addi	a0,a0,-1754 # ffffffffc02051a8 <default_pmm_manager+0xb8>
...
ffffffffc0201894:	8f060613          	addi	a2,a2,-1808 # ffffffffc0205180 <default_pmm_manager+0x90>
ffffffffc0201898:	10b00593          	li	a1,267
ffffffffc020189c:	00004517          	auipc	a0,0x4
ffffffffc02018a0:	90c50513          	addi	a0,a0,-1780 # ffffffffc02051a8 <default_pmm_manager+0xb8>
...
ffffffffc02018ae:	8d660613          	addi	a2,a2,-1834 # ffffffffc0205180 <default_pmm_manager+0x90>
ffffffffc02018b2:	0ff00593          	li	a1,255
ffffffffc02018b6:	00004517          	auipc	a0,0x4
ffffffffc02018ba:	8f250513          	addi	a0,a0,-1806 # ffffffffc02051a8 <default_pmm_manager+0xb8>
...
ffffffffc0201aba:	63a78793          	addi	a5,a5,1594 # ffffffffc02050f0 <default_pmm_manager>
...
ffffffffc0201ac8:	6f450513          	addi	a0,a0,1780 # ffffffffc02051b8 <default_pmm_manager+0xc8>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201b24:	6b050513          	addi	a0,a0,1712 # ffffffffc02051d0 <default_pmm_manager+0xe0>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201b34:	6d050513          	addi	a0,a0,1744 # ffffffffc0205200 <default_pmm_manager+0x110>
...
ffffffffc0201b4e:	6ce50513          	addi	a0,a0,1742 # ffffffffc0205218 <default_pmm_manager+0x128>
...
ffffffffc0201bda:	69250513          	addi	a0,a0,1682 # ffffffffc0205268 <default_pmm_manager+0x178>
...
ffffffffc0201ea2:	6b250513          	addi	a0,a0,1714 # ffffffffc0205550 <default_pmm_manager+0x460>
...
ffffffffc0201f58:	73458593          	addi	a1,a1,1844 # ffffffffc0205688 <default_pmm_manager+0x598>
ffffffffc0201f5c:	10000513          	li	a0,256
ffffffffc0201f60:	3dc020ef          	jal	ra,ffffffffc020433c <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	3e2020ef          	jal	ra,ffffffffc020434e <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb94>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	360020ef          	jal	ra,ffffffffc0204306 <strlen>
...
ffffffffc020209c:	66850513          	addi	a0,a0,1640 # ffffffffc0205700 <default_pmm_manager+0x610>
}
...
ffffffffc02021a2:	41268693          	addi	a3,a3,1042 # ffffffffc02055b0 <default_pmm_manager+0x4c0>
ffffffffc02021a6:	00003617          	auipc	a2,0x3
ffffffffc02021aa:	b9a60613          	addi	a2,a2,-1126 # ffffffffc0204d40 <commands+0x738>
ffffffffc02021ae:	1ce00593          	li	a1,462
ffffffffc02021b2:	00003517          	auipc	a0,0x3
ffffffffc02021b6:	ff650513          	addi	a0,a0,-10 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc02021ba:	9bafe0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc02021be:	00003697          	auipc	a3,0x3
ffffffffc02021c2:	3b268693          	addi	a3,a3,946 # ffffffffc0205570 <default_pmm_manager+0x480>
ffffffffc02021c6:	00003617          	auipc	a2,0x3
ffffffffc02021ca:	b7a60613          	addi	a2,a2,-1158 # ffffffffc0204d40 <commands+0x738>
ffffffffc02021ce:	1cd00593          	li	a1,461
ffffffffc02021d2:	00003517          	auipc	a0,0x3
ffffffffc02021d6:	fd650513          	addi	a0,a0,-42 # ffffffffc02051a8 <default_pmm_manager+0xb8>
...
ffffffffc02021e4:	fa060613          	addi	a2,a2,-96 # ffffffffc0205180 <default_pmm_manager+0x90>
ffffffffc02021e8:	1cd00593          	li	a1,461
ffffffffc02021ec:	00003517          	auipc	a0,0x3
ffffffffc02021f0:	fbc50513          	addi	a0,a0,-68 # ffffffffc02051a8 <default_pmm_manager+0xb8>
...
ffffffffc0202200:	04460613          	addi	a2,a2,68 # ffffffffc0205240 <default_pmm_manager+0x150>
ffffffffc0202204:	07700593          	li	a1,119
ffffffffc0202208:	00003517          	auipc	a0,0x3
ffffffffc020220c:	fa050513          	addi	a0,a0,-96 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc0202210:	964fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202214:	00003617          	auipc	a2,0x3
ffffffffc0202218:	02c60613          	addi	a2,a2,44 # ffffffffc0205240 <default_pmm_manager+0x150>
ffffffffc020221c:	0bd00593          	li	a1,189
ffffffffc0202220:	00003517          	auipc	a0,0x3
ffffffffc0202224:	f8850513          	addi	a0,a0,-120 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc0202228:	94cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc020222c:	00003697          	auipc	a3,0x3
ffffffffc0202230:	07c68693          	addi	a3,a3,124 # ffffffffc02052a8 <default_pmm_manager+0x1b8>
ffffffffc0202234:	00003617          	auipc	a2,0x3
ffffffffc0202238:	b0c60613          	addi	a2,a2,-1268 # ffffffffc0204d40 <commands+0x738>
ffffffffc020223c:	19300593          	li	a1,403
ffffffffc0202240:	00003517          	auipc	a0,0x3
ffffffffc0202244:	f6850513          	addi	a0,a0,-152 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc0202248:	92cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020224c:	00003697          	auipc	a3,0x3
ffffffffc0202250:	03c68693          	addi	a3,a3,60 # ffffffffc0205288 <default_pmm_manager+0x198>
ffffffffc0202254:	00003617          	auipc	a2,0x3
ffffffffc0202258:	aec60613          	addi	a2,a2,-1300 # ffffffffc0204d40 <commands+0x738>
ffffffffc020225c:	19200593          	li	a1,402
ffffffffc0202260:	00003517          	auipc	a0,0x3
ffffffffc0202264:	f4850513          	addi	a0,a0,-184 # ffffffffc02051a8 <default_pmm_manager+0xb8>
...
ffffffffc0202274:	0c868693          	addi	a3,a3,200 # ffffffffc0205338 <default_pmm_manager+0x248>
ffffffffc0202278:	00003617          	auipc	a2,0x3
ffffffffc020227c:	ac860613          	addi	a2,a2,-1336 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202280:	19a00593          	li	a1,410
ffffffffc0202284:	00003517          	auipc	a0,0x3
ffffffffc0202288:	f2450513          	addi	a0,a0,-220 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc020228c:	8e8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202290:	00003697          	auipc	a3,0x3
ffffffffc0202294:	07868693          	addi	a3,a3,120 # ffffffffc0205308 <default_pmm_manager+0x218>
ffffffffc0202298:	00003617          	auipc	a2,0x3
ffffffffc020229c:	aa860613          	addi	a2,a2,-1368 # ffffffffc0204d40 <commands+0x738>
ffffffffc02022a0:	19800593          	li	a1,408
ffffffffc02022a4:	00003517          	auipc	a0,0x3
ffffffffc02022a8:	f0450513          	addi	a0,a0,-252 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc02022ac:	8c8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc02022b0:	00003697          	auipc	a3,0x3
ffffffffc02022b4:	03068693          	addi	a3,a3,48 # ffffffffc02052e0 <default_pmm_manager+0x1f0>
ffffffffc02022b8:	00003617          	auipc	a2,0x3
ffffffffc02022bc:	a8860613          	addi	a2,a2,-1400 # ffffffffc0204d40 <commands+0x738>
ffffffffc02022c0:	19400593          	li	a1,404
ffffffffc02022c4:	00003517          	auipc	a0,0x3
ffffffffc02022c8:	ee450513          	addi	a0,a0,-284 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc02022cc:	8a8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02022d0:	00003697          	auipc	a3,0x3
ffffffffc02022d4:	0f068693          	addi	a3,a3,240 # ffffffffc02053c0 <default_pmm_manager+0x2d0>
ffffffffc02022d8:	00003617          	auipc	a2,0x3
ffffffffc02022dc:	a6860613          	addi	a2,a2,-1432 # ffffffffc0204d40 <commands+0x738>
ffffffffc02022e0:	1a300593          	li	a1,419
ffffffffc02022e4:	00003517          	auipc	a0,0x3
ffffffffc02022e8:	ec450513          	addi	a0,a0,-316 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc02022ec:	888fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02022f0:	00003697          	auipc	a3,0x3
ffffffffc02022f4:	17068693          	addi	a3,a3,368 # ffffffffc0205460 <default_pmm_manager+0x370>
ffffffffc02022f8:	00003617          	auipc	a2,0x3
ffffffffc02022fc:	a4860613          	addi	a2,a2,-1464 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202300:	1a800593          	li	a1,424
ffffffffc0202304:	00003517          	auipc	a0,0x3
ffffffffc0202308:	ea450513          	addi	a0,a0,-348 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc020230c:	868fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202310:	00003697          	auipc	a3,0x3
ffffffffc0202314:	08868693          	addi	a3,a3,136 # ffffffffc0205398 <default_pmm_manager+0x2a8>
ffffffffc0202318:	00003617          	auipc	a2,0x3
ffffffffc020231c:	a2860613          	addi	a2,a2,-1496 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202320:	1a000593          	li	a1,416
ffffffffc0202324:	00003517          	auipc	a0,0x3
ffffffffc0202328:	e8450513          	addi	a0,a0,-380 # ffffffffc02051a8 <default_pmm_manager+0xb8>
...
ffffffffc0202336:	e4e60613          	addi	a2,a2,-434 # ffffffffc0205180 <default_pmm_manager+0x90>
ffffffffc020233a:	19f00593          	li	a1,415
ffffffffc020233e:	00003517          	auipc	a0,0x3
ffffffffc0202342:	e6a50513          	addi	a0,a0,-406 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc0202346:	82efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020234a:	00003697          	auipc	a3,0x3
ffffffffc020234e:	0ae68693          	addi	a3,a3,174 # ffffffffc02053f8 <default_pmm_manager+0x308>
ffffffffc0202352:	00003617          	auipc	a2,0x3
ffffffffc0202356:	9ee60613          	addi	a2,a2,-1554 # ffffffffc0204d40 <commands+0x738>
ffffffffc020235a:	1ad00593          	li	a1,429
ffffffffc020235e:	00003517          	auipc	a0,0x3
ffffffffc0202362:	e4a50513          	addi	a0,a0,-438 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc0202366:	80efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020236a:	00003697          	auipc	a3,0x3
ffffffffc020236e:	15668693          	addi	a3,a3,342 # ffffffffc02054c0 <default_pmm_manager+0x3d0>
ffffffffc0202372:	00003617          	auipc	a2,0x3
ffffffffc0202376:	9ce60613          	addi	a2,a2,-1586 # ffffffffc0204d40 <commands+0x738>
ffffffffc020237a:	1ac00593          	li	a1,428
ffffffffc020237e:	00003517          	auipc	a0,0x3
ffffffffc0202382:	e2a50513          	addi	a0,a0,-470 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc0202386:	feffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020238a:	00003697          	auipc	a3,0x3
ffffffffc020238e:	11e68693          	addi	a3,a3,286 # ffffffffc02054a8 <default_pmm_manager+0x3b8>
ffffffffc0202392:	00003617          	auipc	a2,0x3
ffffffffc0202396:	9ae60613          	addi	a2,a2,-1618 # ffffffffc0204d40 <commands+0x738>
ffffffffc020239a:	1ab00593          	li	a1,427
ffffffffc020239e:	00003517          	auipc	a0,0x3
ffffffffc02023a2:	e0a50513          	addi	a0,a0,-502 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc02023a6:	fcffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc02023aa:	00003697          	auipc	a3,0x3
ffffffffc02023ae:	0ce68693          	addi	a3,a3,206 # ffffffffc0205478 <default_pmm_manager+0x388>
ffffffffc02023b2:	00003617          	auipc	a2,0x3
ffffffffc02023b6:	98e60613          	addi	a2,a2,-1650 # ffffffffc0204d40 <commands+0x738>
ffffffffc02023ba:	1aa00593          	li	a1,426
ffffffffc02023be:	00003517          	auipc	a0,0x3
ffffffffc02023c2:	dea50513          	addi	a0,a0,-534 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc02023c6:	faffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc02023ca:	00003697          	auipc	a3,0x3
ffffffffc02023ce:	26668693          	addi	a3,a3,614 # ffffffffc0205630 <default_pmm_manager+0x540>
ffffffffc02023d2:	00003617          	auipc	a2,0x3
ffffffffc02023d6:	96e60613          	addi	a2,a2,-1682 # ffffffffc0204d40 <commands+0x738>
ffffffffc02023da:	1d800593          	li	a1,472
ffffffffc02023de:	00003517          	auipc	a0,0x3
ffffffffc02023e2:	dca50513          	addi	a0,a0,-566 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc02023e6:	f8ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02023ea:	00003697          	auipc	a3,0x3
ffffffffc02023ee:	05e68693          	addi	a3,a3,94 # ffffffffc0205448 <default_pmm_manager+0x358>
ffffffffc02023f2:	00003617          	auipc	a2,0x3
ffffffffc02023f6:	94e60613          	addi	a2,a2,-1714 # ffffffffc0204d40 <commands+0x738>
ffffffffc02023fa:	1a700593          	li	a1,423
ffffffffc02023fe:	00003517          	auipc	a0,0x3
ffffffffc0202402:	daa50513          	addi	a0,a0,-598 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc0202406:	f6ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_W);
ffffffffc020240a:	00003697          	auipc	a3,0x3
ffffffffc020240e:	02e68693          	addi	a3,a3,46 # ffffffffc0205438 <default_pmm_manager+0x348>
ffffffffc0202412:	00003617          	auipc	a2,0x3
ffffffffc0202416:	92e60613          	addi	a2,a2,-1746 # ffffffffc0204d40 <commands+0x738>
ffffffffc020241a:	1a600593          	li	a1,422
ffffffffc020241e:	00003517          	auipc	a0,0x3
ffffffffc0202422:	d8a50513          	addi	a0,a0,-630 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc0202426:	f4ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc020242a:	00003697          	auipc	a3,0x3
ffffffffc020242e:	10668693          	addi	a3,a3,262 # ffffffffc0205530 <default_pmm_manager+0x440>
ffffffffc0202432:	00003617          	auipc	a2,0x3
ffffffffc0202436:	90e60613          	addi	a2,a2,-1778 # ffffffffc0204d40 <commands+0x738>
ffffffffc020243a:	1e800593          	li	a1,488
ffffffffc020243e:	00003517          	auipc	a0,0x3
ffffffffc0202442:	d6a50513          	addi	a0,a0,-662 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc0202446:	f2ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020244a:	00003697          	auipc	a3,0x3
ffffffffc020244e:	fde68693          	addi	a3,a3,-34 # ffffffffc0205428 <default_pmm_manager+0x338>
ffffffffc0202452:	00003617          	auipc	a2,0x3
ffffffffc0202456:	8ee60613          	addi	a2,a2,-1810 # ffffffffc0204d40 <commands+0x738>
ffffffffc020245a:	1a500593          	li	a1,421
ffffffffc020245e:	00003517          	auipc	a0,0x3
ffffffffc0202462:	d4a50513          	addi	a0,a0,-694 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc0202466:	f0ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020246a:	00003697          	auipc	a3,0x3
ffffffffc020246e:	f1668693          	addi	a3,a3,-234 # ffffffffc0205380 <default_pmm_manager+0x290>
ffffffffc0202472:	00003617          	auipc	a2,0x3
ffffffffc0202476:	8ce60613          	addi	a2,a2,-1842 # ffffffffc0204d40 <commands+0x738>
ffffffffc020247a:	1b200593          	li	a1,434
ffffffffc020247e:	00003517          	auipc	a0,0x3
ffffffffc0202482:	d2a50513          	addi	a0,a0,-726 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc0202486:	eeffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020248a:	00003697          	auipc	a3,0x3
ffffffffc020248e:	04e68693          	addi	a3,a3,78 # ffffffffc02054d8 <default_pmm_manager+0x3e8>
ffffffffc0202492:	00003617          	auipc	a2,0x3
ffffffffc0202496:	8ae60613          	addi	a2,a2,-1874 # ffffffffc0204d40 <commands+0x738>
ffffffffc020249a:	1af00593          	li	a1,431
ffffffffc020249e:	00003517          	auipc	a0,0x3
ffffffffc02024a2:	d0a50513          	addi	a0,a0,-758 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc02024a6:	ecffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02024aa:	00003697          	auipc	a3,0x3
ffffffffc02024ae:	ebe68693          	addi	a3,a3,-322 # ffffffffc0205368 <default_pmm_manager+0x278>
ffffffffc02024b2:	00003617          	auipc	a2,0x3
ffffffffc02024b6:	88e60613          	addi	a2,a2,-1906 # ffffffffc0204d40 <commands+0x738>
ffffffffc02024ba:	1ae00593          	li	a1,430
ffffffffc02024be:	00003517          	auipc	a0,0x3
ffffffffc02024c2:	cea50513          	addi	a0,a0,-790 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc02024c6:	eaffd0ef          	jal	ra,ffffffffc0200374 <__panic>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc02024ca:	00003617          	auipc	a2,0x3
ffffffffc02024ce:	cb660613          	addi	a2,a2,-842 # ffffffffc0205180 <default_pmm_manager+0x90>
ffffffffc02024d2:	06a00593          	li	a1,106
ffffffffc02024d6:	00003517          	auipc	a0,0x3
ffffffffc02024da:	c7250513          	addi	a0,a0,-910 # ffffffffc0205148 <default_pmm_manager+0x58>
ffffffffc02024de:	e97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02024e2:	00003697          	auipc	a3,0x3
ffffffffc02024e6:	02668693          	addi	a3,a3,38 # ffffffffc0205508 <default_pmm_manager+0x418>
ffffffffc02024ea:	00003617          	auipc	a2,0x3
ffffffffc02024ee:	85660613          	addi	a2,a2,-1962 # ffffffffc0204d40 <commands+0x738>
ffffffffc02024f2:	1b900593          	li	a1,441
ffffffffc02024f6:	00003517          	auipc	a0,0x3
ffffffffc02024fa:	cb250513          	addi	a0,a0,-846 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc02024fe:	e77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202502:	00003697          	auipc	a3,0x3
ffffffffc0202506:	fbe68693          	addi	a3,a3,-66 # ffffffffc02054c0 <default_pmm_manager+0x3d0>
ffffffffc020250a:	00003617          	auipc	a2,0x3
ffffffffc020250e:	83660613          	addi	a2,a2,-1994 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202512:	1b700593          	li	a1,439
ffffffffc0202516:	00003517          	auipc	a0,0x3
ffffffffc020251a:	c9250513          	addi	a0,a0,-878 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc020251e:	e57fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202522:	00003697          	auipc	a3,0x3
ffffffffc0202526:	fce68693          	addi	a3,a3,-50 # ffffffffc02054f0 <default_pmm_manager+0x400>
ffffffffc020252a:	00003617          	auipc	a2,0x3
ffffffffc020252e:	81660613          	addi	a2,a2,-2026 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202532:	1b600593          	li	a1,438
ffffffffc0202536:	00003517          	auipc	a0,0x3
ffffffffc020253a:	c7250513          	addi	a0,a0,-910 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc020253e:	e37fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202542:	00003697          	auipc	a3,0x3
ffffffffc0202546:	f7e68693          	addi	a3,a3,-130 # ffffffffc02054c0 <default_pmm_manager+0x3d0>
ffffffffc020254a:	00002617          	auipc	a2,0x2
ffffffffc020254e:	7f660613          	addi	a2,a2,2038 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202552:	1b300593          	li	a1,435
ffffffffc0202556:	00003517          	auipc	a0,0x3
ffffffffc020255a:	c5250513          	addi	a0,a0,-942 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc020255e:	e17fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202562:	00003697          	auipc	a3,0x3
ffffffffc0202566:	0b668693          	addi	a3,a3,182 # ffffffffc0205618 <default_pmm_manager+0x528>
ffffffffc020256a:	00002617          	auipc	a2,0x2
ffffffffc020256e:	7d660613          	addi	a2,a2,2006 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202572:	1d700593          	li	a1,471
ffffffffc0202576:	00003517          	auipc	a0,0x3
ffffffffc020257a:	c3250513          	addi	a0,a0,-974 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc020257e:	df7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202582:	00003697          	auipc	a3,0x3
ffffffffc0202586:	05e68693          	addi	a3,a3,94 # ffffffffc02055e0 <default_pmm_manager+0x4f0>
ffffffffc020258a:	00002617          	auipc	a2,0x2
ffffffffc020258e:	7b660613          	addi	a2,a2,1974 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202592:	1d600593          	li	a1,470
ffffffffc0202596:	00003517          	auipc	a0,0x3
ffffffffc020259a:	c1250513          	addi	a0,a0,-1006 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc020259e:	dd7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc02025a2:	00003697          	auipc	a3,0x3
ffffffffc02025a6:	02668693          	addi	a3,a3,38 # ffffffffc02055c8 <default_pmm_manager+0x4d8>
ffffffffc02025aa:	00002617          	auipc	a2,0x2
ffffffffc02025ae:	79660613          	addi	a2,a2,1942 # ffffffffc0204d40 <commands+0x738>
ffffffffc02025b2:	1d200593          	li	a1,466
ffffffffc02025b6:	00003517          	auipc	a0,0x3
ffffffffc02025ba:	bf250513          	addi	a0,a0,-1038 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc02025be:	db7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02025c2:	00003697          	auipc	a3,0x3
ffffffffc02025c6:	f6e68693          	addi	a3,a3,-146 # ffffffffc0205530 <default_pmm_manager+0x440>
ffffffffc02025ca:	00002617          	auipc	a2,0x2
ffffffffc02025ce:	77660613          	addi	a2,a2,1910 # ffffffffc0204d40 <commands+0x738>
ffffffffc02025d2:	1c000593          	li	a1,448
ffffffffc02025d6:	00003517          	auipc	a0,0x3
ffffffffc02025da:	bd250513          	addi	a0,a0,-1070 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc02025de:	d97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02025e2:	00003697          	auipc	a3,0x3
ffffffffc02025e6:	d8668693          	addi	a3,a3,-634 # ffffffffc0205368 <default_pmm_manager+0x278>
ffffffffc02025ea:	00002617          	auipc	a2,0x2
ffffffffc02025ee:	75660613          	addi	a2,a2,1878 # ffffffffc0204d40 <commands+0x738>
ffffffffc02025f2:	19b00593          	li	a1,411
ffffffffc02025f6:	00003517          	auipc	a0,0x3
ffffffffc02025fa:	bb250513          	addi	a0,a0,-1102 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc02025fe:	d77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc0202602:	00003617          	auipc	a2,0x3
ffffffffc0202606:	b7e60613          	addi	a2,a2,-1154 # ffffffffc0205180 <default_pmm_manager+0x90>
ffffffffc020260a:	19e00593          	li	a1,414
ffffffffc020260e:	00003517          	auipc	a0,0x3
ffffffffc0202612:	b9a50513          	addi	a0,a0,-1126 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc0202616:	d5ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020261a:	00003697          	auipc	a3,0x3
ffffffffc020261e:	d6668693          	addi	a3,a3,-666 # ffffffffc0205380 <default_pmm_manager+0x290>
ffffffffc0202622:	00002617          	auipc	a2,0x2
ffffffffc0202626:	71e60613          	addi	a2,a2,1822 # ffffffffc0204d40 <commands+0x738>
ffffffffc020262a:	19c00593          	li	a1,412
ffffffffc020262e:	00003517          	auipc	a0,0x3
ffffffffc0202632:	b7a50513          	addi	a0,a0,-1158 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc0202636:	d3ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020263a:	00003697          	auipc	a3,0x3
ffffffffc020263e:	dbe68693          	addi	a3,a3,-578 # ffffffffc02053f8 <default_pmm_manager+0x308>
ffffffffc0202642:	00002617          	auipc	a2,0x2
ffffffffc0202646:	6fe60613          	addi	a2,a2,1790 # ffffffffc0204d40 <commands+0x738>
ffffffffc020264a:	1a400593          	li	a1,420
ffffffffc020264e:	00003517          	auipc	a0,0x3
ffffffffc0202652:	b5a50513          	addi	a0,a0,-1190 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc0202656:	d1ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020265a:	00003697          	auipc	a3,0x3
ffffffffc020265e:	07e68693          	addi	a3,a3,126 # ffffffffc02056d8 <default_pmm_manager+0x5e8>
ffffffffc0202662:	00002617          	auipc	a2,0x2
ffffffffc0202666:	6de60613          	addi	a2,a2,1758 # ffffffffc0204d40 <commands+0x738>
ffffffffc020266a:	1e000593          	li	a1,480
ffffffffc020266e:	00003517          	auipc	a0,0x3
ffffffffc0202672:	b3a50513          	addi	a0,a0,-1222 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc0202676:	cfffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020267a:	00003697          	auipc	a3,0x3
ffffffffc020267e:	02668693          	addi	a3,a3,38 # ffffffffc02056a0 <default_pmm_manager+0x5b0>
ffffffffc0202682:	00002617          	auipc	a2,0x2
ffffffffc0202686:	6be60613          	addi	a2,a2,1726 # ffffffffc0204d40 <commands+0x738>
ffffffffc020268a:	1dd00593          	li	a1,477
ffffffffc020268e:	00003517          	auipc	a0,0x3
ffffffffc0202692:	b1a50513          	addi	a0,a0,-1254 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc0202696:	cdffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 2);
ffffffffc020269a:	00003697          	auipc	a3,0x3
ffffffffc020269e:	fd668693          	addi	a3,a3,-42 # ffffffffc0205670 <default_pmm_manager+0x580>
ffffffffc02026a2:	00002617          	auipc	a2,0x2
ffffffffc02026a6:	69e60613          	addi	a2,a2,1694 # ffffffffc0204d40 <commands+0x738>
ffffffffc02026aa:	1d900593          	li	a1,473
ffffffffc02026ae:	00003517          	auipc	a0,0x3
ffffffffc02026b2:	afa50513          	addi	a0,a0,-1286 # ffffffffc02051a8 <default_pmm_manager+0xb8>
...
ffffffffc0202724:	00068693          	mv	a3,a3
ffffffffc0202728:	00002617          	auipc	a2,0x2
ffffffffc020272c:	61860613          	addi	a2,a2,1560 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202730:	17a00593          	li	a1,378
ffffffffc0202734:	00003517          	auipc	a0,0x3
ffffffffc0202738:	a7450513          	addi	a0,a0,-1420 # ffffffffc02051a8 <default_pmm_manager+0xb8>
...
ffffffffc02027dc:	f6068693          	addi	a3,a3,-160 # ffffffffc0205738 <default_pmm_manager+0x648>
ffffffffc02027e0:	00002617          	auipc	a2,0x2
ffffffffc02027e4:	56060613          	addi	a2,a2,1376 # ffffffffc0204d40 <commands+0x738>
ffffffffc02027e8:	1f000593          	li	a1,496
ffffffffc02027ec:	00003517          	auipc	a0,0x3
ffffffffc02027f0:	9bc50513          	addi	a0,a0,-1604 # ffffffffc02051a8 <default_pmm_manager+0xb8>
...
ffffffffc02027fe:	98660613          	addi	a2,a2,-1658 # ffffffffc0205180 <default_pmm_manager+0x90>
ffffffffc0202802:	06a00593          	li	a1,106
ffffffffc0202806:	00003517          	auipc	a0,0x3
ffffffffc020280a:	94250513          	addi	a0,a0,-1726 # ffffffffc0205148 <default_pmm_manager+0x58>
ffffffffc020280e:	b67fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(base != NULL);
ffffffffc0202812:	00003697          	auipc	a3,0x3
ffffffffc0202816:	f4668693          	addi	a3,a3,-186 # ffffffffc0205758 <default_pmm_manager+0x668>
ffffffffc020281a:	00002617          	auipc	a2,0x2
ffffffffc020281e:	52660613          	addi	a2,a2,1318 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202822:	1f300593          	li	a1,499
ffffffffc0202826:	00003517          	auipc	a0,0x3
ffffffffc020282a:	98250513          	addi	a0,a0,-1662 # ffffffffc02051a8 <default_pmm_manager+0xb8>
...
ffffffffc02028c6:	97e60613          	addi	a2,a2,-1666 # ffffffffc0205240 <default_pmm_manager+0x150>
ffffffffc02028ca:	06c00593          	li	a1,108
ffffffffc02028ce:	00003517          	auipc	a0,0x3
ffffffffc02028d2:	87a50513          	addi	a0,a0,-1926 # ffffffffc0205148 <default_pmm_manager+0x58>
ffffffffc02028d6:	a9ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(ptr != NULL);
ffffffffc02028da:	00003697          	auipc	a3,0x3
ffffffffc02028de:	e8e68693          	addi	a3,a3,-370 # ffffffffc0205768 <default_pmm_manager+0x678>
ffffffffc02028e2:	00002617          	auipc	a2,0x2
ffffffffc02028e6:	45e60613          	addi	a2,a2,1118 # ffffffffc0204d40 <commands+0x738>
ffffffffc02028ea:	1fa00593          	li	a1,506
ffffffffc02028ee:	00003517          	auipc	a0,0x3
ffffffffc02028f2:	8ba50513          	addi	a0,a0,-1862 # ffffffffc02051a8 <default_pmm_manager+0xb8>
ffffffffc02028f6:	a7ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0 && n < 1024 * 0124);
ffffffffc02028fa:	00003697          	auipc	a3,0x3
ffffffffc02028fe:	e3e68693          	addi	a3,a3,-450 # ffffffffc0205738 <default_pmm_manager+0x648>
ffffffffc0202902:	00002617          	auipc	a2,0x2
ffffffffc0202906:	43e60613          	addi	a2,a2,1086 # ffffffffc0204d40 <commands+0x738>
ffffffffc020290a:	1f900593          	li	a1,505
ffffffffc020290e:	00003517          	auipc	a0,0x3
ffffffffc0202912:	89a50513          	addi	a0,a0,-1894 # ffffffffc02051a8 <default_pmm_manager+0xb8>
...
ffffffffc0202934:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202936:	3c2010ef          	jal	ra,ffffffffc0203cf8 <swapfs_init>
...
ffffffffc0202994:	e1850513          	addi	a0,a0,-488 # ffffffffc02057a8 <default_pmm_manager+0x6b8>
    return listelm->next;
...
ffffffffc02029e4:	de050513          	addi	a0,a0,-544 # ffffffffc02057c0 <default_pmm_manager+0x6d0>
ffffffffc02029e8:	ed2fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     
     //now we set the phy pages env     
     struct mm_struct *mm = mm_create();
ffffffffc02029ec:	2ab000ef          	jal	ra,ffffffffc0203496 <mm_create>
...
ffffffffc0202a20:	2bf000ef          	jal	ra,ffffffffc02034de <vma_create>
...
ffffffffc0202a2c:	321000ef          	jal	ra,ffffffffc020354c <insert_vma_struct>

     //setup the temp Page Table vaddr 0~4MB
     cprintf("setup Page Table for vaddr 0X1000, so alloc a page\n");
ffffffffc0202a30:	00003517          	auipc	a0,0x3
ffffffffc0202a34:	e0050513          	addi	a0,a0,-512 # ffffffffc0205830 <default_pmm_manager+0x740>
...
ffffffffc0202a50:	e3450513          	addi	a0,a0,-460 # ffffffffc0205880 <default_pmm_manager+0x790>
...
ffffffffc0202ac4:	e4850513          	addi	a0,a0,-440 # ffffffffc0205908 <default_pmm_manager+0x818>
...
ffffffffc0202c10:	da450513          	addi	a0,a0,-604 # ffffffffc02059b0 <default_pmm_manager+0x8c0>
...
ffffffffc0202c36:	1e7000ef          	jal	ra,ffffffffc020361c <mm_destroy>
...
ffffffffc0202c62:	d8250513          	addi	a0,a0,-638 # ffffffffc02059e0 <default_pmm_manager+0x8f0>
ffffffffc0202c66:	c54fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     //assert(count == 0);
     
     cprintf("check_swap() succeeded!\n");
ffffffffc0202c6a:	00003517          	auipc	a0,0x3
ffffffffc0202c6e:	d9650513          	addi	a0,a0,-618 # ffffffffc0205a00 <default_pmm_manager+0x910>
...
ffffffffc0202c80:	0b468693          	addi	a3,a3,180 # ffffffffc0204d30 <commands+0x728>
ffffffffc0202c84:	00002617          	auipc	a2,0x2
ffffffffc0202c88:	0bc60613          	addi	a2,a2,188 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202c8c:	0ba00593          	li	a1,186
ffffffffc0202c90:	00003517          	auipc	a0,0x3
ffffffffc0202c94:	b0850513          	addi	a0,a0,-1272 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202c98:	edcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202c9c:	00003697          	auipc	a3,0x3
ffffffffc0202ca0:	cec68693          	addi	a3,a3,-788 # ffffffffc0205988 <default_pmm_manager+0x898>
ffffffffc0202ca4:	00002617          	auipc	a2,0x2
ffffffffc0202ca8:	09c60613          	addi	a2,a2,156 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202cac:	0fa00593          	li	a1,250
ffffffffc0202cb0:	00003517          	auipc	a0,0x3
ffffffffc0202cb4:	ae850513          	addi	a0,a0,-1304 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202cb8:	ebcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202cbc:	00002617          	auipc	a2,0x2
ffffffffc0202cc0:	49c60613          	addi	a2,a2,1180 # ffffffffc0205158 <default_pmm_manager+0x68>
ffffffffc0202cc4:	07000593          	li	a1,112
ffffffffc0202cc8:	00002517          	auipc	a0,0x2
ffffffffc0202ccc:	48050513          	addi	a0,a0,1152 # ffffffffc0205148 <default_pmm_manager+0x58>
ffffffffc0202cd0:	ea4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202cd4:	00002617          	auipc	a2,0x2
ffffffffc0202cd8:	45460613          	addi	a2,a2,1108 # ffffffffc0205128 <default_pmm_manager+0x38>
ffffffffc0202cdc:	06500593          	li	a1,101
ffffffffc0202ce0:	00002517          	auipc	a0,0x2
ffffffffc0202ce4:	46850513          	addi	a0,a0,1128 # ffffffffc0205148 <default_pmm_manager+0x58>
ffffffffc0202ce8:	e8cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202cec:	00003697          	auipc	a3,0x3
ffffffffc0202cf0:	bd468693          	addi	a3,a3,-1068 # ffffffffc02058c0 <default_pmm_manager+0x7d0>
ffffffffc0202cf4:	00002617          	auipc	a2,0x2
ffffffffc0202cf8:	04c60613          	addi	a2,a2,76 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202cfc:	0db00593          	li	a1,219
ffffffffc0202d00:	00003517          	auipc	a0,0x3
ffffffffc0202d04:	a9850513          	addi	a0,a0,-1384 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202d08:	e6cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202d0c:	00003697          	auipc	a3,0x3
ffffffffc0202d10:	b9c68693          	addi	a3,a3,-1124 # ffffffffc02058a8 <default_pmm_manager+0x7b8>
ffffffffc0202d14:	00002617          	auipc	a2,0x2
ffffffffc0202d18:	02c60613          	addi	a2,a2,44 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202d1c:	0da00593          	li	a1,218
ffffffffc0202d20:	00003517          	auipc	a0,0x3
ffffffffc0202d24:	a7850513          	addi	a0,a0,-1416 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202d28:	e4cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202d2c:	00003617          	auipc	a2,0x3
ffffffffc0202d30:	a4c60613          	addi	a2,a2,-1460 # ffffffffc0205778 <default_pmm_manager+0x688>
ffffffffc0202d34:	02700593          	li	a1,39
ffffffffc0202d38:	00003517          	auipc	a0,0x3
ffffffffc0202d3c:	a6050513          	addi	a0,a0,-1440 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202d40:	e34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202d44:	00003697          	auipc	a3,0x3
ffffffffc0202d48:	c2c68693          	addi	a3,a3,-980 # ffffffffc0205970 <default_pmm_manager+0x880>
ffffffffc0202d4c:	00002617          	auipc	a2,0x2
ffffffffc0202d50:	ff460613          	addi	a2,a2,-12 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202d54:	0f900593          	li	a1,249
ffffffffc0202d58:	00003517          	auipc	a0,0x3
ffffffffc0202d5c:	a4050513          	addi	a0,a0,-1472 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202d60:	e14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d64:	00003697          	auipc	a3,0x3
ffffffffc0202d68:	bfc68693          	addi	a3,a3,-1028 # ffffffffc0205960 <default_pmm_manager+0x870>
ffffffffc0202d6c:	00002617          	auipc	a2,0x2
ffffffffc0202d70:	fd460613          	addi	a2,a2,-44 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202d74:	09d00593          	li	a1,157
ffffffffc0202d78:	00003517          	auipc	a0,0x3
ffffffffc0202d7c:	a2050513          	addi	a0,a0,-1504 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202d80:	df4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d84:	00003697          	auipc	a3,0x3
ffffffffc0202d88:	bdc68693          	addi	a3,a3,-1060 # ffffffffc0205960 <default_pmm_manager+0x870>
ffffffffc0202d8c:	00002617          	auipc	a2,0x2
ffffffffc0202d90:	fb460613          	addi	a2,a2,-76 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202d94:	09f00593          	li	a1,159
ffffffffc0202d98:	00003517          	auipc	a0,0x3
ffffffffc0202d9c:	a0050513          	addi	a0,a0,-1536 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202da0:	dd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert( nr_free == 0);         
ffffffffc0202da4:	00002697          	auipc	a3,0x2
ffffffffc0202da8:	17468693          	addi	a3,a3,372 # ffffffffc0204f18 <commands+0x910>
ffffffffc0202dac:	00002617          	auipc	a2,0x2
ffffffffc0202db0:	f9460613          	addi	a2,a2,-108 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202db4:	0f100593          	li	a1,241
ffffffffc0202db8:	00003517          	auipc	a0,0x3
ffffffffc0202dbc:	9e050513          	addi	a0,a0,-1568 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202dc0:	db4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(ret==0);
ffffffffc0202dc4:	00003697          	auipc	a3,0x3
ffffffffc0202dc8:	c1468693          	addi	a3,a3,-1004 # ffffffffc02059d8 <default_pmm_manager+0x8e8>
ffffffffc0202dcc:	00002617          	auipc	a2,0x2
ffffffffc0202dd0:	f7460613          	addi	a2,a2,-140 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202dd4:	10000593          	li	a1,256
ffffffffc0202dd8:	00003517          	auipc	a0,0x3
ffffffffc0202ddc:	9c050513          	addi	a0,a0,-1600 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202de0:	d94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0202de4:	00003697          	auipc	a3,0x3
ffffffffc0202de8:	a2c68693          	addi	a3,a3,-1492 # ffffffffc0205810 <default_pmm_manager+0x720>
ffffffffc0202dec:	00002617          	auipc	a2,0x2
ffffffffc0202df0:	f5460613          	addi	a2,a2,-172 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202df4:	0ca00593          	li	a1,202
ffffffffc0202df8:	00003517          	auipc	a0,0x3
ffffffffc0202dfc:	9a050513          	addi	a0,a0,-1632 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202e00:	d74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(vma != NULL);
ffffffffc0202e04:	00003697          	auipc	a3,0x3
ffffffffc0202e08:	a1c68693          	addi	a3,a3,-1508 # ffffffffc0205820 <default_pmm_manager+0x730>
ffffffffc0202e0c:	00002617          	auipc	a2,0x2
ffffffffc0202e10:	f3460613          	addi	a2,a2,-204 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202e14:	0cd00593          	li	a1,205
ffffffffc0202e18:	00003517          	auipc	a0,0x3
ffffffffc0202e1c:	98050513          	addi	a0,a0,-1664 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202e20:	d54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0202e24:	00003697          	auipc	a3,0x3
ffffffffc0202e28:	a4468693          	addi	a3,a3,-1468 # ffffffffc0205868 <default_pmm_manager+0x778>
ffffffffc0202e2c:	00002617          	auipc	a2,0x2
ffffffffc0202e30:	f1460613          	addi	a2,a2,-236 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202e34:	0d500593          	li	a1,213
ffffffffc0202e38:	00003517          	auipc	a0,0x3
ffffffffc0202e3c:	96050513          	addi	a0,a0,-1696 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202e40:	d34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(total == nr_free_pages());
ffffffffc0202e44:	00002697          	auipc	a3,0x2
ffffffffc0202e48:	f2c68693          	addi	a3,a3,-212 # ffffffffc0204d70 <commands+0x768>
ffffffffc0202e4c:	00002617          	auipc	a2,0x2
ffffffffc0202e50:	ef460613          	addi	a2,a2,-268 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202e54:	0bd00593          	li	a1,189
ffffffffc0202e58:	00003517          	auipc	a0,0x3
ffffffffc0202e5c:	94050513          	addi	a0,a0,-1728 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202e60:	d14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e64:	00003697          	auipc	a3,0x3
ffffffffc0202e68:	adc68693          	addi	a3,a3,-1316 # ffffffffc0205940 <default_pmm_manager+0x850>
ffffffffc0202e6c:	00002617          	auipc	a2,0x2
ffffffffc0202e70:	ed460613          	addi	a2,a2,-300 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202e74:	09500593          	li	a1,149
ffffffffc0202e78:	00003517          	auipc	a0,0x3
ffffffffc0202e7c:	92050513          	addi	a0,a0,-1760 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202e80:	cf4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e84:	00003697          	auipc	a3,0x3
ffffffffc0202e88:	abc68693          	addi	a3,a3,-1348 # ffffffffc0205940 <default_pmm_manager+0x850>
ffffffffc0202e8c:	00002617          	auipc	a2,0x2
ffffffffc0202e90:	eb460613          	addi	a2,a2,-332 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202e94:	09700593          	li	a1,151
ffffffffc0202e98:	00003517          	auipc	a0,0x3
ffffffffc0202e9c:	90050513          	addi	a0,a0,-1792 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202ea0:	cd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ea4:	00003697          	auipc	a3,0x3
ffffffffc0202ea8:	aac68693          	addi	a3,a3,-1364 # ffffffffc0205950 <default_pmm_manager+0x860>
ffffffffc0202eac:	00002617          	auipc	a2,0x2
ffffffffc0202eb0:	e9460613          	addi	a2,a2,-364 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202eb4:	09900593          	li	a1,153
ffffffffc0202eb8:	00003517          	auipc	a0,0x3
ffffffffc0202ebc:	8e050513          	addi	a0,a0,-1824 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202ec0:	cb4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ec4:	00003697          	auipc	a3,0x3
ffffffffc0202ec8:	a8c68693          	addi	a3,a3,-1396 # ffffffffc0205950 <default_pmm_manager+0x860>
ffffffffc0202ecc:	00002617          	auipc	a2,0x2
ffffffffc0202ed0:	e7460613          	addi	a2,a2,-396 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202ed4:	09b00593          	li	a1,155
ffffffffc0202ed8:	00003517          	auipc	a0,0x3
ffffffffc0202edc:	8c050513          	addi	a0,a0,-1856 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202ee0:	c94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202ee4:	00003697          	auipc	a3,0x3
ffffffffc0202ee8:	a4c68693          	addi	a3,a3,-1460 # ffffffffc0205930 <default_pmm_manager+0x840>
ffffffffc0202eec:	00002617          	auipc	a2,0x2
ffffffffc0202ef0:	e5460613          	addi	a2,a2,-428 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202ef4:	09100593          	li	a1,145
ffffffffc0202ef8:	00003517          	auipc	a0,0x3
ffffffffc0202efc:	8a050513          	addi	a0,a0,-1888 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202f00:	c74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202f04:	00003697          	auipc	a3,0x3
ffffffffc0202f08:	a2c68693          	addi	a3,a3,-1492 # ffffffffc0205930 <default_pmm_manager+0x840>
ffffffffc0202f0c:	00002617          	auipc	a2,0x2
ffffffffc0202f10:	e3460613          	addi	a2,a2,-460 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202f14:	09300593          	li	a1,147
ffffffffc0202f18:	00003517          	auipc	a0,0x3
ffffffffc0202f1c:	88050513          	addi	a0,a0,-1920 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202f20:	c54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(mm != NULL);
ffffffffc0202f24:	00003697          	auipc	a3,0x3
ffffffffc0202f28:	8c468693          	addi	a3,a3,-1852 # ffffffffc02057e8 <default_pmm_manager+0x6f8>
ffffffffc0202f2c:	00002617          	auipc	a2,0x2
ffffffffc0202f30:	e1460613          	addi	a2,a2,-492 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202f34:	0c200593          	li	a1,194
ffffffffc0202f38:	00003517          	auipc	a0,0x3
ffffffffc0202f3c:	86050513          	addi	a0,a0,-1952 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202f40:	c34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0202f44:	00003697          	auipc	a3,0x3
ffffffffc0202f48:	8b468693          	addi	a3,a3,-1868 # ffffffffc02057f8 <default_pmm_manager+0x708>
ffffffffc0202f4c:	00002617          	auipc	a2,0x2
ffffffffc0202f50:	df460613          	addi	a2,a2,-524 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202f54:	0c500593          	li	a1,197
ffffffffc0202f58:	00003517          	auipc	a0,0x3
ffffffffc0202f5c:	84050513          	addi	a0,a0,-1984 # ffffffffc0205798 <default_pmm_manager+0x6a8>
ffffffffc0202f60:	c14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0202f64:	00003697          	auipc	a3,0x3
ffffffffc0202f68:	97c68693          	addi	a3,a3,-1668 # ffffffffc02058e0 <default_pmm_manager+0x7f0>
ffffffffc0202f6c:	00002617          	auipc	a2,0x2
ffffffffc0202f70:	dd460613          	addi	a2,a2,-556 # ffffffffc0204d40 <commands+0x738>
ffffffffc0202f74:	0e800593          	li	a1,232
ffffffffc0202f78:	00003517          	auipc	a0,0x3
ffffffffc0202f7c:	82050513          	addi	a0,a0,-2016 # ffffffffc0205798 <default_pmm_manager+0x6a8>
...
ffffffffc0202fc8:	abcb0b13          	addi	s6,s6,-1348 # ffffffffc0205a80 <default_pmm_manager+0x990>
                    cprintf("SWAP: failed to save\n");
ffffffffc0202fcc:	00003b97          	auipc	s7,0x3
ffffffffc0202fd0:	a9cb8b93          	addi	s7,s7,-1380 # ffffffffc0205a68 <default_pmm_manager+0x978>
...
ffffffffc0203040:	58b000ef          	jal	ra,ffffffffc0203dca <swapfs_write>
...
ffffffffc0203082:	9a250513          	addi	a0,a0,-1630 # ffffffffc0205a20 <default_pmm_manager+0x930>
...
ffffffffc0203094:	9c068693          	addi	a3,a3,-1600 # ffffffffc0205a50 <default_pmm_manager+0x960>
ffffffffc0203098:	00002617          	auipc	a2,0x2
ffffffffc020309c:	ca860613          	addi	a2,a2,-856 # ffffffffc0204d40 <commands+0x738>
ffffffffc02030a0:	06600593          	li	a1,102
ffffffffc02030a4:	00002517          	auipc	a0,0x2
ffffffffc02030a8:	6f450513          	addi	a0,a0,1780 # ffffffffc0205798 <default_pmm_manager+0x6a8>
...
ffffffffc02030de:	453000ef          	jal	ra,ffffffffc0203d30 <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc02030e2:	00093583          	ld	a1,0(s2)
ffffffffc02030e6:	8626                	mv	a2,s1
ffffffffc02030e8:	00003517          	auipc	a0,0x3
ffffffffc02030ec:	9e850513          	addi	a0,a0,-1560 # ffffffffc0205ad0 <default_pmm_manager+0x9e0>
...
ffffffffc020310e:	9b668693          	addi	a3,a3,-1610 # ffffffffc0205ac0 <default_pmm_manager+0x9d0>
ffffffffc0203112:	00002617          	auipc	a2,0x2
ffffffffc0203116:	c2e60613          	addi	a2,a2,-978 # ffffffffc0204d40 <commands+0x738>
ffffffffc020311a:	07c00593          	li	a1,124
ffffffffc020311e:	00002517          	auipc	a0,0x2
ffffffffc0203122:	67a50513          	addi	a0,a0,1658 # ffffffffc0205798 <default_pmm_manager+0x6a8>
...
ffffffffc020312e:	fbe78793          	addi	a5,a5,-66 # ffffffffc02110e8 <pra_list_head1>
...
ffffffffc0203210:	75468693          	addi	a3,a3,1876 # ffffffffc0205960 <default_pmm_manager+0x870>
ffffffffc0203214:	00002617          	auipc	a2,0x2
ffffffffc0203218:	b2c60613          	addi	a2,a2,-1236 # ffffffffc0204d40 <commands+0x738>
ffffffffc020321c:	08d00593          	li	a1,141
ffffffffc0203220:	00003517          	auipc	a0,0x3
ffffffffc0203224:	8f050513          	addi	a0,a0,-1808 # ffffffffc0205b10 <default_pmm_manager+0xa20>
ffffffffc0203228:	94cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==6);
ffffffffc020322c:	00003697          	auipc	a3,0x3
ffffffffc0203230:	93468693          	addi	a3,a3,-1740 # ffffffffc0205b60 <default_pmm_manager+0xa70>
ffffffffc0203234:	00002617          	auipc	a2,0x2
ffffffffc0203238:	b0c60613          	addi	a2,a2,-1268 # ffffffffc0204d40 <commands+0x738>
ffffffffc020323c:	0a400593          	li	a1,164
ffffffffc0203240:	00003517          	auipc	a0,0x3
ffffffffc0203244:	8d050513          	addi	a0,a0,-1840 # ffffffffc0205b10 <default_pmm_manager+0xa20>
ffffffffc0203248:	92cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc020324c:	00003697          	auipc	a3,0x3
ffffffffc0203250:	8ec68693          	addi	a3,a3,-1812 # ffffffffc0205b38 <default_pmm_manager+0xa48>
ffffffffc0203254:	00002617          	auipc	a2,0x2
ffffffffc0203258:	aec60613          	addi	a2,a2,-1300 # ffffffffc0204d40 <commands+0x738>
ffffffffc020325c:	0a200593          	li	a1,162
ffffffffc0203260:	00003517          	auipc	a0,0x3
ffffffffc0203264:	8b050513          	addi	a0,a0,-1872 # ffffffffc0205b10 <default_pmm_manager+0xa20>
ffffffffc0203268:	90cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020326c:	00003697          	auipc	a3,0x3
ffffffffc0203270:	8bc68693          	addi	a3,a3,-1860 # ffffffffc0205b28 <default_pmm_manager+0xa38>
ffffffffc0203274:	00002617          	auipc	a2,0x2
ffffffffc0203278:	acc60613          	addi	a2,a2,-1332 # ffffffffc0204d40 <commands+0x738>
ffffffffc020327c:	0a100593          	li	a1,161
ffffffffc0203280:	00003517          	auipc	a0,0x3
ffffffffc0203284:	89050513          	addi	a0,a0,-1904 # ffffffffc0205b10 <default_pmm_manager+0xa20>
ffffffffc0203288:	8ecfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020328c:	00003697          	auipc	a3,0x3
ffffffffc0203290:	89c68693          	addi	a3,a3,-1892 # ffffffffc0205b28 <default_pmm_manager+0xa38>
ffffffffc0203294:	00002617          	auipc	a2,0x2
ffffffffc0203298:	aac60613          	addi	a2,a2,-1364 # ffffffffc0204d40 <commands+0x738>
ffffffffc020329c:	09f00593          	li	a1,159
ffffffffc02032a0:	00003517          	auipc	a0,0x3
ffffffffc02032a4:	87050513          	addi	a0,a0,-1936 # ffffffffc0205b10 <default_pmm_manager+0xa20>
ffffffffc02032a8:	8ccfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032ac:	00003697          	auipc	a3,0x3
ffffffffc02032b0:	87c68693          	addi	a3,a3,-1924 # ffffffffc0205b28 <default_pmm_manager+0xa38>
ffffffffc02032b4:	00002617          	auipc	a2,0x2
ffffffffc02032b8:	a8c60613          	addi	a2,a2,-1396 # ffffffffc0204d40 <commands+0x738>
ffffffffc02032bc:	09d00593          	li	a1,157
ffffffffc02032c0:	00003517          	auipc	a0,0x3
ffffffffc02032c4:	85050513          	addi	a0,a0,-1968 # ffffffffc0205b10 <default_pmm_manager+0xa20>
ffffffffc02032c8:	8acfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032cc:	00003697          	auipc	a3,0x3
ffffffffc02032d0:	85c68693          	addi	a3,a3,-1956 # ffffffffc0205b28 <default_pmm_manager+0xa38>
ffffffffc02032d4:	00002617          	auipc	a2,0x2
ffffffffc02032d8:	a6c60613          	addi	a2,a2,-1428 # ffffffffc0204d40 <commands+0x738>
ffffffffc02032dc:	09b00593          	li	a1,155
ffffffffc02032e0:	00003517          	auipc	a0,0x3
ffffffffc02032e4:	83050513          	addi	a0,a0,-2000 # ffffffffc0205b10 <default_pmm_manager+0xa20>
ffffffffc02032e8:	88cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032ec:	00003697          	auipc	a3,0x3
ffffffffc02032f0:	83c68693          	addi	a3,a3,-1988 # ffffffffc0205b28 <default_pmm_manager+0xa38>
ffffffffc02032f4:	00002617          	auipc	a2,0x2
ffffffffc02032f8:	a4c60613          	addi	a2,a2,-1460 # ffffffffc0204d40 <commands+0x738>
ffffffffc02032fc:	09900593          	li	a1,153
ffffffffc0203300:	00003517          	auipc	a0,0x3
ffffffffc0203304:	81050513          	addi	a0,a0,-2032 # ffffffffc0205b10 <default_pmm_manager+0xa20>
ffffffffc0203308:	86cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020330c:	00003697          	auipc	a3,0x3
ffffffffc0203310:	81c68693          	addi	a3,a3,-2020 # ffffffffc0205b28 <default_pmm_manager+0xa38>
ffffffffc0203314:	00002617          	auipc	a2,0x2
ffffffffc0203318:	a2c60613          	addi	a2,a2,-1492 # ffffffffc0204d40 <commands+0x738>
ffffffffc020331c:	09700593          	li	a1,151
ffffffffc0203320:	00002517          	auipc	a0,0x2
ffffffffc0203324:	7f050513          	addi	a0,a0,2032 # ffffffffc0205b10 <default_pmm_manager+0xa20>
ffffffffc0203328:	84cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020332c:	00002697          	auipc	a3,0x2
ffffffffc0203330:	7fc68693          	addi	a3,a3,2044 # ffffffffc0205b28 <default_pmm_manager+0xa38>
ffffffffc0203334:	00002617          	auipc	a2,0x2
ffffffffc0203338:	a0c60613          	addi	a2,a2,-1524 # ffffffffc0204d40 <commands+0x738>
ffffffffc020333c:	09500593          	li	a1,149
ffffffffc0203340:	00002517          	auipc	a0,0x2
ffffffffc0203344:	7d050513          	addi	a0,a0,2000 # ffffffffc0205b10 <default_pmm_manager+0xa20>
ffffffffc0203348:	82cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020334c:	00002697          	auipc	a3,0x2
ffffffffc0203350:	61468693          	addi	a3,a3,1556 # ffffffffc0205960 <default_pmm_manager+0x870>
ffffffffc0203354:	00002617          	auipc	a2,0x2
ffffffffc0203358:	9ec60613          	addi	a2,a2,-1556 # ffffffffc0204d40 <commands+0x738>
ffffffffc020335c:	09300593          	li	a1,147
ffffffffc0203360:	00002517          	auipc	a0,0x2
ffffffffc0203364:	7b050513          	addi	a0,a0,1968 # ffffffffc0205b10 <default_pmm_manager+0xa20>
ffffffffc0203368:	80cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020336c:	00002697          	auipc	a3,0x2
ffffffffc0203370:	5f468693          	addi	a3,a3,1524 # ffffffffc0205960 <default_pmm_manager+0x870>
ffffffffc0203374:	00002617          	auipc	a2,0x2
ffffffffc0203378:	9cc60613          	addi	a2,a2,-1588 # ffffffffc0204d40 <commands+0x738>
ffffffffc020337c:	09100593          	li	a1,145
ffffffffc0203380:	00002517          	auipc	a0,0x2
ffffffffc0203384:	79050513          	addi	a0,a0,1936 # ffffffffc0205b10 <default_pmm_manager+0xa20>
ffffffffc0203388:	fedfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020338c:	00002697          	auipc	a3,0x2
ffffffffc0203390:	5d468693          	addi	a3,a3,1492 # ffffffffc0205960 <default_pmm_manager+0x870>
ffffffffc0203394:	00002617          	auipc	a2,0x2
ffffffffc0203398:	9ac60613          	addi	a2,a2,-1620 # ffffffffc0204d40 <commands+0x738>
ffffffffc020339c:	08f00593          	li	a1,143
ffffffffc02033a0:	00002517          	auipc	a0,0x2
ffffffffc02033a4:	77050513          	addi	a0,a0,1904 # ffffffffc0205b10 <default_pmm_manager+0xa20>
...
ffffffffc02033b0:	e406                	sd	ra,8(sp)
         assert(head != NULL);
ffffffffc02033b2:	cd0d                	beqz	a0,ffffffffc02033ec <_clock_swap_out_victim+0x40>
     assert(in_tick==0);
ffffffffc02033b4:	ee21                	bnez	a2,ffffffffc020340c <_clock_swap_out_victim+0x60>
...
ffffffffc02033c0:	6798                	ld	a4,8(a5)
        if(curr_ptr == head){
ffffffffc02033c2:	00f50763          	beq	a0,a5,ffffffffc02033d0 <_clock_swap_out_victim+0x24>
        if(curr_page->visited == 0){
ffffffffc02033c6:	fe07b683          	ld	a3,-32(a5)
ffffffffc02033ca:	c689                	beqz	a3,ffffffffc02033d4 <_clock_swap_out_victim+0x28>
        curr_page->visited = 0;
ffffffffc02033cc:	fe07b023          	sd	zero,-32(a5)
ffffffffc02033d0:	87ba                	mv	a5,a4
ffffffffc02033d2:	b7fd                	j	ffffffffc02033c0 <_clock_swap_out_victim+0x14>
    __list_del(listelm->prev, listelm->next);
ffffffffc02033d4:	6394                	ld	a3,0(a5)
        struct Page* curr_page = le2page(curr_ptr,pra_page_link);
ffffffffc02033d6:	fd078513          	addi	a0,a5,-48
}
ffffffffc02033da:	60a2                	ld	ra,8(sp)
    prev->next = next;
ffffffffc02033dc:	e698                	sd	a4,8(a3)
            curr_ptr = list_next(curr_ptr);
ffffffffc02033de:	679c                	ld	a5,8(a5)
    next->prev = prev;
ffffffffc02033e0:	e314                	sd	a3,0(a4)
ffffffffc02033e2:	e21c                	sd	a5,0(a2)
            *ptr_page = curr_page;
ffffffffc02033e4:	e188                	sd	a0,0(a1)
}
ffffffffc02033e6:	4501                	li	a0,0
ffffffffc02033e8:	0141                	addi	sp,sp,16
ffffffffc02033ea:	8082                	ret
         assert(head != NULL);
ffffffffc02033ec:	00002697          	auipc	a3,0x2
ffffffffc02033f0:	78468693          	addi	a3,a3,1924 # ffffffffc0205b70 <default_pmm_manager+0xa80>
ffffffffc02033f4:	00002617          	auipc	a2,0x2
ffffffffc02033f8:	94c60613          	addi	a2,a2,-1716 # ffffffffc0204d40 <commands+0x738>
ffffffffc02033fc:	04a00593          	li	a1,74
ffffffffc0203400:	00002517          	auipc	a0,0x2
ffffffffc0203404:	71050513          	addi	a0,a0,1808 # ffffffffc0205b10 <default_pmm_manager+0xa20>
ffffffffc0203408:	f6dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(in_tick==0);
ffffffffc020340c:	00002697          	auipc	a3,0x2
ffffffffc0203410:	77468693          	addi	a3,a3,1908 # ffffffffc0205b80 <default_pmm_manager+0xa90>
ffffffffc0203414:	00002617          	auipc	a2,0x2
ffffffffc0203418:	92c60613          	addi	a2,a2,-1748 # ffffffffc0204d40 <commands+0x738>
ffffffffc020341c:	04b00593          	li	a1,75
ffffffffc0203420:	00002517          	auipc	a0,0x2
ffffffffc0203424:	6f050513          	addi	a0,a0,1776 # ffffffffc0205b10 <default_pmm_manager+0xa20>
ffffffffc0203428:	f4dfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020342c <_clock_map_swappable>:
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc020342c:	0000e797          	auipc	a5,0xe
ffffffffc0203430:	12c7b783          	ld	a5,300(a5) # ffffffffc0211558 <curr_ptr>
ffffffffc0203434:	cf89                	beqz	a5,ffffffffc020344e <_clock_map_swappable+0x22>
    list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc0203436:	751c                	ld	a5,40(a0)
ffffffffc0203438:	03060713          	addi	a4,a2,48
}
ffffffffc020343c:	4501                	li	a0,0
    __list_add(elm, listelm->prev, listelm);
ffffffffc020343e:	6394                	ld	a3,0(a5)
    prev->next = next->prev = elm;
ffffffffc0203440:	e398                	sd	a4,0(a5)
ffffffffc0203442:	e698                	sd	a4,8(a3)
    elm->next = next;
ffffffffc0203444:	fe1c                	sd	a5,56(a2)
    page->visited = 1;
ffffffffc0203446:	4785                	li	a5,1
    elm->prev = prev;
ffffffffc0203448:	fa14                	sd	a3,48(a2)
ffffffffc020344a:	ea1c                	sd	a5,16(a2)
}
...
ffffffffc0203454:	74068693          	addi	a3,a3,1856 # ffffffffc0205b90 <default_pmm_manager+0xaa0>
ffffffffc0203458:	00002617          	auipc	a2,0x2
ffffffffc020345c:	8e860613          	addi	a2,a2,-1816 # ffffffffc0204d40 <commands+0x738>
ffffffffc0203460:	03700593          	li	a1,55
ffffffffc0203464:	00002517          	auipc	a0,0x2
ffffffffc0203468:	6ac50513          	addi	a0,a0,1708 # ffffffffc0205b10 <default_pmm_manager+0xa20>
{
ffffffffc020346c:	e406                	sd	ra,8(sp)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc020346e:	f07fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203472 <check_vma_overlap.part.0>:
}
...
ffffffffc0203478:	75c68693          	addi	a3,a3,1884 # ffffffffc0205bd0 <default_pmm_manager+0xae0>
ffffffffc020347c:	00002617          	auipc	a2,0x2
ffffffffc0203480:	8c460613          	addi	a2,a2,-1852 # ffffffffc0204d40 <commands+0x738>
ffffffffc0203484:	07d00593          	li	a1,125
ffffffffc0203488:	00002517          	auipc	a0,0x2
ffffffffc020348c:	76850513          	addi	a0,a0,1896 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc020349e:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02034a0:	ad8ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02034a4:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc02034a6:	c105                	beqz	a0,ffffffffc02034c6 <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc02034a8:	e408                	sd	a0,8(s0)
ffffffffc02034aa:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc02034ac:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02034b0:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02034b4:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02034b8:	0000e797          	auipc	a5,0xe
ffffffffc02034bc:	0987a783          	lw	a5,152(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc02034c0:	eb81                	bnez	a5,ffffffffc02034d0 <mm_create+0x3a>
        else mm->sm_priv = NULL;
ffffffffc02034c2:	02053423          	sd	zero,40(a0)
}
ffffffffc02034c6:	60a2                	ld	ra,8(sp)
ffffffffc02034c8:	8522                	mv	a0,s0
ffffffffc02034ca:	6402                	ld	s0,0(sp)
ffffffffc02034cc:	0141                	addi	sp,sp,16
ffffffffc02034ce:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02034d0:	ab5ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
}
ffffffffc02034d4:	60a2                	ld	ra,8(sp)
ffffffffc02034d6:	8522                	mv	a0,s0
ffffffffc02034d8:	6402                	ld	s0,0(sp)
ffffffffc02034da:	0141                	addi	sp,sp,16
ffffffffc02034dc:	8082                	ret

ffffffffc02034de <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc02034de:	1101                	addi	sp,sp,-32
ffffffffc02034e0:	e04a                	sd	s2,0(sp)
ffffffffc02034e2:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02034e4:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc02034e8:	e822                	sd	s0,16(sp)
ffffffffc02034ea:	e426                	sd	s1,8(sp)
ffffffffc02034ec:	ec06                	sd	ra,24(sp)
ffffffffc02034ee:	84ae                	mv	s1,a1
ffffffffc02034f0:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02034f2:	a86ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (vma != NULL) {
ffffffffc02034f6:	c509                	beqz	a0,ffffffffc0203500 <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc02034f8:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc02034fc:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02034fe:	ed00                	sd	s0,24(a0)
}
ffffffffc0203500:	60e2                	ld	ra,24(sp)
ffffffffc0203502:	6442                	ld	s0,16(sp)
ffffffffc0203504:	64a2                	ld	s1,8(sp)
ffffffffc0203506:	6902                	ld	s2,0(sp)
ffffffffc0203508:	6105                	addi	sp,sp,32
ffffffffc020350a:	8082                	ret

ffffffffc020350c <find_vma>:
find_vma(struct mm_struct *mm, uintptr_t addr) {
ffffffffc020350c:	86aa                	mv	a3,a0
    if (mm != NULL) {
ffffffffc020350e:	c505                	beqz	a0,ffffffffc0203536 <find_vma+0x2a>
        vma = mm->mmap_cache;
ffffffffc0203510:	6908                	ld	a0,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203512:	c501                	beqz	a0,ffffffffc020351a <find_vma+0xe>
ffffffffc0203514:	651c                	ld	a5,8(a0)
ffffffffc0203516:	02f5f263          	bgeu	a1,a5,ffffffffc020353a <find_vma+0x2e>
    return listelm->next;
ffffffffc020351a:	669c                	ld	a5,8(a3)
                while ((le = list_next(le)) != list) {
ffffffffc020351c:	00f68d63          	beq	a3,a5,ffffffffc0203536 <find_vma+0x2a>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc0203520:	fe87b703          	ld	a4,-24(a5)
ffffffffc0203524:	00e5e663          	bltu	a1,a4,ffffffffc0203530 <find_vma+0x24>
ffffffffc0203528:	ff07b703          	ld	a4,-16(a5)
ffffffffc020352c:	00e5ec63          	bltu	a1,a4,ffffffffc0203544 <find_vma+0x38>
ffffffffc0203530:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc0203532:	fef697e3          	bne	a3,a5,ffffffffc0203520 <find_vma+0x14>
    struct vma_struct *vma = NULL;
ffffffffc0203536:	4501                	li	a0,0
}
ffffffffc0203538:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc020353a:	691c                	ld	a5,16(a0)
ffffffffc020353c:	fcf5ffe3          	bgeu	a1,a5,ffffffffc020351a <find_vma+0xe>
            mm->mmap_cache = vma;
ffffffffc0203540:	ea88                	sd	a0,16(a3)
ffffffffc0203542:	8082                	ret
                    vma = le2vma(le, list_link);
ffffffffc0203544:	fe078513          	addi	a0,a5,-32
            mm->mmap_cache = vma;
ffffffffc0203548:	ea88                	sd	a0,16(a3)
ffffffffc020354a:	8082                	ret

ffffffffc020354c <insert_vma_struct>:
...
ffffffffc020354c:	6590                	ld	a2,8(a1)
ffffffffc020354e:	0105b803          	ld	a6,16(a1) # 1010 <kern_entry-0xffffffffc01feff0>
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc0203552:	1141                	addi	sp,sp,-16
ffffffffc0203554:	e406                	sd	ra,8(sp)
ffffffffc0203556:	87aa                	mv	a5,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203558:	01066763          	bltu	a2,a6,ffffffffc0203566 <insert_vma_struct+0x1a>
ffffffffc020355c:	a085                	j	ffffffffc02035bc <insert_vma_struct+0x70>
...
ffffffffc0203562:	04e66863          	bltu	a2,a4,ffffffffc02035b2 <insert_vma_struct+0x66>
ffffffffc0203566:	86be                	mv	a3,a5
ffffffffc0203568:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc020356a:	fef51ae3          	bne	a0,a5,ffffffffc020355e <insert_vma_struct+0x12>
        }
    ...
    /* check overlap */
    if (le_prev != list) {
ffffffffc020356e:	02a68463          	beq	a3,a0,ffffffffc0203596 <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc0203572:	ff06b703          	ld	a4,-16(a3)
    assert(prev->vm_start < prev->vm_end);
ffffffffc0203576:	fe86b883          	ld	a7,-24(a3)
ffffffffc020357a:	08e8f163          	bgeu	a7,a4,ffffffffc02035fc <insert_vma_struct+0xb0>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020357e:	04e66f63          	bltu	a2,a4,ffffffffc02035dc <insert_vma_struct+0x90>
    }
    if (le_next != list) {
ffffffffc0203582:	00f50a63          	beq	a0,a5,ffffffffc0203596 <insert_vma_struct+0x4a>
            if (mmap_prev->vm_start > vma->vm_start) {
ffffffffc0203586:	fe87b703          	ld	a4,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc020358a:	05076963          	bltu	a4,a6,ffffffffc02035dc <insert_vma_struct+0x90>
    assert(next->vm_start < next->vm_end);
ffffffffc020358e:	ff07b603          	ld	a2,-16(a5)
ffffffffc0203592:	02c77363          	bgeu	a4,a2,ffffffffc02035b8 <insert_vma_struct+0x6c>
    }
    ...
    mm->map_count ++;
ffffffffc0203596:	5118                	lw	a4,32(a0)
    vma->vm_mm = mm;
ffffffffc0203598:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc020359a:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc020359e:	e390                	sd	a2,0(a5)
ffffffffc02035a0:	e690                	sd	a2,8(a3)
}
ffffffffc02035a2:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc02035a4:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc02035a6:	f194                	sd	a3,32(a1)
    mm->map_count ++;
ffffffffc02035a8:	0017079b          	addiw	a5,a4,1
ffffffffc02035ac:	d11c                	sw	a5,32(a0)
}
ffffffffc02035ae:	0141                	addi	sp,sp,16
ffffffffc02035b0:	8082                	ret
    if (le_prev != list) {
ffffffffc02035b2:	fca690e3          	bne	a3,a0,ffffffffc0203572 <insert_vma_struct+0x26>
ffffffffc02035b6:	bfd1                	j	ffffffffc020358a <insert_vma_struct+0x3e>
ffffffffc02035b8:	ebbff0ef          	jal	ra,ffffffffc0203472 <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc02035bc:	00002697          	auipc	a3,0x2
ffffffffc02035c0:	64468693          	addi	a3,a3,1604 # ffffffffc0205c00 <default_pmm_manager+0xb10>
ffffffffc02035c4:	00001617          	auipc	a2,0x1
ffffffffc02035c8:	77c60613          	addi	a2,a2,1916 # ffffffffc0204d40 <commands+0x738>
ffffffffc02035cc:	08400593          	li	a1,132
ffffffffc02035d0:	00002517          	auipc	a0,0x2
ffffffffc02035d4:	62050513          	addi	a0,a0,1568 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc02035d8:	d9dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02035dc:	00002697          	auipc	a3,0x2
ffffffffc02035e0:	66468693          	addi	a3,a3,1636 # ffffffffc0205c40 <default_pmm_manager+0xb50>
ffffffffc02035e4:	00001617          	auipc	a2,0x1
ffffffffc02035e8:	75c60613          	addi	a2,a2,1884 # ffffffffc0204d40 <commands+0x738>
ffffffffc02035ec:	07c00593          	li	a1,124
ffffffffc02035f0:	00002517          	auipc	a0,0x2
ffffffffc02035f4:	60050513          	addi	a0,a0,1536 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc02035f8:	d7dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02035fc:	00002697          	auipc	a3,0x2
ffffffffc0203600:	62468693          	addi	a3,a3,1572 # ffffffffc0205c20 <default_pmm_manager+0xb30>
ffffffffc0203604:	00001617          	auipc	a2,0x1
ffffffffc0203608:	73c60613          	addi	a2,a2,1852 # ffffffffc0204d40 <commands+0x738>
ffffffffc020360c:	07b00593          	li	a1,123
ffffffffc0203610:	00002517          	auipc	a0,0x2
ffffffffc0203614:	5e050513          	addi	a0,a0,1504 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
...
ffffffffc0203638:	9faff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
...
ffffffffc020364c:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020364e:	9e4ff06f          	j	ffffffffc0202832 <kfree>
...
ffffffffc0203656:	f44e                	sd	s3,40(sp)
ffffffffc0203658:	f052                	sd	s4,32(sp)
ffffffffc020365a:	e0a2                	sd	s0,64(sp)
ffffffffc020365c:	fc26                	sd	s1,56(sp)
ffffffffc020365e:	f84a                	sd	s2,48(sp)
...
ffffffffc0203666:	82cfe0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
...
check_vma_struct(void) {
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc020366c:	826fe0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203670:	8a2a                	mv	s4,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203672:	03000513          	li	a0,48
ffffffffc0203676:	902ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (mm != NULL) {
ffffffffc020367a:	56050863          	beqz	a0,ffffffffc0203bea <vmm_init+0x598>
    elm->prev = elm->next = elm;
ffffffffc020367e:	e508                	sd	a0,8(a0)
ffffffffc0203680:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc0203682:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203686:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc020368a:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020368e:	0000e797          	auipc	a5,0xe
ffffffffc0203692:	ec27a783          	lw	a5,-318(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203696:	84aa                	mv	s1,a0
ffffffffc0203698:	e7b9                	bnez	a5,ffffffffc02036e6 <vmm_init+0x94>
        else mm->sm_priv = NULL;
ffffffffc020369a:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc020369e:	03200413          	li	s0,50
ffffffffc02036a2:	a811                	j	ffffffffc02036b6 <vmm_init+0x64>
        vma->vm_start = vm_start;
ffffffffc02036a4:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
...
ffffffffc02036a8:	00053c23          	sd	zero,24(a0)
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc02036ac:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc02036ae:	8526                	mv	a0,s1
ffffffffc02036b0:	e9dff0ef          	jal	ra,ffffffffc020354c <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc02036b4:	cc05                	beqz	s0,ffffffffc02036ec <vmm_init+0x9a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02036b6:	03000513          	li	a0,48
ffffffffc02036ba:	8beff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02036be:	85aa                	mv	a1,a0
ffffffffc02036c0:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc02036c4:	f165                	bnez	a0,ffffffffc02036a4 <vmm_init+0x52>
        assert(vma != NULL);
ffffffffc02036c6:	00002697          	auipc	a3,0x2
ffffffffc02036ca:	15a68693          	addi	a3,a3,346 # ffffffffc0205820 <default_pmm_manager+0x730>
ffffffffc02036ce:	00001617          	auipc	a2,0x1
ffffffffc02036d2:	67260613          	addi	a2,a2,1650 # ffffffffc0204d40 <commands+0x738>
ffffffffc02036d6:	0ce00593          	li	a1,206
ffffffffc02036da:	00002517          	auipc	a0,0x2
ffffffffc02036de:	51650513          	addi	a0,a0,1302 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc02036e2:	c93fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02036e6:	89fff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc02036ea:	bf55                	j	ffffffffc020369e <vmm_init+0x4c>
ffffffffc02036ec:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc02036f0:	1f900913          	li	s2,505
ffffffffc02036f4:	a819                	j	ffffffffc020370a <vmm_init+0xb8>
        vma->vm_start = vm_start;
...
ffffffffc02036fa:	00053c23          	sd	zero,24(a0)
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc02036fe:	0415                	addi	s0,s0,5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203700:	8526                	mv	a0,s1
ffffffffc0203702:	e4bff0ef          	jal	ra,ffffffffc020354c <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203706:	03240a63          	beq	s0,s2,ffffffffc020373a <vmm_init+0xe8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020370a:	03000513          	li	a0,48
ffffffffc020370e:	86aff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203712:	85aa                	mv	a1,a0
ffffffffc0203714:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc0203718:	fd79                	bnez	a0,ffffffffc02036f6 <vmm_init+0xa4>
        assert(vma != NULL);
ffffffffc020371a:	00002697          	auipc	a3,0x2
ffffffffc020371e:	10668693          	addi	a3,a3,262 # ffffffffc0205820 <default_pmm_manager+0x730>
ffffffffc0203722:	00001617          	auipc	a2,0x1
ffffffffc0203726:	61e60613          	addi	a2,a2,1566 # ffffffffc0204d40 <commands+0x738>
ffffffffc020372a:	0d400593          	li	a1,212
ffffffffc020372e:	00002517          	auipc	a0,0x2
ffffffffc0203732:	4c250513          	addi	a0,a0,1218 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc0203736:	c3ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    return listelm->next;
ffffffffc020373a:	649c                	ld	a5,8(s1)
ffffffffc020373c:	471d                	li	a4,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc020373e:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc0203742:	2ef48463          	beq	s1,a5,ffffffffc0203a2a <vmm_init+0x3d8>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203746:	fe87b603          	ld	a2,-24(a5)
ffffffffc020374a:	ffe70693          	addi	a3,a4,-2
ffffffffc020374e:	26d61e63          	bne	a2,a3,ffffffffc02039ca <vmm_init+0x378>
ffffffffc0203752:	ff07b683          	ld	a3,-16(a5)
ffffffffc0203756:	26e69a63          	bne	a3,a4,ffffffffc02039ca <vmm_init+0x378>
    for (i = 1; i <= step2; i ++) {
ffffffffc020375a:	0715                	addi	a4,a4,5
ffffffffc020375c:	679c                	ld	a5,8(a5)
ffffffffc020375e:	feb712e3          	bne	a4,a1,ffffffffc0203742 <vmm_init+0xf0>
ffffffffc0203762:	4b1d                	li	s6,7
ffffffffc0203764:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203766:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc020376a:	85a2                	mv	a1,s0
ffffffffc020376c:	8526                	mv	a0,s1
ffffffffc020376e:	d9fff0ef          	jal	ra,ffffffffc020350c <find_vma>
ffffffffc0203772:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc0203774:	2c050b63          	beqz	a0,ffffffffc0203a4a <vmm_init+0x3f8>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc0203778:	00140593          	addi	a1,s0,1
ffffffffc020377c:	8526                	mv	a0,s1
ffffffffc020377e:	d8fff0ef          	jal	ra,ffffffffc020350c <find_vma>
ffffffffc0203782:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc0203784:	2e050363          	beqz	a0,ffffffffc0203a6a <vmm_init+0x418>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc0203788:	85da                	mv	a1,s6
ffffffffc020378a:	8526                	mv	a0,s1
ffffffffc020378c:	d81ff0ef          	jal	ra,ffffffffc020350c <find_vma>
        assert(vma3 == NULL);
ffffffffc0203790:	2e051d63          	bnez	a0,ffffffffc0203a8a <vmm_init+0x438>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc0203794:	00340593          	addi	a1,s0,3
ffffffffc0203798:	8526                	mv	a0,s1
ffffffffc020379a:	d73ff0ef          	jal	ra,ffffffffc020350c <find_vma>
        assert(vma4 == NULL);
ffffffffc020379e:	30051663          	bnez	a0,ffffffffc0203aaa <vmm_init+0x458>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc02037a2:	00440593          	addi	a1,s0,4
ffffffffc02037a6:	8526                	mv	a0,s1
ffffffffc02037a8:	d65ff0ef          	jal	ra,ffffffffc020350c <find_vma>
        assert(vma5 == NULL);
ffffffffc02037ac:	30051f63          	bnez	a0,ffffffffc0203aca <vmm_init+0x478>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02037b0:	00893783          	ld	a5,8(s2)
ffffffffc02037b4:	24879b63          	bne	a5,s0,ffffffffc0203a0a <vmm_init+0x3b8>
ffffffffc02037b8:	01093783          	ld	a5,16(s2)
ffffffffc02037bc:	25679763          	bne	a5,s6,ffffffffc0203a0a <vmm_init+0x3b8>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc02037c0:	008ab783          	ld	a5,8(s5)
ffffffffc02037c4:	22879363          	bne	a5,s0,ffffffffc02039ea <vmm_init+0x398>
ffffffffc02037c8:	010ab783          	ld	a5,16(s5)
ffffffffc02037cc:	21679f63          	bne	a5,s6,ffffffffc02039ea <vmm_init+0x398>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc02037d0:	0415                	addi	s0,s0,5
ffffffffc02037d2:	0b15                	addi	s6,s6,5
ffffffffc02037d4:	f9741be3          	bne	s0,s7,ffffffffc020376a <vmm_init+0x118>
ffffffffc02037d8:	4411                	li	s0,4
    }

    for (i =4; i>=0; i--) {
ffffffffc02037da:	597d                	li	s2,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc02037dc:	85a2                	mv	a1,s0
ffffffffc02037de:	8526                	mv	a0,s1
ffffffffc02037e0:	d2dff0ef          	jal	ra,ffffffffc020350c <find_vma>
ffffffffc02037e4:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc02037e8:	c90d                	beqz	a0,ffffffffc020381a <vmm_init+0x1c8>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc02037ea:	6914                	ld	a3,16(a0)
ffffffffc02037ec:	6510                	ld	a2,8(a0)
ffffffffc02037ee:	00002517          	auipc	a0,0x2
ffffffffc02037f2:	57250513          	addi	a0,a0,1394 # ffffffffc0205d60 <default_pmm_manager+0xc70>
ffffffffc02037f6:	8c5fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc02037fa:	00002697          	auipc	a3,0x2
ffffffffc02037fe:	58e68693          	addi	a3,a3,1422 # ffffffffc0205d88 <default_pmm_manager+0xc98>
ffffffffc0203802:	00001617          	auipc	a2,0x1
ffffffffc0203806:	53e60613          	addi	a2,a2,1342 # ffffffffc0204d40 <commands+0x738>
ffffffffc020380a:	0f600593          	li	a1,246
ffffffffc020380e:	00002517          	auipc	a0,0x2
ffffffffc0203812:	3e250513          	addi	a0,a0,994 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc0203816:	b5ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc020381a:	147d                	addi	s0,s0,-1
ffffffffc020381c:	fd2410e3          	bne	s0,s2,ffffffffc02037dc <vmm_init+0x18a>
ffffffffc0203820:	a811                	j	ffffffffc0203834 <vmm_init+0x1e2>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203822:	6118                	ld	a4,0(a0)
ffffffffc0203824:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203826:	03000593          	li	a1,48
ffffffffc020382a:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc020382c:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc020382e:	e398                	sd	a4,0(a5)
ffffffffc0203830:	802ff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203834:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc0203836:	fea496e3          	bne	s1,a0,ffffffffc0203822 <vmm_init+0x1d0>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
...
ffffffffc0203844:	e4ffd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203848:	3caa1163          	bne	s4,a0,ffffffffc0203c0a <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc020384c:	00002517          	auipc	a0,0x2
ffffffffc0203850:	57c50513          	addi	a0,a0,1404 # ffffffffc0205dc8 <default_pmm_manager+0xcd8>
...
ffffffffc020385c:	84aa                	mv	s1,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc020385e:	03000513          	li	a0,48
ffffffffc0203862:	f17fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203866:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203868:	2a050163          	beqz	a0,ffffffffc0203b0a <vmm_init+0x4b8>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020386c:	0000e797          	auipc	a5,0xe
ffffffffc0203870:	ce47a783          	lw	a5,-796(a5) # ffffffffc0211550 <swap_init_ok>
    elm->prev = elm->next = elm;
ffffffffc0203874:	e508                	sd	a0,8(a0)
ffffffffc0203876:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc0203878:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc020387c:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203880:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203884:	14079063          	bnez	a5,ffffffffc02039c4 <vmm_init+0x372>
        else mm->sm_priv = NULL;
ffffffffc0203888:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc020388c:	0000e917          	auipc	s2,0xe
ffffffffc0203890:	c8c93903          	ld	s2,-884(s2) # ffffffffc0211518 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc0203894:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc0203898:	0000e717          	auipc	a4,0xe
ffffffffc020389c:	cc873423          	sd	s0,-824(a4) # ffffffffc0211560 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc02038a0:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc02038a4:	24079363          	bnez	a5,ffffffffc0203aea <vmm_init+0x498>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
...
ffffffffc02038b0:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc02038b2:	28050063          	beqz	a0,ffffffffc0203b32 <vmm_init+0x4e0>
        vma->vm_end = vm_end;
ffffffffc02038b6:	002007b7          	lui	a5,0x200
ffffffffc02038ba:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
...
ffffffffc02038c0:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc02038c2:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc02038c6:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc02038c8:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc02038cc:	c81ff0ef          	jal	ra,ffffffffc020354c <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc02038d0:	10000593          	li	a1,256
ffffffffc02038d4:	8522                	mv	a0,s0
ffffffffc02038d6:	c37ff0ef          	jal	ra,ffffffffc020350c <find_vma>
ffffffffc02038da:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc02038de:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc02038e2:	26aa1863          	bne	s4,a0,ffffffffc0203b52 <vmm_init+0x500>
        *(char *)(addr + i) = i;
ffffffffc02038e6:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc02038ea:	0785                	addi	a5,a5,1
ffffffffc02038ec:	fee79de3          	bne	a5,a4,ffffffffc02038e6 <vmm_init+0x294>
        sum += i;
ffffffffc02038f0:	6705                	lui	a4,0x1
ffffffffc02038f2:	10000793          	li	a5,256
ffffffffc02038f6:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc02038fa:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc02038fe:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc0203902:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc0203904:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc0203906:	fec79ce3          	bne	a5,a2,ffffffffc02038fe <vmm_init+0x2ac>
    }
    assert(sum == 0);
ffffffffc020390a:	26071463          	bnez	a4,ffffffffc0203b72 <vmm_init+0x520>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc020390e:	4581                	li	a1,0
ffffffffc0203910:	854a                	mv	a0,s2
ffffffffc0203912:	80afe0ef          	jal	ra,ffffffffc020191c <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203916:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc020391a:	0000e717          	auipc	a4,0xe
ffffffffc020391e:	c0673703          	ld	a4,-1018(a4) # ffffffffc0211520 <npage>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203922:	078a                	slli	a5,a5,0x2
ffffffffc0203924:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203926:	26e7f663          	bgeu	a5,a4,ffffffffc0203b92 <vmm_init+0x540>
    return &pages[PPN(pa) - nbase];
ffffffffc020392a:	00003717          	auipc	a4,0x3
ffffffffc020392e:	86673703          	ld	a4,-1946(a4) # ffffffffc0206190 <nbase>
ffffffffc0203932:	8f99                	sub	a5,a5,a4
ffffffffc0203934:	00379713          	slli	a4,a5,0x3
ffffffffc0203938:	97ba                	add	a5,a5,a4
ffffffffc020393a:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc020393c:	0000e517          	auipc	a0,0xe
ffffffffc0203940:	bec53503          	ld	a0,-1044(a0) # ffffffffc0211528 <pages>
ffffffffc0203944:	953e                	add	a0,a0,a5
ffffffffc0203946:	4585                	li	a1,1
ffffffffc0203948:	d0bfd0ef          	jal	ra,ffffffffc0201652 <free_pages>
    return listelm->next;
ffffffffc020394c:	6408                	ld	a0,8(s0)

    pgdir[0] = 0;
ffffffffc020394e:	00093023          	sd	zero,0(s2)

    mm->pgdir = NULL;
ffffffffc0203952:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203956:	00a40e63          	beq	s0,a0,ffffffffc0203972 <vmm_init+0x320>
    __list_del(listelm->prev, listelm->next);
ffffffffc020395a:	6118                	ld	a4,0(a0)
ffffffffc020395c:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc020395e:	03000593          	li	a1,48
ffffffffc0203962:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203964:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203966:	e398                	sd	a4,0(a5)
ffffffffc0203968:	ecbfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc020396c:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc020396e:	fea416e3          	bne	s0,a0,ffffffffc020395a <vmm_init+0x308>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203972:	03000593          	li	a1,48
ffffffffc0203976:	8522                	mv	a0,s0
ffffffffc0203978:	ebbfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    mm_destroy(mm);

    check_mm_struct = NULL;
    nr_free_pages_store--;	// szx : Sv39第二级页表多占了一个内存页，所以执行此操作
ffffffffc020397c:	14fd                	addi	s1,s1,-1
    check_mm_struct = NULL;
ffffffffc020397e:	0000e797          	auipc	a5,0xe
ffffffffc0203982:	be07b123          	sd	zero,-1054(a5) # ffffffffc0211560 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203986:	d0dfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc020398a:	22a49063          	bne	s1,a0,ffffffffc0203baa <vmm_init+0x558>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc020398e:	00002517          	auipc	a0,0x2
ffffffffc0203992:	48a50513          	addi	a0,a0,1162 # ffffffffc0205e18 <default_pmm_manager+0xd28>
ffffffffc0203996:	f24fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc020399a:	cf9fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc020399e:	19fd                	addi	s3,s3,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039a0:	22a99563          	bne	s3,a0,ffffffffc0203bca <vmm_init+0x578>
}
ffffffffc02039a4:	6406                	ld	s0,64(sp)
ffffffffc02039a6:	60a6                	ld	ra,72(sp)
ffffffffc02039a8:	74e2                	ld	s1,56(sp)
ffffffffc02039aa:	7942                	ld	s2,48(sp)
ffffffffc02039ac:	79a2                	ld	s3,40(sp)
ffffffffc02039ae:	7a02                	ld	s4,32(sp)
ffffffffc02039b0:	6ae2                	ld	s5,24(sp)
ffffffffc02039b2:	6b42                	ld	s6,16(sp)
ffffffffc02039b4:	6ba2                	ld	s7,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc02039b6:	00002517          	auipc	a0,0x2
ffffffffc02039ba:	48250513          	addi	a0,a0,1154 # ffffffffc0205e38 <default_pmm_manager+0xd48>
}
ffffffffc02039be:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc02039c0:	efafc06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02039c4:	dc0ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc02039c8:	b5d1                	j	ffffffffc020388c <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc02039ca:	00002697          	auipc	a3,0x2
ffffffffc02039ce:	2ae68693          	addi	a3,a3,686 # ffffffffc0205c78 <default_pmm_manager+0xb88>
ffffffffc02039d2:	00001617          	auipc	a2,0x1
ffffffffc02039d6:	36e60613          	addi	a2,a2,878 # ffffffffc0204d40 <commands+0x738>
ffffffffc02039da:	0dd00593          	li	a1,221
ffffffffc02039de:	00002517          	auipc	a0,0x2
ffffffffc02039e2:	21250513          	addi	a0,a0,530 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc02039e6:	98ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc02039ea:	00002697          	auipc	a3,0x2
ffffffffc02039ee:	34668693          	addi	a3,a3,838 # ffffffffc0205d30 <default_pmm_manager+0xc40>
ffffffffc02039f2:	00001617          	auipc	a2,0x1
ffffffffc02039f6:	34e60613          	addi	a2,a2,846 # ffffffffc0204d40 <commands+0x738>
ffffffffc02039fa:	0ee00593          	li	a1,238
ffffffffc02039fe:	00002517          	auipc	a0,0x2
ffffffffc0203a02:	1f250513          	addi	a0,a0,498 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc0203a06:	96ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203a0a:	00002697          	auipc	a3,0x2
ffffffffc0203a0e:	2f668693          	addi	a3,a3,758 # ffffffffc0205d00 <default_pmm_manager+0xc10>
ffffffffc0203a12:	00001617          	auipc	a2,0x1
ffffffffc0203a16:	32e60613          	addi	a2,a2,814 # ffffffffc0204d40 <commands+0x738>
ffffffffc0203a1a:	0ed00593          	li	a1,237
ffffffffc0203a1e:	00002517          	auipc	a0,0x2
ffffffffc0203a22:	1d250513          	addi	a0,a0,466 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc0203a26:	94ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203a2a:	00002697          	auipc	a3,0x2
ffffffffc0203a2e:	23668693          	addi	a3,a3,566 # ffffffffc0205c60 <default_pmm_manager+0xb70>
ffffffffc0203a32:	00001617          	auipc	a2,0x1
ffffffffc0203a36:	30e60613          	addi	a2,a2,782 # ffffffffc0204d40 <commands+0x738>
ffffffffc0203a3a:	0db00593          	li	a1,219
ffffffffc0203a3e:	00002517          	auipc	a0,0x2
ffffffffc0203a42:	1b250513          	addi	a0,a0,434 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc0203a46:	92ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203a4a:	00002697          	auipc	a3,0x2
ffffffffc0203a4e:	26668693          	addi	a3,a3,614 # ffffffffc0205cb0 <default_pmm_manager+0xbc0>
ffffffffc0203a52:	00001617          	auipc	a2,0x1
ffffffffc0203a56:	2ee60613          	addi	a2,a2,750 # ffffffffc0204d40 <commands+0x738>
ffffffffc0203a5a:	0e300593          	li	a1,227
ffffffffc0203a5e:	00002517          	auipc	a0,0x2
ffffffffc0203a62:	19250513          	addi	a0,a0,402 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc0203a66:	90ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203a6a:	00002697          	auipc	a3,0x2
ffffffffc0203a6e:	25668693          	addi	a3,a3,598 # ffffffffc0205cc0 <default_pmm_manager+0xbd0>
ffffffffc0203a72:	00001617          	auipc	a2,0x1
ffffffffc0203a76:	2ce60613          	addi	a2,a2,718 # ffffffffc0204d40 <commands+0x738>
ffffffffc0203a7a:	0e500593          	li	a1,229
ffffffffc0203a7e:	00002517          	auipc	a0,0x2
ffffffffc0203a82:	17250513          	addi	a0,a0,370 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc0203a86:	8effc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203a8a:	00002697          	auipc	a3,0x2
ffffffffc0203a8e:	24668693          	addi	a3,a3,582 # ffffffffc0205cd0 <default_pmm_manager+0xbe0>
ffffffffc0203a92:	00001617          	auipc	a2,0x1
ffffffffc0203a96:	2ae60613          	addi	a2,a2,686 # ffffffffc0204d40 <commands+0x738>
ffffffffc0203a9a:	0e700593          	li	a1,231
ffffffffc0203a9e:	00002517          	auipc	a0,0x2
ffffffffc0203aa2:	15250513          	addi	a0,a0,338 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc0203aa6:	8cffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203aaa:	00002697          	auipc	a3,0x2
ffffffffc0203aae:	23668693          	addi	a3,a3,566 # ffffffffc0205ce0 <default_pmm_manager+0xbf0>
ffffffffc0203ab2:	00001617          	auipc	a2,0x1
ffffffffc0203ab6:	28e60613          	addi	a2,a2,654 # ffffffffc0204d40 <commands+0x738>
ffffffffc0203aba:	0e900593          	li	a1,233
ffffffffc0203abe:	00002517          	auipc	a0,0x2
ffffffffc0203ac2:	13250513          	addi	a0,a0,306 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc0203ac6:	8affc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203aca:	00002697          	auipc	a3,0x2
ffffffffc0203ace:	22668693          	addi	a3,a3,550 # ffffffffc0205cf0 <default_pmm_manager+0xc00>
ffffffffc0203ad2:	00001617          	auipc	a2,0x1
ffffffffc0203ad6:	26e60613          	addi	a2,a2,622 # ffffffffc0204d40 <commands+0x738>
ffffffffc0203ada:	0eb00593          	li	a1,235
ffffffffc0203ade:	00002517          	auipc	a0,0x2
ffffffffc0203ae2:	11250513          	addi	a0,a0,274 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc0203ae6:	88ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203aea:	00002697          	auipc	a3,0x2
ffffffffc0203aee:	d2668693          	addi	a3,a3,-730 # ffffffffc0205810 <default_pmm_manager+0x720>
ffffffffc0203af2:	00001617          	auipc	a2,0x1
ffffffffc0203af6:	24e60613          	addi	a2,a2,590 # ffffffffc0204d40 <commands+0x738>
ffffffffc0203afa:	10d00593          	li	a1,269
ffffffffc0203afe:	00002517          	auipc	a0,0x2
ffffffffc0203b02:	0f250513          	addi	a0,a0,242 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc0203b06:	86ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203b0a:	00002697          	auipc	a3,0x2
ffffffffc0203b0e:	34668693          	addi	a3,a3,838 # ffffffffc0205e50 <default_pmm_manager+0xd60>
ffffffffc0203b12:	00001617          	auipc	a2,0x1
ffffffffc0203b16:	22e60613          	addi	a2,a2,558 # ffffffffc0204d40 <commands+0x738>
ffffffffc0203b1a:	10a00593          	li	a1,266
ffffffffc0203b1e:	00002517          	auipc	a0,0x2
ffffffffc0203b22:	0d250513          	addi	a0,a0,210 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
    check_mm_struct = mm_create();
ffffffffc0203b26:	0000e797          	auipc	a5,0xe
ffffffffc0203b2a:	a207bd23          	sd	zero,-1478(a5) # ffffffffc0211560 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203b2e:	847fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203b32:	00002697          	auipc	a3,0x2
ffffffffc0203b36:	cee68693          	addi	a3,a3,-786 # ffffffffc0205820 <default_pmm_manager+0x730>
ffffffffc0203b3a:	00001617          	auipc	a2,0x1
ffffffffc0203b3e:	20660613          	addi	a2,a2,518 # ffffffffc0204d40 <commands+0x738>
ffffffffc0203b42:	11100593          	li	a1,273
ffffffffc0203b46:	00002517          	auipc	a0,0x2
ffffffffc0203b4a:	0aa50513          	addi	a0,a0,170 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc0203b4e:	827fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203b52:	00002697          	auipc	a3,0x2
ffffffffc0203b56:	29668693          	addi	a3,a3,662 # ffffffffc0205de8 <default_pmm_manager+0xcf8>
ffffffffc0203b5a:	00001617          	auipc	a2,0x1
ffffffffc0203b5e:	1e660613          	addi	a2,a2,486 # ffffffffc0204d40 <commands+0x738>
ffffffffc0203b62:	11600593          	li	a1,278
ffffffffc0203b66:	00002517          	auipc	a0,0x2
ffffffffc0203b6a:	08a50513          	addi	a0,a0,138 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc0203b6e:	807fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203b72:	00002697          	auipc	a3,0x2
ffffffffc0203b76:	29668693          	addi	a3,a3,662 # ffffffffc0205e08 <default_pmm_manager+0xd18>
ffffffffc0203b7a:	00001617          	auipc	a2,0x1
ffffffffc0203b7e:	1c660613          	addi	a2,a2,454 # ffffffffc0204d40 <commands+0x738>
ffffffffc0203b82:	12000593          	li	a1,288
ffffffffc0203b86:	00002517          	auipc	a0,0x2
ffffffffc0203b8a:	06a50513          	addi	a0,a0,106 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc0203b8e:	fe6fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203b92:	00001617          	auipc	a2,0x1
ffffffffc0203b96:	59660613          	addi	a2,a2,1430 # ffffffffc0205128 <default_pmm_manager+0x38>
ffffffffc0203b9a:	06500593          	li	a1,101
ffffffffc0203b9e:	00001517          	auipc	a0,0x1
ffffffffc0203ba2:	5aa50513          	addi	a0,a0,1450 # ffffffffc0205148 <default_pmm_manager+0x58>
ffffffffc0203ba6:	fcefc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203baa:	00002697          	auipc	a3,0x2
ffffffffc0203bae:	1f668693          	addi	a3,a3,502 # ffffffffc0205da0 <default_pmm_manager+0xcb0>
ffffffffc0203bb2:	00001617          	auipc	a2,0x1
ffffffffc0203bb6:	18e60613          	addi	a2,a2,398 # ffffffffc0204d40 <commands+0x738>
ffffffffc0203bba:	12e00593          	li	a1,302
ffffffffc0203bbe:	00002517          	auipc	a0,0x2
ffffffffc0203bc2:	03250513          	addi	a0,a0,50 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc0203bc6:	faefc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203bca:	00002697          	auipc	a3,0x2
ffffffffc0203bce:	1d668693          	addi	a3,a3,470 # ffffffffc0205da0 <default_pmm_manager+0xcb0>
ffffffffc0203bd2:	00001617          	auipc	a2,0x1
ffffffffc0203bd6:	16e60613          	addi	a2,a2,366 # ffffffffc0204d40 <commands+0x738>
ffffffffc0203bda:	0bd00593          	li	a1,189
ffffffffc0203bde:	00002517          	auipc	a0,0x2
ffffffffc0203be2:	01250513          	addi	a0,a0,18 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc0203be6:	f8efc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203bea:	00002697          	auipc	a3,0x2
ffffffffc0203bee:	bfe68693          	addi	a3,a3,-1026 # ffffffffc02057e8 <default_pmm_manager+0x6f8>
ffffffffc0203bf2:	00001617          	auipc	a2,0x1
ffffffffc0203bf6:	14e60613          	addi	a2,a2,334 # ffffffffc0204d40 <commands+0x738>
ffffffffc0203bfa:	0c700593          	li	a1,199
ffffffffc0203bfe:	00002517          	auipc	a0,0x2
ffffffffc0203c02:	ff250513          	addi	a0,a0,-14 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc0203c06:	f6efc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c0a:	00002697          	auipc	a3,0x2
ffffffffc0203c0e:	19668693          	addi	a3,a3,406 # ffffffffc0205da0 <default_pmm_manager+0xcb0>
ffffffffc0203c12:	00001617          	auipc	a2,0x1
ffffffffc0203c16:	12e60613          	addi	a2,a2,302 # ffffffffc0204d40 <commands+0x738>
ffffffffc0203c1a:	0fb00593          	li	a1,251
ffffffffc0203c1e:	00002517          	auipc	a0,0x2
ffffffffc0203c22:	fd250513          	addi	a0,a0,-46 # ffffffffc0205bf0 <default_pmm_manager+0xb00>
ffffffffc0203c26:	f4efc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203c2a <do_pgfault>:
...
ffffffffc0203c2a:	7179                	addi	sp,sp,-48
    int ret = -E_INVAL;
    //try to find a vma which include addr
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203c2c:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203c2e:	f022                	sd	s0,32(sp)
ffffffffc0203c30:	ec26                	sd	s1,24(sp)
ffffffffc0203c32:	f406                	sd	ra,40(sp)
ffffffffc0203c34:	e84a                	sd	s2,16(sp)
ffffffffc0203c36:	8432                	mv	s0,a2
ffffffffc0203c38:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203c3a:	8d3ff0ef          	jal	ra,ffffffffc020350c <find_vma>

    pgfault_num++;
ffffffffc0203c3e:	0000e797          	auipc	a5,0xe
ffffffffc0203c42:	92a7a783          	lw	a5,-1750(a5) # ffffffffc0211568 <pgfault_num>
ffffffffc0203c46:	2785                	addiw	a5,a5,1
ffffffffc0203c48:	0000e717          	auipc	a4,0xe
ffffffffc0203c4c:	92f72023          	sw	a5,-1760(a4) # ffffffffc0211568 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203c50:	c159                	beqz	a0,ffffffffc0203cd6 <do_pgfault+0xac>
ffffffffc0203c52:	651c                	ld	a5,8(a0)
ffffffffc0203c54:	08f46163          	bltu	s0,a5,ffffffffc0203cd6 <do_pgfault+0xac>
...
ffffffffc0203c58:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203c5a:	4941                	li	s2,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203c5c:	8b89                	andi	a5,a5,2
ffffffffc0203c5e:	ebb1                	bnez	a5,ffffffffc0203cb2 <do_pgfault+0x88>
        perm |= (PTE_R | PTE_W);
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203c60:	75fd                	lui	a1,0xfffff
...
ffffffffc0203c62:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203c64:	8c6d                	and	s0,s0,a1
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc0203c66:	85a2                	mv	a1,s0
ffffffffc0203c68:	4605                	li	a2,1
ffffffffc0203c6a:	a63fd0ef          	jal	ra,ffffffffc02016cc <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0203c6e:	610c                	ld	a1,0(a0)
ffffffffc0203c70:	c1b9                	beqz	a1,ffffffffc0203cb6 <do_pgfault+0x8c>
...
ffffffffc0203c76:	8de7a783          	lw	a5,-1826(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203c7a:	c7bd                	beqz	a5,ffffffffc0203ce8 <do_pgfault+0xbe>
...
ffffffffc0203c7e:	0030                	addi	a2,sp,8
ffffffffc0203c80:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203c82:	e402                	sd	zero,8(sp)
            swap_in(mm, addr, &page);
ffffffffc0203c84:	c2cff0ef          	jal	ra,ffffffffc02030b0 <swap_in>
            page_insert(mm->pgdir, page, addr, perm);
ffffffffc0203c88:	65a2                	ld	a1,8(sp)
ffffffffc0203c8a:	6c88                	ld	a0,24(s1)
ffffffffc0203c8c:	86ca                	mv	a3,s2
ffffffffc0203c8e:	8622                	mv	a2,s0
ffffffffc0203c90:	d27fd0ef          	jal	ra,ffffffffc02019b6 <page_insert>
            swap_map_swappable(mm, addr, page, 1);
ffffffffc0203c94:	6622                	ld	a2,8(sp)
ffffffffc0203c96:	4685                	li	a3,1
ffffffffc0203c98:	85a2                	mv	a1,s0
ffffffffc0203c9a:	8526                	mv	a0,s1
ffffffffc0203c9c:	af4ff0ef          	jal	ra,ffffffffc0202f90 <swap_map_swappable>
            page->pra_vaddr = addr;
ffffffffc0203ca0:	67a2                	ld	a5,8(sp)
...
ffffffffc0203ca2:	4501                	li	a0,0
            page->pra_vaddr = addr;
ffffffffc0203ca4:	e3a0                	sd	s0,64(a5)
failed:
    return ret;
}
ffffffffc0203ca6:	70a2                	ld	ra,40(sp)
ffffffffc0203ca8:	7402                	ld	s0,32(sp)
ffffffffc0203caa:	64e2                	ld	s1,24(sp)
ffffffffc0203cac:	6942                	ld	s2,16(sp)
ffffffffc0203cae:	6145                	addi	sp,sp,48
ffffffffc0203cb0:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203cb2:	4959                	li	s2,22
ffffffffc0203cb4:	b775                	j	ffffffffc0203c60 <do_pgfault+0x36>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203cb6:	6c88                	ld	a0,24(s1)
ffffffffc0203cb8:	864a                	mv	a2,s2
ffffffffc0203cba:	85a2                	mv	a1,s0
ffffffffc0203cbc:	a05fe0ef          	jal	ra,ffffffffc02026c0 <pgdir_alloc_page>
ffffffffc0203cc0:	87aa                	mv	a5,a0
   ret = 0;
ffffffffc0203cc2:	4501                	li	a0,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203cc4:	f3ed                	bnez	a5,ffffffffc0203ca6 <do_pgfault+0x7c>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203cc6:	00002517          	auipc	a0,0x2
ffffffffc0203cca:	1d250513          	addi	a0,a0,466 # ffffffffc0205e98 <default_pmm_manager+0xda8>
ffffffffc0203cce:	becfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203cd2:	5571                	li	a0,-4
            goto failed;
ffffffffc0203cd4:	bfc9                	j	ffffffffc0203ca6 <do_pgfault+0x7c>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203cd6:	85a2                	mv	a1,s0
ffffffffc0203cd8:	00002517          	auipc	a0,0x2
ffffffffc0203cdc:	19050513          	addi	a0,a0,400 # ffffffffc0205e68 <default_pmm_manager+0xd78>
ffffffffc0203ce0:	bdafc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203ce4:	5575                	li	a0,-3
        goto failed;
ffffffffc0203ce6:	b7c1                	j	ffffffffc0203ca6 <do_pgfault+0x7c>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203ce8:	00002517          	auipc	a0,0x2
ffffffffc0203cec:	1d850513          	addi	a0,a0,472 # ffffffffc0205ec0 <default_pmm_manager+0xdd0>
ffffffffc0203cf0:	bcafc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203cf4:	5571                	li	a0,-4
            goto failed;
ffffffffc0203cf6:	bf45                	j	ffffffffc0203ca6 <do_pgfault+0x7c>

ffffffffc0203cf8 <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
ffffffffc0203cfc:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0203cfe:	f96fc0ef          	jal	ra,ffffffffc0200494 <ide_device_valid>
ffffffffc0203d02:	cd01                	beqz	a0,ffffffffc0203d1a <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203d04:	4505                	li	a0,1
ffffffffc0203d06:	f94fc0ef          	jal	ra,ffffffffc020049a <ide_device_size>
}
ffffffffc0203d0a:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203d0c:	810d                	srli	a0,a0,0x3
ffffffffc0203d0e:	0000e797          	auipc	a5,0xe
ffffffffc0203d12:	82a7b923          	sd	a0,-1998(a5) # ffffffffc0211540 <max_swap_offset>
}
ffffffffc0203d16:	0141                	addi	sp,sp,16
ffffffffc0203d18:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0203d1a:	00002617          	auipc	a2,0x2
ffffffffc0203d1e:	1ce60613          	addi	a2,a2,462 # ffffffffc0205ee8 <default_pmm_manager+0xdf8>
ffffffffc0203d22:	45b5                	li	a1,13
ffffffffc0203d24:	00002517          	auipc	a0,0x2
ffffffffc0203d28:	1e450513          	addi	a0,a0,484 # ffffffffc0205f08 <default_pmm_manager+0xe18>
ffffffffc0203d2c:	e48fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203d30 <swapfs_read>:
...
ffffffffc0203d34:	00855793          	srli	a5,a0,0x8
ffffffffc0203d38:	c3a5                	beqz	a5,ffffffffc0203d98 <swapfs_read+0x68>
ffffffffc0203d3a:	0000e717          	auipc	a4,0xe
ffffffffc0203d3e:	80673703          	ld	a4,-2042(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203d42:	04e7fb63          	bgeu	a5,a4,ffffffffc0203d98 <swapfs_read+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203d46:	0000d617          	auipc	a2,0xd
ffffffffc0203d4a:	7e263603          	ld	a2,2018(a2) # ffffffffc0211528 <pages>
ffffffffc0203d4e:	8d91                	sub	a1,a1,a2
ffffffffc0203d50:	4035d613          	srai	a2,a1,0x3
ffffffffc0203d54:	00002597          	auipc	a1,0x2
ffffffffc0203d58:	4345b583          	ld	a1,1076(a1) # ffffffffc0206188 <error_string+0x38>
ffffffffc0203d5c:	02b60633          	mul	a2,a2,a1
ffffffffc0203d60:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203d64:	00002797          	auipc	a5,0x2
ffffffffc0203d68:	42c7b783          	ld	a5,1068(a5) # ffffffffc0206190 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203d6c:	0000d717          	auipc	a4,0xd
ffffffffc0203d70:	7b473703          	ld	a4,1972(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203d74:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203d76:	00c61793          	slli	a5,a2,0xc
ffffffffc0203d7a:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203d7c:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203d7e:	02e7f963          	bgeu	a5,a4,ffffffffc0203db0 <swapfs_read+0x80>
}
ffffffffc0203d82:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203d84:	0000d797          	auipc	a5,0xd
ffffffffc0203d88:	7b47b783          	ld	a5,1972(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203d8c:	46a1                	li	a3,8
ffffffffc0203d8e:	963e                	add	a2,a2,a5
ffffffffc0203d90:	4505                	li	a0,1
}
ffffffffc0203d92:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203d94:	f0cfc06f          	j	ffffffffc02004a0 <ide_read_secs>
ffffffffc0203d98:	86aa                	mv	a3,a0
ffffffffc0203d9a:	00002617          	auipc	a2,0x2
ffffffffc0203d9e:	18660613          	addi	a2,a2,390 # ffffffffc0205f20 <default_pmm_manager+0xe30>
ffffffffc0203da2:	45d1                	li	a1,20
ffffffffc0203da4:	00002517          	auipc	a0,0x2
ffffffffc0203da8:	16450513          	addi	a0,a0,356 # ffffffffc0205f08 <default_pmm_manager+0xe18>
ffffffffc0203dac:	dc8fc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203db0:	86b2                	mv	a3,a2
ffffffffc0203db2:	06a00593          	li	a1,106
ffffffffc0203db6:	00001617          	auipc	a2,0x1
ffffffffc0203dba:	3ca60613          	addi	a2,a2,970 # ffffffffc0205180 <default_pmm_manager+0x90>
ffffffffc0203dbe:	00001517          	auipc	a0,0x1
ffffffffc0203dc2:	38a50513          	addi	a0,a0,906 # ffffffffc0205148 <default_pmm_manager+0x58>
ffffffffc0203dc6:	daefc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203dca <swapfs_write>:
...
ffffffffc0203dd2:	c3a5                	beqz	a5,ffffffffc0203e32 <swapfs_write+0x68>
ffffffffc0203dd4:	0000d717          	auipc	a4,0xd
ffffffffc0203dd8:	76c73703          	ld	a4,1900(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203ddc:	04e7fb63          	bgeu	a5,a4,ffffffffc0203e32 <swapfs_write+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0203df2:	39a5b583          	ld	a1,922(a1) # ffffffffc0206188 <error_string+0x38>
ffffffffc0203df6:	02b60633          	mul	a2,a2,a1
ffffffffc0203dfa:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203dfe:	00002797          	auipc	a5,0x2
ffffffffc0203e02:	3927b783          	ld	a5,914(a5) # ffffffffc0206190 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
...
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e18:	02e7f963          	bgeu	a5,a4,ffffffffc0203e4a <swapfs_write+0x80>
}
...
ffffffffc0203e2c:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e2e:	e96fc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203e32:	86aa                	mv	a3,a0
ffffffffc0203e34:	00002617          	auipc	a2,0x2
ffffffffc0203e38:	0ec60613          	addi	a2,a2,236 # ffffffffc0205f20 <default_pmm_manager+0xe30>
ffffffffc0203e3c:	45e5                	li	a1,25
ffffffffc0203e3e:	00002517          	auipc	a0,0x2
ffffffffc0203e42:	0ca50513          	addi	a0,a0,202 # ffffffffc0205f08 <default_pmm_manager+0xe18>
...
ffffffffc0203e54:	33060613          	addi	a2,a2,816 # ffffffffc0205180 <default_pmm_manager+0x90>
ffffffffc0203e58:	00001517          	auipc	a0,0x1
ffffffffc0203e5c:	2f050513          	addi	a0,a0,752 # ffffffffc0205148 <default_pmm_manager+0x58>
ffffffffc0203e60:	d14fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203e64 <printnum>:
 * */
static void
...
ffffffffc0203e64:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203e68:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203e6a:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203e6e:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203e70:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203e74:	f022                	sd	s0,32(sp)
ffffffffc0203e76:	ec26                	sd	s1,24(sp)
ffffffffc0203e78:	e84a                	sd	s2,16(sp)
ffffffffc0203e7a:	f406                	sd	ra,40(sp)
ffffffffc0203e7c:	e44e                	sd	s3,8(sp)
ffffffffc0203e7e:	84aa                	mv	s1,a0
ffffffffc0203e80:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203e82:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203e86:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0203e88:	03067e63          	bgeu	a2,a6,ffffffffc0203ec4 <printnum+0x60>
ffffffffc0203e8c:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203e8e:	00805763          	blez	s0,ffffffffc0203e9c <printnum+0x38>
ffffffffc0203e92:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203e94:	85ca                	mv	a1,s2
ffffffffc0203e96:	854e                	mv	a0,s3
ffffffffc0203e98:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203e9a:	fc65                	bnez	s0,ffffffffc0203e92 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203e9c:	1a02                	slli	s4,s4,0x20
ffffffffc0203e9e:	00002797          	auipc	a5,0x2
ffffffffc0203ea2:	0a278793          	addi	a5,a5,162 # ffffffffc0205f40 <default_pmm_manager+0xe50>
ffffffffc0203ea6:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203eaa:	9a3e                	add	s4,s4,a5
}
ffffffffc0203eac:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203eae:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203eb2:	70a2                	ld	ra,40(sp)
ffffffffc0203eb4:	69a2                	ld	s3,8(sp)
ffffffffc0203eb6:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203eb8:	85ca                	mv	a1,s2
ffffffffc0203eba:	87a6                	mv	a5,s1
}
ffffffffc0203ebc:	6942                	ld	s2,16(sp)
ffffffffc0203ebe:	64e2                	ld	s1,24(sp)
ffffffffc0203ec0:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ec2:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203ec4:	03065633          	divu	a2,a2,a6
ffffffffc0203ec8:	8722                	mv	a4,s0
ffffffffc0203eca:	f9bff0ef          	jal	ra,ffffffffc0203e64 <printnum>
ffffffffc0203ece:	b7f9                	j	ffffffffc0203e9c <printnum+0x38>

ffffffffc0203ed0 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203ed0:	7119                	addi	sp,sp,-128
ffffffffc0203ed2:	f4a6                	sd	s1,104(sp)
ffffffffc0203ed4:	f0ca                	sd	s2,96(sp)
ffffffffc0203ed6:	ecce                	sd	s3,88(sp)
ffffffffc0203ed8:	e8d2                	sd	s4,80(sp)
ffffffffc0203eda:	e4d6                	sd	s5,72(sp)
ffffffffc0203edc:	e0da                	sd	s6,64(sp)
ffffffffc0203ede:	fc5e                	sd	s7,56(sp)
ffffffffc0203ee0:	f06a                	sd	s10,32(sp)
ffffffffc0203ee2:	fc86                	sd	ra,120(sp)
ffffffffc0203ee4:	f8a2                	sd	s0,112(sp)
ffffffffc0203ee6:	f862                	sd	s8,48(sp)
ffffffffc0203ee8:	f466                	sd	s9,40(sp)
ffffffffc0203eea:	ec6e                	sd	s11,24(sp)
ffffffffc0203eec:	892a                	mv	s2,a0
ffffffffc0203eee:	84ae                	mv	s1,a1
ffffffffc0203ef0:	8d32                	mv	s10,a2
ffffffffc0203ef2:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203ef4:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203ef8:	5b7d                	li	s6,-1
ffffffffc0203efa:	00002a97          	auipc	s5,0x2
ffffffffc0203efe:	07aa8a93          	addi	s5,s5,122 # ffffffffc0205f74 <default_pmm_manager+0xe84>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203f02:	00002b97          	auipc	s7,0x2
ffffffffc0203f06:	24eb8b93          	addi	s7,s7,590 # ffffffffc0206150 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f0a:	000d4503          	lbu	a0,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
ffffffffc0203f0e:	001d0413          	addi	s0,s10,1
ffffffffc0203f12:	01350a63          	beq	a0,s3,ffffffffc0203f26 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203f16:	c121                	beqz	a0,ffffffffc0203f56 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0203f18:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f1a:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203f1c:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f1e:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203f22:	ff351ae3          	bne	a0,s3,ffffffffc0203f16 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f26:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203f2a:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203f2e:	4c81                	li	s9,0
ffffffffc0203f30:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203f32:	5c7d                	li	s8,-1
ffffffffc0203f34:	5dfd                	li	s11,-1
ffffffffc0203f36:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203f3a:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f3c:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203f40:	0ff5f593          	zext.b	a1,a1
ffffffffc0203f44:	00140d13          	addi	s10,s0,1
ffffffffc0203f48:	04b56263          	bltu	a0,a1,ffffffffc0203f8c <vprintfmt+0xbc>
ffffffffc0203f4c:	058a                	slli	a1,a1,0x2
ffffffffc0203f4e:	95d6                	add	a1,a1,s5
ffffffffc0203f50:	4194                	lw	a3,0(a1)
ffffffffc0203f52:	96d6                	add	a3,a3,s5
ffffffffc0203f54:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203f56:	70e6                	ld	ra,120(sp)
ffffffffc0203f58:	7446                	ld	s0,112(sp)
ffffffffc0203f5a:	74a6                	ld	s1,104(sp)
ffffffffc0203f5c:	7906                	ld	s2,96(sp)
ffffffffc0203f5e:	69e6                	ld	s3,88(sp)
ffffffffc0203f60:	6a46                	ld	s4,80(sp)
ffffffffc0203f62:	6aa6                	ld	s5,72(sp)
ffffffffc0203f64:	6b06                	ld	s6,64(sp)
ffffffffc0203f66:	7be2                	ld	s7,56(sp)
ffffffffc0203f68:	7c42                	ld	s8,48(sp)
ffffffffc0203f6a:	7ca2                	ld	s9,40(sp)
ffffffffc0203f6c:	7d02                	ld	s10,32(sp)
ffffffffc0203f6e:	6de2                	ld	s11,24(sp)
ffffffffc0203f70:	6109                	addi	sp,sp,128
ffffffffc0203f72:	8082                	ret
            padc = '0';
ffffffffc0203f74:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0203f76:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f7a:	846a                	mv	s0,s10
ffffffffc0203f7c:	00140d13          	addi	s10,s0,1
ffffffffc0203f80:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203f84:	0ff5f593          	zext.b	a1,a1
ffffffffc0203f88:	fcb572e3          	bgeu	a0,a1,ffffffffc0203f4c <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0203f8c:	85a6                	mv	a1,s1
ffffffffc0203f8e:	02500513          	li	a0,37
ffffffffc0203f92:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0203f94:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203f98:	8d22                	mv	s10,s0
ffffffffc0203f9a:	f73788e3          	beq	a5,s3,ffffffffc0203f0a <vprintfmt+0x3a>
ffffffffc0203f9e:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0203fa2:	1d7d                	addi	s10,s10,-1
ffffffffc0203fa4:	ff379de3          	bne	a5,s3,ffffffffc0203f9e <vprintfmt+0xce>
ffffffffc0203fa8:	b78d                	j	ffffffffc0203f0a <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0203faa:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
...
ffffffffc0203fb4:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0203fb8:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203fbc:	02d86463          	bltu	a6,a3,ffffffffc0203fe4 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0203fc0:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0203fc4:	002c169b          	slliw	a3,s8,0x2
ffffffffc0203fc8:	0186873b          	addw	a4,a3,s8
ffffffffc0203fcc:	0017171b          	slliw	a4,a4,0x1
ffffffffc0203fd0:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0203fd2:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0203fd6:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0203fd8:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0203fdc:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203fe0:	fed870e3          	bgeu	a6,a3,ffffffffc0203fc0 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0203fe4:	f40ddce3          	bgez	s11,ffffffffc0203f3c <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0203fe8:	8de2                	mv	s11,s8
ffffffffc0203fea:	5c7d                	li	s8,-1
ffffffffc0203fec:	bf81                	j	ffffffffc0203f3c <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0203fee:	fffdc693          	not	a3,s11
ffffffffc0203ff2:	96fd                	srai	a3,a3,0x3f
ffffffffc0203ff4:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203ff8:	00144603          	lbu	a2,1(s0)
ffffffffc0203ffc:	2d81                	sext.w	s11,s11
ffffffffc0203ffe:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204000:	bf35                	j	ffffffffc0203f3c <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204002:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204006:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc020400a:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020400c:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc020400e:	bfd9                	j	ffffffffc0203fe4 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204010:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204012:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204016:	01174463          	blt	a4,a7,ffffffffc020401e <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc020401a:	1a088e63          	beqz	a7,ffffffffc02041d6 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc020401e:	000a3603          	ld	a2,0(s4)
ffffffffc0204022:	46c1                	li	a3,16
ffffffffc0204024:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204026:	2781                	sext.w	a5,a5
ffffffffc0204028:	876e                	mv	a4,s11
ffffffffc020402a:	85a6                	mv	a1,s1
ffffffffc020402c:	854a                	mv	a0,s2
ffffffffc020402e:	e37ff0ef          	jal	ra,ffffffffc0203e64 <printnum>
            break;
ffffffffc0204032:	bde1                	j	ffffffffc0203f0a <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204034:	000a2503          	lw	a0,0(s4)
ffffffffc0204038:	85a6                	mv	a1,s1
ffffffffc020403a:	0a21                	addi	s4,s4,8
ffffffffc020403c:	9902                	jalr	s2
            break;
ffffffffc020403e:	b5f1                	j	ffffffffc0203f0a <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204040:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204042:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204046:	01174463          	blt	a4,a7,ffffffffc020404e <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc020404a:	18088163          	beqz	a7,ffffffffc02041cc <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc020404e:	000a3603          	ld	a2,0(s4)
ffffffffc0204052:	46a9                	li	a3,10
ffffffffc0204054:	8a2e                	mv	s4,a1
ffffffffc0204056:	bfc1                	j	ffffffffc0204026 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204058:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc020405c:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020405e:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204060:	bdf1                	j	ffffffffc0203f3c <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204062:	85a6                	mv	a1,s1
ffffffffc0204064:	02500513          	li	a0,37
ffffffffc0204068:	9902                	jalr	s2
            break;
ffffffffc020406a:	b545                	j	ffffffffc0203f0a <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020406c:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204070:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204072:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204074:	b5e1                	j	ffffffffc0203f3c <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204076:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204078:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020407c:	01174463          	blt	a4,a7,ffffffffc0204084 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204080:	14088163          	beqz	a7,ffffffffc02041c2 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204084:	000a3603          	ld	a2,0(s4)
ffffffffc0204088:	46a1                	li	a3,8
ffffffffc020408a:	8a2e                	mv	s4,a1
ffffffffc020408c:	bf69                	j	ffffffffc0204026 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc020408e:	03000513          	li	a0,48
ffffffffc0204092:	85a6                	mv	a1,s1
ffffffffc0204094:	e03e                	sd	a5,0(sp)
ffffffffc0204096:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204098:	85a6                	mv	a1,s1
ffffffffc020409a:	07800513          	li	a0,120
ffffffffc020409e:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040a0:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc02040a2:	6782                	ld	a5,0(sp)
ffffffffc02040a4:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040a6:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc02040aa:	bfb5                	j	ffffffffc0204026 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02040ac:	000a3403          	ld	s0,0(s4)
ffffffffc02040b0:	008a0713          	addi	a4,s4,8
ffffffffc02040b4:	e03a                	sd	a4,0(sp)
ffffffffc02040b6:	14040263          	beqz	s0,ffffffffc02041fa <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc02040ba:	0fb05763          	blez	s11,ffffffffc02041a8 <vprintfmt+0x2d8>
ffffffffc02040be:	02d00693          	li	a3,45
ffffffffc02040c2:	0cd79163          	bne	a5,a3,ffffffffc0204184 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02040c6:	00044783          	lbu	a5,0(s0)
ffffffffc02040ca:	0007851b          	sext.w	a0,a5
ffffffffc02040ce:	cf85                	beqz	a5,ffffffffc0204106 <vprintfmt+0x236>
ffffffffc02040d0:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02040d4:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02040d8:	000c4563          	bltz	s8,ffffffffc02040e2 <vprintfmt+0x212>
ffffffffc02040dc:	3c7d                	addiw	s8,s8,-1
ffffffffc02040de:	036c0263          	beq	s8,s6,ffffffffc0204102 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc02040e2:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02040e4:	0e0c8e63          	beqz	s9,ffffffffc02041e0 <vprintfmt+0x310>
ffffffffc02040e8:	3781                	addiw	a5,a5,-32
ffffffffc02040ea:	0ef47b63          	bgeu	s0,a5,ffffffffc02041e0 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc02040ee:	03f00513          	li	a0,63
ffffffffc02040f2:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02040f4:	000a4783          	lbu	a5,0(s4)
ffffffffc02040f8:	3dfd                	addiw	s11,s11,-1
ffffffffc02040fa:	0a05                	addi	s4,s4,1
ffffffffc02040fc:	0007851b          	sext.w	a0,a5
ffffffffc0204100:	ffe1                	bnez	a5,ffffffffc02040d8 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204102:	01b05963          	blez	s11,ffffffffc0204114 <vprintfmt+0x244>
ffffffffc0204106:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204108:	85a6                	mv	a1,s1
ffffffffc020410a:	02000513          	li	a0,32
ffffffffc020410e:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204110:	fe0d9be3          	bnez	s11,ffffffffc0204106 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204114:	6a02                	ld	s4,0(sp)
ffffffffc0204116:	bbd5                	j	ffffffffc0203f0a <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204118:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020411a:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc020411e:	01174463          	blt	a4,a7,ffffffffc0204126 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204122:	08088d63          	beqz	a7,ffffffffc02041bc <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204126:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc020412a:	0a044d63          	bltz	s0,ffffffffc02041e4 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc020412e:	8622                	mv	a2,s0
ffffffffc0204130:	8a66                	mv	s4,s9
ffffffffc0204132:	46a9                	li	a3,10
ffffffffc0204134:	bdcd                	j	ffffffffc0204026 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204136:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc020413a:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc020413c:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc020413e:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204142:	8fb5                	xor	a5,a5,a3
ffffffffc0204144:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204148:	02d74163          	blt	a4,a3,ffffffffc020416a <vprintfmt+0x29a>
ffffffffc020414c:	00369793          	slli	a5,a3,0x3
ffffffffc0204150:	97de                	add	a5,a5,s7
ffffffffc0204152:	639c                	ld	a5,0(a5)
ffffffffc0204154:	cb99                	beqz	a5,ffffffffc020416a <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204156:	86be                	mv	a3,a5
ffffffffc0204158:	00002617          	auipc	a2,0x2
ffffffffc020415c:	e1860613          	addi	a2,a2,-488 # ffffffffc0205f70 <default_pmm_manager+0xe80>
ffffffffc0204160:	85a6                	mv	a1,s1
ffffffffc0204162:	854a                	mv	a0,s2
ffffffffc0204164:	0ce000ef          	jal	ra,ffffffffc0204232 <printfmt>
ffffffffc0204168:	b34d                	j	ffffffffc0203f0a <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc020416a:	00002617          	auipc	a2,0x2
ffffffffc020416e:	df660613          	addi	a2,a2,-522 # ffffffffc0205f60 <default_pmm_manager+0xe70>
ffffffffc0204172:	85a6                	mv	a1,s1
ffffffffc0204174:	854a                	mv	a0,s2
ffffffffc0204176:	0bc000ef          	jal	ra,ffffffffc0204232 <printfmt>
ffffffffc020417a:	bb41                	j	ffffffffc0203f0a <vprintfmt+0x3a>
                p = "(null)";
ffffffffc020417c:	00002417          	auipc	s0,0x2
ffffffffc0204180:	ddc40413          	addi	s0,s0,-548 # ffffffffc0205f58 <default_pmm_manager+0xe68>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204184:	85e2                	mv	a1,s8
ffffffffc0204186:	8522                	mv	a0,s0
ffffffffc0204188:	e43e                	sd	a5,8(sp)
ffffffffc020418a:	196000ef          	jal	ra,ffffffffc0204320 <strnlen>
ffffffffc020418e:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204192:	01b05b63          	blez	s11,ffffffffc02041a8 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204196:	67a2                	ld	a5,8(sp)
ffffffffc0204198:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020419c:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc020419e:	85a6                	mv	a1,s1
ffffffffc02041a0:	8552                	mv	a0,s4
ffffffffc02041a2:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041a4:	fe0d9ce3          	bnez	s11,ffffffffc020419c <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041a8:	00044783          	lbu	a5,0(s0)
ffffffffc02041ac:	00140a13          	addi	s4,s0,1
ffffffffc02041b0:	0007851b          	sext.w	a0,a5
ffffffffc02041b4:	d3a5                	beqz	a5,ffffffffc0204114 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02041b6:	05e00413          	li	s0,94
ffffffffc02041ba:	bf39                	j	ffffffffc02040d8 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc02041bc:	000a2403          	lw	s0,0(s4)
ffffffffc02041c0:	b7ad                	j	ffffffffc020412a <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc02041c2:	000a6603          	lwu	a2,0(s4)
ffffffffc02041c6:	46a1                	li	a3,8
ffffffffc02041c8:	8a2e                	mv	s4,a1
ffffffffc02041ca:	bdb1                	j	ffffffffc0204026 <vprintfmt+0x156>
ffffffffc02041cc:	000a6603          	lwu	a2,0(s4)
ffffffffc02041d0:	46a9                	li	a3,10
ffffffffc02041d2:	8a2e                	mv	s4,a1
ffffffffc02041d4:	bd89                	j	ffffffffc0204026 <vprintfmt+0x156>
ffffffffc02041d6:	000a6603          	lwu	a2,0(s4)
ffffffffc02041da:	46c1                	li	a3,16
ffffffffc02041dc:	8a2e                	mv	s4,a1
ffffffffc02041de:	b5a1                	j	ffffffffc0204026 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc02041e0:	9902                	jalr	s2
ffffffffc02041e2:	bf09                	j	ffffffffc02040f4 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc02041e4:	85a6                	mv	a1,s1
ffffffffc02041e6:	02d00513          	li	a0,45
ffffffffc02041ea:	e03e                	sd	a5,0(sp)
ffffffffc02041ec:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02041ee:	6782                	ld	a5,0(sp)
ffffffffc02041f0:	8a66                	mv	s4,s9
ffffffffc02041f2:	40800633          	neg	a2,s0
ffffffffc02041f6:	46a9                	li	a3,10
ffffffffc02041f8:	b53d                	j	ffffffffc0204026 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc02041fa:	03b05163          	blez	s11,ffffffffc020421c <vprintfmt+0x34c>
ffffffffc02041fe:	02d00693          	li	a3,45
ffffffffc0204202:	f6d79de3          	bne	a5,a3,ffffffffc020417c <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204206:	00002417          	auipc	s0,0x2
ffffffffc020420a:	d5240413          	addi	s0,s0,-686 # ffffffffc0205f58 <default_pmm_manager+0xe68>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020420e:	02800793          	li	a5,40
ffffffffc0204212:	02800513          	li	a0,40
ffffffffc0204216:	00140a13          	addi	s4,s0,1
ffffffffc020421a:	bd6d                	j	ffffffffc02040d4 <vprintfmt+0x204>
ffffffffc020421c:	00002a17          	auipc	s4,0x2
ffffffffc0204220:	d3da0a13          	addi	s4,s4,-707 # ffffffffc0205f59 <default_pmm_manager+0xe69>
ffffffffc0204224:	02800513          	li	a0,40
ffffffffc0204228:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020422c:	05e00413          	li	s0,94
ffffffffc0204230:	b565                	j	ffffffffc02040d8 <vprintfmt+0x208>
...
ffffffffc0204246:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204248:	c89ff0ef          	jal	ra,ffffffffc0203ed0 <vprintfmt>
}
...
ffffffffc0204256:	e0a6                	sd	s1,64(sp)
ffffffffc0204258:	fc4a                	sd	s2,56(sp)
ffffffffc020425a:	f84e                	sd	s3,48(sp)
ffffffffc020425c:	f452                	sd	s4,40(sp)
ffffffffc020425e:	f056                	sd	s5,32(sp)
ffffffffc0204260:	ec5a                	sd	s6,24(sp)
ffffffffc0204262:	e85e                	sd	s7,16(sp)
    if (prompt != NULL) {
ffffffffc0204264:	c901                	beqz	a0,ffffffffc0204274 <readline+0x22>
ffffffffc0204266:	85aa                	mv	a1,a0
        cprintf("%s", prompt);
ffffffffc0204268:	00002517          	auipc	a0,0x2
ffffffffc020426c:	d0850513          	addi	a0,a0,-760 # ffffffffc0205f70 <default_pmm_manager+0xe80>
ffffffffc0204270:	e4bfb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
...
ffffffffc0204276:	497d                	li	s2,31
            cputchar(c);
            buf[i ++] = c;
        }
        else if (c == '\b' && i > 0) {
ffffffffc0204278:	49a1                	li	s3,8
            cputchar(c);
            i --;
        }
        else if (c == '\n' || c == '\r') {
ffffffffc020427a:	4aa9                	li	s5,10
ffffffffc020427c:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc020427e:	0000db97          	auipc	s7,0xd
ffffffffc0204282:	e7ab8b93          	addi	s7,s7,-390 # ffffffffc02110f8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204286:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc020428a:	e69fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc020428e:	00054a63          	bltz	a0,ffffffffc02042a2 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204292:	00a95a63          	bge	s2,a0,ffffffffc02042a6 <readline+0x54>
ffffffffc0204296:	029a5263          	bge	s4,s1,ffffffffc02042ba <readline+0x68>
        c = getchar();
ffffffffc020429a:	e59fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc020429e:	fe055ae3          	bgez	a0,ffffffffc0204292 <readline+0x40>
            return NULL;
ffffffffc02042a2:	4501                	li	a0,0
ffffffffc02042a4:	a091                	j	ffffffffc02042e8 <readline+0x96>
        else if (c == '\b' && i > 0) {
ffffffffc02042a6:	03351463          	bne	a0,s3,ffffffffc02042ce <readline+0x7c>
ffffffffc02042aa:	e8a9                	bnez	s1,ffffffffc02042fc <readline+0xaa>
        c = getchar();
ffffffffc02042ac:	e47fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042b0:	fe0549e3          	bltz	a0,ffffffffc02042a2 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042b4:	fea959e3          	bge	s2,a0,ffffffffc02042a6 <readline+0x54>
ffffffffc02042b8:	4481                	li	s1,0
            cputchar(c);
ffffffffc02042ba:	e42a                	sd	a0,8(sp)
ffffffffc02042bc:	e35fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i ++] = c;
ffffffffc02042c0:	6522                	ld	a0,8(sp)
ffffffffc02042c2:	009b87b3          	add	a5,s7,s1
ffffffffc02042c6:	2485                	addiw	s1,s1,1
ffffffffc02042c8:	00a78023          	sb	a0,0(a5)
ffffffffc02042cc:	bf7d                	j	ffffffffc020428a <readline+0x38>
        else if (c == '\n' || c == '\r') {
ffffffffc02042ce:	01550463          	beq	a0,s5,ffffffffc02042d6 <readline+0x84>
ffffffffc02042d2:	fb651ce3          	bne	a0,s6,ffffffffc020428a <readline+0x38>
            cputchar(c);
ffffffffc02042d6:	e1bfb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
ffffffffc02042da:	0000d517          	auipc	a0,0xd
ffffffffc02042de:	e1e50513          	addi	a0,a0,-482 # ffffffffc02110f8 <buf>
ffffffffc02042e2:	94aa                	add	s1,s1,a0
ffffffffc02042e4:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc02042e8:	60a6                	ld	ra,72(sp)
ffffffffc02042ea:	6486                	ld	s1,64(sp)
ffffffffc02042ec:	7962                	ld	s2,56(sp)
ffffffffc02042ee:	79c2                	ld	s3,48(sp)
ffffffffc02042f0:	7a22                	ld	s4,40(sp)
ffffffffc02042f2:	7a82                	ld	s5,32(sp)
ffffffffc02042f4:	6b62                	ld	s6,24(sp)
ffffffffc02042f6:	6bc2                	ld	s7,16(sp)
ffffffffc02042f8:	6161                	addi	sp,sp,80
ffffffffc02042fa:	8082                	ret
            cputchar(c);
ffffffffc02042fc:	4521                	li	a0,8
ffffffffc02042fe:	df3fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            i --;
ffffffffc0204302:	34fd                	addiw	s1,s1,-1
ffffffffc0204304:	b759                	j	ffffffffc020428a <readline+0x38>

ffffffffc0204306 <strlen>:
...
strlen(const char *s) {
ffffffffc020430a:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc020430c:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc020430e:	cb81                	beqz	a5,ffffffffc020431e <strlen+0x18>
        cnt ++;
ffffffffc0204310:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204312:	00a707b3          	add	a5,a4,a0
ffffffffc0204316:	0007c783          	lbu	a5,0(a5)
ffffffffc020431a:	fbfd                	bnez	a5,ffffffffc0204310 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204320:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204322:	e589                	bnez	a1,ffffffffc020432c <strnlen+0xc>
ffffffffc0204324:	a811                	j	ffffffffc0204338 <strnlen+0x18>
        cnt ++;
ffffffffc0204326:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204328:	00f58863          	beq	a1,a5,ffffffffc0204338 <strnlen+0x18>
ffffffffc020432c:	00f50733          	add	a4,a0,a5
ffffffffc0204330:	00074703          	lbu	a4,0(a4)
ffffffffc0204334:	fb6d                	bnez	a4,ffffffffc0204326 <strnlen+0x6>
ffffffffc0204336:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204338:	852e                	mv	a0,a1
ffffffffc020433a:	8082                	ret

ffffffffc020433c <strcpy>:
char *
...
ffffffffc020433c:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc020433e:	0005c703          	lbu	a4,0(a1)
ffffffffc0204342:	0785                	addi	a5,a5,1
ffffffffc0204344:	0585                	addi	a1,a1,1
ffffffffc0204346:	fee78fa3          	sb	a4,-1(a5)
ffffffffc020434a:	fb75                	bnez	a4,ffffffffc020433e <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020434e:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204352:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204356:	cb89                	beqz	a5,ffffffffc0204368 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204358:	0505                	addi	a0,a0,1
ffffffffc020435a:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020435c:	fee789e3          	beq	a5,a4,ffffffffc020434e <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204360:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204364:	9d19                	subw	a0,a0,a4
ffffffffc0204366:	8082                	ret
ffffffffc0204368:	4501                	li	a0,0
ffffffffc020436a:	bfed                	j	ffffffffc0204364 <strcmp+0x16>

ffffffffc020436c <strchr>:
...
ffffffffc0204370:	c799                	beqz	a5,ffffffffc020437e <strchr+0x12>
        if (*s == c) {
ffffffffc0204372:	00f58763          	beq	a1,a5,ffffffffc0204380 <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204376:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc020437a:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc020437c:	fbfd                	bnez	a5,ffffffffc0204372 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204382:	ca01                	beqz	a2,ffffffffc0204392 <memset+0x10>
ffffffffc0204384:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204386:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204388:	0785                	addi	a5,a5,1
ffffffffc020438a:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc020438e:	fec79de3          	bne	a5,a2,ffffffffc0204388 <memset+0x6>
    }
    return s;
...
ffffffffc0204394 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204394:	ca19                	beqz	a2,ffffffffc02043aa <memcpy+0x16>
ffffffffc0204396:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204398:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc020439a:	0005c703          	lbu	a4,0(a1)
ffffffffc020439e:	0585                	addi	a1,a1,1
ffffffffc02043a0:	0785                	addi	a5,a5,1
ffffffffc02043a2:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02043a6:	fec59ae3          	bne	a1,a2,ffffffffc020439a <memcpy+0x6>
    }
    return dst;
